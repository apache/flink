...
/**
 * This class provides an interface for decompressing byte-buffers with the native miniLZO library.
 * 
 * @author akli
 */
public class LzoDecompressor extends AbstractDecompressor {
