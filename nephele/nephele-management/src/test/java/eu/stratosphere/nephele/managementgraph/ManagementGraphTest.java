...
public class ManagementGraphTest {
	...
	private static ManagementGraph constructTestManagementGraph() {
		...
		// Edges
		new ManagementEdge(new ManagementEdgeID(outputGate1_1.getManagementGateID(),
			inputGate2_1.getManagementGateID()), outputGate1_1, 0, inputGate2_1, 0, ChannelType.NETWORK,
			CompressionLevel.NO_COMPRESSION);
		new ManagementEdge(new ManagementEdgeID(outputGate1_1.getManagementGateID(),
			inputGate2_2.getManagementGateID()), outputGate1_1, 1, inputGate2_2, 0, ChannelType.NETWORK,
			CompressionLevel.NO_COMPRESSION);
		new ManagementEdge(new ManagementEdgeID(outputGate2_1.getManagementGateID(),
			inputGate3_1.getManagementGateID()), outputGate2_1, 0, inputGate3_1, 0, ChannelType.FILE,
			CompressionLevel.NO_COMPRESSION);
		new ManagementEdge(new ManagementEdgeID(outputGate2_2.getManagementGateID(),
			inputGate3_1.getManagementGateID()), outputGate2_2, 0, inputGate3_1, 1, ChannelType.FILE,
			CompressionLevel.NO_COMPRESSION);
		new ManagementEdge(new ManagementEdgeID(outputGate3_1.getManagementGateID(),
			inputGate4_1.getManagementGateID()), outputGate3_1, 0, inputGate4_1, 0, ChannelType.INMEMORY,
			CompressionLevel.NO_COMPRESSION);
