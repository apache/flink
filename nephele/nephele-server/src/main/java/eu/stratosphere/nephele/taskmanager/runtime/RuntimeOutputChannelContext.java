...
public final class RuntimeOutputChannelContext implements ByteBufferedOutputChannelBroker, OutputChannelContext {

	/**
	 * The static object used for logging.
	 */
	private static final Log LOG = LogFactory.getLog(RuntimeOutputChannelContext.class);
	...
	RuntimeOutputChannelContext(final RuntimeOutputGateContext outputGateContext,
