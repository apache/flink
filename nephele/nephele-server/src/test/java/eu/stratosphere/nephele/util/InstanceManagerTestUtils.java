...
/**
 * This class contains utility methods used during the tests of the different {@link InstanceManager} implementations.
 * 
 * @author warneke
 */
public class InstanceManagerTestUtils {
	 ...
	 */
	private InstanceManagerTestUtils() {
	}
