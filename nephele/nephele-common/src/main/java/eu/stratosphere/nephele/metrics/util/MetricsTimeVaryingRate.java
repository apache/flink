...
public class MetricsTimeVaryingRate extends MetricsBase {
	 ...
	 * (JMX gets the info via {@link #getPreviousIntervalAverageTime()} and {@link #getPreviousIntervalNumOps()}
	 * 
	 * @param mr
	 */
	...
	/**
	 * The min time for a single operation since the last reset {@link #resetMinMax()}
	 * 
	...
	/**
	 * The max time for a single operation since the last reset {@link #resetMinMax()}
	 * 
