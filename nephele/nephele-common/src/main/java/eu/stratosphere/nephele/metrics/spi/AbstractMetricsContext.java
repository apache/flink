...
import eu.stratosphere.nephele.metrics.ContextFactory;
import eu.stratosphere.nephele.metrics.MetricsContext;
import eu.stratosphere.nephele.metrics.MetricsException;
 ...
 * client library.
 * <p/>
 * This class implements the internal table of metric data, and the timer on which data is to be sent to the metrics
 * system. Subclasses must override the abstract <code>emitRecord</code> method in order to transmit the data.
 * <p/>
 */
