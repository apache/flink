...
public abstract class UserDefinedAggregateFunction<T, ACC> extends UserDefinedFunction {
	...
	/**
	 * Creates and initializes the accumulator for this {@link UserDefinedAggregateFunction}.
	 * The accumulator is used to keep the aggregated values which are needed to compute an
	 * aggregation result.
	 *
	 ...
	 * accumulator.
	 *
	 * @return The {@link TypeInformation} of the {@link UserDefinedAggregateFunction}'s
	 *         accumulator or <code>null</code> if the accumulator type should be automatically
	 *         inferred.
	 */
