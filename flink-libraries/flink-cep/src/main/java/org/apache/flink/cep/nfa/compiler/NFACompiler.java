 ...
 * {@link NFAFactory}.
 */
//todo 4、创建createWaitingState 并添加createMiddleStates，在NFAFactoryCompiler中添加字段waitingTime以及方法getWaitingTime,相应修改compileFactory和NFAFactory,createEndingState
