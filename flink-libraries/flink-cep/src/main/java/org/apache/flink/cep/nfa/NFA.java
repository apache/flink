...
public class NFA<T> {
    ...
    private Collection<ComputationState> computeNextStates(
        ...
        //此处对createDecisionGraph方法进行包装成getOutgoingEdges
    ...
    private OutgoingEdges<T> getOutgoingEdges(final ConditionContext<T> context, ComputationState computationState, EventWrapper event) {
