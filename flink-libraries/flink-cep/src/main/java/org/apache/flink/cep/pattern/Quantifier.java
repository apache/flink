 ...
 * </ol>
 *
 * <p>Each {@link Pattern} can be optional and have a {@link ConsumingStrategy}. Looping and Times have also additional
 * inner consuming strategy that is applied between accepted events in the pattern
 *
 */
public class Quantifier {
	...
	/**
	 * Describes strategy which events are matched in this {@link Pattern}. See docs for more info.
	 */
