...
public class CEPOperatorTest extends TestLogger {
	...
	@Test
	public void testCEPPatternFunctionWatermarkForwarding() throws Exception {

		OneInputStreamOperatorTestHarness<Event, Map<String, Event>> harness =
			new KeyedOneInputStreamOperatorTestHarness<>(
				new ProcessOperator<>(new CEPPatternFunction<>(
	...
	@Test
	public void testCEPPatternFunctionCheckpointing() throws Exception {

		OneInputStreamOperatorTestHarness<Event, Map<String, Event>> harness =
			new KeyedOneInputStreamOperatorTestHarness<>(
				new ProcessOperator<>(
					new CEPPatternFunction<>(
						Event.createTypeSerializer(),
						TimeCharacteristic.EventTime,
						new NFAFactory())),
				new TestKeySelector(),
	...
	@Test
	public void testCEPPatternFunctionCheckpointingWithRocksDB() throws Exception {
	 ...
	 */
	@Test
	public void testCEPTimedoutPatternFunctionAdvancingTimeWithoutElements() throws Exception {
		...
		OneInputStreamOperatorTestHarness<Event, Either<Tuple2<Map<String, Event>, Long>, Map<String, Event>>> harness =
			new KeyedOneInputStreamOperatorTestHarness<>(
				new ProcessOperator<>(
					new CEPTimedoutPatternFunction<>(
						Event.createTypeSerializer(),
						TimeCharacteristic.EventTime,
						new NFAFactory(true))),
				new TestKeySelector(),
