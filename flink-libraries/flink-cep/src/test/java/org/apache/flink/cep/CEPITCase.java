...
public class CEPITCase extends AbstractTestBase {
    ...
    @Test
    public void testTimesWithIn() throws Exception {
        StreamExecutionEnvironment env =
                StreamExecutionEnvironment.getExecutionEnvironment(envConfiguration);
        env.setParallelism(1);
        ...
        DataStream<Event> input =
                env.fromElements(
                                ...
                                // output (5), (5,6), (5,6,7)
                                Tuple2.of(new Event(1, "start", 5.0), 10L),
                                Tuple2.of(new Event(1, "end", 6.0), 11L),
                                Tuple2.of(new Event(1, "end", 7.0), 12L),

                                // output (8), (8,9)
                                Tuple2.of(new Event(1, "start", 8.0), 20L),
                                Tuple2.of(new Event(1, "end", 9.0), 21L),
                                Tuple2.of(new Event(1, "end", 10.0), 24L))
                        .assignTimestampsAndWatermarks(
                                new AssignerWithPunctuatedWatermarks<Tuple2<Event, Long>>() {
                        ...
                        .select(
                                ...
                                new PatternSelectFunction<Event, String>() {
                                    ...
                                    public String select(Map<String, List<Event>> pattern) {
                                        StringBuilder builder = new StringBuilder();
                                        builder.append(pattern.get("start").get(0).getPrice());
                                        List<Event> endPatternList = pattern.get("end");
                                        if (endPatternList != null) {
                                            for (Event event : endPatternList) {
                                                builder.append(",").append(event.getPrice());
                                            }
                                        }
                                        return builder.toString();
                                    }
        ...
        List<Either<String, String>> expected =
                Arrays.asList(
                        ...
                        Either.Right.of("1.0"),
                        Either.Right.of("5.0"),
                        Either.Right.of("5.0,6.0"),
                        Either.Right.of("5.0,6.0,7.0"),
                        Either.Right.of("8.0"),
                        Either.Right.of("8.0,9.0"));
