...
public class NFAStatusChangeITCase {
    ...
    public void testNFAChange() throws Exception {
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertFalse(                nfaState.isStateChanged(),                "NFA status should not change as the event does not match the take condition of the 'start' state");
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertTrue(                nfaState.isStateChanged(),                "NFA status should change as the event matches the take condition of the 'start' state");
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertTrue(                nfaState.isStateChanged(),                "NFA status should change as the event matches the ignore condition and proceed condition of the 'middle:1' state");
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertFalse(                nfaState.isStateChanged(),                "NFA status should not change as the event only matches the ignore condition of the 'middle:2' state and the target state is still 'middle:2'");
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertTrue(                nfaState.isStateChanged(),                "NFA status should change as the event matches the take condition of 'middle:2' state");
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertTrue(                nfaState.isStateChanged(),                "NFA status should change as the event matches the take condition of 'middle2' state");

        // both the queue of ComputationStatus and eventSharedBuffer have not changed
        // as the timestamp is within the window
        nfaState.resetStateChanged();
        nfa.advanceTime(sharedBufferAccessor, nfaState, 8L);
        assertFalse(                nfaState.isStateChanged(),                "NFA status should not change as the timestamp is within the window");
        ...
        assertTrue(                nfaState.isStateChanged() && !timeoutResults.isEmpty(),                "NFA status should change as timeout happens");
    }
