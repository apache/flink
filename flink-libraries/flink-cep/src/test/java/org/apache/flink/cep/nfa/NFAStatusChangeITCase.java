...
class NFAStatusChangeITCase {
    ...
    @Test
    void testNFAChange() throws Exception {
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertThat(nfaState.isStateChanged())
                .as(
        ...
        assertThat(nfaState.isStateChanged())
                .as("NFA status should not change as the timestamp is within the window")
                .isFalse();
        ...
        assertThat(nfaState.isStateChanged() && !timeoutResults.isEmpty())
                .as("NFA status should change as timeout happens")
                .isTrue();
    }

    @Test
    void testNFAChangedOnOneNewComputationState() throws Exception {
        Pattern<Event, ?> pattern =
                Pattern.<Event>begin("start")
        ...
        nfa.process(
                ...
                skipStrategy,
                timerService);
        assertThat(nfaState.isStateChanged()).isTrue();
    }

    @Test
    void testNFAChangedOnTimeoutWithoutPrune() throws Exception {
        Pattern<Event, ?> pattern =
                Pattern.<Event>begin("start")
                        .where(
                                new IterativeCondition<Event>() {
