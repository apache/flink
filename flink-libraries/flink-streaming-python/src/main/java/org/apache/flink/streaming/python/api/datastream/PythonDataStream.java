...
public class PythonDataStream<D extends DataStream> {
	 ...
	 */
	public PythonDataStream map(MapFunction mapper) throws IOException {
	 ...
	 * @return The transformed {@link PythonDataStream}.
	 */
	public PythonDataStream flat_map(FlatMapFunction flat_mapper) throws IOException {
	 ...
	 */
	@PublicEvolving
	public void add_sink(SinkFunction sink_func) throws IOException {
