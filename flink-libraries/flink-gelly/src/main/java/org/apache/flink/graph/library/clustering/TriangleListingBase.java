...
extends GraphAlgorithmWrappingDataSet<K, VV, EV, R> {
	...
	/**
	 * By default only one result is output for each pair of triangle, whether
	 * sorted or unsorted. When permutation is enabled a result is output for
	 * each of the six permutations of the three vertex IDs.
	 *
