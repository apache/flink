...
public final class IntValueArraySerializer extends TypeSerializerSingleton<IntValueArray> {
	...
	public static final ParameterlessTypeSerializerConfig CONFIG =
			new ParameterlessTypeSerializerConfig(IntValueArraySerializer.class.getCanonicalName());
	...
	public ReconfigureResult reconfigure(TypeSerializerConfigSnapshot configSnapshot) {
		return (configSnapshot.equals(CONFIG) || configSnapshot.equals(IntPrimitiveArraySerializer.CONFIG))
