...
object RowTypeBuilder {

  /**
    * Creates a struct type with the input fieldNames and input fieldTypes using FlinkTypeFactory
    *
    * @param flinkTypeFactory
    ...
    */
  def build(flinkTypeFactory: FlinkTypeFactory, fieldNames: Array[String], fieldTypes: Array[TypeInformation[_]]): RelDataType = {
