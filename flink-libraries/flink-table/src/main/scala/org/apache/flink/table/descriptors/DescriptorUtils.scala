...
/**
  * Various utilities for descriptor processing.
  */
object DescriptorUtils {

  /**
    * Validates a table descriptor and returns the descriptor properties.
    */
  def validateTableDescriptorProperties(
      isStreaming: Boolean,
    ...
    tableDescriptor.addProperties(properties)
