...
class CodeGenerator(
  ...
  override def visitFieldAccess(rexFieldAccess: RexFieldAccess): GeneratedExpression =
    throw new CodeGenException("The 'FieldAccess' feature is currently not supported.")
  ...
  override def visitCorrelVariable(correlVariable: RexCorrelVariable): GeneratedExpression =
    throw new CodeGenException("The 'CorrelVariable' feature is currently not supported.")

  override def visitLocalRef(localRef: RexLocalRef): GeneratedExpression =
    throw new CodeGenException("The 'LocalRef' feature is currently not supported.")

  override def visitRangeRef(rangeRef: RexRangeRef): GeneratedExpression =
    throw new CodeGenException("The 'RangeRef' feature is currently not supported.")

  override def visitDynamicParam(dynamicParam: RexDynamicParam): GeneratedExpression =
    throw new CodeGenException("The 'DynamicParam' feature is currently not supported.")
  ...
  override def visitOver(over: RexOver): GeneratedExpression =
    throw new CodeGenException("The 'Over' feature is currently not supported.")

  override def visitSubQuery(subQuery: RexSubQuery): GeneratedExpression =
    throw new CodeGenException("The 'SubQuery' feature is currently not supported.")
