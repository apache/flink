...
import org.apache.flink.table.{BatchTableEnvironment, TableConfig, TableException}
...
trait DataSetRel extends RelNode with FlinkRel {
  ...
  /**
    ...
    *
    * @param tableEnv [[org.apache.flink.table.BatchTableEnvironment]] of the translated Table.
