...
import org.apache.flink.table.codegen.{CodeGenerator, GeneratedCollector, GeneratedExpression,
GeneratedFunction}
...
trait FlinkCorrelate {
  ...
  /** Generates the flat map function to run user defined table function */
