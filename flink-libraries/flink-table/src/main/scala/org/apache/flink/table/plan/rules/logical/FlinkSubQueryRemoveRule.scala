...
import org.apache.calcite.rel.core.{Filter, RelFactories}
...
import org.apache.calcite.rex.{RexShuttle, RexVisitorImpl, _}
...
/**
  * Transform that converts IN and EXISTS into semi-join,
