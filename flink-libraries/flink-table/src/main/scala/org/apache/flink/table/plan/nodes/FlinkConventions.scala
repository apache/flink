...
object FlinkConventions {
  ...
  val STREAM_PHYSICAL: Convention =
    new FlinkConvention("STREAM_PHYSICAL", classOf[StreamPhysicalRel])
  val BATCH_PHYSICAL: Convention =
    new FlinkConvention("BATCH_PHYSICAL", classOf[BatchPhysicalRel])
}
