...
import org.apache.calcite.sql.`type`.SqlTypeName.{INTERVAL_MONTH, INTERVAL_YEAR, INTERVAL_YEAR_MONTH}
...
class DataStreamMatch(
  ...
  override def translateToPlan(
    ...
    // use CEP.Pattern, generate PatternStream
