...
class LogicalCorrelateToTemporalTableFunctionJoinRule
  extends RelOptRule(
    operand(classOf[LogicalCorrelate],
      some(
        operand(classOf[RelNode], any()),
        operand(classOf[TableFunctionScan], none()))),
    "LogicalCorrelateToTemporalTableFunctionJoinRule") {
...
object LogicalCorrelateToTemporalTableFunctionJoinRule {
  val INSTANCE: RelOptRule = new LogicalCorrelateToTemporalTableFunctionJoinRule
}
