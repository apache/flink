...
/**
  * BUG:
  * when the number of fields of the row is greater than 8,
  * and the max index of key fields is less than or equal to floor(numberOfFields/8)*8,
  * the result of [[RowComparator.compareSerialized]] is wrong.
  */
