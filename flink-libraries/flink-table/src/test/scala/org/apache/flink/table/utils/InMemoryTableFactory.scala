...
import org.apache.flink.table.connectors.{TableFactoryDiscoverable, TableSinkFactory, TableSourceFactory}
...
class InMemoryTableFactory extends TableSourceFactory[Row]
  with TableSinkFactory[Row] with TableFactoryDiscoverable {
