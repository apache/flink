...
import org.apache.flink.table.runtime.harness.SortProcessFunctionHarnessTest._
import org.apache.flink.table.runtime.types.{CRow, CRowTypeInfo}
import org.apache.flink.types.Row
import org.junit.Test
import org.apache.flink.table.runtime.aggregate.ProcTimeIdentitySortProcessFunctionOffsetFetch

class SortProcessFunctionHarnessTest {
 
   /**
   * Time descending tests with retraction
   */
  
  @Test
  def testSortProcTimeDescOffsetHarnessPartitioned(): Unit = {
    ...
    val processFunction = new KeyedProcessOperator[Integer,CRow,CRow](
      new ProcTimeDescSortProcessFunctionOffset(
        2,  
        inputCRowType,
  ...
  @Test
  def testSortProcTimeDescOffsetFetchHarnessPartitioned(): Unit = {
    ...
    val processFunction = new KeyedProcessOperator[Integer,CRow,CRow](
      new ProcTimeDescSortProcessFunctionOffsetFetch(
        2,
        2,
        inputCRowType,
        collectionRowComparator))
  ...
  @Test
  def testSortProcTimeDescOffsetHarnessIdentity(): Unit = {
    ...
    val processFunction = new KeyedProcessOperator[Integer,CRow,CRow](
      new ProcTimeDescIdentitySortProcessFunctionOffsetFetch(
        2,  
        -1,
        inputCRowType))
  ...
  @Test
  def testSortProcTimeDescOffsetFetchHarnessIdentity(): Unit = {
  ...
  @Test
  def testSortRowTimeDescOffsetHarnessPartitioned(): Unit = {
    ...
    val processFunction = new KeyedProcessOperator[Integer,CRow,CRow](
      new RowTimeDescSortProcessFunctionOffset(
        2,
        inputCRowType,
        collectionRowComparator))
  ...
  @Test
  def testSortRowTimeDescOffsetFetchHarnessPartitioned(): Unit = {
    ...
    val processFunction = new KeyedProcessOperator[Integer,CRow,CRow](
      new RowTimeDescSortProcessFunctionOffsetFetch(
        0,
        3,
        inputCRowType,
        collectionRowComparator))
