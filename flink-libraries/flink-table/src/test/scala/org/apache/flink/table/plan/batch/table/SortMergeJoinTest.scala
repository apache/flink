...
class SortMergeJoinTest extends TableTestBase {
  ...
  private val util: BatchTableTestUtil = batchTestUtil()
  ...
  def testInnerJoinWithFilter(): Unit = {
    val table1 = util.addTable[(Int, Long, Int, String, Long)]("Table5", 'd, 'e, 'f, 'g, 'h)
    val table2 = util.addTable[(Int, Long, String)]("Table3", 'a, 'b, 'c)
