...
object Recommendation {
  ...
  val expectedResultSGD = {
    Seq(
      (4, 11, 469.0562912930168),
      (1, 15, 527.8332532676197),
      (2, 2, 566.1588634826129),
      (10, 3, 490.51214034074144),
      (5, 9, 490.54741144694884),
      (5, 13, 457.2293427021535)
    )
  }
