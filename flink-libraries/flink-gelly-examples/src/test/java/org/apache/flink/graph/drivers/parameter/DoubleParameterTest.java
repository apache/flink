...
public class DoubleParameterTest extends ParameterTestBase {
    ...
    public void testWithDefaultWithParameter() {
        ...
        Assertions.assertEquals(new Double(12.34), parameter.getValue());
    }
    ...
    public void testWithDefaultWithoutParameter() {
        ...
        Assertions.assertEquals(new Double(43.21), parameter.getValue());
    }
    ...
    public void testMinInRange() {
        ...
        Assertions.assertEquals(new Double(1), parameter.getValue());
    }
    ...
    public void testMinAtRangeInclusive() {
        ...
        Assertions.assertEquals(new Double(0), parameter.getValue());
    }
