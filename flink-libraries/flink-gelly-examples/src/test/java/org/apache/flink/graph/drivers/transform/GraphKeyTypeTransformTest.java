...
public class GraphKeyTypeTransformTest {
	...
	public void testToByteValue() throws Exception {
		...
		Assert.assertEquals(new ByteValue((byte) -1), translator.translate(new LongValue((1L << 8) - 1), byteValue));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToByteValueUpperOutOfRange() throws Exception {
		new LongValueToUnsignedByteValue().translate(new LongValue(1L << 8), byteValue);
	}
	...
	public void testFromByteValue() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 8) - 1), translator.translate(new ByteValue((byte) -1), longValueWithProperHashCode));
	}
	...
	public void testToByte() throws Exception {
		...
		Assert.assertEquals(Byte.valueOf((byte) -1), translator.translate(new LongValue((1L << 8) - 1), null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToByteUpperOutOfRange() throws Exception {
		new LongValueToUnsignedByte().translate(new LongValue(1L << 8), null);
	}
	...
	public void testFromByte() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 8) - 1), translator.translate((byte) -1, longValueWithProperHashCode));
	}
	...
	public void testToShortValue() throws Exception {
		...
		Assert.assertEquals(new ShortValue((short) -1), translator.translate(new LongValue((1L << 16) - 1), shortValue));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToShortValueUpperOutOfRange() throws Exception {
		new LongValueToUnsignedShortValue().translate(new LongValue(1L << 16), shortValue);
	}
	...
	public void testFromShortValue() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 16) - 1), translator.translate(new ShortValue((short) -1), longValueWithProperHashCode));
	}
	...
	public void testToShort() throws Exception {
		...
		Assert.assertEquals(Short.valueOf((short) -1), translator.translate(new LongValue((1L << 16) - 1), null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToShortUpperOutOfRange() throws Exception {
		new LongValueToUnsignedShort().translate(new LongValue(1L << 16), null);
	}
	...
	public void testFromShort() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 16) - 1), translator.translate((short) -1, longValueWithProperHashCode));
	}
	...
	public void testToCharValue() throws Exception {
		...
		Assert.assertEquals(new CharValue(Character.MAX_VALUE), translator.translate(new LongValue((long) Character.MAX_VALUE), charValue));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToCharValueUpperOutOfRange() throws Exception {
		new LongValueToCharValue().translate(new LongValue(1L << 16), charValue);
	}
	...
	public void testToCharacter() throws Exception {
		...
		Assert.assertEquals(Character.valueOf(Character.MAX_VALUE), translator.translate(new LongValue((long) Character.MAX_VALUE), null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToCharacterUpperOutOfRange() throws Exception {
		new LongValueToChar().translate(new LongValue(1L << 16), null);
	}
	...
	public void testToInt() throws Exception {
		...
		Assert.assertEquals(Integer.valueOf(-1), translator.translate(new LongValue((1L << 32) - 1), null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToIntUpperOutOfRange() throws Exception {
		new LongValueToUnsignedInt().translate(new LongValue(1L << 32), null);
	}
	...
	public void testFromInt() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 32) - 1), translator.translate(-1, longValueWithProperHashCode));
	}
	...
	public void testToFloatValue() throws Exception {
		...
		Assert.assertEquals(new FloatValue(Float.intBitsToFloat(-1)), translator.translate(new LongValue((1L << 32) - 1), floatValue));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToFloatValueUpperOutOfRange() throws Exception {
		new LongValueToUnsignedFloatValue().translate(new LongValue(1L << 32), floatValue);
	}
	...
	public void testFromFloatValue() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 32) - 1), translator.translate(new FloatValue(Float.intBitsToFloat(-1)), longValueWithProperHashCode));
	}
	...
	public void testToFloat() throws Exception {
		...
		Assert.assertEquals(Float.valueOf(Float.intBitsToFloat(-1)), translator.translate(new LongValue((1L << 32) - 1), null));
	}

	@Test(expected = IllegalArgumentException.class)
	public void testToFloatUpperOutOfRange() throws Exception {
		new LongValueToUnsignedFloat().translate(new LongValue(1L << 32), null);
	}
	...
	public void testFromFloat() throws Exception {
		...
		Assert.assertEquals(new LongValueWithProperHashCode((1L << 32) - 1), translator.translate(Float.intBitsToFloat(-1), longValueWithProperHashCode));
	}
