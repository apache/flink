...
implements Transform<Graph<LongValue, VV, EV>, Graph<?, VV, EV>, DataSet<TranslatableResult<?>>, DataSet<TranslatableResult<?>>> {
	 ...
	 * arguments but the size of the vertex identifier must be set explicitly
	 * by the input.
	 *
	 * @param vertexCount the size of the vertex set the input graph
	 */
	...
	public Graph<?, VV, EV> transformInput(Graph<LongValue, VV, EV> input)
			throws Exception {
		// throw exception is vertex count is larger than the key size
