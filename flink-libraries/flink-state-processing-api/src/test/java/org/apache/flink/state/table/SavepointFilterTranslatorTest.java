...
class SavepointFilterTranslatorTest {
    ...
    void literalNotRepresentableAsDoubleIsConvertedToTheNearestDouble() {
        ...
        // the bound becomes the nearest double, which is the value SQL compares against too.
        FieldReferenceExpression doubleKey =
                new FieldReferenceExpression("key", DataTypes.DOUBLE().notNull(), 0, KEY_COL);
    ...
    void equalsWithLongLiteralNotRepresentableAsDoubleUsesNearestDouble() {
        ...
        SavepointKeyFilter<Object> filter = keyFilterOf(eq(doubleKey, longLit(9007199254740993L)));
