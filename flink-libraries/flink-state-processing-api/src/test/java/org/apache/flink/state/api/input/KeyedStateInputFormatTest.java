...
public class KeyedStateInputFormatTest {
	...
	public void testReadTime() throws Exception {
		...
		KeyedStateInputFormat<?, ?, ?> format = new KeyedStateInputFormat<>(operatorState, new MemoryStateBackend(), new KeyedStateReaderOperator<>(new TimeReaderFunction(), Types.INT));
		KeyGroupRangeInputSplit split = format.createInputSplits(1)[0];
