 ...
 *   <li>Restore the {@code StateTestRecord.avsc} Avro schema to {@code
 *       src/test/resources/avro/StateTestRecord.avsc}.
 *   <li>Re-add the {@code avro-maven-plugin} and {@code flink-avro} test dependency in pom.xml.
 ...
 *   <li>Remove the copied {@code .java} file from the source tree and revert pom.xml changes.
 * </ol>
 */
