...
public class KeyedOperatorTransformation<K, T> {
	 ...
	 */
	public WindowedOperatorTransformation<T, K, TimeWindow> timeWindow(Time size) {
		if (timestamper == null) {
	 ...
	 */
	public WindowedOperatorTransformation<T, K, TimeWindow> timeWindow(Time size, Time slide) {
		if (timestamper == null) {
