...
import org.apache.flink.state.api.input.operator.enumerator.UnionOperatorStateSourceSplitEnumerator;
...
public class UnionStateSource<OUT> extends OperatorStateSource<OUT> {
    ...
    public SplitEnumerator<OperatorStateSourceSplit, NoOpEnumState> createEnumerator(
        ...
        return new UnionOperatorStateSourceSplitEnumerator(enumContext, operatorState);
    }
