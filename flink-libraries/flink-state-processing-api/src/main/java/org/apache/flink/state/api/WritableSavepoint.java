...
public abstract class WritableSavepoint<F extends WritableSavepoint> {
    ...
    private DataSet<OperatorState> unionOperatorStates(
            DataSet<OperatorState> newOperatorStates, List<OperatorState> existingOperators) {
        DataSet<OperatorState> finalOperatorStates;
                ...
                .orElseThrow(
                        () ->
                                new IllegalStateException(
                                        "Savepoint's must contain at least one operator"));
    }
}
