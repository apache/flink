...
@Internal
public final class OperatorStateSourceSplit implements PrioritizedOperatorSubtaskStateSourceSplit {
    ...
    public OperatorStateSourceSplit(
            StateObjectCollection<OperatorStateHandle> managedOperatorState, int split) {
