...
public abstract class StateReaderOperator<F extends Function, KEY, N, OUT>
    ...
    public abstract Iterator<Tuple2<KEY, N>> getKeysAndNamespaces(SavepointRuntimeContext ctx)
            throws Exception;
