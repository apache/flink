...
public class UtilsTest {
	...
	public void testHeapCutoff() {
		...
		conf.setDouble(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, 0.15);
		conf.setInteger(ConfigConstants.CONTAINER_HEAP_CUTOFF_MIN, 384);
		...
		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_MIN, "1000");
		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "0.1");
		Assert.assertEquals(3000, Utils.calculateHeapSize(4000, conf));

		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "0.5");
		Assert.assertEquals(2000, Utils.calculateHeapSize(4000, conf));

		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "1");
	...
	public void illegalArgument() {
		Configuration conf = new Configuration();
		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "1.1");
		Assert.assertEquals(0, Utils.calculateHeapSize(4000, conf));
	}
	...
	public void illegalArgumentNegative() {
		Configuration conf = new Configuration();
		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "-0.01");
		Assert.assertEquals(0, Utils.calculateHeapSize(4000, conf));
	}
	...
	public void tooMuchCutoff() {
		Configuration conf = new Configuration();
		conf.setString(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO, "6000");
		Assert.assertEquals(0, Utils.calculateHeapSize(4000, conf));
	}
