...
public class YARNITCase extends YarnTestBase {
	...
	public void testPerJobWithProvidedLibDirs() throws Exception {
		...
		// Prepare a provided flink lib, it should be publicly accessible. So copy it to the /tmp directory.
		...
		flinkConfig.set(
			...
			Collections.singletonList(tmpFlinkReleaseBinary.getAbsoluteFile().toString()));
