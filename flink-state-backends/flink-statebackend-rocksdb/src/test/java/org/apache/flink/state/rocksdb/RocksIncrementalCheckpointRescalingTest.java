...
class RocksIncrementalCheckpointRescalingTest {

    @TempDir private Path rootFolder;
    ...
    @ParameterizedTest(name = "useIngestDbRestoreMode: {0}")
    @ValueSource(booleans = {false, true})
    @SuppressWarnings("unchecked")
    void testScalingUp(boolean useIngestDbRestoreMode) throws Exception {
        ...
        try (KeyedOneInputStreamOperatorTestHarness<String, String, Integer> harness =
            ...
            harness.setStateBackend(getStateBackend(useIngestDbRestoreMode));
        ...
        try {
            ...
            harness2[0].setStateBackend(getStateBackend(useIngestDbRestoreMode));
            ...
            harness2[1].setStateBackend(getStateBackend(useIngestDbRestoreMode));
        ...
        try {
            ...
            harness3[0].setStateBackend(getStateBackend(useIngestDbRestoreMode));
            ...
            harness3[1].setStateBackend(getStateBackend(useIngestDbRestoreMode));
            ...
            harness3[2].setStateBackend(getStateBackend(useIngestDbRestoreMode));
    ...
    @ValueSource(booleans = {false, true})
    @SuppressWarnings("unchecked")
    void testScalingDown(boolean useIngestDbRestoreMode) throws Exception {
    ...
    private StateBackend getStateBackend(boolean useIngestDbRestoreMode) throws Exception {
