...
public class RocksIncrementalCheckpointRescalingTest extends TestLogger {
	...
	public void testScalingUp() throws Exception {
		...
		KeyedOneInputStreamOperatorTestHarness harness = getHarnessTest(keySelector, maxParallelism, 1, 0);
		...
		KeyedOneInputStreamOperatorTestHarness[] harness2 = new KeyedOneInputStreamOperatorTestHarness[3];
		...
		KeyedOneInputStreamOperatorTestHarness[] harness3 = new KeyedOneInputStreamOperatorTestHarness[3];
	...
	void closeHarness(KeyedOneInputStreamOperatorTestHarness<?, ?, ?>[] harnessArr) throws Exception {
	...
	KeyedOneInputStreamOperatorTestHarness getHarnessTest(
		KeySelector<String, String> keySelector,
		int maxParallelism,
		int taskParallelism,
		int subtaskIdx) throws Exception {
		return new KeyedOneInputStreamOperatorTestHarness<>(
			new KeyedProcessOperator<String, String, Integer>(new TestKeyedFunction()),
			keySelector,
	...
	StateBackend getStateBackend() throws Exception {
	...
	private class TestKeyedFunction extends KeyedProcessFunction<String, String, Integer> {
		...
		public void open(Configuration parameters) throws Exception {
			...
			counterState = this.getRuntimeContext().getState(new ValueStateDescriptor<Integer>("counter", Integer.class));
		}
