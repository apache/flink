...
class LegacyEnumBridge {
	...
	static RocksDBStateBackend.PriorityQueueStateType convert(EmbeddedRocksDBStateBackend.PriorityQueueStateType t) {
		switch (t) {
			case HEAP:
	...
	static EmbeddedRocksDBStateBackend.PriorityQueueStateType convert(RocksDBStateBackend.PriorityQueueStateType t) {
		switch (t) {
			case HEAP:
