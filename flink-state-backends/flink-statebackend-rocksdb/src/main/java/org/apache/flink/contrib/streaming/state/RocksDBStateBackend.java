...
/**
 *<b>IMPORTANT</b> {@link RocksDBStateBackend} is deprecated in favor of {@link EmbeddedRocksDBStateBackend}.
 * and {@link org.apache.flink.runtime.state.storage.FileSystemCheckpointStorage}. This change does
 ...
 * }</pre>
 *
 *<p>If you are configuring your state backend via the {@code flink-conf.yaml} no changes are required.
 *
 *<p>A State Backend that stores its state in {@code RocksDB}. This state backend can
...
public class RocksDBStateBackend extends AbstractManagedMemoryStateBackend
	 ...
	 * {@link CheckpointStorage#createCheckpointStorage(JobID)}.
	 *
	...
	public String toString() {
		return "RocksDBStateBackend{" +
				...
				", numberOfTransferThreads=" + rocksDBStateBackend.getNumberOfTransferThreads() +
				", writeBatchSize=" + rocksDBStateBackend.getWriteBatchSize() +
				'}';
	}
