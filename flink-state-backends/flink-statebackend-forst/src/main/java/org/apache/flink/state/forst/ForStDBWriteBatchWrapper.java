...
/**
 * It's a wrapper class around ForStDB's {@link WriteBatch} for writing in bulk.
 *
 * <p>IMPORTANT: This class is not thread safe.
 */
public class ForStDBWriteBatchWrapper implements AutoCloseable {
    ...
    public ForStDBWriteBatchWrapper(@Nonnull RocksDB rocksDB, @Nullable WriteOptions options) {
        this(rocksDB, options, 500, DEFAULT_BATCH_SIZE);
    }

    public ForStDBWriteBatchWrapper(
