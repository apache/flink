...
import static org.apache.flink.state.forst.ForStIncrementalCheckpointUtils.exportColumnFamilies;
...
public class ForStIncrementalRestoreOperation<K> implements ForStRestoreOperation {
    ...
    public void mergeStateHandlesWithClipAndIngest(
        ...
        Path exportCfBasePath = new Path(forstBasePath.toString(), "export-cfs");
        ...
        try {
            KeyGroupRange exportedSstKeyGroupsRange =
                    exportColumnFamiliesWithSstDataInKeyGroupsRange(
                            new File(
                                            new URI(
                                                    exportCfBasePath.getFileSystem().getUri()
                                                            + exportCfBasePath.getPath()))
                                    .toPath(),
                            keyedStateHandles,
    ...
    private KeyGroupRange exportColumnFamiliesWithSstDataInKeyGroupsRange(
            java.nio.file.Path exportCfBasePath,
