...
public class ForStFlinkFileSystemTest {
    ...
    void testSstFileInCache() throws IOException {
        ...
        assertThat(cacheEntry.getReferenceCount()).isEqualTo(1);
        assertThat(cacheEntry.getReferenceCount()).isEqualTo(1);
        assertThat(registeredCounters.get("forst-cache.hit").getCount()).isEqualTo(2L);
        // evict
        ...
        assertThat(registeredGauges.get("forst-cache.cachedBytes").getValue()).isEqualTo(233L);
        // read after evict
