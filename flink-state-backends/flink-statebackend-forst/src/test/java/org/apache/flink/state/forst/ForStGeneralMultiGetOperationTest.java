...
public class ForStGeneralMultiGetOperationTest extends ForStDBOperationTestBase {
    ...
    public void testValueStateMultiGet() throws Exception {
        ...
        for (int i = 0; i < keyNum; i++) {
            ...
            ForStDBSingleGetRequest<Integer, Void, String> request =
    ...
    public void testListStateMultiGet() throws Exception {
        ForStListState<Integer, Void, String> listState1 = buildForStListState("test-multiGet-1");
        ForStListState<Integer, Void, String> listState2 = buildForStListState("test-multiGet-2");
        List<ForStDBGetRequest<?, ?, ?, ?>> batchGetRequest = new ArrayList<>();
        ...
        for (int i = 0; i < keyNum; i++) {
            ...
            ForStListState<Integer, Void, String> table = ((i % 2 == 0) ? listState1 : listState2);
            ForStDBListGetRequest<Integer, Void, String> request =
