...
/**
 * SampleInPartition wrap the sample logic in partition side(the first phase of distributed sample algorithm),
 * it execute the partition side sample logic in mapPartition function.
 *
