...
public interface UdfOperator<O extends UdfOperator<O>> {
     ...
     * org.apache.flink.api.common.functions.AbstractRichFunction#open(org.apache.flink.api.common.functions.OpenContext)}.
     * The configuration is set via the {@link #withParameters(Configuration)} method.
     *
