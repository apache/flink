 ...
 * @see CoGroupFunction
 */
public class CoGroupOperator extends CoGroupOperatorBase<Record, Record, Record, GenericCoGrouper<Record, Record, Record>> implements RecordOperator {
	...
	public static Builder builder(CoGroupFunction udf, Class<? extends Key<?>> keyClass, int keyColumn1, int keyColumn2) {
		...
		return new Builder(new UserCodeObjectWrapper<GenericCoGrouper<Record, Record, Record>>(wrapper), keyClass, keyColumn1, keyColumn2);
	}
	...
	public static class Builder {
		...
		private final UserCodeWrapper<GenericCoGrouper<Record, Record, Record>> udf;
		 ...
		 * @param keyColumn2 The position of the key in the second input's records.
		 */
		protected Builder(UserCodeWrapper<GenericCoGrouper<Record, Record, Record>> udf, Class<? extends Key<?>> keyClass,
				int keyColumn1, int keyColumn2)
		{
			this.udf = udf;
		 ...
		 * @param udf The {@link CoGroupFunction} implementation for this CoGroup operator.
		 */
		protected Builder(UserCodeWrapper<GenericCoGrouper<Record, Record, Record>> udf) {
			this.udf = udf;
			this.keyClasses = new ArrayList<Class<? extends Key<?>>>();
			this.keyColumns1 = new ArrayList<Integer>();
			this.keyColumns2 = new ArrayList<Integer>();
	...
	public static class WrappingCoGroupFunction extends WrappingFunction<CoGroupFunction> implements GenericCoGrouper<Record, Record, Record> {
