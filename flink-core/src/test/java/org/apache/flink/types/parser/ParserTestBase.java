...
public abstract class ParserTestBase<T> {
    ...
    public void testTest() {
        ...
        assertThat(getValidTestValues().length).isEqualTo(getValidTestResults().length);
    }
    ...
    public void testValidStringInIsolation() {
        ...
        for (int i = 0; i < testValues.length; i++) {
            ...
            assertThat(bytes1.length).isEqualTo(numRead1);
            assertThat(bytes2.length).isEqualTo(numRead2);
            assertThat(bytes3.length).isEqualTo(numRead3);
    ...
    @Test
    public void testStaticParseMethodWithInvalidValues() throws IllegalAccessException {
        Method parseMethod = null;
        try {
            parseMethod =
                    getParser()
