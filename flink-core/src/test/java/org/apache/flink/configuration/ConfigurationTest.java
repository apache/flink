...
class ConfigurationTest {
    ...
    void testConfigurationSerializationAndGetters() throws ClassNotFoundException, IOException {
        ...
        orig.set(getIntegerConfigOption("mynumber"), 100);
        ...
        assertThat(copy.get(getIntegerConfigOption("mynumber"), 0)).isEqualTo(100);
    ...
    void testOptionWithDefault() {
        ...
        cfg.set(getIntegerConfigOption("int-key"), 11);
    ...
    void testDeprecatedKeys() {
        Configuration cfg = new Configuration();
        cfg.set(getIntegerConfigOption("the-key"), 11);
        cfg.set(getIntegerConfigOption("old-key"), 12);
        cfg.set(getIntegerConfigOption("older-key"), 13);
    ...
    void testRemove() {
        Configuration cfg = new Configuration();
        cfg.set(getIntegerConfigOption("a"), 1);
        cfg.set(getIntegerConfigOption("b"), 2);
    ...
    void testRemoveKey() {
        ...
        String key1 = "a.b";
        String key2 = "c.d";
        cfg.set(getIntegerConfigOption(key1), 42);
        cfg.set(getIntegerConfigOption(key2), 44);
        cfg.set(getIntegerConfigOption(key2 + ".f1"), 44);
        cfg.set(getIntegerConfigOption(key2 + ".f2"), 44);
        cfg.set(getIntegerConfigOption("e.f"), 1337);
    ...
    void testMapWithPrefix() {
        ...
        cfg.set(getIntegerConfigOption(MAP_PROPERTY_2), 12);
    ...
    void testMapNonPrefixHasPrecedence() {
        ...
        cfg.set(MAP_OPTION, PROPERTIES_MAP);
        cfg.setString(MAP_PROPERTY_1, "value1");
        cfg.set(getIntegerConfigOption(MAP_PROPERTY_2), 99999);
