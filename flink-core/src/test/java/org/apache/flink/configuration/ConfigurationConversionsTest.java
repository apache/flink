...
class ConfigurationConversionsTest {
    ...
    void init() {
        ...
        pc.set(getIntegerConfigOption("int"), 5);
    ...
    private static Collection<TestSpec> getSpecs() {
        return Arrays.asList(
                // from integer
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("int"), 0)).expect(5),
                ...
                // from long
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("long"), 0))
                        .expect(15),
                ...
                // from too long
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("too_long"), 0))
                ...
                // from float
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("float"), 0))
                        .expectException(
                ...
                // from double
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("double"), 0))
                        .expectException(
                ...
                TestSpec.whenAccessed(
                                conf -> conf.get(getIntegerConfigOption("negative_double"), 0))
                        .expectException(
                ...
                // from zero
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("zero"), 0))
                        .expectException(
                ...
                TestSpec.whenAccessed(
                                conf -> conf.get(getIntegerConfigOption("too_long_double"), 0))
                        .expectException(
                ...
                // from string
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("string"), 0))
                        .expect(42),
                ...
                TestSpec.whenAccessed(
                                conf ->
                                        conf.get(
                                                getIntegerConfigOption("non_convertible_string"),
                                                0))
                        .expectException(
                ...
                // from boolean
                TestSpec.whenAccessed(conf -> conf.get(getIntegerConfigOption("boolean"), 0))
