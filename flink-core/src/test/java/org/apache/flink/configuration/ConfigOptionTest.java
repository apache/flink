...
public class ConfigOptionTest {
    ...
    void testDeprecationFlagForFallbackKeys() {
        ...
        for (final FallbackKey fallbackKey : optionWithFallbackKeys.fallbackKeys()) {
            assertThat(fallbackKey.isDeprecated()).isFalse();
        }
    }
    ...
    void testDeprecationFlagForMixedAlternativeKeys() {
        ...
        assertThat(containsInAnyOrder("fallback1", "fallback2")).isEqualTo(fallbackKeys);
        assertThat(containsInAnyOrder("deprecated1", "deprecated2")).isEqualTo(deprecatedKeys);
    }
