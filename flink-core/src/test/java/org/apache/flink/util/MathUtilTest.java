...
public class MathUtilTest {
    ...
    void testDivideRoundUp() {
        assertThat(MathUtils.divideRoundUp(0, 1)).isEqualTo(0);
        assertThat(MathUtils.divideRoundUp(0, 2)).isEqualTo(0);
        assertThat(MathUtils.divideRoundUp(1, 1)).isEqualTo(1);
        assertThat(MathUtils.divideRoundUp(1, 2)).isEqualTo(1);
        assertThat(MathUtils.divideRoundUp(2, 1)).isEqualTo(2);
        assertThat(MathUtils.divideRoundUp(2, 2)).isEqualTo(1);
        assertThat(MathUtils.divideRoundUp(2, 3)).isEqualTo(1);
    }
