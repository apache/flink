...
class ResourceSpecTest {
    ...
    void testMerge() {
        ...
        assertThat(rs3.getExtendedResource(EXTERNAL_RESOURCE_NAME)).contains(new ExternalResource(EXTERNAL_RESOURCE_NAME, 1.1));

        ResourceSpec rs4 = rs1.merge(rs3);
        assertThat(rs4.getExtendedResource(EXTERNAL_RESOURCE_NAME)).contains(new ExternalResource(EXTERNAL_RESOURCE_NAME, 2.2));
    }
    ...
    void testSubtract() {
        ...
        assertThat(subtracted.getExtendedResource(EXTERNAL_RESOURCE_NAME)).contains(new ExternalResource(EXTERNAL_RESOURCE_NAME, 0.6));
    }
