...
public class WatermarkOutputMultiplexerTest {
    ...
    void whenImmediateOutputBecomesIdleWatermarkAdvances() {
        ...
        assertThat(underlyingWatermarkOutput.lastWatermark()).isEqualTo(watermark(5));
    }
    ...
    void testRemoveUnblocksWatermarks() {
        ...
        assertThat(highTimestamp)
                .isEqualTo(underlyingWatermarkOutput.lastWatermark().getTimestamp());
    }
