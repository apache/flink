...
public abstract class TypeInformationTestBase<T extends TypeInformation<?>> extends TestLogger {
	...
	public void testHashcodeAndEquals() throws Exception {
		...
		for (T sampleTypeInfo : testData) {
			// check for implemented hashCode and equals
			if (sampleTypeInfo.getClass().getMethod("hashCode").getDeclaringClass() == Object.class) {
				throw new AssertionError("Type information does not implement own hashCode method: " +
					sampleTypeInfo.getClass().getCanonicalName());
			}
			if (sampleTypeInfo.getClass().getMethod("equals", Object.class).getDeclaringClass() == Object.class) {
