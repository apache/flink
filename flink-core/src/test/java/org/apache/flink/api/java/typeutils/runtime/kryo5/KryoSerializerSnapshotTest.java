...
import org.apache.flink.api.java.typeutils.runtime.kryo5.KryoPojosForMigrationTests.Animal;
import org.apache.flink.api.java.typeutils.runtime.kryo5.KryoPojosForMigrationTests.Dog;
import org.apache.flink.api.java.typeutils.runtime.kryo5.KryoPojosForMigrationTests.DogKryoSerializer;
import org.apache.flink.api.java.typeutils.runtime.kryo5.KryoPojosForMigrationTests.DogV2KryoSerializer;
import org.apache.flink.api.java.typeutils.runtime.kryo5.KryoPojosForMigrationTests.Parrot;
...
public class KryoSerializerSnapshotTest {
    ...
    public void addingTypesIsCompatibleAfterReconfiguration() {
        ...
        newConfig.registerTypeWithKryo5Serializer(Dog.class, DogKryoSerializer.class);
    ...
    public void replacingKryoSerializersIsCompatibleAsIs() {
        oldConfig.registerKryoType(Animal.class);
        oldConfig.registerTypeWithKryo5Serializer(Dog.class, DogKryoSerializer.class);

        newConfig.registerKryoType(Animal.class);
        newConfig.registerTypeWithKryo5Serializer(Dog.class, DogV2KryoSerializer.class);
    ...
    public void reorderingIsCompatibleAfterReconfiguration() {
        oldConfig.registerKryo5Type(Parrot.class);
        oldConfig.registerKryo5Type(Dog.class);

        newConfig.registerKryo5Type(Dog.class);
        newConfig.registerKryo5Type(Parrot.class);
