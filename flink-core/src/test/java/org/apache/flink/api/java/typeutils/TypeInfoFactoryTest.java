...
public class TypeInfoFactoryTest {
    ...
    void testMyOptionGenericType() {
        ...
        assertThat(oti.getInnerType()).isInstanceOf(TupleTypeInfo.class);
    ...
    void testMyTuple() {
        ...
        assertThat(tti.getTypeAt(0)).isInstanceOf(MyTupleTypeInfo.class);
    ...
    void testWithFieldTypeInfoAnnotation() {
        ...
        // field outerEither
        assertThat(pojoTypeWithAnnotation.getTypeAt(1)).isInstanceOf(EitherTypeInfo.class);
        assertThat(pojoTypeWithoutAnnotation.getTypeAt(1)).isInstanceOf(GenericTypeInfo.class);
        ...
        // field outerEither
        assertThat(tiPojo.getTypeAt(1)).isInstanceOf(EitherTypeInfo.class);
    ...
    public void testMissingTypeInfo() {
        ...
        assertThatThrownBy(() -> TypeExtractor.getMapReturnTypes(f, INT_TYPE_INFO))
    ...
    public void testMissingTypeInference() {
        ...
        assertThatThrownBy(() -> TypeExtractor.getMapReturnTypes(f, new MyFaultyTypeInfo()))
                .isInstanceOf(InvalidTypesException.class);
    }
