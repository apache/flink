...
public class ExpressionKeysTest {
    ...
    void testStandardTupleKeys() {
        ...
        for (int i = 1; i < 8; i++) {
            ...
            assertThat(ints.length).isEqualTo(ek.computeLogicalKeyPositions().length);
    ...
    @Test
    void testInvalidTuple() throws Throwable {
    ...
    void testTupleKeyExpansion() {
        ...
        assertThat(fpk.computeLogicalKeyPositions()).isEqualTo(new int[] {1, 2, 3});
        ...
        assertThat(fpk.computeLogicalKeyPositions()).isEqualTo(new int[] {0, 1, 2, 3, 4});
        ...
        assertThat(fpk.computeLogicalKeyPositions()).isEqualTo(new int[] {0, 1, 2, 4});

        fpk = new ExpressionKeys<>(new String[] {"f2", "f0"}, typeInfo);
        assertThat(fpk.computeLogicalKeyPositions()).isEqualTo(new int[] {4, 0});
        ...
        assertThat(complexFpk.computeLogicalKeyPositions())
        ...
        assertThat(complexFpk.computeLogicalKeyPositions()).isEqualTo(new int[] {1, 2, 3});
    ...
    void testPojoKeys() {
        ...
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {0, 1, 2, 3, 4});

        ek = new ExpressionKeys<>("p1.*", ti);
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {1, 2});

        ek = new ExpressionKeys<>("p2.*", ti);
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {3, 4});
    ...
    void testTupleWithNestedPojo() {
        ...
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {3, 4, 5, 6, 7});

        ek = new ExpressionKeys<>(new int[] {}, ti, true);
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {0, 1, 2, 3, 4, 5, 6, 7});

        ek = new ExpressionKeys<>("*", ti);
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {0, 1, 2, 3, 4, 5, 6, 7});

        ek = new ExpressionKeys<>("f2.p1.*", ti);
        assertThat(ek.computeLogicalKeyPositions()).isEqualTo(new int[] {4, 5});
    }
    ...
    void testOriginalTypes() {
        ...
        assertThat(ek.getOriginalKeyFieldTypes())
                .isEqualTo(new TypeInformation[] {BasicTypeInfo.INT_TYPE_INFO});

        ek = new ExpressionKeys<>(1, ti);
        assertThat(ek.getOriginalKeyFieldTypes())
                .isEqualTo(new TypeInformation[] {TypeExtractor.getForClass(Pojo1.class)});
        ...
        assertThat(ek.getOriginalKeyFieldTypes())
                .isEqualTo(new TypeInformation<?>[] {TypeExtractor.getForClass(Pojo2.class)});
    ...
    @Test
    void testInvalidPojo() throws Throwable {
