...
public class CompositeTypeTest {
    ...
    void testGetFlatFields() {
        ...
        assertThat(nestedTypeInfo.getFlatFields("f1").size()).isEqualTo(3);
        ...
        assertThat(nestedTypeInfo.getFlatFields("f3").size()).isEqualTo(2);
        ...
        assertThat(pojoTypeInfo.getFlatFields("*").size()).isEqualTo(2);
        ...
        assertThat(pojoInTupleTypeInfo.getFlatFields("1").size()).isEqualTo(2);
        ...
        assertThat(pojoInTupleTypeInfo.getFlatFields("f1.*").size()).isEqualTo(2);
        ...
        assertThat(pojoInTupleTypeInfo.getFlatFields("*").size()).isEqualTo(3);
