...
public class GenericDataSourceBaseTest implements java.io.Serializable {
    ...
    void testDataSourcePlain() {
        try {
            ...
            assertThat(asList(TestIOData.NAMES)).isEqualTo(resultMutableSafe);
            assertThat(asList(TestIOData.NAMES)).isEqualTo(resultRegular);
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
    ...
    void testDataSourceWithRuntimeContext() {
        try {
            ...
            ExecutionConfig executionConfig = new ExecutionConfig();
            executionConfig.disableObjectReuse();
            assertThat(false).isEqualTo(in.hasBeenClosed());
            assertThat(false).isEqualTo(in.hasBeenOpened());
            ...
            assertThat(true).isEqualTo(in.hasBeenClosed());
            assertThat(true).isEqualTo(in.hasBeenOpened());
            ...
            assertThat(asList(TestIOData.RICH_NAMES)).isEqualTo(resultMutableSafe);
            assertThat(asList(TestIOData.RICH_NAMES)).isEqualTo(resultRegular);
        } catch (Exception e) {
            e.printStackTrace();
            fail(e.getMessage());
        }
