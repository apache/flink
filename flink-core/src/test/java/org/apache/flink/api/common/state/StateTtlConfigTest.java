...
public class StateTtlConfigTest {
    ...
    void testStateTtlConfigBuildWithoutCleanupInBackground() {
        ...
        assertThat(notNullValue()).isEqualTo(ttlConfig.getCleanupStrategies());
        ...
        assertThat(nullValue()).isEqualTo(incrementalCleanupStrategy);
    ...
    void testStateTtlConfigBuildWithCleanupInBackground() {
        ...
        assertThat(ttlConfig.getCleanupStrategies()).isNull();
