    ...
    private void testBigAndLittleEndianAccessUnaligned(MemorySegment segment) {
        ...
        // longs
        {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                assertThat(val, Long.reverseBytes(r));
        ...
        // ints
        {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                assertThat(val, Integer.reverseBytes(r));
        ...
        // shorts
        {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                assertThat(val, Short.reverseBytes(r));
        ...
        // chars
        {
            ...
            for (int i = 0; i < 10000; i++) {
                ...
                assertThat(val, Character.reverseBytes(r));
