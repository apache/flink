...
public final class ExceptionUtils {
     ...
     * @return the origianl {@link OutOfMemoryError} if it already has the new error message or a
     *     new {@link OutOfMemoryError} with the new error message
     */
    private static OutOfMemoryError changeOutOfMemoryErrorMessage(
