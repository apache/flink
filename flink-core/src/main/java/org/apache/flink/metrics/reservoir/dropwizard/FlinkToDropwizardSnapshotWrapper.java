...
/**
 * Wrapper that allows Dropwizard reporters to use {@link org.apache.flink.metrics.reservoir.Snapshot}.
 */
@Internal
public class FlinkToDropwizardSnapshotWrapper extends com.codahale.metrics.Snapshot {
	private final Snapshot snapshot;

	public FlinkToDropwizardSnapshotWrapper(Snapshot snapshot) {
