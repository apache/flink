...
/**
 * An exponentially-decaying random reservoir of {@code long}s.
 */
@PublicEvolving
public class ExponentiallyDecayingReservoir extends com.codahale.metrics.ExponentiallyDecayingReservoir implements Reservoir {
	@Override
