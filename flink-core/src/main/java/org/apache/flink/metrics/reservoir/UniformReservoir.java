...
/**
 * A random sampling reservoir of a stream of {@code long}s.
 */
@PublicEvolving
public class UniformReservoir extends com.codahale.metrics.UniformReservoir implements Reservoir {
	@Override
