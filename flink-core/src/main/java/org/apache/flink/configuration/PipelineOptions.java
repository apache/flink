...
public class PipelineOptions {
	...
	public static final ConfigOption<String> JARS =
			key("pipeline.jars")
					.noDefaultValue()
					.withDescription("A comma-separated list of the jars to package with the job jars to be sent to the cluster. These have to be valid paths.");
	...
	public static final ConfigOption<String> CLASSPATHS =
			key("pipeline.classpaths")
					.noDefaultValue()
					.withDescription("A comma-separated list of the classpaths to package with the job jars to be sent to the cluster. These have to be valid URLs.");
}
