...
public class JobManagerOptions {
    ...
    @Documentation.ExcludeFromDocumentation(
            "User normally should not be expected to change this config.")
    public static final ConfigOption<String> SCHEDULING_STRATEGY =
            key("jobmanager.scheduler.scheduling-strategy")
                    ...
                    .withDescription(
                            Description.builder()
                                    .text(
                                            "Determines which scheduling strategy is used to schedule tasks. Accepted values are:")
                                    .list(
                                            text("'region': pipelined region scheduling"),
                                            text(
                                                    "'legacy': legacy scheduling strategy, which is eager scheduling for streaming jobs "
