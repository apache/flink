...
public class CheckpointingOptions {
    ...
    public static final ConfigOption<Boolean> PAUSE_SOURCES_UNTIL_FIRST_CHECKPOINT =
            key("pipeline.sources.pause-until-first-checkpoint")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "Only pull data from sources until the first checkpoint is triggered. "
                                    + "This might be helpful in reducing recovery times in cases where "
                                    + "recovered records from an unaligned checkpoint compete with new incoming records for processing. "
