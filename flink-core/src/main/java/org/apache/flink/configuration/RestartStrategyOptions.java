                            ...
                            Description.builder()
                                    ...
                                    .list(
                                            ...
                                            text(
                                                    ...
                                                    code("fixed-delay"),
                                                    link(
                                                            "{{.Site.BaseURL}}{{.Site.LanguagePrefix}}/docs/dev/execution/task_failure_recovery/#fixed-delay-restart-strategy",
                                                            "here")),
                                            text(
                                                    ...
                                                    code("failure-rate"),
                                                    link(
                                                            "{{.Site.BaseURL}}{{.Site.LanguagePrefix}}/docs/dev/execution/task_failure_recovery/#failure-rate-restart-strategy",
                                                            "here")),
                                            text(
                                                    ...
                                                    link(
                                                            "{{.Site.BaseURL}}{{.Site.LanguagePrefix}}/docs/dev/execution/task_failure_recovery/#exponential-delay-restart-strategy",
                                                            "here")))
                                    .text(
