...
/**
 * Extension point for object-storage input stream implementations.
 *
 * <p>All methods are called with the stream's internal lock held. Implementations do not need their
 * own synchronisation.
 */
@Internal
