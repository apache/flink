...
/**
 * Context passed to {@link OutputStreamOpener} describing the write operation, including encryption
 * metadata to be persisted with the cloud object.
 *
...
public interface WriteContext {
    ...
    /** Shared empty context — avoids allocation for plain (non-encrypted) writes. */
