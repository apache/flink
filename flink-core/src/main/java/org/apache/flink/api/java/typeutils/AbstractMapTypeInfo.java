...
abstract class AbstractMapTypeInfo<K, V, M extends Map<K, V>> extends TypeInformation<M> {
	...
	AbstractMapTypeInfo(
		...
		Preconditions.checkNotNull(keyTypeInfo,
			"The type information for the keys cannot be null.");
		Preconditions.checkNotNull(valueTypeInfo,
			"The type information for the values cannot be null.");
	...
	AbstractMapTypeInfo(Class<K> keyClass, Class<V> valueClass) {
		Preconditions.checkNotNull(keyClass,
			"The key class cannot be null.");
		Preconditions.checkNotNull(valueClass,
			"The value class cannot be null.");
