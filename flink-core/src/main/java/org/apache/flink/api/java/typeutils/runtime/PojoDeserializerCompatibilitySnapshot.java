 ...
 * user POJO class being on the classpath, such as the {@code PojoToRowDataDeserializer} of the
 * State Processing API. It declares itself {@link
 * TypeSerializerSchemaCompatibility#compatibleAsIs() compatible as-is} with any stored {@link
