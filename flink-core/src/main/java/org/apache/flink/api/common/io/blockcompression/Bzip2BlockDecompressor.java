...
/**
 * Decompress data from Bzip2 format.
 *
 * Note that this class is only a wrapper of {@link BZip2CompressorInputStream}.
 * For efficiency, one should rewrite this class.
 */
public class Bzip2BlockDecompressor extends AbstractBlockDecompressor {
