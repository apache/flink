...
public abstract class TypeSerializerConfigSnapshot<T> extends VersionedIOReadableWritable implements TypeSerializerSnapshot<T> {
	...
	public TypeSerializerSchemaCompatibility<T> resolveSchemaCompatibility(
		...
		throw new UnsupportedOperationException(
			"This serializer snapshot is still implementing the deprecated TypeSerializerConfigSnapshot class.\n" +
				"Please update to implement the TypeSerializerSnapshot interface instead, to enable state evolution as well as being future-proof.\n\n" +
