...
public class AsyncValueStateDescriptor<T> extends StateDescriptor<AsyncValueState<T>, T> {
	 ...
	 * consider using the {@link #AsyncValueStateDescriptor(String, TypeInformation, Object)} constructor.
	 *
	 * @deprecated Use {@link #AsyncValueStateDescriptor(String, Class)} instead and manually manage
	 ...
	 */
	@Deprecated
	public AsyncValueStateDescriptor(String name, Class<T> typeClass, T defaultValue) {
	 ...
	 *
	 * @deprecated Use {@link #AsyncValueStateDescriptor(String, TypeInformation)} instead and manually
	 ...
	 */
	@Deprecated
	public AsyncValueStateDescriptor(String name, TypeInformation<T> typeInfo, T defaultValue) {
	 ...
	 * serializer.
	 *
	 * @deprecated Use {@link #AsyncValueStateDescriptor(String, TypeSerializer)} instead and manually
	 * manage the default value by checking whether the contents of the state is {@code null}.
	 *
	 * @param name The (unique) name for the state.
	 ...
	 */
	@Deprecated
	public AsyncValueStateDescriptor(String name, TypeSerializer<T> typeSerializer, T defaultValue) {
	 ...
	 *
	 * <p>If this constructor fails (because it is not possible to describe the type via a class),
	 * consider using the {@link #AsyncValueStateDescriptor(String, TypeInformation)} constructor.
	 *
	 * @param name The (unique) name for the state.
	 * @param typeClass The type of the values in the state.
	 */
	public AsyncValueStateDescriptor(String name, Class<T> typeClass) {
	 ...
	 * @param typeSerializer The type serializer of the values in the state.
	 */
	public AsyncValueStateDescriptor(String name, TypeSerializer<T> typeSerializer) {
