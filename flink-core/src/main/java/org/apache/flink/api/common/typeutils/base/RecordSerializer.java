...
public class RecordSerializer extends TypeSerializerSingleton<Record> {

	private static final long serialVersionUID = 1L;

	public static final RecordSerializer INSTANCE = new RecordSerializer();

	private transient Record tmp;
	...
	@Override
	public Record deserialize(Record reuse, DataInputView source) throws IOException {
		reuse.read(source);
		return reuse;
	}
