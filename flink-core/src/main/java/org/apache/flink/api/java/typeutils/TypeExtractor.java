...
public class TypeExtractor {
	...
	private static final String PROTOBUF_MESSAGE_CLASS = "com.google.protobuf.AbstractMessage";
	...
	private <OUT,IN1,IN2> TypeInformation<OUT> privateGetForClass(Class<OUT> clazz, ArrayList<Type> typeHierarchy,
		...
		// special case for class generated by Protobuf.
		if (hasSuperclass(clazz, PROTOBUF_MESSAGE_CLASS)) {
			return ProtobufUtils.getProtobufUtils().createProtobufTypeInfo(clazz);
		}
