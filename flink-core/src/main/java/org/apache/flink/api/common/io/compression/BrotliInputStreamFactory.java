...
/** Factory for Brotli decompressors. */
public class BrotliInputStreamFactory implements InflaterInputStreamFactory<BrotliInputStream> {
    ...
    @Override
    public BrotliInputStream create(InputStream in) throws IOException {
