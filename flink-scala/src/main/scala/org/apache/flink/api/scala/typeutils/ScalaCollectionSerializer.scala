 ...
 */
abstract class ScalaCollectionSerializer[T <: Iterable[E], E](
  ...
  override def copy(from: T): T = {
    ...
    while (it.hasNext) {
      builder += it.next().asInstanceOf[E]
    }
    builder.result()
  }
  ...
  override def serialize(coll: T, target: DataOutputView): Unit = {
    ...
    while (it.hasNext) {
      ...
      if (e == null) {
        ...
        elementSerializer.serialize(e.asInstanceOf[E], target)
      }
    }
  }
  ...
  override def equals(obj: Any): Boolean = {
    if (obj != null && obj.isInstanceOf[ScalaCollectionSerializer[_, _]]) {
      val other = obj.asInstanceOf[ScalaCollectionSerializer[_, _]]
