...
public class JoinCustomPartitioningTest extends CompilerTestBase {
	...
	public void testJoinWithTuples() {
		try {
			...
			input1
				.join(input2, JoinOperatorBase.JoinHint.REPARTITION_HASH_FIRST).where(1).equalTo(0).withPartitioner(partitioner)
	...
	public void testJoinWithTuplesWrongType() {
		try {
			...
			try {
				input1
					.join(input2, JoinOperatorBase.JoinHint.REPARTITION_HASH_FIRST).where(1).equalTo(0)
	...
	public void testJoinWithPojos() {
		try {
			...
			input1
				.join(input2, JoinOperatorBase.JoinHint.REPARTITION_HASH_FIRST)
	...
	public void testIncompatibleHashAndCustomPartitioning() {
		try {
			...
			grouped
				.join(partitioned, JoinOperatorBase.JoinHint.REPARTITION_HASH_FIRST).where(0).equalTo(0)
