...
public class OpenAIAsyncChatModelFunction extends AbstractOpenAIAsyncModelFunction {
    private static final long serialVersionUID = 1L;

    private final OpenAIChatTask task;

    public OpenAIAsyncChatModelFunction(
    ...
    public CompletableFuture<Collection<RowData>> asyncPredictInternal(String input) {
        return client.chat()
                .completions()
                .create(task.buildParams(input))
                .handle(task::convertToRowData);
    }
}
