...
public class QwenChatModelFunction extends AbstractQwenModelFunction {
    private static final long serialVersionUID = 1L;

    public static final String MODEL_PREFIX = "qwen-plus";
    ...
    public CompletableFuture<Collection<RowData>> asyncPredict(RowData rowData) {
        com.openai.models.chat.completions.ChatCompletionCreateParams.Builder builder =
    ...
    private List<RowData> convertToRowData(
