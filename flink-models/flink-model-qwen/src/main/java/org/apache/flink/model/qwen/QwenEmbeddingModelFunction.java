...
/** {@link AbstractQwenModelFunction} for Qwen embedding task. */
public class QwenEmbeddingModelFunction extends AbstractQwenModelFunction {
    private static final long serialVersionUID = 1L;

    public static final String MODEL_PREFIX = "text-embedding";
    ...
    public QwenEmbeddingModelFunction(
