...
public abstract class HierarchicalCluster {
	...
	public HierarchicalCluster(final String id) {
		this.id = id;
	}
	...
	/**
	 * Optimization. Tell the cluster that its children will not be needed any
	 * longer, so it frees them for garbage collection.
	 */
