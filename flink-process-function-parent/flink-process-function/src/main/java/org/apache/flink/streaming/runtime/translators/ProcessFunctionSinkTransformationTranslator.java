...
/** A {@link TransformationTranslator} for the {@link ProcessFunctionSinkTransformation}. */
@Internal
public class ProcessFunctionSinkTransformationTranslator<Input, Output>
        implements TransformationTranslator<
                Output, ProcessFunctionSinkTransformation<Input, Output>> {
    ...
    public Collection<Integer> translateForBatch(
            ProcessFunctionSinkTransformation<Input, Output> transformation, Context context) {
    ...
    private Collection<Integer> translateInternal(
            ProcessFunctionSinkTransformation<Input, Output> transformation,
            Context context,
            boolean batch) {
    ...
    public static void registerSinkTransformationTranslator() throws Exception {
        ...
        underlyingMap.put(
                ProcessFunctionSinkTransformation.class,
                new ProcessFunctionSinkTransformationTranslator<>());
    }
    ...
    private static class SinkExpander<T> {
        private final ProcessFunctionSinkTransformation<T, ?> transformation;
        ...
        public SinkExpander(
                ...
                Sink<T> sink,
                ProcessFunctionSinkTransformation<T, ?> transformation,
                Context context,
                boolean isBatchMode) {
