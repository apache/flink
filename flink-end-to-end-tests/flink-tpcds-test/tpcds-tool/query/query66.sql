-- start query 1 in stream 0 using template ../query_templates_qualified/query66.tpl
select   
         w_warehouse_name
 	,w_warehouse_sq_ft
 	,w_city
...
-- end query 1 in stream 0 using template ../query_templates_qualified/query66.tpl
