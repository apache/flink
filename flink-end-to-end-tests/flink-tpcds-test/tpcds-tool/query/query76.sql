-- start query 1 in stream 0 using template ../query_templates_qualified/query76.tpl
...
-- end query 1 in stream 0 using template ../query_templates_qualified/query76.tpl
