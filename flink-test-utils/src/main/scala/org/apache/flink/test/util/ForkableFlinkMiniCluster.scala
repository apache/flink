...
TestingCluster, TestingTaskManager}
...
object ForkableFlinkMiniCluster {
  ...
  ForkableFlinkMiniCluster = {
    ...
    config.setString(ConfigConstants.AKKA_WATCH_HEARTBEAT_INTERVAL, "100 ms")
    config.setString(ConfigConstants.AKKA_WATCH_HEARTBEAT_PAUSE, "400 ms")
