...
public class TransitiveClosureEntryAccessors implements TypeAccessorsV2<TransitiveClosureEntry>
{
	...
	public long serialize(TransitiveClosureEntry record, DataOutput target) throws IOException
	{
	...
	public void deserialize(TransitiveClosureEntry target, DataInput source) throws IOException
	{
