...
public class AccessibleConcurrentHashMap<K, V> extends AbstractMap<K, V>
  ...
  @SuppressWarnings("unchecked")
     ...
     * @since 1.6
     */
    public AccessibleConcurrentHashMap(int initialCapacity, float loadFactor) {
     ...
     */
    public AccessibleConcurrentHashMap() {
     ...
     * @param m the map
     */
    public AccessibleConcurrentHashMap(Map<? extends K, ? extends V> m) {
  ...
  int hash = hash(key.hashCode());
    ...
    abstract class HashIterator {
        ...
        public void remove() {
            ...
            AccessibleConcurrentHashMap.this.remove(lastReturned.key);
            lastReturned = null;
        }
    }
  ...
  implements Iterator<Entry<K,V>> {
    ...
    final class KeySet extends AbstractSet<K> {
        ...
        public boolean contains(Object o) {
            return AccessibleConcurrentHashMap.this.containsKey(o);
        }
    ...
    final class EntrySet extends AbstractSet<Map.Entry<K,V>> {
        ...
        public boolean contains(Object o) {
            ...
            V v = AccessibleConcurrentHashMap.this.get(e.getKey());
        ...
        public boolean remove(Object o) {
            if (!(o instanceof Map.Entry))
                return false;
            Map.Entry<?,?> e = (Map.Entry<?,?>)o;
            return AccessibleConcurrentHashMap.this.remove(e.getKey(), e.getValue());
        }
        public int size() {
            return AccessibleConcurrentHashMap.this.size();
        }
