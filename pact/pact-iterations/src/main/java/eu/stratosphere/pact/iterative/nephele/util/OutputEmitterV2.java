...
//	private PartitionFunction partitionFunction;
	...
	public OutputEmitterV2(ShipStrategy strategy, JobID jobId, TypeAccessorsV2<Value> accessor)
	{
		this(strategy, jobId, DEFAULT_SALT, accessor);
	}
	
	public OutputEmitterV2(ShipStrategy strategy, JobID jobId, byte[] salt, TypeAccessorsV2<Value> accessor)
	{
