...
import eu.stratosphere.pact.iterative.nephele.tasks.AsynchronousIterationHead;
...
public class AsynchronousUpdateableMatchingOptimized extends AsynchronousIterationHead {

  protected static final Log LOG = LogFactory.getLog(AsynchronousUpdateableMatchingOptimized.class);
