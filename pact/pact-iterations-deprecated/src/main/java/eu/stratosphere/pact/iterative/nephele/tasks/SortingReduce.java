...
//      sorter = new UnilateralSortMerger(getEnvironment().getMemoryManager(), getEnvironment().getIOManager(),
//          memorySize, 64, comparators, keyPos, keyClasses, pactIter, this, 0.8f);
//    } catch (Exception ex) {
