 ...
 */
public abstract class ReduceStub<K extends Key> extends SingleInputKeyStub<K>
{
	/**
	 ...
	 */
	public abstract void reduce(K key, Iterator<PactRecord> records, Collector out) throws Exception;
	 ...
	 * @param key The key to combine values for.
	 * @param records
