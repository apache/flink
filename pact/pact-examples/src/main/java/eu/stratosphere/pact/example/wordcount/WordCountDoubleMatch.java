 ...
 */
public class WordCountDoubleMatch implements PlanAssembler, PlanAssemblerDescription {
	 ...
	 *
	 */
	public static class MatchWords extends MatchStub<PactString, PactInteger, PactInteger, PactString, PactInteger> {

		@Override
		public void match(PactString key, PactInteger value1, PactInteger value2, Collector<PactString, PactInteger> out) {
	...
	public Plan getPlan(String... args) {
		...
		FileDataSourceContract<PactNull, PactString> data3 = new FileDataSourceContract<PactNull, PactString>(
				LineInFormat.class, dataInput, "Input Lines");
		...
		MapContract<PactNull, PactString, PactString, PactInteger> mapper3 = new MapContract<PactNull, PactString, PactString, PactInteger>(
				TokenizeLine.class, "Tokenize Lines");
		mapper3.setDegreeOfParallelism(noSubTasks);

		MatchContract<PactString, PactInteger, PactInteger, PactString, PactInteger> matcher = new MatchContract<PactString, PactInteger, PactInteger, PactString, PactInteger>(
				MatchWords.class, "MatchWords");
