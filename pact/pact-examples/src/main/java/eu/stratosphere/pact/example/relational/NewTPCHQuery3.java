 ...
 */
public class NewTPCHQuery3 implements PlanAssembler, PlanAssemblerDescription {

	private static Log LOGGER = LogFactory.getLog(NewTPCHQuery3.class);
	...
	public static class JoinLiO extends MatchStub<PactLong>
	{
		 ...
		 */
		@Override
		public void match(PactLong key, PactRecord first, PactRecord second, Collector out)
		{
	 ...
	 */
	@Combinable
	public static class AggLiO extends ReduceStub<PactLong>
	{
		private final PactDouble extendedPrice = new PactDouble();
		 ...
		 */
		@Override
		public void reduce(PactLong key, Iterator<PactRecord> values, Collector out)
		{
			PactRecord rec = null;
		 ...
		 */
		@Override
		public void combine(PactLong key, Iterator<PactRecord> values, Collector out)
		{
	...
	public Plan getPlan(final String... args) {
		...
		MatchContract joinLiO = new MatchContract(JoinLiO.class, 0, 0, filterO, projectLi, "JoinLiO");
		...
		ReduceContract aggLiO = new ReduceContract(AggLiO.class, new int[] {0, 1}, joinLiO, "AggLio");
