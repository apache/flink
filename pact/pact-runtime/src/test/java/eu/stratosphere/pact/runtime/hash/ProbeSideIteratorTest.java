...
//import eu.stratosphere.pact.runtime.hash.HashJoin.ProbeIterator;
...
//{
//	private Iterator<PactRecord> source;		// the iterator that provides the input
//	
//	private ProbeIterator psi;				// the probe iterator, progressing in key steps
//	
//	
//	@Before
//	public void setup()
//	{
//		ArrayList<PactRecord> source = new ArrayList<PactRecord>();
//		
//		// add elements to the source
//		source.add(new PactRecord(new PactInteger(1), new PactString("A")));
//		source.add(new PactRecord(new PactInteger(2), new PactString("B")));
//		source.add(new PactRecord(new PactInteger(3), new PactString("C")));
//		source.add(new PactRecord(new PactInteger(3), new PactString("D")));
//		source.add(new PactRecord(new PactInteger(4), new PactString("E")));
//		source.add(new PactRecord(new PactInteger(4), new PactString("F")));
//		source.add(new PactRecord(new PactInteger(4), new PactString("G")));
//		source.add(new PactRecord(new PactInteger(5), new PactString("H")));
//		source.add(new PactRecord(new PactInteger(5), new PactString("I")));
//		source.add(new PactRecord(new PactInteger(5), new PactString("J")));
//		source.add(new PactRecord(new PactInteger(5), new PactString("K")));
//		source.add(new PactRecord(new PactInteger(5), new PactString("L")));
//		
//		this.source = source.iterator();
//		this.psi = new ProbeIterator(new MutableObjectIteratorWrapper(this.source));
//	}
//	
//	@Test
...
//	{
//		try {
//			if (this.psi.next() != null) {
//				Assert.fail("A new ProbeSideIterator must not have any value available");
//			}
//		} catch (IOException e) {
//			Assert.fail("A new ProbeSideIterator should not throw an IOException.");
//		}
//		// all right!
//	}
//	
...
//	{
//		PactRecord record;
//		Assert.assertNotNull("ProbeSideIterator must have another key.", (record = this.psi.next()));
//		Assert.assertEquals("ProbeSideIterator returned a wrong key.", 1, record.getField(0, PactInteger.class).getValue());
//		
//		Assert.assertNotNull("ProbeSideIterator must have another key.", (record = this.psi.next()));
//		Assert.assertEquals("ProbeSideIterator returned a wrong key.", 2, record.getField(0, PactInteger.class).getValue());
//		
//		Assert.assertNotNull("ProbeSideIterator must have another key.", (record = this.psi.next()));
//		Assert.assertEquals("ProbeSideIterator returned a wrong key.", 3, record.getField(0, PactInteger.class).getValue());
//		
//		Assert.assertNotNull("ProbeSideIterator must have another key.", (record = this.psi.next()));
//		Assert.assertEquals("ProbeSideIterator returned a wrong key.", 4, record.getField(0, PactInteger.class).getValue());
//		
//		Assert.assertNotNull("ProbeSideIterator must have another key.", (record = this.psi.next()));
//		Assert.assertEquals("ProbeSideIterator returned a wrong key.", 5, record.getField(0, PactInteger.class).getValue());
//		
//		Assert.assertNull("ProbeSideIterator must not have another key.", (record = this.psi.next()));
//		
//		try {
//			this.psi.next();
