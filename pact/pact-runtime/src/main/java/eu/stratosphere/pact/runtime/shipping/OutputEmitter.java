...
public class OutputEmitter<T> implements ChannelSelector<SerializationDelegate<T>>
{
	...
	private TypeComparator<T>[] partitionBoundaries;		// the partition boundaries for range partitioning
	
	private final DataDistribution<T> distribution; // the data distribution to create the partition boundaries for range partitioning
	 ...
	 */
	public OutputEmitter(ShipStrategyType strategy, TypeComparator<T> comparator, DataDistribution<T> distr)
	{
	 ...
	 * @param distr The distribution pattern used in the case of a range partitioning.
	 */
	public OutputEmitter(ShipStrategyType strategy, TypeComparator<T> comparator, byte[] salt, DataDistribution<T> distr)
	{
