...
public class RepeatableHashjoinMatchDriverWithCachedBuildside<IT1, IT2, OT> extends AbstractRepeatableMatchDriver {

  @Override
  protected long getMemorySizeForHashjoin() {
    return taskContext.getTaskConfig().getMemorySize();
  }
  ...
  protected MutableObjectIterator getProbeSideForMatch() {
    return taskContext.getInput(PROBESIDE_INDEX);
  }
