package eu.stratosphere.pact.example.wordcount.nephele;
...
import eu.stratosphere.pact.common.io.BinaryIntInputFormat;
...
public class WordCountNephele
{
	...
	private static final long MEMORY_PER_NODE = 16000 * 1024 * 1024L;
	...
	public static void main(String[] args) throws Exception
	{
		...
		jobGraph.addJar(new Path("file:///home/cicero/repositories/stratosphere/pact/pact-tests/Wordcount.jar"));
		
		Configuration cfg = new Configuration();
		cfg.setString(ConfigConstants.JOB_MANAGER_IPC_ADDRESS_KEY, "cloud-7.dima.tu-berlin.de");
		cfg.setInteger(ConfigConstants.JOB_MANAGER_IPC_PORT_KEY, 6002);
