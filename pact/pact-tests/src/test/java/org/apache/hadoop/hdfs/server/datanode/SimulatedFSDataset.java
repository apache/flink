 ...
 * Note the monitor is coarse grained - it is at each method.
 */
...
public class SimulatedFSDataset implements FSConstants, FSDatasetInterface, Configurable {
	...
	private class BInfo { // information about a single block
		...
		BInfo(Block b, boolean forWriting)
											throws IOException {
	...
	static private class SimulatedStorage {
		private long capacity; // in memory

		private long used; // in memory
	 ...
	 * @throws IOException
	 *         - block does not exist or problems accessing
	 *         the meta file
	 */
	...
	static private class SimulatedInputStream extends java.io.InputStream {
		...
		/**
		 * An input stream of size l with repeated memory
		 * 
		 * @param l
		 * @param iRepeatedData
		 */
