...
gulp.task('scripts', function() {
  stream = gulp.src([ paths.src + 'scripts/config.js', paths.src + 'scripts/**/*.coffee', '!' + paths.src + 'scripts/index2.coffee'] )
    .pipe(plumber())
    .pipe(sourcemaps.init())
...
gulp.task('html2', function() {
  gulp.src(paths.src + 'index2.jade')
    .pipe(plumber())
    .pipe(jade({
      pretty: true
    }))
...
gulp.task('compile', ['html', 'html2', 'partials','styles', 'scripts', 'scripts2']);
