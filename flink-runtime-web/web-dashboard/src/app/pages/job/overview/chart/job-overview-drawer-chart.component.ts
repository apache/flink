...
export class JobOverviewDrawerChartComponent implements OnInit, OnDestroy {
  ...
  loadMetricList(jobId: string, vertexId: string) {
    ...
    this.metricsService.getAllAvailableMetrics(jobId, vertexId).subscribe(data => {
      ...
      this.showList = [...this.showList,...this.optionList.slice(this.showListPageNum * this.showListPageSize,(this.showListPageNum + 1) * this.showListPageSize)];
  ...
  nzOnSearch(val: string){
    ...
    if(val){
      ...
      this.showList = [...this.optionList.slice(this.showListPageNum * this.showListPageSize,(this.showListPageNum + 1) * this.showListPageSize)];
      this.showListPageNum++;
  }
