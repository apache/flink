    ...
    children: [
      {
        ...
        children: [
          {
            path: ':jid',
            loadChildren: () => import('./modules/running-job/routes').then(m => m.RUNNING_JOB_ROUTES)
          }
        ]
      },
      {
        ...
        children: [
          {
            path: ':jid',
            loadChildren: () => import('./modules/completed-job/routes').then(m => m.COMPLETED_JOB_ROUES)
          }
        ]
      }
    ]
