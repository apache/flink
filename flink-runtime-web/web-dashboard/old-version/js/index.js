      ...
      return (
        e
          ...
          .state('single-manager', {
            ...
            abstract: !0,
            views: {
              main: { templateUrl: 'partials/taskmanager/taskmanager.html', controller: 'SingleTaskManagerController' }
            }
          })
          ...
          .state('jobmanager.config', {
            url: '/config',
            views: {
              details: { templateUrl: 'partials/jobmanager/config.html', controller: 'JobManagerConfigController' }
            }
          })
          .state('jobmanager.stdout', {
            url: '/stdout',
            views: {
              details: { templateUrl: 'partials/jobmanager/stdout.html', controller: 'JobManagerStdoutController' }
            }
          })
      ...
      return function(e) {
        ...
        return (
          ...
          (t = function(e, n) {
            ...
            return (
              (o = Math.pow(1024, n)),
              e < o ? (e / o).toFixed(2) + ' ' + r[n] : e < 1e3 * o ? (e / o).toPrecision(3) + ' ' + r[n] : t(e, n + 1)
            );
          }),
    ...
    function(e, t, r) {
      return (
        (this.loadConfig = function() {
          ...
          return (
            (n = r.defer()),
            e.get(t.jobServer + 'config').success(function(e, t, r, o) {
              return n.resolve(e);
            }),
            n.promise
          );
      ...
      function(e, t, r) {
        ...
        return (
          ...
          (this.loadConfig = function() {
            ...
            return (
              (n = r.defer()),
              e.get(t.jobServer + 'jobmanager/config').success(function(e, t, r, o) {
      ...
      function(e, t, r) {
        ...
        return (
          ...
          (this.loadLogs = function() {
            ...
            return (
              (o = r.defer()),
              e.get(t.jobServer + 'jobmanager/log').success(function(e, t, r, i) {
      ...
      function(e, t, r) {
        ...
        return (
          ...
          (this.loadStdout = function() {
            ...
            return (
              (o = r.defer()),
              e.get(t.jobServer + 'jobmanager/stdout').success(function(e, t, r, i) {
                return (n = e), o.resolve(e);
              }),
              o.promise
            );
              ...
              (i = (function(t) {
                return function(t) {
                  ...
                  return (
                    ...
                    (a = (function() {
                      var e, r, o;
                      for (o = [], n = e = 0, r = t.parallelism - 1; 0 <= r ? e <= r : e >= r; n = 0 <= r ? ++e : --e)
                        o.push(n + '.currentInputWatermark');
                      return o;
                    })()),
                    o.getMetrics(i, t.id, a).then(function(e) {
                      ...
                      for (t in i)
                        (s = i[t]),
                          (a = t.replace('.currentInputWatermark', '')),
                          (l[a] = s),
                          (isNaN(o) || s < o) && (o = s);
                      return (
                        (n = !isNaN(o) && o > u.noWatermark ? o : NaN), r.resolve({ lowWatermark: n, watermarks: l })
                      );
                    }),
                    r.promise
                  );
    ...
    .controller('JobPlanCheckpointDetailsController', [
      ...
      function(e, t, r, n) {
        ...
        return (
          ...
          o(r.checkpointId),
          e.nodeid && i(r.checkpointId, e.nodeid),
          e.$on('reload', function(t) {
      ...
      function(e) {
        return {
          ...
          link: function(e, t, r) {
            ...
            (i = t.children()[0]),
              (o = t.width()),
              angular.element(i).attr('width', o),
              (n = function(e) {
                var t, r, n;
                return (
                  d3
      ...
      function(e) {
        return {
          ...
          link: function(t, r, n) {
            ...
            (a = r.children()[0]),
              (i = r.width()),
              angular.element(a).attr('width', i),
              (s = function(e) {
                return e.replace('&gt;', '>');
              }),
              (o = function(r) {
          ...
          link: function(e, t, r) {
            ...
            (p = null),
              ...
              (a = function(e, t, r, n) {
                var o, i;
                return (
                  (o = "<div href='#/jobs/" + h + '/vertex/' + e.id + "' class='node-label " + m(e, t) + "'>"),
                  (o +=
                    'mirror' === t
                  ...
                  '' === e.description
                    ? (o += '')
                    : ((i = e.description), (i = M(i)), (o += "<h4 class='step-name'>" + i + '</h4>')),
                  null != e.step_function
                    ? (o += f(e.id, r, n))
                    : (g(t) && (o += '<h5>' + t + ' Node</h5>'),
                      '' !== e.parallelism && (o += '<h5>Parallelism: ' + e.parallelism + '</h5>'),
                      void 0 !== e.lowWatermark && (o += '<h5>Low Watermark: ' + e.lowWatermark + '</h5>'),
                      void 0 !== e.operator &&
                        e.operator_strategy &&
                        (o += '<h5>Operation: ' + M(e.operator_strategy) + '</h5>')),
                  (o += '</div>')
                );
              }),
              (f = function(e, t, r) {
              ...
              (s = function(e, t, r, n, o, i) {
                return (
                  ...
                  r.id === t.partial_solution
                    ...
                    : r.id === t.workset
                    ? e.setNode(r.id, { label: a(r, 'workset', o, i), labelType: 'html', class: m(r, 'workset') })
                    : r.id === t.next_workset
                    ? e.setNode(r.id, {
              ...
              (k = function(e, t) {
                ...
                for (
                  n = [], null != t.nodes ? (b = t.nodes) : ((b = t.step_function), (i = !0)), a = 0, u = b.length;
                  a < u;
                  a++
                )
                  if (
                    ...
                    (f = 0),
                    r.step_function &&
                      ((v = new dagreD3.graphlib.Graph({ multigraph: !0, compound: !0 }).setGraph({
                        nodesep: 20,
                        edgesep: 0,
                        ranksep: 20,
                        rankdir: 'LR',
                    ...
                    for (h = r.inputs, l = 0, d = h.length; l < d; l++) (m = h[l]), o(e, t, r, n, m);
                return e;
              }),
              (y = function(e, t) {
                var r, n, o;
                for (n in e.nodes) {
                  ...
                  if (null != r.step_function)
                    for (o in r.step_function) if (r.step_function[o].id === t) return r.step_function[o];
                }
              }),
              ($ = function(e, t) {
                var r, n, o, i;
                if (!_.isEmpty(t))
                  for (i = e.nodes, r = 0, n = i.length; r < n; r++)
                    (o = i[r]), t[o.id] && !isNaN(t[o.id].lowWatermark) && (o.lowWatermark = t[o.id].lowWatermark);
                return e;
              }),
              (v = 0),
              (b = 0),
              (d = function() {
                ...
                if (e.plan) {
                  ...
                  return (
                    (r = 0.5),
                    (i = Math.floor((angular.element(S).width() - p.graph().width * r) / 2)),
                    (a = Math.floor((angular.element(S).height() - p.graph().height * r) / 2)),
                    0 !== b && 0 !== v
                      ? (C.scale(b).translate(v), u.attr('transform', 'translate(' + v + ') scale(' + b + ')'))
                      : (C.scale(r).translate([i, a]),
                        u.attr('transform', 'translate(' + i + ', ' + a + ') scale(' + C.scale() + ')')),
                    C.on('zoom', function() {
                      var e;
                      return (
                        (e = d3.event),
                        (b = e.scale),
                        (v = e.translate),
                        u.attr('transform', 'translate(' + v + ') scale(' + b + ')')
                      );
                    }),
                    C(l),
    ...
    function(e, t, r, n, o, i) {
      ...
      return (
            ...
            l.job.promise.then(
              (function(o) {
                return function(i) {
                  ...
                  return (
                    (s = o.seekVertex(r)),
                    e.get(t.jobServer + 'jobs/' + a.jid + '/vertices/' + r + '/subtasktimes').success(function(e) {
            ...
            l.job.promise.then(
              (function(o) {
                return function(o) {
                  return (
                    console.log(a.jid),
                    e.get(t.jobServer + 'jobs/' + a.jid + '/vertices/' + r + '/accumulators').success(function(o) {
                      var i;
                      return (
                        (i = o['user-accumulators']),
                        e
                          .get(t.jobServer + 'jobs/' + a.jid + '/vertices/' + r + '/subtasks/accumulators')
                          .success(function(e) {
                            var t;
          ...
          return (
            ...
            l.job.promise.then(
              (function(o) {
                return function(o) {
                  return e
                    .get(t.jobServer + 'jobs/' + a.jid + '/checkpoints/details/' + r + '/subtasks/' + n)
                    .success(function(e) {
        ...
        (this.getOperatorBackPressure = function(r) {
          ...
          return (
            (n = o.defer()),
            e.get(t.jobServer + 'jobs/' + a.jid + '/vertices/' + r + '/backpressure').success(
              (function(e) {
                return function(e) {
                  return n.resolve(e);
                };
        ...
        return (
          ...
          (e.options = {
            ...
            yTickFormat: function(e) {
              var t, r, n, o;
              for (r = !1, n = 0, o = 1, t = Math.abs(e); !r && n < 50; )
                Math.pow(10, n) <= t && t < Math.pow(10, n + o) ? (r = !0) : (n += o);
      ...
      return (
              ...
              return angular.forEach(e.metrics, function(t, r) {
                return angular.forEach(t, function(t, n) {
                  ...
                  if (
                    ...
                    return e.getMetrics(r, n, o).then(function(t) {
        ...
        (this.removeMetric = (function(e) {
          return function(t, r, n) {
            ...
            if (null != e.metrics[t][r])
              return (
                (o = e.metrics[t][r].indexOf(n)),
                o === -1 && (o = _.findIndex(e.metrics[t][r], { id: n })),
                o !== -1 && e.metrics[t][r].splice(o, 1),
                e.saveSetup()
              );
          };
        })(this)),
        (this.setMetricSize = (function(e) {
          return function(t, r, n, o) {
            ...
            if (null != e.metrics[t][r])
              return (
                (i = e.metrics[t][r].indexOf(n.id)),
                i === -1 && (i = _.findIndex(e.metrics[t][r], { id: n.id })),
                i !== -1 && (e.metrics[t][r][i] = { id: n.id, size: o, view: n.view }),
                e.saveSetup()
              );
          };
        })(this)),
          ...
          return function(t, r, n, o) {
            ...
            if (null != e.metrics[t][r])
              return (
                (i = e.metrics[t][r].indexOf(n.id)),
                i === -1 && (i = _.findIndex(e.metrics[t][r], { id: n.id })),
                i !== -1 && (e.metrics[t][r][i] = { id: n.id, size: n.size, view: o }),
                e.saveSetup()
              );
          };
        })(this)),
        ...
        (this.getAvailableMetrics = (function(n) {
          return function(o, i) {
            ...
            return (
              n.setupLSFor(o, i),
              (a = t.defer()),
              e.get(r.jobServer + 'jobs/' + o + '/vertices/' + i + '/metrics').success(function(e) {
                var t;
                return (
                  (t = []),
                  angular.forEach(e, function(e, r) {
                    var a;
                    if (
                      ((a = n.metrics[o][i].indexOf(e.id)),
                      a === -1 && (a = _.findIndex(n.metrics[o][i], { id: e.id })),
                      a === -1)
                    )
                      return t.push(e);
                  }),
        ...
        (this.getAllAvailableMetrics = (function(n) {
          return function(n, o) {
            ...
            return (
              (i = t.defer()),
              e.get(r.jobServer + 'jobs/' + n + '/vertices/' + o + '/metrics').success(function(e) {
                return i.resolve(e);
              }),
              i.promise
            );
        ...
        (this.getMetrics = function(n, o, i) {
          var a, s;
          return (
            (a = t.defer()),
            (s = i.join(',')),
            e.get(r.jobServer + 'jobs/' + n + '/vertices/' + o + '/metrics?get=' + s).success(
              (function(e) {
                return function(t) {
                  var r, i;
                  return (
    ...
    function(e, t, r) {
      ...
      return (
        ...
        (this.loadOverview = function() {
          ...
          return (
            (o = r.defer()),
            e.get(t.jobServer + 'overview').success(function(e, t, r, i) {
              return (n = e), o.resolve(e);
            }),
            o.promise
          );
  ...
  angular
    ...
    .controller('JobSubmitController', [
      ...
      function(e, t, r, n, o, i) {
        var a;
        return (
          (e.yarn = i.absUrl().indexOf('/proxy/application_') !== -1),
          (e.loadList = function() {
          ...
          (e.runJob = function() {
            ...
            if ('Submit' === e.state['submit-button'])
              return (
                ...
                (n = {}),
                e.state['entry-class'] &&
                  ((i.entryClass = e.state['entry-class']), (n['entry-class'] = e.state['entry-class'])),
                e.state.parallelism && ((i.parallelism = e.state.parallelism), (n.parallelism = e.state.parallelism)),
                e.state['program-args'] &&
                  ((i.programArgs = e.state['program-args']), (n['program-args'] = e.state['program-args'])),
                e.state.savepointPath &&
                  ((i.savepointPath = e.state.savepointPath), (n.savepointPath = e.state.savepointPath)),
                e.state.allowNonRestoredState &&
                  ((i.allowNonRestoredState = e.state.allowNonRestoredState),
                  (n.allowNonRestoredState = e.state.allowNonRestoredState)),
                t
                  .runJob(e.state.selected, i, n)
                  .then(function(t) {
                    if (
                      ...
                      return o.go('single-job.plan.subtasks', { jobid: t.jobid });
                  })
                  ['catch'](function(t) {
    ...
    function(e, t, r) {
      return (
        (this.loadJarList = function() {
          ...
          return (
            (n = r.defer()),
            e.get(t.jobServer + 'jars/').success(function(e, t, r, o) {
              return n.resolve(e);
            }),
            n.promise
          );
        ...
        (this.getPlan = function(n, o) {
          ...
          return (
            (i = r.defer()),
            e
              .get(t.jobServer + 'jars/' + encodeURIComponent(n) + '/plan', { params: o })
        ...
        (this.runJob = function(n, o, i) {
          ...
          return (
            (a = r.defer()),
            e
              .post(t.jobServer + 'jars/' + encodeURIComponent(n) + '/run', o, { params: i })
              .success(function(e, t, r, n) {
                return a.resolve(e);
              })
              .error(function(e) {
      ...
      function(e, t, r) {
        return (
          (this.loadManagers = function() {
            ...
            return (
              (n = r.defer()),
              e.get(t.jobServer + 'taskmanagers').success(function(e, t, r, o) {
