...
public class JarRunApplicationHeaders
    ...
    private static final JarRunApplicationHeaders INSTANCE = new JarRunApplicationHeaders();

    private static final String URL = "/jars/:" + JarIdPathParameter.KEY + "/run-application";
    ...
    public String getDescription() {
        return "Submits an application by running a jar previously uploaded via '"
