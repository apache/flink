...
/**
 * Path parameter to identify uploaded artifact files.
 */
public class ArtifactIdPathParameter extends MessagePathParameter<String> {

	public static final String KEY = "artifactid";

	protected ArtifactIdPathParameter() {
		super(KEY);
	}
