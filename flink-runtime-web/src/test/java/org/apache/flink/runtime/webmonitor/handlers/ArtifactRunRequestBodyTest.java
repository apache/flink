...
/**
 * Tests for {@link ArtifactRunRequestBody}.
 */
public class ArtifactRunRequestBodyTest extends RestRequestMarshallingTestBase<ArtifactRunRequestBody> {

	@Override
	protected Class<ArtifactRunRequestBody> getTestRequestClass() {
		return ArtifactRunRequestBody.class;
	}

	@Override
	protected ArtifactRunRequestBody getTestRequestInstance() {
	...
	protected void assertOriginalEqualsToUnmarshalled(
			final ArtifactRunRequestBody expected,
			final ArtifactRunRequestBody actual) {
