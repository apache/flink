...
class CompositeJobRetainedStrategyTest {
    ...
    void testTimeToLiveBasedJobRetainedStrategy() {
        // Test the case where no specific retention policy is configured, i.e., all archived files are retained.
        ...
        // Test the case where TTL-based retention policies is specified.
