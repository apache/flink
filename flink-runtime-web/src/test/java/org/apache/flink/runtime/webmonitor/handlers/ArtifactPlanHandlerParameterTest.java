...
public class ArtifactPlanHandlerParameterTest
	extends ArtifactHandlerParameterTest<ArtifactPlanRequestBody, ArtifactPlanMessageParameters> {
	private static ArtifactPlanHandler handler;

	@BeforeClass
	public static void setup() throws Exception {
		init();
		handler = new ArtifactPlanHandler(
			gatewayRetriever,
			timeout,
			responseHeaders,
	...
	@Override
	ArtifactPlanMessageParameters getUnresolvedArtifactMessageParameters() {
		return handler.getMessageHeaders().getUnresolvedMessageParameters();
	}

	@Override
	ArtifactPlanMessageParameters getArtifactMessageParameters(ProgramArgsParType programArgsParType) {
		final ArtifactPlanMessageParameters parameters = getUnresolvedArtifactMessageParameters();
	...
	@Override
	ArtifactPlanMessageParameters getWrongArtifactMessageParameters(ProgramArgsParType programArgsParType) {
	...
	@Override
	ArtifactPlanRequestBody getDefaultArtifactRequestBody() {
		return new ArtifactPlanRequestBody();
	}

	@Override
	ArtifactPlanRequestBody getArtifactRequestBody(ProgramArgsParType programArgsParType) {
		return new ArtifactPlanRequestBody(
	...
	@Override
	ArtifactPlanRequestBody getArtifactRequestBodyWithJobId(JobID jobId) {
		return new ArtifactPlanRequestBody(null, null, null, null, jobId);
	}

	@Override
	void handleRequest(HandlerRequest<ArtifactPlanRequestBody, ArtifactPlanMessageParameters> request)
		throws Exception {
