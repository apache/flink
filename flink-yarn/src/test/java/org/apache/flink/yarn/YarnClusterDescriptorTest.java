...
public class YarnClusterDescriptorTest extends TestLogger {
    ...
    public void testSetupApplicationMasterContainer() {
        ...
        try {
            ...
            assertEquals(
                    java + " " + jvmmem + "" + // jvmOpts
                            " " + logfile + " " + logback + " " + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(
                                    mainClass, false, jobManagerProcessSpec)
                            .getCommands()
            ...
            assertEquals(
                    java + " " + jvmmem + "" + // jvmOpts
                            " " + logfile + " " + log4j + " " + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(
                                    mainClass, false, jobManagerProcessSpec)
                            .getCommands()
            ...
            cfg.set(
                    ...
                    YarnLogConfigUtil.CONFIG_FILE_LOGBACK_NAME);
            assertEquals(
                    java + " " + jvmmem + " " + jvmOpts + " " + logfile + " " + logback + " "
                            + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(
                                    mainClass, false, jobManagerProcessSpec)
            ...
            cfg.set(
                    ...
                    YarnLogConfigUtil.CONFIG_FILE_LOG4J_NAME);
            assertEquals(
                    java + " " + jvmmem + " " + jvmOpts + " " + jmJvmOpts + " " + logfile + " "
                            + log4j + " " + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(
                                    mainClass, false, jobManagerProcessSpec)
                            .getCommands()
            ...
            cfg.set(
                    ...
                    YarnLogConfigUtil.CONFIG_FILE_LOG4J_NAME);
            assertEquals(
                    java + " " + jvmmem + " " + jvmOpts + " " + jmJvmOpts + " " + krb5 + // jvmOpts
                            " " + logfile + " " + log4j + " " + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(mainClass, true, jobManagerProcessSpec)
                            .getCommands()
            ...
            assertEquals(
                    java + " 1 " + jvmmem + " 2 " + jvmOpts + " " + jmJvmOpts + " " + krb5
                            + // jvmOpts
                            " 3 " + logfile + " " + logback + " 4 " + mainClass + " 5 6 "
                            + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(mainClass, true, jobManagerProcessSpec)
                            .getCommands()
            ...
            // YarnClusterDescriptor
            assertEquals(
                    java + " " + logfile + " " + logback + " " + jvmOpts + " " + jmJvmOpts + " "
                            + krb5 + // jvmOpts
                            " " + jvmmem + " " + mainClass + " " + redirects,
                    clusterDescriptor
                            .setupApplicationMasterContainer(mainClass, true, jobManagerProcessSpec)
                            .getCommands()
                            .get(0));
