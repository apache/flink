...
public class YarnConfigOptionsInternal {
    ...
    /**
     * **DO NOT USE** Whether {@link YarnResourceManager} should match the vcores of allocated
     * containers with those requested.
     *
    ...
    public static final ConfigOption<Boolean> MATCH_CONTAINER_VCORES =
            key("$internal.yarn.resourcemanager.enable-vcore-matching")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "**DO NOT USE** Whether YarnResourceManager should match the container vcores.");
}
