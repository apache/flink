...
public final class Utils {
	...
	public static int calculateHeapSize(int memory, org.apache.flink.configuration.Configuration conf) {
		...
		BootstrapTools.substituteDeprecatedConfigKey(conf,
			ConfigConstants.YARN_HEAP_CUTOFF_RATIO, ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO);
		BootstrapTools.substituteDeprecatedConfigKey(conf,
			ConfigConstants.YARN_HEAP_CUTOFF_MIN, ConfigConstants.CONTAINER_HEAP_CUTOFF_MIN);

		float memoryCutoffRatio = conf.getFloat(ConfigConstants.CONTAINER_HEAP_CUTOFF_RATIO,
			ConfigConstants.DEFAULT_YARN_HEAP_CUTOFF_RATIO);
		int minCutoff = conf.getInteger(ConfigConstants.CONTAINER_HEAP_CUTOFF_MIN,
