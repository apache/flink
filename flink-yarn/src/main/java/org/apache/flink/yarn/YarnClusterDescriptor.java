...
public class YarnClusterDescriptor implements ClusterDescriptor<ApplicationId> {
    ...
    private ApplicationReport startAppMaster(
        ...
        try {
            tmpConfigurationFile = File.createTempFile(appId + "-flink-config.yaml", null);
            ...
            String flinkConfigKey = "flink-config.yaml";
            fileUploader.registerSingleLocalResource(
                    flinkConfigKey,
                    ...
                    true,
                    true);
            classPathBuilder.append("flink-config.yaml").append(File.pathSeparator);
        } finally {
