...
object YarnMessages {
  ...
  /**
    * Callback from the async resource manager client when containers where allocated.
    * @param containers List of containers which were allocated.
    */
  case class YarnContainersAllocated(containers: JavaList[Container])

  /**
    * Callback from the async resource manager client when containers where completed.
