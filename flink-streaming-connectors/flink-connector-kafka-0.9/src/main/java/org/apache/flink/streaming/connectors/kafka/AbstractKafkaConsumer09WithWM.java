...
public abstract class AbstractKafkaConsumer09WithWM<T> extends AbstractKafkaConsumer09<T> {
	 ...
	 * @param partitionInfo
	 *           The topic and partition we are interested in.
	 * @param timestamp
	 ...
	 * */
	protected boolean updateMinimumTimestampForPartition(TopicPartition partitionInfo, long timestamp) {
		Map<Integer, Long> minTimestampsForTopic =
			getMinTimestampsForPartitionsOfTopic(partitionInfo.topic());
