 ...
 *
 * <p>NOTE: This test is in the flink-client package because we cannot have it in flink-java,
 * where the JSON plan generator is not available. Making it available, by depending on
 * flink-optimizer would create a cyclic dependency.
 */
