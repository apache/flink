...
public class CliFrontend {
	...
	protected void info(String[] args) throws CliArgsException, FileNotFoundException, ProgramInvocationException {
		...
		try {
			...
			FlinkPlan flinkPlan = ClientUtils.getOptimizedPlan(compiler, program, parallelism);
	...
	protected void executeProgram(PackagedProgram program, ClusterClient<?> client, int parallelism) throws ProgramMissingJobException, ProgramInvocationException {
		...
		final JobSubmissionResult result = ClientUtils.executeProgram(client, program, parallelism);
