...
public class PipelineExecutorUtils {
    ...
    public static StreamGraphWrapper getStreamGraphWrapper(
        ...
        StreamGraphWrapper streamGraphWrapper;
        try {
            streamGraphWrapper = new StreamGraphWrapper(streamGraph, serializationExecutor);
        } finally {
            serializationExecutor.shutdown();
        }

        return streamGraphWrapper;
    }
}
