...
public class WatermarkCombinerTest {
    ...
    @Test
    public void testLongWatermarkCombinerWaitForAllChannels() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
        ...
        combiner = internalWatermarkDeclaration.watermarkCombiner(2, null);
    ...
    @Test
    public void testLongWatermarkCombinerCombineMax() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
    ...
    @Test
    public void testLongWatermarkCombinerCombineMin() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
    ...
    @Test
    public void testBoolWatermarkCombinerWaitForAllChannels() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
    ...
    @Test
    public void testBoolWatermarkCombinerCombineAnd() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
    ...
    @Test
    public void testBoolWatermarkCombinerCombineOr() throws Exception {
        // The test scenario is as follows:
        // -----------------------------------------------------------------------------
        //               test scenario     |         expected result
        // -----------------------------------------------------------------------------
