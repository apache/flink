...
public class ExecutionGraphTestUtils {
    ...
    /**
     * Creates an execution graph with on job vertex of parallelism 10, using the given restart
     * strategy.
     */
    public static ExecutionGraph createSimpleTestGraph(RestartStrategy restartStrategy)
            throws Exception {
    ...
    public static ExecutionGraph createSimpleTestGraph(JobVertex... vertices) throws Exception {
        return createSimpleTestGraph(
                new SimpleAckingTaskManagerGateway(), new NoRestartStrategy(), vertices);
    }
    ...
    public static ExecutionGraph createSimpleTestGraph(
            SlotProvider slotProvider, RestartStrategy restartStrategy, JobVertex... vertices)
            throws Exception {

        return createExecutionGraph(
                slotProvider, restartStrategy, TestingUtils.defaultExecutor(), vertices);
    }
    ...
    public static ExecutionGraph createExecutionGraph(
        ...
        return createExecutionGraph(
                slotProvider, restartStrategy, executor, Time.seconds(10L), vertices);
    }
    ...
    public static Execution getExecution(final TaskManagerLocation... preferredLocations)
            throws Exception {
    ...
    public static Execution getExecution(
        ...
        final ExecutionJobVertex ejv = getExecutionJobVertex(new JobVertexID());
        final TestExecutionVertex ev =
                new TestExecutionVertex(ejv, 0, new IntermediateResult[0], DEFAULT_TIMEOUT);
    ...
    public static Execution getExecution(
            ...
            final int numTasks,
            final SlotSharingGroup slotSharingGroup,
            @Nullable final TaskManagerLocation... locations)
            throws Exception {
        ...
        final TestExecutionVertex ev =
                new TestExecutionVertex(
                        ejv, subtaskIndex, new IntermediateResult[0], DEFAULT_TIMEOUT);
