...
/**
 * Tests for RpcConnection, validating the successful, failure and close behavior.
 */
public class RpcConnectionTest extends TestLogger {
	...
	private static class TestRpcConnection extends RpcConnection<TestRegistrationGateway, RetryingRegistrationTest.TestRegistrationSuccess> {
		...
		{
			super(LoggerFactory.getLogger(RpcConnectionTest.class), targetAddress, targetLeaderId, executor);
