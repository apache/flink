...
public class NonReusingSortMergeOuterJoinIteratorITCase  extends AbstractSortMergeOuterJoinIteratorITCase {
	...
	@Override
	protected <T1, T2, O> AbstractMergeOuterJoinIterator<T1, T2, O> createOuterJoinIterator(OuterJoinType outerJoinType, MutableObjectIterator<T1> input1,
		...
		return new NonReusingMergeOuterJoinIterator<T1, T2, O>(outerJoinType, input1, input2, serializer1, comparator1,
