...
public class StandaloneSubmittedJobGraphsTest {
	...
	public void testNoOps() throws Exception {
		StandaloneSubmittedJobGraphs jobGraphs = new StandaloneSubmittedJobGraphs();
		...
		try {
			jobGraphs.recoverJobGraph(new JobID());
