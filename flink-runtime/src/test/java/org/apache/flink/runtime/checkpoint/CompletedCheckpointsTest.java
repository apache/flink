...
/**
 * Test for basic {@link CompletedCheckpoints} contract.
 */
public abstract class CompletedCheckpointsTest extends TestLogger {

	/**
	 * Creates the {@link CompletedCheckpoints} implementation to be tested.
	 */
	protected abstract CompletedCheckpoints createCompletedCheckpoints(
	...
	public void testAddAndGetLatestCheckpoint() throws Exception {
		CompletedCheckpoints checkpoints = createCompletedCheckpoints(4, userClassLoader);
	...
	public void testAddCheckpointMoreThanMaxRetained() throws Exception {
		CompletedCheckpoints checkpoints = createCompletedCheckpoints(1, userClassLoader);
	 ...
	 * Tests that
	 * <ul>
	 * <li>{@link CompletedCheckpoints#getLatestCheckpoint()} returns <code>null</code>,</li>
	 * <li>{@link CompletedCheckpoints#getAllCheckpoints()} returns an empty list,</li>
	 * <li>{@link CompletedCheckpoints#getNumberOfRetainedCheckpoints()} returns 0.</li>
	 * </ul>
	 */
	@Test
	...
	public void testGetAllCheckpoints() throws Exception {
		...
		List<SuccessfulCheckpoint> actual = checkpoints.getAllCheckpoints();
	...
	private void verifyCheckpoint(SuccessfulCheckpoint expected, SuccessfulCheckpoint actual) {
	...
	/**
	 * A test {@link SuccessfulCheckpoint}. We want to verify that the correct class loader is
	 * used when discarding. Spying on a regular {@link SuccessfulCheckpoint} instance with
	 * Mockito doesn't work, because it it breaks serializability.
	 */
	protected static class TestCheckpoint extends SuccessfulCheckpoint {
