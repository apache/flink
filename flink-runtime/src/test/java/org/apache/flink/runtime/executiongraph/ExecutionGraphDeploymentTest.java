...
public class ExecutionGraphDeploymentTest extends TestLogger {
    ...
    public void testRegistrationOfExecutionsFinishing() {
        try {
            ...
            Tuple2<ExecutionGraph, Map<ExecutionAttemptID, Execution>> graphExecutionsTuple =
                    setupExecution(v1, 7650, v2, 2350);
    ...
    /**
     * Verifies that {@link ExecutionGraph#updateState(TaskExecutionState)} updates the accumulators
    ...
    public void testAccumulatorsAndMetricsForwarding() throws Exception {
        ...
        Tuple2<ExecutionGraph, Map<ExecutionAttemptID, Execution>> graphAndExecutions =
                setupExecution(v1, 1, v2, 1);
     ...
     * Execution#markFailed(Throwable, Map, IOMetrics)} store the given accumulators and metrics
     * correctly.
     */
    @Test
    ...
    private Tuple2<ExecutionGraph, Map<ExecutionAttemptID, Execution>> setupExecution(
    ...
    public void testEagerSchedulingWaitsOnAllInputPreferredLocations() throws Exception {
        ...
        for (ExecutionVertex executionVertex : executionGraph.getAllExecutionVertices()) {
            ExecutionGraphTestUtils.waitUntilExecutionState(
                    executionVertex.getCurrentExecutionAttempt(), ExecutionState.DEPLOYING, 5000L);
        }
    }
