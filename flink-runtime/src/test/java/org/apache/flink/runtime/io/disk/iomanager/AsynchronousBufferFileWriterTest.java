...
public class AsynchronousBufferFileWriterTest {
	...
	public void testSubscribe() throws Exception {
		final MockNotificationListener listener = new MockNotificationListener();

		// Unsuccessful subscription, because no outstanding requests
		assertFalse("Allowed to subscribe w/o any outstanding requests.", writer.subscribe(listener));

		// Successful subscription
		addRequest();
		assertTrue("Didn't allow to subscribe.", writer.subscribe(listener));
