...
public class TestingJobMasterGatewayBuilder {
    ...
    private BiConsumer<ResourceID, AccumulatorReport> taskManagerHeartbeatConsumer =
            (ignoredA, ignoredB) -> {};
    ...
    public TestingJobMasterGatewayBuilder setScheduleOrUpdateConsumersFunction(
    ...
    public TestingJobMasterGatewayBuilder setTaskManagerHeartbeatConsumer(
            BiConsumer<ResourceID, AccumulatorReport> taskManagerHeartbeatConsumer) {
