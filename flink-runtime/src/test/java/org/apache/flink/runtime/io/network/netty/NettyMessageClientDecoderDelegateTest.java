...
public class NettyMessageClientDecoderDelegateTest extends TestLogger {
    ...
    public void setup() throws IOException, InterruptedException {
        ...
        networkBufferPool =
                new NetworkBufferPool(
                        NUMBER_OF_BUFFER_RESPONSES, BUFFER_SIZE, NUMBER_OF_BUFFER_RESPONSES);
    ...
    private void verifyDecodedMessages(
            List<NettyMessage> expectedMessages, List<NettyMessage> decodedMessages) {
        ...
        for (int i = 0; i < expectedMessages.size(); ++i) {
            ...
            if (expectedMessages.get(i) instanceof NettyMessage.BufferResponse) {
                ...
                verifyErrorResponse(
                        (ErrorResponse) expectedMessages.get(i),
