...
public class ZooKeeperCompletedCheckpointStoreITCase extends CompletedCheckpointStoreTest {
	...
	public void testRecover() throws Exception {
		...
		CompletedCheckpointStore checkpoints = createCompletedCheckpoints(3, Executors.directExecutor());
	...
	public void testLatestCheckpointRecovery() throws Exception {
		...
		SharedStateRegistry sharedStateRegistry = new SharedStateRegistry();
		CompletedCheckpointStore checkpointStore = createCompletedCheckpoints(numCheckpoints, Executors.directExecutor());
	...
	public void testConcurrentCheckpointOperations() throws Exception {
		...
		ZooKeeperCompletedCheckpointStore zkCheckpointStore1 = createCompletedCheckpoints(numberOfCheckpoints, Executors.directExecutor());
		ZooKeeperCompletedCheckpointStore zkCheckpointStore2 = createCompletedCheckpoints(numberOfCheckpoints, Executors.directExecutor());
