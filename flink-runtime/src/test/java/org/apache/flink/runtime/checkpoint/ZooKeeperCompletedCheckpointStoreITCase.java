...
public class ZooKeeperCompletedCheckpointStoreITCase extends CompletedCheckpointStoreTest {
    ...
    @Override
    protected ZooKeeperCompletedCheckpointStore createCompletedCheckpoints(
        ...
        return new ZooKeeperCompletedCheckpointStore(
                maxNumberOfCheckpointsToRetain, checkpointsInZooKeeper, Executors.directExecutor());
    }
    ...
    public void testShutdownDiscardsCheckpoints() throws Exception {
        ...
        assertNotNull(
                client.checkExists()
                        .forPath(
                                CHECKPOINT_PATH
                                        + ZooKeeperCompletedCheckpointStore.checkpointIdToPath(
