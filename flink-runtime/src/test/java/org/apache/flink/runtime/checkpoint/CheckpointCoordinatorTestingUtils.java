...
public class CheckpointCoordinatorTestingUtils {
    ...
    public static class CheckpointCoordinatorBuilder {
        ...
        public CheckpointCoordinatorBuilder() throws Exception {
            executionGraph =
                    new CheckpointExecutionGraphBuilder().addJobVertex(new JobVertexID()).build();
        }
        ...
        public CheckpointCoordinator build() throws Exception {
            return new CheckpointCoordinator(
                    ...
                    new CheckpointBriefCalculator(
                            executionGraph.getJobID(),
                            new ExecutionGraphCheckpointBriefCalculatorContext(executionGraph),
