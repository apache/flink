...
public class TestingTaskExecutorGatewayBuilder {
	...
	private static final Function<Tuple6<SlotID, JobID, AllocationID, String, List<SlotTag>, ResourceManagerId>, CompletableFuture<Acknowledge>> NOOP_REQUEST_SLOT_FUNCTION = ignored -> CompletableFuture.completedFuture(Acknowledge.get());
	...
	private Function<Tuple6<SlotID, JobID, AllocationID, String, List<SlotTag>, ResourceManagerId>, CompletableFuture<Acknowledge>> requestSlotFunction = NOOP_REQUEST_SLOT_FUNCTION;
	...
	public TestingTaskExecutorGatewayBuilder setRequestSlotFunction(Function<Tuple6<SlotID, JobID, AllocationID, String, List<SlotTag>, ResourceManagerId>, CompletableFuture<Acknowledge>> requestSlotFunction) {
