...
class AllToAllBlockingResultInfoTest {
    ...
    void testGetNumBytesProducedForBroadcast(boolean consumeAllSubpartitions) {
        testGetNumBytesProduced(
                true, consumeAllSubpartitions, consumeAllSubpartitions ? 192L : 96L);
    }
    ...
    private void testGetNumBytesProduced(
            boolean isBroadcast, boolean consumeAllSubpartitions, long expectedBytes) {
        AllToAllBlockingResultInfo resultInfo =
                new AllToAllBlockingResultInfo(
                        new IntermediateDataSetID(), 2, 2, isBroadcast, consumeAllSubpartitions);
