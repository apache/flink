...
public class PipelinedRegionComputeUtilTest extends TestLogger {
    ...
    /**
     * This test checks that are strictly co-located vertices are in the same failover region, even
     * through they are only connected via a blocking pattern. This is currently an assumption /
     * limitation of the scheduler.
     *
     * <pre>
     *     (a1) -+-> (b1)
     *           X
    ...
    public void testBlockingAllToAllTopologyWithCoLocation() {
        ...
        topology.connect(va1, vb1, ResultPartitionType.BLOCKING)
    ...
    /**
     * This test checks that are strictly co-located vertices are in the same failover region, even
     * through they are not connected. This is currently an assumption / limitation of the
     * scheduler.
     *
     * <pre>
     *     (a1) -+-> (b1)
