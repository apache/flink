...
public class RestartBackoffTimeStrategyFactoryLoaderTest extends TestLogger {
	...
	public void testExponentialDelayRestartStrategySpecifiedInJobConfig() {
		...
		final RestartBackoffTimeStrategy.Factory factory =
			RestartBackoffTimeStrategyFactoryLoader.createRestartBackoffTimeStrategyFactory(
				RestartStrategies.exponentialDelayRestart(Time.milliseconds(1), Time.milliseconds(1000), 1.1, Time.milliseconds(2000), 0),
				conf,
				false);

		assertThat(
			factory,
			instanceOf(ExponentialDelayRestartBackoffTimeStrategy.ExponentialDelayRestartBackoffTimeStrategyFactory.class));
	}
