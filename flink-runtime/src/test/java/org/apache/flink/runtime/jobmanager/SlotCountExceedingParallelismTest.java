...
public class SlotCountExceedingParallelismTest extends TestLogger {
    ...
    private JobGraph createTestJobGraph(
        ...
        sender.getConfiguration()
                .set(
                        getIntegerConfigOption(RoundRobinSubtaskIndexSender.CONFIG_KEY),
                        receiverParallelism);
        ...
        receiver.getConfiguration()
                .set(getIntegerConfigOption(SubtaskIndexReceiver.CONFIG_KEY), senderParallelism);
    ...
    public static class RoundRobinSubtaskIndexSender extends AbstractInvokable {
        ...
        public void invoke() throws Exception {
            ...
            final int numberOfTimesToSend =
                    getTaskConfiguration().get(getIntegerConfigOption(CONFIG_KEY), 0);
