...
public class ChainTaskTest extends TaskTestBase {
	...
	public void testMapTask() {
		...
		try {
			...
			// chained map+combine
			{
				RegularTask<GenericCollectorMap<Record, Record>, Record> testTask =
											new RegularTask<GenericCollectorMap<Record, Record>, Record>();
	...
	public void testFailingMapTask() {
		...
		try {
			...
			// chained map+combine
			{
				final RegularTask<GenericCollectorMap<Record, Record>, Record> testTask =
											new RegularTask<GenericCollectorMap<Record, Record>, Record>();
