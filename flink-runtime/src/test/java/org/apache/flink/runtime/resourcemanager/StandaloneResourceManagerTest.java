...
public class StandaloneResourceManagerTest extends TestLogger {
	...
	public void testRequestTaskManagerInfo() throws Exception {
		...
		configuration.setInteger(TaskManagerOptions.TASK_MANAGER_NATIVE_MEMORY, 128);
		configuration.setInteger(TaskManagerOptions.TASK_MANAGER_DIRECT_MEMORY, 128);
		configuration.setLong(TaskManagerOptions.MANAGED_MEMORY_SIZE, 128);
		...
		final ResourceManager resourceManager = new StandaloneResourceManager(
			rpcService,
