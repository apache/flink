...
public class HighAvailabilityServicesUtilsTest {
	...
	public void testCreateCustomHAServices() throws Exception {
		...
		config.setString(HighAvailabilityOptions.HA_FACTORY_CLASS, TestHAFactory.class.getName());
	...
	static class TestHAFactory implements HighAvailabilityServicesFactory {

		static HighAvailabilityServices haServices;

		@Override
		public HighAvailabilityServices createHAServices(Configuration config, Executor executor) {
			return haServices;
		}
	}
}
