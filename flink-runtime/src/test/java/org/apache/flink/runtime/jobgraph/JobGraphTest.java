...
public class JobGraphTest {
	...
	public void testSerialization() {
		try {
			JobGraph jg = new JobGraph("The graph", JobType.BATCHING);
	...
	public void testTopologicalSort1() {
		try {
			...
			JobGraph graph = new JobGraph("TestGraph", JobType.BATCHING, source1, source2, intermediate1, intermediate2, target1, target2);
	...
	public void testTopologicalSort2() {
		try {
			...
			JobGraph graph = new JobGraph("TestGraph", JobType.BATCHING, source1, source2, root, l11, l13, l12, l2);
			List<JobVertex> sorted = graph.getVerticesSortedTopologicallyFromSources();
	...
	public void testTopologicalSort3() {
		...
		try {
			...
			JobGraph graph = new JobGraph("TestGraph", JobType.BATCHING, source, op1, op2, op3);
			List<JobVertex> sorted = graph.getVerticesSortedTopologicallyFromSources();
	...
	public void testTopoSortCyclicGraphNoSources() {
		try {
			...
			JobGraph jg = new JobGraph("Cyclic Graph", JobType.BATCHING, v1, v2, v3, v4);
			try {
	...
	public void testTopoSortCyclicGraphIntermediateCycle() {
		try{ 
			...
			JobGraph jg = new JobGraph("Cyclic Graph", JobType.BATCHING, v1, v2, v3, v4, source, target);
			try {
				jg.getVerticesSortedTopologicallyFromSources();
				fail("Failed to raise error on topologically sorting cyclic graph.");
			}
