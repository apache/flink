...
public class ZooKeeperCompletedCheckpointStoreTest extends TestLogger {
    ...
    private void testDownloadInternal(
        ...
        List<Tuple2<RetrievableStateHandle<CompletedCheckpoint>, String>> checkpointsInZk =
                new ArrayList<>();
        ...
        ZooKeeperCompletedCheckpointStore store =
                new ZooKeeperCompletedCheckpointStore(
                        10, checkpointsInZooKeeper, Executors.directExecutor());
        try {
    ...
    @Nonnull
    private ZooKeeperCompletedCheckpointStore createZooKeeperCheckpointStore(
        ...
        return new ZooKeeperCompletedCheckpointStore(
                1, checkpointsInZooKeeper, Executors.directExecutor());
    }
