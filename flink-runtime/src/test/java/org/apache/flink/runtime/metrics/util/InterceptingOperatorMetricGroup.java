 ...
 */
public class InterceptingOperatorMetricGroup extends OperatorMetricGroup {

	private Map<String, Metric> intercepted;

	public InterceptingOperatorMetricGroup(OperatorID operatorID, String operatorName) {
		super(NoOpMetricRegistry.INSTANCE, UnregisteredMetricGroups.createUnregisteredTaskMetricGroup(), operatorID, operatorName);
	}
