...
class VertexParallelismAndInputInfosDeciderUtilsTest {
    ...
    void testCartesianProduct() {
        ...
        List<List<Integer>> resultEmpty =
                VertexParallelismAndInputInfosDeciderUtils.cartesianProduct(inputEmpty);
        ...
        List<List<Integer>> resultTwo =
                VertexParallelismAndInputInfosDeciderUtils.cartesianProduct(inputTwo);
        ...
        List<List<String>> expectedThree =
                Arrays.asList(
                        ...
                        Arrays.asList("B", "2", "X"),
                        Arrays.asList("B", "2", "Y"));
        List<List<String>> resultThree =
                VertexParallelismAndInputInfosDeciderUtils.cartesianProduct(inputThree);
    ...
    void testMedian() {
        long[] numsOdd = {5, 1, 3};
        long resultOdd = VertexParallelismAndInputInfosDeciderUtils.median(numsOdd);
        assertEquals(3L, resultOdd);

        long[] numsEven = {7, 3, 9, 1};
        long resultEven = VertexParallelismAndInputInfosDeciderUtils.median(numsEven);
        assertEquals(5L, resultEven);

        long[] numsSame = {2, 2, 2, 2, 2};
        long resultSame = VertexParallelismAndInputInfosDeciderUtils.median(numsSame);
        assertEquals(2L, resultSame);

        long[] numsSingle = {8};
        long resultSingle = VertexParallelismAndInputInfosDeciderUtils.median(numsSingle);
        assertEquals(8L, resultSingle);

        long[] numsEdges = {2, 4};
        long resultEdges = VertexParallelismAndInputInfosDeciderUtils.median(numsEdges);
        assertEquals(3L, resultEdges);

        long[] numsLessThanOne = {1, 2, 3, 0, 0};
        long resultLessThanOne = VertexParallelismAndInputInfosDeciderUtils.median(numsLessThanOne);
    ...
    void computeSkewThresholdTest() {
        ...
        long result1 =
                VertexParallelismAndInputInfosDeciderUtils.computeSkewThreshold(
                        mediaSize1, skewedFactor1, defaultSkewedThreshold1);
        ...
        long result2 =
                VertexParallelismAndInputInfosDeciderUtils.computeSkewThreshold(
                        mediaSize2, skewedFactor2, defaultSkewedThreshold2);
    ...
    public void testComputeTargetSize() {
        ...
        long result1 =
                VertexParallelismAndInputInfosDeciderUtils.computeTargetSize(
                        subpartitionBytes1, skewedThreshold1, dataVolumePerTask1);
        ...
        long result2 =
                VertexParallelismAndInputInfosDeciderUtils.computeTargetSize(
                        subpartitionBytes2, skewedThreshold2, dataVolumePerTask2);
        ...
        long result3 =
                VertexParallelismAndInputInfosDeciderUtils.computeTargetSize(
                        subpartitionBytes3, skewedThreshold3, dataVolumePerTask3);
