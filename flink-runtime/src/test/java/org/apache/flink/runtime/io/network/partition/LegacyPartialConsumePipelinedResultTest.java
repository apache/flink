...
public class LegacyPartialConsumePipelinedResultTest extends TestLogger {
	...
	public static class SlowBufferSender extends AbstractInvokable {
		...
		public void invoke() throws Exception {
			...
			for (int i = 0; i < 8; i++) {
				final BufferBuilder bufferBuilder = ((InternalResultPartition) writer).getBufferProvider().requestBufferBuilderBlocking();
				((InternalResultPartition) writer).addBufferConsumer(bufferBuilder.createBufferConsumer(), 0);
				Thread.sleep(50);
