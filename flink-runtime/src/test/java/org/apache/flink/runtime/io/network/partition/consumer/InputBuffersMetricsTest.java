...
class InputBuffersMetricsTest {
    ...
    void testExclusiveBuffersUsage() throws Exception {
        ...
        assertThat(exclusiveBuffersUsageGauge.getValue()).isEqualTo(0.0f, within(0.0f));
        assertThat(inputBuffersUsageGauge.getValue()).isEqualTo(0.0f, within(0.0f));
    ...
    void testFloatingBuffersUsage() throws Exception {
        ...
        assertThat(floatingBuffersUsageGauge.getValue()).isEqualTo(0.0f, within(0.0f));
        assertThat(inputBuffersUsageGauge.getValue()).isEqualTo(0.0f, within(0.0f));
    ...
    private void drainAndValidate(
        ...
        assertThat((double) exclusiveBuffersUsageGauge.getValue())
                .isEqualTo((double) totalRequestedBuffers / totalExclusiveBuffers, within(0.0001));

        assertThat((double) inputBuffersUsageGauge.getValue())
                .isEqualTo((double) totalRequestedBuffers / totalBuffers, within(0.0001));
    }
