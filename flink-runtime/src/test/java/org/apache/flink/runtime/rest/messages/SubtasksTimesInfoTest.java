...
class SubtasksTimesInfoTest extends RestResponseMarshallingTestBase<SubtasksTimesInfo> {
    ...
    protected SubtasksTimesInfo getTestResponseInstance() throws Exception {
        ...
        subtasks.add(
                new SubtasksTimesInfo.SubtaskTimeInfo(0, "local1:123", 1L, subTimeMap1));
        ...
        subtasks.add(
                new SubtasksTimesInfo.SubtaskTimeInfo(1, "local2:123", 2L, subTimeMap2));
        ...
        subtasks.add(
                new SubtasksTimesInfo.SubtaskTimeInfo(2, "local3:123", 3L, subTimeMap3));
