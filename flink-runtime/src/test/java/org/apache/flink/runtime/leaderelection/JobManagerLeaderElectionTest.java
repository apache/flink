...
import org.apache.flink.runtime.jobmanager.StandaloneSubmittedJobGraphs;
import org.apache.flink.runtime.jobmanager.SubmittedJobGraphs;
...
public class JobManagerLeaderElectionTest extends TestLogger {
	...
	private Props createJobManagerProps(Configuration configuration) throws Exception {
		...
		SubmittedJobGraphs submittedJobGraphs = new StandaloneSubmittedJobGraphs();
