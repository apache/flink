...
public class SharingPhysicalSlotRequestBulkTest extends TestLogger {
	...
	private static final ExecutionSlotSharingGroup SG1 = createExecutionSlotSharingGroup(EV1, EV2, EV3);
	...
	public void testCancel() {
		...
		assertThat(
			...
			containsInAnyOrder(Tuple2.of(EV1, cause), Tuple2.of(EV2, cause), Tuple2.of(EV4, cause)));
	}
