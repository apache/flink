...
/**
 * Tests for basic {@link CompletedCheckpoints} contract and ZooKeeper state handling.
 */
public class ZooKeeperCompletedCheckpointsITCase extends CompletedCheckpointsTest {
	...
	@Override
	protected CompletedCheckpoints createCompletedCheckpoints(int maxNumberOfCheckpointsToRetain,
			ClassLoader userLoader) throws Exception {

		return new ZooKeeperCompletedCheckpoints(maxNumberOfCheckpointsToRetain, userLoader,
				ZooKeeper.createClient(), CheckpointsPath, new LocalStateHandle
				.LocalStateHandleProvider<SuccessfulCheckpoint>());
	}
	...
	public void testRecover() throws Exception {
		CompletedCheckpoints checkpoints = createCompletedCheckpoints(3, ClassLoader
