...
public class CheckpointStorageLoadingTest {
	...
	public void testLegacyStateBackendTakesPrecedence() throws Exception {
		...
		Assert.assertEquals("Legacy state backends should always take precendence", legacy, configured);
	}
	...
	public void testModernStateBackendDoesNotTakePrecedence() throws Exception {
		...
		Assert.assertEquals("Modern state backends should never take precendence", storage, configured);
	}
	...
	public void testLoadingFromFactory() throws Exception {
		...
		CheckpointStorage storage = CheckpointStorageLoader
				.fromApplicationOrConfigOrDefault(null, new ModernStateBackend(), config, cl, null);
	...
	public void testLoadingFails() throws Exception {
		...
		try {
			CheckpointStorageLoader.fromApplicationOrConfigOrDefault(null, new ModernStateBackend(), config, cl, null);
