...
public class HashVsSortMiniBenchmark {
    ...
    public void testSortBothMerge() {
        try {
            ...
            final UnilateralSortMerger<Tuple2<Integer, String>> sorter1 =
                    new UnilateralSortMerger<>(
                            ...
                            (double) MEMORY_FOR_SORTER / MEMORY_SIZE,
                            128,
                            0.8f,
                            true /*use large record handler*/,
                            true);

            final UnilateralSortMerger<Tuple2<Integer, String>> sorter2 =
                    new UnilateralSortMerger<>(
                            this.memoryManager,
                            this.ioManager,
                            input2,
    ...
    public void testSortOnly() throws Exception {
        ...
        final UnilateralSortMerger<Tuple2<Integer, String>> sorter =
                new UnilateralSortMerger<>(
                        this.memoryManager,
                        this.ioManager,
                        input1,
