...
public class DefaultExecutionTopologyTest extends TestLogger {
    ...
    public void setUp() throws Exception {
        ...
        executionGraph =
                createSimpleTestGraph(taskManagerGateway, triggeredRestartStrategy, jobVertices);
    ...
    private ExecutionGraph createExecutionGraphWithCoLocationConstraint() throws Exception {
        ...
        return createSimpleTestGraph(taskManagerGateway, triggeredRestartStrategy, jobVertices);
    }
