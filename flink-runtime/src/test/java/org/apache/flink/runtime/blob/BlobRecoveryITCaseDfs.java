...
public class BlobRecoveryITCaseDfs extends BlobRecoveryITCaseHA {
	...
	/**
	 * Tests that with {@link HighAvailabilityMode#NONE} distributed JARs are recoverable from any
	 * participating BlobServer when a common storage directory is set, e.g. on a distributed file
	 * system.
	 */
	@Test
	@Override
