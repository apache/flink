        ...
        try {
            ...
            while (iterator.next()) {
                ...
                while (iter1.hasNext()) {
                    Tuple2<Integer, String> rec = iter1.next();
                    Assertions.assertTrue(
                            expValues1.remove(rec.f1), "Value not in expected set of first input");
                }
                Assertions.assertTrue(
                ...
                while (iter2.hasNext()) {
                    Tuple2<Integer, String> rec = iter2.next();
                    Assertions.assertTrue(
                            expValues2.remove(rec.f1), "Value not in expected set of second input");
                }
                Assertions.assertTrue(
            ...
            Assertions.assertTrue(expectedCoGroupsMap.isEmpty(), "Expected key set not empty");
        } catch (Exception e) {
            e.printStackTrace();
