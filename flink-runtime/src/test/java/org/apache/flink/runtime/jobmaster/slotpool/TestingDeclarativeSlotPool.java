...
final class TestingDeclarativeSlotPool implements DeclarativeSlotPool {
    ...
    private final Supplier<Map<ResourceID, ResourceUnitCount>> taskExecutorsLoadingWeightSupplier;
    ...
    TestingDeclarativeSlotPool(
            ...
            Supplier<Map<ResourceID, ResourceUnitCount>> taskExecutorsLoadingWeightSupplier) {
