...
public class ExecutionTest extends TestLogger {
    ...
    public void testSlotReleaseOnFailedResourceAssignment() throws Exception {
        ...
        ExecutionGraph executionGraph =
                ExecutionGraphTestUtils.createSimpleTestGraph(
                        slotProvider, new NoRestartStrategy(), jobVertex);
    ...
    /**
     * Tests that the slot is released in case of a execution cancellation when having a slot
     * assigned and being in state SCHEDULED.
     */
    @Test
    ...
    /**
     * Tests that a slot allocation from a {@link SlotProvider} is cancelled if the {@link
    ...
    public void testSlotAllocationCancellationWhenExecutionCancelled() throws Exception {
        ...
        final CompletableFuture<Execution> allocationFuture =
                currentExecutionAttempt.allocateResourcesForExecution(
                        executionGraph.getSlotProviderStrategy(),
                        LocationPreferenceConstraint.ALL,
                        Collections.emptySet());
    ...
    public void testAllPreferredLocationCalculation() throws Exception {
        ...
        final Execution execution =
                getExecution(Arrays.asList(locationFuture1, locationFuture2, locationFuture3));
        ...
        assertThat(
                preferredLocations,
                containsInAnyOrder(
                        taskManagerLocation1, taskManagerLocation2, taskManagerLocation3));
    }
    ...
    public void testAnyPreferredLocationCalculation() throws Exception {
        ...
        assertThat(
                preferredLocations, containsInAnyOrder(taskManagerLocation1, taskManagerLocation3));
    }
        ...
        slotRequestIdFuture.thenAcceptAsync(
                (SlotRequestId slotRequestId) -> {
                    final SingleLogicalSlot singleLogicalSlot =
                            ExecutionGraphSchedulingTest.createSingleLogicalSlot(
