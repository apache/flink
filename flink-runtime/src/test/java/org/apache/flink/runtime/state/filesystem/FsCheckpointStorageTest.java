...
/**
 * Tests for the {@link FsCheckpointStorage}, which implements the checkpoint storage aspects of the
 * {@link FsStateBackend}.
 */
public class FsCheckpointStorageTest extends AbstractFileCheckpointStorageTestBase {
    ...
    @Override
    protected CheckpointStorage createCheckpointStorageWithSavepointDir(
    ...
    public void testSavepointsInOneDirectoryDefaultLocation() throws Exception {
        ...
        final FsCheckpointStorage storage =
