...
public class SlotSharingManagerTest extends TestLogger {
    ...
    public void testRootSlotCreation() {
        ...
        final SlotSharingManager.MultiTaskSlot multiTaskSlot =
                slotSharingManager.createRootSlot(
                        slotRequestId, new CompletableFuture<>(), allocatedSlotRequestId);
    ...
    public void testRootSlotRelease() throws ExecutionException, InterruptedException {
        ...
        final SlotSharingManager slotSharingManager =
                new SlotSharingManager(SLOT_SHARING_GROUP_ID, allocatedSlotActions, SLOT_OWNER);
        ...
        SlotSharingManager.MultiTaskSlot rootSlot =
                slotSharingManager.createRootSlot(
                        slotRequestId, slotContextFuture, allocatedSlotRequestId);
    ...
    public void testNestedSlotCreation() {
        ...
        SlotSharingManager.MultiTaskSlot rootSlot =
                slotSharingManager.createRootSlot(
                        new SlotRequestId(), new CompletableFuture<>(), new SlotRequestId());
        ...
        SlotSharingManager.MultiTaskSlot multiTaskSlot =
                rootSlot.allocateMultiTaskSlot(multiTaskSlotRequestId, multiTaskSlotGroupId);
    ...
    public void testNestedSlotRelease() throws Exception {
        ...
        final SlotSharingManager slotSharingManager =
                new SlotSharingManager(
                        SLOT_SHARING_GROUP_ID, testingAllocatedSlotActions, SLOT_OWNER);

        SlotRequestId rootSlotRequestId = new SlotRequestId();
        SlotRequestId allocatedSlotRequestId = new SlotRequestId();
        SlotSharingManager.MultiTaskSlot rootSlot =
                slotSharingManager.createRootSlot(
                        rootSlotRequestId, new CompletableFuture<>(), allocatedSlotRequestId);
        ...
        SlotRequestId multiTaskSlotRequestId = new SlotRequestId();
        SlotSharingManager.MultiTaskSlot multiTaskSlot =
                rootSlot.allocateMultiTaskSlot(multiTaskSlotRequestId, new AbstractID());
    ...
    /**
     * Tests that we can release inner slots and that this triggers the slot release for all its
     * children.
     */
    @Test
    public void testInnerSlotRelease() {
        ...
        SlotSharingManager.MultiTaskSlot multiTaskSlot =
                rootSlot.allocateMultiTaskSlot(new SlotRequestId(), new AbstractID());
        ...
        SlotSharingManager.MultiTaskSlot multiTaskSlot1 =
                multiTaskSlot.allocateMultiTaskSlot(new SlotRequestId(), new AbstractID());
    ...
    /**
     * Tests that the logical task slot futures are completed once the slot context future is
     * completed.
     */
    @Test
    public void testSlotContextFutureCompletion() throws Exception {
        ...
        SlotSharingManager.MultiTaskSlot rootSlot =
                slotSharingManager.createRootSlot(
                        new SlotRequestId(), slotContextFuture, new SlotRequestId());

        Locality locality1 = Locality.LOCAL;
        SlotSharingManager.SingleTaskSlot singleTaskSlot1 =
                rootSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), ResourceProfile.UNKNOWN, new AbstractID(), locality1);

        Locality locality2 = Locality.HOST_LOCAL;
        SlotSharingManager.SingleTaskSlot singleTaskSlot2 =
                rootSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), ResourceProfile.UNKNOWN, new AbstractID(), locality2);
        ...
        SlotSharingManager.SingleTaskSlot singleTaskSlot3 =
                rootSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), ResourceProfile.UNKNOWN, new AbstractID(), locality3);
    ...
    /**
     * Tests that the root slot are moved from unresolved to resolved once the slot context future
    ...
    public void testGetResolvedSlot() {
        ...
        SlotSharingManager.MultiTaskSlot rootSlot =
                createRootSlot(new LocalTaskManagerLocation(), slotSharingManager);

        AbstractID groupId = new AbstractID();

        Collection<SlotSelectionStrategy.SlotInfoAndResources> slotInfos =
                slotSharingManager.listResolvedRootSlotInfo(groupId);
        Assertions.assertEquals(1, slotInfos.size());

        SlotSelectionStrategy.SlotInfoAndResources slotInfoAndRemainingResource =
                slotInfos.iterator().next();
        ...
        final LocationPreferenceSlotSelectionStrategy locationPreferenceSlotSelectionStrategy =
        ...
        SlotSelectionStrategy.SlotInfoAndLocality slotInfoAndLocality =
                locationPreferenceSlotSelectionStrategy
                        .selectBestSlotForProfile(slotInfos, SlotProfile.noRequirements())
                        .get();
        ...
        resolvedMultiTaskSlot.allocateSingleTaskSlot(
                new SlotRequestId(), ResourceProfile.UNKNOWN, groupId, Locality.UNCONSTRAINED);
    ...
    public void testGetResolvedSlotWithLocationPreferences() {
        ...
        SlotSharingManager.MultiTaskSlot rootSlot1 =
                createRootSlot(new LocalTaskManagerLocation(), slotSharingManager);

        LocalTaskManagerLocation taskManagerLocation = new LocalTaskManagerLocation();
        SlotSharingManager.MultiTaskSlot rootSlot2 =
                createRootSlot(taskManagerLocation, slotSharingManager);

        AbstractID groupId = new AbstractID();

        SlotProfile slotProfile =
                SlotProfile.preferredLocality(
                        ResourceProfile.UNKNOWN, Collections.singleton(taskManagerLocation));
        ...
        SlotSelectionStrategy.SlotInfoAndLocality slotInfoAndLocality =
                locationPreferenceSlotSelectionStrategy
                        .selectBestSlotForProfile(slotInfos, slotProfile)
                        .get();
        SlotSharingManager.MultiTaskSlot resolvedRootSlot =
                slotSharingManager.getResolvedRootSlot(slotInfoAndLocality.getSlotInfo());
                        ...
                        new LogicalSlot.Payload() {
                            ...
                            public void fail(Throwable cause) {
                                assertEquals(
                                        0,
                                        slotSharingManager
                                                .listResolvedRootSlotInfo(groupId2)
                                                .size());
    ...
    public void testGetUnresolvedSlot() {
        ...
        unresolvedRootSlot.allocateSingleTaskSlot(
                new SlotRequestId(), ResourceProfile.UNKNOWN, groupId, Locality.UNKNOWN);

        SlotSharingManager.MultiTaskSlot unresolvedRootSlot1 =
                slotSharingManager.getUnresolvedRootSlot(groupId);
    ...
    public void testResourceCalculationOnSlotAllocatingAndReleasing() {
        ...
        SlotSharingManager.MultiTaskSlot leftMultiTaskSlot =
                unresolvedRootSlot.allocateMultiTaskSlot(
        ...
        SlotSharingManager.SingleTaskSlot firstChild =
                leftMultiTaskSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), rp1, new SlotSharingGroupId(), Locality.LOCAL);
        SlotSharingManager.SingleTaskSlot secondChild =
                leftMultiTaskSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), rp2, new SlotSharingGroupId(), Locality.LOCAL);
        ...
        SlotSharingManager.SingleTaskSlot thirdChild =
                unresolvedRootSlot.allocateSingleTaskSlot(
                        new SlotRequestId(), rp3, new SlotSharingGroupId(), Locality.LOCAL);
    ...
    public void testGetResolvedSlotWithResourceConfigured() {
        ...
        assertEquals(
                allocatedSlotRp.subtract(rp1),
                resolvedRoots.iterator().next().getRemainingResources());
        ...
        assertEquals(1, resolvedRoots.size());
        assertEquals(
                allocatedSlotRp.subtract(rp1).subtract(rp2),
                resolvedRoots.iterator().next().getRemainingResources());
    }
    ...
    public void testHashEnoughResourceOfMultiTaskSlot() {
        ...
        assertThat(
                multiTaskSlot.mayHaveEnoughResourcesToFulfill(ResourceProfile.UNKNOWN), is(true));
    ...
    public void testSlotAllocatedWithEnoughResource() {
        SlotSharingResourceTestContext context =
                createResourceTestContext(ResourceProfile.fromResources(16.0, 1600));
        ...
        assertThat(
                context.slotSharingManager.getTaskSlot(
                        context.coLocationTaskSlot.getSlotRequestId()),
                notNullValue());
    }
    ...
    public void testSlotOverAllocatedAndTaskSlotsReleased() {
        SlotSharingResourceTestContext context =
                createResourceTestContext(ResourceProfile.fromResources(7.0, 700));

        for (int i = 0; i < context.singleTaskSlotsInOrder.size(); ++i) {
            SlotSharingManager.SingleTaskSlot singleTaskSlot =
                    context.singleTaskSlotsInOrder.get(i);
            assertThat(singleTaskSlot.getLogicalSlotFuture().isDone(), is(true));
            ...
            singleTaskSlot
                    .getLogicalSlotFuture()
                    .whenComplete(
                            (LogicalSlot ignored, Throwable throwable) -> {
    ...
    private SlotSharingResourceTestContext createResourceTestContext(
            ResourceProfile allocatedResourceProfile) {
        ...
        SlotSharingManager.MultiTaskSlot coLocationTaskSlot =
                unresolvedRootSlot.allocateMultiTaskSlot(
                        new SlotRequestId(), new SlotSharingGroupId());

        SlotSharingManager.SingleTaskSlot firstCoLocatedChild =
                coLocationTaskSlot.allocateSingleTaskSlot(
                        new SlotRequestId(),
                        coLocationTaskRp,
                        new SlotSharingGroupId(),
                        Locality.LOCAL);
        SlotSharingManager.SingleTaskSlot secondCoLocatedChild =
                coLocationTaskSlot.allocateSingleTaskSlot(
                        new SlotRequestId(),
                        coLocationTaskRp,
                        new SlotSharingGroupId(),
        ...
        SlotSharingManager.SingleTaskSlot forthChild =
                unresolvedRootSlot.allocateSingleTaskSlot(
                        new SlotRequestId(),
                        forthChildRp,
                        new SlotSharingGroupId(),
    ...
    private SlotSharingManager createTestingSlotSharingManager() {
        ...
        return new SlotSharingManager(SLOT_SHARING_GROUP_ID, allocatedSlotActions, SLOT_OWNER);
    }
    ...
    public void testTaskExecutorUtilizationCalculation() {
        ...
        final SlotSharingManager.MultiTaskSlot firstRootSlot =
        ...
        firstRootSlot.allocateSingleTaskSlot(
                new SlotRequestId(), ResourceProfile.UNKNOWN, groupId, Locality.UNCONSTRAINED);

        final Collection<SlotSelectionStrategy.SlotInfoAndResources> slotInfoAndResources =
                slotSharingManager.listResolvedRootSlotInfo(groupId);

        assertThat(slotInfoAndResources, hasSize(2));

        final Map<TaskManagerLocation, Double> utilizationPerTaskExecutor =
                slotInfoAndResources.stream()
                        .collect(
                                Collectors.toMap(
        ...
        assertThat(
                utilizationPerTaskExecutor.get(firstTaskExecutorLocation),
                is(closeTo(1.0 / 2, 0.1)));
    ...
    public void shouldResolveRootSlotBeforeCompletingChildSlots() {
        ...
        // important to add additional completion stage in order to reverse the execution order of
        // callbacks
        final CompletableFuture<SlotContext> identityFuture =
                slotFuture.thenApply(Function.identity());

        final SlotSharingManager.MultiTaskSlot rootSlot =
                slotSharingManager.createRootSlot(
                        new SlotRequestId(), identityFuture, new SlotRequestId());
    ...
    private SlotSharingManager.MultiTaskSlot createRootSlot(
            TaskManagerLocation firstTaskExecutorLocation, SlotSharingManager slotSharingManager) {
