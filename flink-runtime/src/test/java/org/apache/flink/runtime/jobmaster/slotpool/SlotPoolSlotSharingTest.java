...
public class SlotPoolSlotSharingTest extends TestLogger {
    ...
    public void testSingleQueuedSharedSlotScheduling() throws Exception {
        ...
        final TestingResourceManagerGateway testingResourceManagerGateway =
                slotPoolResource.getTestingResourceManagerGateway();
        ...
        boolean booleanCompletableFuture =
                slotPool.offerSlot(
                        ...
                        new SlotOffer(allocationId, 0, ResourceProfile.ANY));
    ...
    public void testQueuedSharedSlotScheduling() throws Exception {
        ...
        final SlotProvider slotProvider = slotPoolResource.getSlotProvider();
        CompletableFuture<LogicalSlot> logicalSlotFuture1 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId1, slotSharingGroupId, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());

        CompletableFuture<LogicalSlot> logicalSlotFuture2 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId2, slotSharingGroupId, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());
        ...
        boolean offerFuture =
                slotPool.offerSlot(
                        taskManagerLocation,
                        new SimpleAckingTaskManagerGateway(),
                        new SlotOffer(allocationId1, 0, ResourceProfile.ANY));
    ...
    public void testQueuedMultipleSlotSharingGroups() throws Exception {
        ...
        CompletableFuture<LogicalSlot> logicalSlotFuture1 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId1, slotSharingGroupId1, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());

        CompletableFuture<LogicalSlot> logicalSlotFuture2 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId2, slotSharingGroupId1, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());

        CompletableFuture<LogicalSlot> logicalSlotFuture3 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId3, slotSharingGroupId2, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());

        CompletableFuture<LogicalSlot> logicalSlotFuture4 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId4, slotSharingGroupId2, null),
                        SlotProfile.noRequirements(),
                        TestingUtils.infiniteTime());
        ...
        boolean offerFuture2 =
                slotPool.offerSlot(
                        taskManagerLocation,
                        new SimpleAckingTaskManagerGateway(),
                        new SlotOffer(allocationId2, 0, ResourceProfile.ANY));
    ...
    /**
     * Tests that when matching from the allocated slot, the remaining resources of the slot will be
     * used instead of the total resource.
     */
    @Test
    public void testSlotSharingRespectsRemainingResource() throws Exception {
        ...
        boolean offerFuture =
                slotPool.offerSlot(
                        taskManagerLocation,
                        new SimpleAckingTaskManagerGateway(),
                        new SlotOffer(allocationId1, 0, allocatedSlotRp));

        assertTrue(offerFuture);
        assertTrue(logicalSlotFuture1.isDone());
        assertEquals(allocationId1, logicalSlotFuture1.get().getAllocationId());

        // The second request should not share the same slot with the first request since it is
        // large.
        CompletableFuture<LogicalSlot> logicalSlotFuture2 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId2, slotSharingGroupId, null),
        ...
        // The third request should be able to share the same slot with the first request since it
        // is small.
        CompletableFuture<LogicalSlot> logicalSlotFuture3 =
                slotProvider.allocateSlot(
                        new ScheduledUnit(jobVertexId3, slotSharingGroupId, null),
        ...
        offerFuture =
                slotPool.offerSlot(
                        taskManagerLocation,
                        new SimpleAckingTaskManagerGateway(),
                        new SlotOffer(allocationId2, 0, allocatedSlotRp));
