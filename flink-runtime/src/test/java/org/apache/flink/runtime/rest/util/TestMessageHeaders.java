...
public class TestMessageHeaders<REQ extends RequestBody, RES extends ResponseBody, M extends MessageParameters>
	...
	public static TestMessageHeaders.Builder<EmptyRequestBody, EmptyResponseBody, EmptyMessageParameters> emptyBuilder() {
		return new Builder<>(
	...
	public static <MREQ extends RequestBody, MRES extends ResponseBody, MM extends MessageParameters> Builder<MREQ, MRES, MM> builder(
			Class<MREQ> requestClass,
			Class<MRES> responseClass,
			MM messageParameters) {
