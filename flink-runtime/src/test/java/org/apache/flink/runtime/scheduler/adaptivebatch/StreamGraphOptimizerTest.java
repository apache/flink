...
class StreamGraphOptimizerTest {
    ...
    @Test
    void testMaybeOptimizeStreamGraph() throws Exception {
        ...
        StreamGraphContext context =
                new StreamGraphContext() {
                    ...
                    @Override
                    public @org.jetbrains.annotations.Nullable StreamPartitioner<?>
        ...
        optimizer.maybeOptimizeStreamGraph(operatorsFinished, context);
