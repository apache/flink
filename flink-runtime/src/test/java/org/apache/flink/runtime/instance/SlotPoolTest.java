...
public class SlotPoolTest extends TestLogger {
	...
	public void testAllocateSimpleSlot() throws Exception {
		...
		try {
			...
			CompletableFuture<SimpleSlot> future = slotPoolGateway.allocateSlot(allocationID, DEFAULT_TESTING_PROFILE, null, timeout);
	...
	public void testAllocationFulfilledByReturnedSlot() throws Exception {
		...
		try {
			...
			CompletableFuture<SimpleSlot> future1 = slotPoolGateway.allocateSlot(new AllocationID(), DEFAULT_TESTING_PROFILE, null, timeout);
			CompletableFuture<SimpleSlot> future2 = slotPoolGateway.allocateSlot(new AllocationID(), DEFAULT_TESTING_PROFILE, null, timeout);
	...
	public void testOfferSlot() throws Exception {
		...
		try {
			...
			CompletableFuture<SimpleSlot> future = slotPoolGateway.allocateSlot(new AllocationID(), DEFAULT_TESTING_PROFILE, null, timeout);
			assertFalse(future.isDone());
