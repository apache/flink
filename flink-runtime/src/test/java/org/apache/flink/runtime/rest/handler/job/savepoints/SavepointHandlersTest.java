...
import org.apache.flink.runtime.dispatcher.OperationAlreadyFailedException;
...
public class SavepointHandlersTest extends TestLogger {
    ...
    @Test
    public void testRepeatedTriggerIdForFailedOperationReturnsError()
                        ...
                        .setTriggerSavepointFunction(
                                (key, ignored) ->
                                        FutureUtils.completedExceptionally(
                                                new OperationAlreadyFailedException(
        ...
        final CompletableFuture<TriggerResponse> triggerFuture =
                savepointTriggerHandler.handleRequest(
                        triggerSavepointRequest(
                                DEFAULT_REQUESTED_SAVEPOINT_TARGET_DIRECTORY, new TriggerId()),
                        testingRestfulGateway);

        assertThat(triggerFuture, RestMatchers.respondsWithError(HttpResponseStatus.CONFLICT));
    }
