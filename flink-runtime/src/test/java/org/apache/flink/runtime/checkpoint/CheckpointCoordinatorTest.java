...
public class CheckpointCoordinatorTest {
	...
	public void testTriggerAndDeclineCheckpointSimple() {
		try {
			...
			assertEquals(0, checkpoint.getTaskGroupStates().size());
			...
			assertEquals(0, checkpointNew.getTaskGroupStates().size());
	...
	public void testTriggerAndDeclineCheckpointComplex() {
		try {
			...
			assertEquals(0, checkpoint1.getTaskGroupStates().size());
			...
			assertEquals(0, checkpoint2.getTaskGroupStates().size());
	...
	public void testTriggerAndConfirmSimpleCheckpoint() {
		try {
			...
			assertTrue(success.getTaskGroupStates().isEmpty());
			...
			assertTrue(successNew.getTaskGroupStates().isEmpty());
	...
	public void testMultipleConcurrentCheckpoints() {
		try {
			...
			assertTrue(sc1.getTaskGroupStates().isEmpty());
			...
			assertTrue(sc2.getTaskGroupStates().isEmpty());
