	...
	public void testCheckpointAbortsIfTriggerTasksAreNotExecuted() {
		try {
			...
			CheckpointCoordinator coord = new CheckpointCoordinator(
					...
					new StandaloneCompletedCheckpoints(1, cl), RecoveryMode.STANDALONE);
	...
	public void testCheckpointAbortsIfAckTasksAreNotExecuted() {
		try {
			...
			CheckpointCoordinator coord = new CheckpointCoordinator(
					...
					StandaloneCompletedCheckpoints(1, cl), RecoveryMode.STANDALONE);
	...
	public void testMultipleConcurrentCheckpoints() {
		try {
			...
			CheckpointCoordinator coord = new CheckpointCoordinator(
					...
					new StandaloneCheckpointIDCounter(),
					new StandaloneCompletedCheckpoints(2, cl), RecoveryMode.STANDALONE);
	...
	public void testSuccessfulCheckpointSubsumesUnsuccessful() {
		try {
			...
			CheckpointCoordinator coord = new CheckpointCoordinator(
					...
					new ExecutionVertex[] { commitVertex }, cl,
					new StandaloneCheckpointIDCounter(),
					new StandaloneCompletedCheckpoints(10, cl), RecoveryMode.STANDALONE);
