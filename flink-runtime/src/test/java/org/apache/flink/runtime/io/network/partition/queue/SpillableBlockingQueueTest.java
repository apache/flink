...
import org.apache.flink.runtime.io.disk.iomanager.BufferFileWriterReaderTest.TestEvent;
...
public class SpillableBlockingQueueTest {
	...
	public void testSerialWriteReadConcurrentSpill() {
		try {
			...
			final BufferPool inputBufferPool = buffers.createBufferPool(1, false);

			IntermediateResultPartitionQueueIterator it = queue.getQueueIterator(Optional.of((BufferProvider) inputBufferPool));
