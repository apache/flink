...
public class TestingJobMasterGateway implements JobMasterGateway {
	...
	@Override
	public CompletableFuture<String> stopWithSavepoint(@Nullable final String targetDirectory, final boolean advanceToEndOfTime, final Time timeout) {
		return stopWithSavepointFunction.apply(targetDirectory, advanceToEndOfTime);
	}
