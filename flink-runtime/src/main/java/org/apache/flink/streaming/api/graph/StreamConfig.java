...
public class StreamConfig implements Serializable {
    ...
    private static final ConfigOption<Integer> NUMBER_OF_OUTPUTS =
            getIntegerConfigOption("numberOfOutputs");
    private static final ConfigOption<Integer> NUMBER_OF_NETWORK_INPUTS =
            getIntegerConfigOption("numberOfNetworkInputs");
    ...
    private static final ConfigOption<Boolean> IS_CHAINED_VERTEX =
            getBooleanConfigOption("isChainedSubtask");
    private static final ConfigOption<Integer> CHAIN_INDEX = getIntegerConfigOption("chainIndex");
    private static final ConfigOption<Integer> VERTEX_NAME = getIntegerConfigOption("vertexID");
    ...
    private static final ConfigOption<Long> ITERATON_WAIT = getLongConfigOption("iterationWait");
    ...
    private static final ConfigOption<Boolean> CHAIN_END = getBooleanConfigOption("chainEnd");
    private static final ConfigOption<Boolean> GRAPH_CONTAINING_LOOPS =
            getBooleanConfigOption("graphContainingLoops");

    private static final ConfigOption<Boolean> CHECKPOINTING_ENABLED =
            getBooleanConfigOption("checkpointing");
    private static final ConfigOption<Integer> CHECKPOINT_MODE =
            getIntegerConfigOption("checkpointMode");
    ...
    private static final ConfigOption<Integer> TIME_CHARACTERISTIC =
            getIntegerConfigOption("timechar");
    ...
    public Integer getVertexID() {
        return config.get(VERTEX_NAME, -1);
    }
    ...
    public long getIterationWaitTime() {
        return config.get(ITERATON_WAIT, 0L);
    }
    ...
    public int getNumberOfNetworkInputs() {
        return config.get(NUMBER_OF_NETWORK_INPUTS, 0);
    }
    ...
    public int getNumberOfOutputs() {
        return config.get(NUMBER_OF_OUTPUTS, 0);
    }
    ...
    public boolean isCheckpointingEnabled() {
        return config.get(CHECKPOINTING_ENABLED, false);
    }
    ...
    public int getChainIndex() {
        return this.config.get(CHAIN_INDEX, 0);
    }
    ...
    public boolean isChainStart() {
        return config.get(IS_CHAINED_VERTEX, false);
    }
    ...
    public boolean isChainEnd() {
        return config.get(CHAIN_END, false);
    }
    ...
    public boolean isGraphContainingLoops() {
        return config.get(GRAPH_CONTAINING_LOOPS, false);
    }
