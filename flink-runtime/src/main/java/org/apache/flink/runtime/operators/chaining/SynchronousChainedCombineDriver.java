...
public class SynchronousChainedCombineDriver<IN, OUT> extends ChainedDriver<IN, OUT> {
	...
	public void setup(AbstractInvokable parent) {
		...
		final GroupCombineFunction<IN, OUT> combiner =
			RegularTask.instantiateUserCode(this.config, userCodeClassLoader, GroupCombineFunction.class);
	...
	public void openTask() throws Exception {
		...
		RegularTask.openUserCode(this.combiner, stubConfig);
	...
	public void closeTask() throws Exception {
		...
		if (this.running) {
			RegularTask.closeUserCode(this.combiner);
		}
	}
