 ...
 * {@link ClassLoaderLease} becomes invalid once it gets released.
 */
public interface LibraryCacheManager {
	...
	interface ClassLoaderLease extends ClassLoaderHandle {
		 ...
		 * code class loader for the associated job. Once all leases for a job are
		 * released, the library cache manager is allowed to release the associated
