...
public interface LibraryCacheManager {
    ...
    interface ClassLoaderHandle {
         ...
         *
         * <p>Required jar files are matched by content, not by {@link PermanentBlobKey} identity, so
         * a jar that is re-uploaded without changing still resolves to the cached class loader.
         *
