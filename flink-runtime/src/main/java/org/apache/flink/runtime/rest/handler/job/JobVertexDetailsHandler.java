		...
		for (AccessExecutionVertex vertex : jobVertex.getTaskVertices()) {
			...
			subtasks.add(new JobVertexDetailsInfo.VertexTaskDetail(
				...
				new IOMetricsInfo(
					...
					counts.getNumBuffersInLocal() + counts.getNumBuffersInRemote(),
					counts.isNumBuffersInLocalComplete() && counts.isNumBuffersInRemoteComplete(),
					counts.getNumBuffersOut(),
					counts.isNumBuffersOutComplete(),
