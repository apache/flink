...
/** Factory for {@link BalancedSlotSharingExecutionSlotAllocator}. */
public class BalancedSlotSharingExecutionSlotAllocatorFactory
    ...
    public BalancedSlotSharingExecutionSlotAllocatorFactory(
        ...
        this(
                ...
                bulkChecker,
                allocationTimeout,
                new BalancedPreferredSlotSharingStrategy.Factory());
    }
    ...
    public ExecutionSlotAllocator createInstance(ExecutionSlotAllocationContext context) {
        ...
        return new BalancedSlotSharingExecutionSlotAllocator(
                slotProvider,
                slotWillBeOccupiedIndefinitely,
                slotSharingStrategy,
                sharedSlotProfileRetrieverFactory,
