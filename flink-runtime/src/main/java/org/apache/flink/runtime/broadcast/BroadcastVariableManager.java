...
public class BroadcastVariableManager {
	...
	public <T> BroadcastVariableMaterialization<T, ?> materializeBroadcastVariable(String name, int superstep, RegularTask<?, ?> holder,
	...
	public void releaseReference(String name, int superstep, RegularTask<?, ?> referenceHolder) {
	...
	public void releaseReference(BroadcastVariableKey key, RegularTask<?, ?> referenceHolder) {
	...
	public void releaseAllReferencesFromTask(RegularTask<?, ?> referenceHolder) {
