 ...
 */
public class FrontMetricGroup<P extends AbstractMetricGroup<?>> extends ProxyMetricGroup {
	...
	public String getMetricIdentifier(String metricName) {
		return ((AbstractMetricGroup)parentMetricGroup).getMetricIdentifier(metricName, null, this.reporterIndex);
	}

	@Override
	public String getMetricIdentifier(String metricName, CharacterFilter filter) {
		return ((AbstractMetricGroup)parentMetricGroup).getMetricIdentifier(metricName, filter, this.reporterIndex);
	}
}
