...
*                           and can create a default state value.
	...
	@Override
	public KvStateSnapshot<K, N, FoldingState<T, ACC>, FoldingStateDescriptor<T, ACC>, PartitionedFsStateBackend<K>> createHeapSnapshot(Path filePath) {
	...
	public static class Snapshot<K, N, T, ACC> extends AbstractFsStateSnapshot<K, N, ACC, FoldingState<T, ACC>, FoldingStateDescriptor<T, ACC>> {
		...
		@Override
		public KvState<K, N, FoldingState<T, ACC>, FoldingStateDescriptor<T, ACC>, PartitionedFsStateBackend<K>> createFsState(PartitionedFsStateBackend<K> backend, HashMap<N, Map<K, ACC>> stateMap) {
