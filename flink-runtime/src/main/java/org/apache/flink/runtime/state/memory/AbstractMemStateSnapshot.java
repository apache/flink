 ...
 */
public abstract class AbstractMemStateSnapshot<K, N, SV, S extends PartitionedState, SD extends StateDescriptor<S, ?>> implements KvStateSnapshot<K, N, PartitionedMemoryStateBackend<K>> {
	...
	public abstract KvState<K, N, PartitionedMemoryStateBackend<K>> createMemState(HashMap<N, Map<K, SV>> stateMap);

	@Override
	public KvState<K, N, PartitionedMemoryStateBackend<K>> restoreState(
