...
class SavepointV1Serializer implements SavepointSerializer<SavepointV1> {
	...
	public static void serializeSubtaskState(SubtaskState subtaskState, DataOutputStream dos) throws IOException {
		...
		ChainedStateHandle<StreamStateHandle> nonPartitionableState = subtaskState.getNonPartitionableOperatorState();
		...
		ChainedStateHandle<OperatorStateHandle> operatorStateBackend = subtaskState.getOperatorStateFromBackend();
		...
		ChainedStateHandle<OperatorStateHandle> operatorStateFromStream = subtaskState.getOperatorStateFromStream();
		...
		KeyGroupsStateHandle keyedStateBackend = subtaskState.getKeyedStateFromBackend();
		serializeKeyGroupStateHandle(keyedStateBackend, dos);

		KeyGroupsStateHandle keyedStateStream = subtaskState.getKeyedStateFromStream();
