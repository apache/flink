 ...
 */
public abstract class AbstractPartitionedCheckpointOutputStream<T extends StreamStateHandle> extends OutputStream {

	protected final CheckpointStreamFactory.CheckpointStateOutputStream delegate;

	public AbstractPartitionedCheckpointOutputStream(
