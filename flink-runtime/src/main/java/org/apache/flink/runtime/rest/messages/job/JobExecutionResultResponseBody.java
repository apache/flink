...
public class JobExecutionResultResponseBody implements ResponseBody {
	...
	public JobExecutionResultResponseBody(
			...
			@JsonProperty(value = "job-execution-result") @Nullable final JobExecutionResult jobExecutionResult) {
	...
	public static JobExecutionResultResponseBody created(final JobExecutionResult jobExecutionResult) {
		return new JobExecutionResultResponseBody(QueueStatus.created(), jobExecutionResult);
	}
