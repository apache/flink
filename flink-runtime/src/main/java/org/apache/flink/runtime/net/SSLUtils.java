...
public class SSLUtils {
        ...
        if (watchForCertificateChange) {
            FileSystemCertificateWatchService fileSystemWatchService =
                    new FileSystemCertificateWatchService(
                            certificatePaths, reloadableJdkSslContext);
    ...
    public static SslContext createRestNettySSLContext(
        ...
        if (keystoreFilePath != null) {
            certificatePaths.add(Path.of(keystoreFilePath).getParent().toString());
        }
        String truststoreFilePath =
                config.get(
                        SecurityOptions.SSL_REST_TRUSTSTORE,
        ...
        FileSystemCertificateWatchService fileSystemWatchService =
                new FileSystemCertificateWatchService(certificatePaths, reloadableSslContext);
        fileSystemWatchService.launch();
