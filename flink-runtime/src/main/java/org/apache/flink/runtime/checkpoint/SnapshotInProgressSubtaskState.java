...
/**
 * Encapsulates all runnable futures draw snapshots for a single subtask state of an in-flight checkpointing operation.
 */
public class SnapshotInProgressSubtaskState {
	...
	public SnapshotInProgressSubtaskState() {
	}
