...
public class JobDetailsInfo implements ResponseBody {
    ...
    // The json string of the submitted stream graph, or an empty string if the job is submitted
    // with a JobGraph or if it's a streaming job.
    ...
    public JobDetailsInfo(
            ...
            @JsonProperty(FIELD_NAME_STREAM_GRAPH_JSON) JobPlanInfo.RawJson streamGraphJson,
