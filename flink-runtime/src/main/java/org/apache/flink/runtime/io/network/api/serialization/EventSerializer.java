...
public class EventSerializer {
     ...
     *
     * <p><strong>Pre-condition</strong>: This buffer must encode some event!
     *
    ...
    private static ByteBuffer serializeCheckpointBarrier(CheckpointBarrier barrier)
        ...
        final ByteBuffer buf =
                ByteBuffer.allocate(30 + (locationBytes == null ? 0 : locationBytes.length));
    ...
    public static Buffer toBuffer(AbstractEvent event) throws IOException {
        ...
        final Buffer buffer =
                new NetworkBuffer(
                        data, FreeingBufferRecycler.INSTANCE, Buffer.DataType.getDataType(event));
