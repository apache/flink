...
/**
 * FileRangeRead pageSize query parameter used by range read log REST related handlers.
 */
public class FileNameQueryParameter extends MessageQueryParameter<String> {
