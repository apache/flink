...
class LocalBufferPool implements BufferPool {
	...
	LocalBufferPool(BufferPoolOwner owner, NetworkBufferPool networkBufferPool, int numRequiredBuffers) {
		this.owner = owner;
	...
	public BufferFuture requestBuffer(int size) {
		...
		synchronized (availableMemorySegments) {
			checkState(!isDestroyed, "Requested buffer from destroyed buffer pool.");
