...
public class ZooKeeperUtils {
	...
	public enum ZkClientACLMode {
		 ...
		 * @return Configured ACL mode or {@link HighAvailabilityOptions#HA_ZOOKEEPER_CLIENT_ACL} if not
		 * configured.
		 */
		public static ZkClientACLMode fromConfig(Configuration config) {
			String aclMode = config.getString(HighAvailabilityOptions.HA_ZOOKEEPER_CLIENT_ACL, null);
