...
public class ZooKeeperUtils {
    ...
    public static ZooKeeperJobGraphStore createJobGraphs(
        ...
        return new ZooKeeperJobGraphStore(
                zooKeeperFullJobsPath, zooKeeperStateHandleStore, pathCache);
    }
    ...
    public static CompletedCheckpointStore createCompletedCheckpoints(
        ...
        final ZooKeeperCompletedCheckpointStore zooKeeperCompletedCheckpointStore =
        ...
        LOG.info(
                "Initialized {} in '{}'.",
                ZooKeeperCompletedCheckpointStore.class.getSimpleName(),
                checkpointsPath);
