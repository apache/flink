...
public class ResourceProfile implements Serializable {
     ...
     */
    @Nonnull
    public LoadableResourceProfile toLoadableResourceProfile(@Nonnull LoadingWeight weight) {
     ...
     */
    @Nonnull
    public LoadableResourceProfile toEmptyLoadsResourceProfile() {
        return toLoadableResourceProfile(LoadingWeight.EMPTY);
    }
