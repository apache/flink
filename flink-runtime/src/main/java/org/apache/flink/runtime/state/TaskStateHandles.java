...
public class TaskStateHandles implements Serializable {
	...
	public TaskStateHandles(SubtaskState checkpointStateHandles) {
		this(checkpointStateHandles.getNonPartitionableOperatorState(),
				transform(checkpointStateHandles.getOperatorStateFromBackend()),
				transform(checkpointStateHandles.getOperatorStateFromStream()),
				transform(checkpointStateHandles.getKeyedStateFromBackend()),
				transform(checkpointStateHandles.getKeyedStateFromStream()));
	}
