 ...
 */
@PublicEvolving
public class JobManagerCheckpointStorageFactory implements CheckpointStorageFactory<JobManagerCheckpointStorage> {

	@Override
	public JobManagerCheckpointStorage createFromConfig(ReadableConfig config, ClassLoader classLoader) throws IllegalConfigurationException {
		try {
