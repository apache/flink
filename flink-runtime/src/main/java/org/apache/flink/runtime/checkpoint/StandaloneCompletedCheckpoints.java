...
/**
 * {@link CompletedCheckpoints} for JobManagers running in {@link RecoveryMode#STANDALONE}.
 */
class StandaloneCompletedCheckpoints implements CompletedCheckpoints {
	...
	private final ArrayDeque<SuccessfulCheckpoint> checkpoints;

	/**
	 * Creates {@link StandaloneCompletedCheckpoints}.
	 *
	 ...
	 */
	public StandaloneCompletedCheckpoints(
	...
	@Override
	public void addCheckpoint(SuccessfulCheckpoint checkpoint) {
	...
	@Override
	public SuccessfulCheckpoint getLatestCheckpoint() {
		return checkpoints.isEmpty() ? null : checkpoints.getLast();
	}

	@Override
	public List<SuccessfulCheckpoint> getAllCheckpoints() {
	...
	public void discardAllCheckpoints() {
		for (SuccessfulCheckpoint checkpoint : checkpoints) {
