                ...
                CompletableFuture.allOf(
                        ...
                        .thenApplyAsync(
                                ignored -> {
                                    ...
                                    Collection<ApplicationResult> dirtyApplicationResults =
        ...
        ApplicationID applicationId =
                executionPlan
                        ...
                        .orElseThrow(
                                () ->
                                        new IllegalStateException(
                                                "Application ID is missing in the added execution plan. This suggests the job was submitted through an unsupported or incomplete path."));
