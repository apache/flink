 ...
 */
public class KvStateForTasks implements Serializable {
	private static final long serialVersionUID = -5926696455438467634L;

	private static final Logger LOG = LoggerFactory.getLogger(KvStateForTasks.class);
	...
	public KvStateForTasks(SerializedValue<StateHandle<?>> keyGroupState, long stateSize, long duration) {
	...
	public boolean equals(Object obj) {
		if (obj instanceof KvStateForTasks) {
			KvStateForTasks other = (KvStateForTasks) obj;
