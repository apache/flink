...
public class JobRescalesSummaryHeaders
    ...
    public static final JobRescalesSummaryHeaders INSTANCE = new JobRescalesSummaryHeaders();
    public static final String JOB_RESCALES_SUMMARY_PATH = "/jobs/:jobid/rescales/summary";
