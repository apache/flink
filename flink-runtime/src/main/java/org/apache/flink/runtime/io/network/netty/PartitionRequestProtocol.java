...
class PartitionRequestProtocol implements NettyProtocol {
	...
	PartitionRequestProtocol(ResultPartitionProvider partitionProvider, TaskEventDispatcher taskEventDispatcher, BufferPool bufferPool) {
	...
	public void setServerChannelPipeline(ChannelPipeline channelPipeline) {
		...
		channelPipeline
				...
				.addLast("Server request handler", new PartitionRequestServerHandler(partitionProvider, taskEventDispatcher, queueOfPartitionQueues, bufferPool))
