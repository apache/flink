 ...
 * This {@code RpcConnection} implements registration and get target gateway .
 *
 ...
 */
public abstract class RpcConnection<Gateway extends RpcGateway, Success extends RegistrationResponse.Success> {
