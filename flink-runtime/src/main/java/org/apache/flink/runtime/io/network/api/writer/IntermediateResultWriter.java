...
public class IntermediateResultWriter {

	protected final IntermediateResultPartition outputGate;

	public IntermediateResultWriter(AbstractInvokable invokable) {
	...
	public void unsubscribeFromEvent(EventListener<TaskEvent> eventListener, Class<? extends TaskEvent> eventType) {
