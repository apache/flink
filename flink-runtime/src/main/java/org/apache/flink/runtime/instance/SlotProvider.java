 ...
 * {@link org.apache.flink.runtime.jobmanager.scheduler.SlotAllocationFuture#getSlot()} to get the allocated slot,
 * or a {@link NoResourceAvailableException} will be thrown.</li>
...
public interface SlotProvider {
	...
	Map<String, List<Instance>> getInstancesByHost();
}
