...
public class LeaderElectionUtils {
    ...
    public static String convertToString(
        ...
        final Map<String, String> convertedMap =
                leaderInformationPerContender.entrySet().stream()
                        .collect(
                                Collectors.toMap(
                                        Map.Entry::getKey,
                                        entry -> convertToString(entry.getValue())));
        return convertToHumanReadableString(convertedMap);
    }

    public static String convertToHumanReadableString(Map<String, String> map) {
