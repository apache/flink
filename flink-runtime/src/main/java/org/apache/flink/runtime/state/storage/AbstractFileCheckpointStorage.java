...
public abstract class AbstractFileCheckpointStorage implements CheckpointStorage {
	...
	/**
	 * Sets the given savepoint directory, or the values defined in
	 * the given configuration. If a checkpoint parameter is not null, that value takes precedence
	 * over the value in the configuration. If the configuration does not specify a value, it is possible
	 * that the savepoint directory in the savepoint storage will be null.
	 *
	...
	public void setSavepointPath(Path baseSavepointPath, ReadableConfig config) {
		this.baseSavepointPath = parameterOrConfigured(
				baseSavepointPath,
				config,
	...
	/**
	 * Sets the given checkpoint directory, or the values defined in
	 * the given configuration. If a checkpoint parameter is not null, that value takes precedence
	 * over the value in the configuration. If the configuration does not specify a value, it is possible
	 * that the checkpoint directory in the checkpoint storage will be null.
	 *
	...
	public void setCheckpointPath(Path baseCheckpointPath, ReadableConfig config) {
		this.baseCheckpointPath = parameterOrConfigured(
				baseCheckpointPath,
				config,
	...
	@Nullable
	protected static Path parameterOrConfigured(@Nullable Path path, ReadableConfig config, ConfigOption<String> option) {
		if (path != null) {
			return path;
		}
		else {
