...
public class CoGroupWithSolutionSetSecondDriver<IT1, IT2, OT> implements ResettablePactDriver<CoGroupable<IT1, IT2, OT>, OT> {
	...
	public void run() throws Exception {
		...
		final CoGroupable<IT1, IT2, OT> coGroupStub = taskContext.getStub();
