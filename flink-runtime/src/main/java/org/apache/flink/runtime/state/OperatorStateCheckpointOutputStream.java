...
public final class OperatorStateCheckpointOutputStream
		extends AbstractPartitionedCheckpointOutputStream<OperatorStateHandle> {
	...
	OperatorStateHandle closeAndGetHandle() throws IOException {
		...
		offsetsMap.put(OperatorStateStore.DEFAULT_OPERATOR_STATE_NAME, partitionOffsets.toArray());
