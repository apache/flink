...
public class GroupCombineChainedDriver<IN, OUT> extends ChainedDriver<IN, OUT> {
	...
	public void setup(AbstractInvokable parent) {
		...
		final GroupReduceFunction<IN, OUT> combiner =
			RegularTask.instantiateUserCode(this.config, userCodeClassLoader, GroupReduceFunction.class);
	...
	public void openTask() throws Exception {
		...
		RegularTask.openUserCode(this.reducer, stubConfig);
	...
	public void closeTask() throws Exception {
		...
		if (this.running) {
			RegularTask.closeUserCode(this.reducer);
		}
	}
