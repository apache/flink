...
/**
 *<b>IMPORTANT</b> {@link FsStateBackend} is deprecated in favor of
 * {@link org.apache.flink.runtime.state.hashmap.HashMapStateBackend} and
 * {@link org.apache.flink.runtime.state.storage.FileSystemCheckpointStorage}. This change does
 ...
 * the following changes set your state backend type to "hashmap" {@code state.backend: hashmap}.
 *
