...
public class MemFoldingState<K, N, T, ACC>
	...
	@Override
	public KvStateSnapshot<K, N, FoldingState<T, ACC>, PartitionedMemoryStateBackend<K>> createHeapSnapshot(byte[] bytes) {
	...
	public static class Snapshot<K, N, T, ACC> extends AbstractMemStateSnapshot<K, N, ACC, FoldingState<T, ACC>, FoldingStateDescriptor<T, ACC>> {
		...
		@Override
		public KvState<K, N, FoldingState<T, ACC>, PartitionedMemoryStateBackend<K>> createMemState(HashMap<N, Map<K, ACC>> stateMap) {
