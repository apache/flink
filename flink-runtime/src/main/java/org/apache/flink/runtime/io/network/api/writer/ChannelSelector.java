...
/**
 * Objects implementing this interface are passed to an {@link IntermediateResultPartition}. When a record is sent through the output
 * gate, the channel selector object is called to determine to which {@link org.apache.flink.runtime.io.network.partition.OutputChannel} objects the record
 * shall be passed on.
 * 
 * @param <T>
...
public interface ChannelSelector<T extends IOReadableWritable> {
	...
	/**
	 * Called to determine to which attached {@link org.apache.flink.runtime.io.network.partition.OutputChannel} objects the given record shall be forwarded.
	 * 
	 * @param record
