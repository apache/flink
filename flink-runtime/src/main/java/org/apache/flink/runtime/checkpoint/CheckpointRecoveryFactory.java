...
public interface CheckpointRecoveryFactory {
	...
	/**
	 * The number of {@link SuccessfulCheckpoint} instances to retain.
	 */
	...
	/**
	 * Creates a {@link CompletedCheckpoints} instance for a job.
	 *
	 * @param jobId           Job ID to recover checkpoints for
	 * @param userClassLoader User code class loader of the job
	 * @return {@link CompletedCheckpoints} instance for the job
	 */
	CompletedCheckpoints createCompletedCheckpoints(JobID jobId, ClassLoader userClassLoader)
			throws Exception;
