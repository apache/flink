 ...
 */
@PublicEvolving
public class FileSystemCheckpointStorageFactory implements CheckpointStorageFactory<FileSystemCheckpointStorage> {

	@Override
	public FileSystemCheckpointStorage createFromConfig(ReadableConfig config, ClassLoader classLoader) throws IllegalConfigurationException {
