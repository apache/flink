...
@PublicEvolving
public class FileSystemCheckpointStorageFactory
        implements CheckpointStorageFactory<FileSystemCheckpointStorage> {

    @Override
    public FileSystemCheckpointStorage createFromConfig(
