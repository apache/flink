...
/**
 * JDK SSL context for internal communication with stricter security requirements.
 *
 * <p>This context enforces mutual TLS authentication, uses internal keystores/truststores, and
 * configures session caching. It differs from the base {@link ReloadableSslContext} which is used
 * for external connections with more flexible authentication settings.
 */
