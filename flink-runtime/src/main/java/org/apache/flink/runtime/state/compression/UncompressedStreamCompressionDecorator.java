...
public class UncompressedStreamCompressionDecorator extends StreamCompressionDecorator {
	...
	public StreamCompressionDecoratorSnapshot snapshotConfiguration() {
		return UncompressedDecoratorSnapshot.INSTANCE;
	}

	public static class UncompressedDecoratorSnapshot extends SimpleStreamCompressionDecoratorSnapshot {

		public static final UncompressedDecoratorSnapshot INSTANCE = new UncompressedDecoratorSnapshot();

		public UncompressedDecoratorSnapshot() {
			super(UncompressedStreamCompressionDecorator.class);
		}
	}
}
