...
/**
 * An interface for checkpoint storage types that pick up additional parameters
...
public interface ConfigurableCheckpointStorage {
	 ...
	 *
	 * <p>Settings that were directly done on the original checkpoint storage object in the application
	 ...
	 * the (mutable) checkpoint storage object, this method may return the original checkpoint storage object.
	 ...
	 */
	CheckpointStorage configure(ReadableConfig config, ClassLoader classLoader) throws IllegalConfigurationException;
}
