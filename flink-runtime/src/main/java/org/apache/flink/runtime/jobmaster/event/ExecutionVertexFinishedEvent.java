...
public class ExecutionVertexFinishedEvent implements JobEvent {
    ...
    public ExecutionVertexFinishedEvent(
        ...
        // the result partition bytes in io metrics should be null
        checkState(ioMetrics.getResultPartitionBytes() == null);
    ...
    public static class Serializer implements SimpleVersionedSerializer<JobEvent> {
        ...
        public byte[] serialize(JobEvent jobEvent) throws IOException {
            checkState(jobEvent.getType() == TYPE_ID);
