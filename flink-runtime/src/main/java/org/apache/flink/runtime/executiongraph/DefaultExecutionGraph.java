...
public class DefaultExecutionGraph implements ExecutionGraph, InternalExecutionGraphAccessor {
    ...
    private final MutableVertexParallelismStore parallelismStore;
    ...
    private final StreamGraphTopologyContext streamGraphTopologyContext;
    ...
    public DefaultExecutionGraph(
        ...
        this.streamGraphTopologyContext = checkNotNull(streamGraphTopologyContext);
    ...
    public void addNewJobVertices(
        ...
        parallelismStore.mergeParallelismStore(newVerticesParallelismStore);
    ...
    public void initializeJobVertex(
        ...
        ejv.initialize(
                ...
                streamGraphTopologyContext::getParallelism,
                streamGraphTopologyContext::getMaxParallelismOrDefault);
    ...
    public void jobVertexFinished() {
        ...
        if (numFinished == numJobVerticesTotal
                && streamGraphTopologyContext.getPendingOperatorCount() == 0) {
