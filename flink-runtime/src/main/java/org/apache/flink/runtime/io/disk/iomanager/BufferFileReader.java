...
public class BufferFileReader extends BufferChannelAccess<ReadRequest> implements BufferFileReaderBase {
	...
	protected BufferFileReader(
			...
			long initialPosition, BufferProvider bufferProvider) throws IOException {
	...
	static class BufferOrEventReadRequest implements ReadRequest {
		...
		public void read() throws IOException {
			...
			if (type == BufferOrEventType.BUFFER) {
				...
				bufferOrEvent = new BufferOrEvent(SerializationUtil.fromSerializedEvent(serializedEvent, getClass().getClassLoader()));
			}
			else {
