...
/**
 * The abstract class encapsulates the lifecycle and execution strategy for asynchronous operations that use resources.
 *
...
public abstract class AbstractAsyncCallableWithResources<V> implements StoppableCallbackCallable<V> {
	...
	/** Stores a collected exception if there was on during stop. */
