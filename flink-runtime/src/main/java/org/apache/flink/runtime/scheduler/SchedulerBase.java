...
public abstract class SchedulerBase implements SchedulerNG {
    ...
    public SchedulerBase(
        ...
        this.executionGraphHandler = new ExecutionGraphHandler(executionGraph, log, ioExecutor);
    ...
    public void reportCheckpointMetrics(
        ...
        executionGraphHandler.reportCheckpointMetrics(jobID, attemptId, id, metrics);
    }
