...
public class JobVertex implements java.io.Serializable {
     ...
     * same slot sharing group can run one subtask each in the same slot. If the vertex is not
     * associated with a slot sharing group, this method returns {@code null}.
     *
     * @return The slot sharing group to associate the vertex with, or {@code null}, if not
     *     associated with one.
     */
    @Nullable
