...
public abstract class AbstractFsCheckpointStorage implements CheckpointStorage {
	...
	/** The name of the success file, written once all is done and well. */
	public static final String SUCCESS_FILE_NAME = "_success";

	/** The magic number which is the only contents of the success file. */
	public static final long SUCCESS_FILE_MAGIC_NUMBER = 0xa0a1a2a3a4a5a6a7L;
	 ...
	 */
	@Override
	public FsCheckpointStorageLocation initializeSavepoint(
