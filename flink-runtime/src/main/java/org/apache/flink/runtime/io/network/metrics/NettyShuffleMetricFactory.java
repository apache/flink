...
public class NettyShuffleMetricFactory {
    ...
    public static void registerShuffleMetrics(
        ...
        registerShuffleMetrics(
                METRIC_GROUP_NETTY, metricGroup.addGroup(METRIC_GROUP_SHUFFLE), networkBufferPool);
    }

    private static void registerShuffleMetrics(
            String groupName, MetricGroup metricGroup, NetworkBufferPool networkBufferPool) {
        MetricGroup networkGroup = metricGroup.addGroup(groupName);
        networkGroup.<Integer, Gauge<Integer>>gauge(
