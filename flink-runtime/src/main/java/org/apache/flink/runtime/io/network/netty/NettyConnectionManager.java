...
import org.apache.flink.runtime.io.network.netty.protocols.partition.PartitionRequestProtocol;
...
public class NettyConnectionManager implements NetworkConnectionManager {
	...
	public void start() throws IOException {
		NettyProtocol protocol = new PartitionRequestProtocol();
	...
	public Channel connectOrGet(RemoteAddress target) throws IOException {
		return connections.connectOrGet(target);
	}
