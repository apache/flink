...
public class RootExceptionHistoryEntry extends ExceptionHistoryEntry {
     ...
     * @param labels Map of string labels associated with the failure.
    ...
    public static RootExceptionHistoryEntry fromGlobalFailure(
        ...
        return createRootExceptionHistoryEntry(cause, timestamp, labels, null, null, executions);
    }
    ...
    public static RootExceptionHistoryEntry fromExceptionHistoryEntry(
        ...
        return new RootExceptionHistoryEntry(
                entry.getException(), entry.getTimestamp(), entry.getLabels(), null, null, entries);
    }
     ...
     * @param cause The reason for the failure.
     * @param timestamp The time the failure was caught.
     * @param labels associated with the failure.
    ...
    public RootExceptionHistoryEntry(
        ...
        super(cause, timestamp, labels, failingTaskName, taskManagerLocation);
