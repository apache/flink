...
public interface ReaderBase {
	 ...
	 * @param eventType
	 */
	void subscribeToEvent(EventListener<TaskEvent> eventListener, Class<? extends TaskEvent> eventType);
	 ...
	 */
	void unsubscribeFromEvent(final EventListener<TaskEvent> eventListener, final Class<? extends TaskEvent> eventType);
	 ...
	 */
	void publishEvent(TaskEvent event) throws IOException, InterruptedException;
