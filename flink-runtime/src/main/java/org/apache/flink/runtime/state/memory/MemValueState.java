...
public class MemValueState<K, N, V>
	...
	@Override
	public KvStateSnapshot<K, N, ValueState<V>, ValueStateDescriptor<V>, PartitionedMemoryStateBackend<K>> createHeapSnapshot(byte[] bytes) {
	...
	public static class Snapshot<K, N, V> extends AbstractMemStateSnapshot<K, N, V, ValueState<V>, ValueStateDescriptor<V>> {
		...
		@Override
		public KvState<K, N, ValueState<V>, ValueStateDescriptor<V>, PartitionedMemoryStateBackend<K>> createMemState(HashMap<N, Map<K, V>> stateMap) {
