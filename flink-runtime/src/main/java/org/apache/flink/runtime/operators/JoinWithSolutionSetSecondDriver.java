...
public class JoinWithSolutionSetSecondDriver<IT1, IT2, OT> implements ResettablePactDriver<FlatJoinable<IT1, IT2, OT>, OT> {
	
	private PactTaskContext<FlatJoinable<IT1, IT2, OT>, OT> taskContext;
	...
	public void run() throws Exception {
		...
		final FlatJoinable<IT1, IT2, OT> joinFunction = taskContext.getStub();
