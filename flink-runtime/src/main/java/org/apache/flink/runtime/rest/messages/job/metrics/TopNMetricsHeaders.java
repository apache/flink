...
public final class TopNMetricsHeaders
        implements RuntimeMessageHeaders<
                EmptyRequestBody, TopNMetricsResponseBody, TopNMetricsParameters> {
    ...
    @Override
    public TopNMetricsParameters getUnresolvedMessageParameters() {
        return new TopNMetricsParameters();
    }
