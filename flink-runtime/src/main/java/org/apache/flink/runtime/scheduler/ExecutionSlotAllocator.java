...
public interface ExecutionSlotAllocator {
	 ...
	 *
	 * @param slotExecutionVertexAssignment The previous slot execution vertex assignment return when allocating.
	 */
	void cancel(SlotExecutionVertexAssignment slotExecutionVertexAssignment);
