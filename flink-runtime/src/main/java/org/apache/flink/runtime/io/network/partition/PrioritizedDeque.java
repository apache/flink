...
public final class PrioritizedDeque<T> implements Iterable<T> {
	 ...
	 * optimizations for special cases are used.}
	 *
	...
	public void prioritize(T element) {
		...
		// If the next non-priority element is the given element, we can simply include it in the priority section
	...
	public boolean equals(Object o) {
		...
		return numPriorityElements == that.numPriorityElements &&
			deque.equals(that.deque);
	}
