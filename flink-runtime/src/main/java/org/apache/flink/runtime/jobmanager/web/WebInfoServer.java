...
public class WebInfoServer {
	...
	public void start() throws Exception {
		...
		if (connectors != null && connectors.length > 0 && connectors[0] instanceof ServerConnector) {
			ServerConnector conn = (ServerConnector) connectors[0];
			
			assignedPort = conn.getLocalPort(); // we have to use getLocalPort() instead of getPort() http://stackoverflow.com/questions/8884865/how-to-discover-jetty-7-running-port
