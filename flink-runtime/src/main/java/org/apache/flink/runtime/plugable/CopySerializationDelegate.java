...
/**
 * The copy serialization delegate exposes an arbitrary serialized element as a {@link IOReadableWritable} for
 * copying this element, with the help of a type serializer.
 *
 * @param <T> The type to be copied.
 */
