...
class ChannelStateHandleSerializer {
    ...
    ResultSubpartitionStateHandle deserializeResultSubpartitionStateHandle(
        ...
        return deserializeChannelStateHandle(
                ...
                (streamStateHandle, contentMetaInfo, info) ->
                        new ResultSubpartitionStateHandle(info, streamStateHandle, contentMetaInfo),
                dis,
                context);
    }
    ...
    InputChannelStateHandle deserializeInputChannelStateHandle(
        ...
        return deserializeChannelStateHandle(
                ...
                (streamStateHandle, contentMetaInfo, inputChannelInfo) ->
                        new InputChannelStateHandle(
                                inputChannelInfo, streamStateHandle, contentMetaInfo),
                dis,
                context);
    }
