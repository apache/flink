...
/**
 * A {@link SpillingThread.RecordsMerger} that reads the merged stream and writes it back.
 *
 * @see CombiningRecordsMerger
 */
final class DefaultRecordsMerger<R> implements SpillingThread.RecordsMerger<R> {

	private final boolean objectReuseEnabled;
	private final TypeSerializer<R> serializer;

	DefaultRecordsMerger(
