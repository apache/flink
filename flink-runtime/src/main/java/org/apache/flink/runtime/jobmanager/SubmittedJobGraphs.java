...
public interface SubmittedJobGraphs {
	...
	/**
	 * Starts the {@link SubmittedJobGraphs} service.
	 */
	void start(SubmittedJobGraphListener jobGraphListener) throws Exception;

	/**
	 * Stops the {@link SubmittedJobGraphs} service.
	 */
