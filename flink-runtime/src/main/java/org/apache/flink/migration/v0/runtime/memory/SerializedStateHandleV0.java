...
public class SerializedStateHandleV0<T extends Serializable> extends AbstractCloseableHandleV0 implements StateHandleV0<T> {
	 ...
	 */
	public SerializedStateHandleV0(T value) throws IOException {
	 ...
	 */
	public SerializedStateHandleV0(byte[] serializedData) {
	...
	public T getState(ClassLoader classLoader) throws Exception {
		...
		return serializedData == null ? null :
			MigrationInstantiationUtil.<T>deserializeObject(SavepointV0.VERSION, serializedData, classLoader);
	}
}
