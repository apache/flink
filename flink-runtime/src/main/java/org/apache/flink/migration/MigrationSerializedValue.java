 ...
 */
@Deprecated
public class MigrationSerializedValue<T> implements java.io.Serializable {
	...
	private MigrationSerializedValue(byte[] serializedData) {
		this.serializedData = serializedData;
	}

	public MigrationSerializedValue(T value) throws IOException {
	...
	public T deserializeValue(ClassLoader loader) throws IOException, ClassNotFoundException {
		return serializedData == null ? null : (T) MigrationInstantiationUtil.deserializeObject(
			SavepointV0.VERSION, serializedData, loader);
	}
	...
	public static <T> MigrationSerializedValue<T> fromBytes(byte[] serializedData) {
		return new MigrationSerializedValue<T>(serializedData);
	}
	...
	public boolean equals(Object obj) {
		if (obj instanceof MigrationSerializedValue) {
			MigrationSerializedValue<?> other = (MigrationSerializedValue<?>) obj;
