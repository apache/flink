...
public class MemValueStateV0<K, N, V> {

	public static class Snapshot<K, N, V> extends AbstractMemStateSnapshotV0<K, N, V, ValueState<V>, ValueStateDescriptorV0<V>> {
		private static final long serialVersionUID = 1L;

		public Snapshot(TypeSerializer<K> keySerializer,
			TypeSerializer<N> namespaceSerializer,
			TypeSerializer<V> stateSerializer,
			ValueStateDescriptorV0<V> stateDescs, byte[] data) {
