...
/**
 * A snapshot for the states of MemoryStateBackend in SavepointV0.
 */
@Deprecated
@SuppressWarnings("deprecation")
public abstract class AbstractMemStateSnapshotV0<K, N, SV, S extends State, SD extends StateDescriptorV0<S, ?>>
		implements KvStateSnapshotV0<K, N, S, SD>, MigrationRestoreSnapshot<K, N, SV> {
	 ...
	 */
	public AbstractMemStateSnapshotV0(TypeSerializer<K> keySerializer,
