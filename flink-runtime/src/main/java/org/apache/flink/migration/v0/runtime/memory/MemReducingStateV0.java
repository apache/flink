...
import org.apache.flink.migration.v0.api.ReducingStateDescriptorV0;
...
public class MemReducingStateV0<K, N, V> {

	public static class Snapshot<K, N, V> extends AbstractMemStateSnapshotV0<K, N, V, ReducingState<V>, ReducingStateDescriptorV0<V>> {
		private static final long serialVersionUID = 1L;

		public Snapshot(TypeSerializer<K> keySerializer,
			TypeSerializer<N> namespaceSerializer,
			TypeSerializer<V> stateSerializer,
			ReducingStateDescriptorV0<V> stateDescs, byte[] data) {
