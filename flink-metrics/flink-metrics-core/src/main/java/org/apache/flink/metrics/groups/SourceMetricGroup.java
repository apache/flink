...
public interface SourceMetricGroup extends OperatorMetricGroup {
    ...
    /**
     * Adds an optional gauge for last fetch time. Source readers can use this gauge to indicate the
    ...
    /**
     * Adds an optional gauge for the number of bytes that have not been fetched by the source. e.g.
     ...
     * @see SettableGauge SettableGauge to continuously update the value.
     */
    Gauge<Long> addPendingBytesGauge(Gauge<Long> pendingBytesGauge);

    /**
     * Adds an optional gauge for the number of records that have not been fetched by the source.
     ...
     * @see SettableGauge SettableGauge to continuously update the value.
     */
    Gauge<Long> addPendingRecordsGauge(Gauge<Long> pendingRecordsGauge);
}
