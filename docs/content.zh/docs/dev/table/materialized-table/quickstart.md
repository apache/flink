...
[下载](https://repo1.maven.org/maven2/org/apache/flink/flink-table-filesystem-test-utils/1.20.0/flink-table-filesystem-test-utils-1.20.0.jar) test-filesystem 连接器， 并将其放入 lib 目录：
