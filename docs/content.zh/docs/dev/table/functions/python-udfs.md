...
aliases:
  ...
  - /zh/docs/dev/table/python/udfs/python_udfs/
  - /zh/dev/python/table-api-users-guide/udfs/vectorized_python_udfs.html
  - /zh/docs/dev/table/python/udfs/vectorized_python_udfs/
  - /zh/docs/dev/table/python/udfs/overview/
  - /zh/docs/dev/table/python/udfs/
---
<!--
...
**NOTE:** Currently the general user-defined aggregate function is only supported in the GroupBy aggregation and Group Window Aggregation in streaming mode. For batch mode, it's currently not supported and it is recommended to use the [Vectorized Aggregate Functions](#vectorized-aggregate-functions).
