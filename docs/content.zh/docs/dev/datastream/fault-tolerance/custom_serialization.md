...
<<<<<<< HEAD:docs/dev/stream/state/custom_serialization.zh.md
{% endhighlight %}
</div>
...
=======
```
>>>>>>> 5b42f7100b ([FLINK-21193][docs] Migrate Flink docs from Jekyll to Hugo):docs/content.zh/docs/dev/datastream/fault-tolerance/custom_serialization.md
