...
Flink JDBC Driver is a Java library for connecting and submitting SQL statements to [SQL Gateway]({{< ref "docs/sql/interfaces/sql-gateway/overview" >}}) as the JDBC server.
