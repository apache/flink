...
可以在 [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}) 中执行 ALTER 语句。
...
### ADD
使用 `ADD` 语句向已有表中增加 [columns]({{< ref "docs/sql/reference/ddl/create" >}}#columns)，[constraints]({{< ref "docs/sql/reference/ddl/create" >}}#primary-key)，[watermark]({{< ref "docs/sql/reference/ddl/create" >}}#watermark)，[partitions]({{< ref "docs/sql/reference/ddl/create" >}}#partitioned-by) 和 [distribution]({{< ref "docs/sql/reference/ddl/create" >}}#distributed)。
