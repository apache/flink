...
deployment/resource-providers/standalone/index.zh.md %}), in containers, or managed by resource
...
*standby* (see [High Availability (HA)]({% link deployment/ha/index.zh.md %})).
