...
<div class="alert alert-info"> <strong>注意：</strong> 以前，Flink Session 集群也被称为 <i> session 模式</i>下的 Flink 集群。</div>
...
<div class="alert alert-info"> <strong>注意：</strong> 以前，Flink Job 集群也被称为<i> job (or per-job) 模式</i>下的 Flink 集群。</div>
...
<div class="alert alert-info"> <strong>注意：</strong> Flink Job 集群可以看做是 Flink Application 集群”客户端运行“的替代方案。</div>
