...
| [JVM metaspace]({% link deployment/memory/mem_setup.md %}#jvm-parameters)                 | [`jobmanager.memory.jvm-metaspace.size`]({% link ops/config.md %}#jobmanager-memory-jvm-metaspace-size)                                                                                                                                                                                                       | Metaspace size of the Flink JVM process                                                                                                                                                                                                                                  |
