  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><a href="{% link deployment/resource-providers/standalone/local.md %}">Learn more</a>
      </div>
    </div>
  </div>
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><a href="{% link deployment/resource-providers/standalone/index.md %}">Learn more</a>
      </div>
    </div>
  </div>
  <div class="col-sm-4">
  ...
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><a href="{% link deployment/resource-providers/standalone/docker.md %}">Learn more</a>
      </div>
    </div>
  </div>
  <div class="col-sm-4">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <br><a href="{% link deployment/resource-providers/standalone/kubernetes.md %}">Learn more</a>
      </div>
    </div>
  </div>
</div>
