...
{% endhighlight %}
    ...
    <tr>
      <td><strong>User-defined Scalar Functions (Scalar UDF)</strong></td>
      <td>
...
<table class="table table-bordered">
  ...
  <tbody>
    <tr>
      ...
      <td>
        <p><b>Note:</b> GroupBy on a streaming table produces an updating result. See the [Streaming Concepts](streaming.html) page for details.
        </p>
{% highlight sql %}
SELECT a, SUM(b) as d 
FROM Orders 
...
{% endhighlight %}
    ...
    <tr>
    	<td><strong>Over Window</strong> (Streaming only)</td>
    	<td>
...
{% endhighlight %}
    ...
    <tr>
      <td><strong>User-defined Aggregate Functions (UDAGG)</strong></td>
      <td>
...
{% endhighlight %}
    ...
    <tr>
    	<td><strong>User Defined Table Functions (UDTF)</strong></td>
    	<td>
