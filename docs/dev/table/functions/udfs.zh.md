...
如果你打算使用 Python 实现或调用标量函数，详情可参考 [Python 标量函数]({% link dev/python/user-guide/table/udfs/python_udfs.zh.md %}#scalar-functions)。
...
如果你打算使用 Python 实现或调用表值函数，详情可参考 [Python 表值函数]({% link dev/python/user-guide/table/udfs/python_udfs.zh.md %}#table-functions)。
