...
[Apache Avro](https://avro.apache.org/) 格式允许基于 Avro 模式读取和写入 Avro 数据。目前，Avro 模式派生自表模式。

依赖
------------

为了设置 Avro 格式，下表提供了使用自动化构建工具（例如 Maven 或 SBT）和带有 SQL JAR 捆绑包的 SQL Client 的项目依赖信息。
...
<table class="table table-bordered">
    ...
    <tr>
      ...
      <td>String</td>
      <td>指定使用什么格式，这里应该是 <code>‘avro’</code>。</td>
    </tr>
    <tr>
