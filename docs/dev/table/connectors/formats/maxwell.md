...
Currently, the Maxwell format uses JSON for serialization and deserialization. Please refer to [JSON Format documentation]({% link dev/table/connectors/formats/json.md %}#data-type-mapping) for more details about the data type mapping.
