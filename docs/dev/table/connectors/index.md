...
The desired connection properties are converted into string-based key-value pairs. [Factories]({% link dev/table/sourceSinks.md %})
...
next to the physical payload columns. See the [`CREATE TABLE` section]({% link dev/table/sql/create.md %}#columns)
