...
own implementation. Please use the options in the [Connector Options]({% link dev/table/connectors/kafka.zh.md %}#connector-options) as the first choice before using the `'properties.*'`.
