...
The file system connector supports multiple formats:
 ...
 - Debezium-JSON: [debezium-json]({% link dev/table/connectors/formats/debezium.zh.md %}).
 - Canal-JSON: [canal-json]({% link dev/table/connectors/formats/canal.zh.md %}).
 - Raw: [raw]({% link dev/table/connectors/formats/raw.zh.md %}).
