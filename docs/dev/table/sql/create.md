...
If the language tag is PYTHON, however the current program is written in Java/Scala or pure SQL, then you need to [configure the Python dependencies]({% link dev/python/dependency_management.md %}#python-dependencies).
