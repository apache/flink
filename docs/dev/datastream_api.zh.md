...
- `addSource` - Attach a new source function. For example, to read from Apache Kafka you can use
    `addSource(new FlinkKafkaConsumer09<>(...))`. See [connectors]({{ site.baseurl }}/dev/connectors/index.html) for more details.
...
- `addSource` - Attach a new source function. For example, to read from Apache Kafka you can use
    `addSource(new FlinkKafkaConsumer09<>(...))`. See [connectors]({{ site.baseurl }}/dev/connectors/) for more details.
