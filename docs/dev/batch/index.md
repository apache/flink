...
Check also the [best practices guide on how to pass command line arguments to functions]({{ site.baseurl }}/testing/best_practices.html#parsing-command-line-arguments-and-passing-them-around-in-your-flink-application).
