...
** The operator for AsyncFunction (AsyncWaitOperator) must currently not be chained for consistency reasons **

For the reasons given in issue `FLINK-13063`, we currently suppress chaining of the `AsyncWaitOperator` to prevent 
