...
{% endhighlight %}
      ...
      {% endhighlight %}
             ...
             <p>will generate matches with consecutive applied: {C A1 B}, {C A1 A2 B}, {C A1 A2 A3 B}</p>
             <p>will generate matches without consecutive applied: {C A1 B}, {C A1 A2 B}, {C A1 A2 A3 B}, {C A1 A2 A3 A4 B}</p>
