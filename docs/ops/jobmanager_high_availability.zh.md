...
Kubernetes high availability service could support both [standalone Flink on Kubernetes]({{ site.baseurl}}/zh/ops/deployment/kubernetes.html) and [native Kubernetes integration]({{ site.baseurl}}/zh/ops/deployment/native_kubernetes.html).
