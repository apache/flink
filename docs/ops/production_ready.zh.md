...
Configuring [High Availability]({% link deployment/ha/index.zh.md %}), in conjunction with Apache Zookeeper, allows for a swift recovery and is highly recommended for production setups. 
