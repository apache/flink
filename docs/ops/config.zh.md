...
Check also the [how to configure task manager memory](mem_setup.html).

The table below contains configuration options related to the [managed memory setup](mem_setup.html#managed-memory).
