...
- `classloader.parent-first-patterns`: A (comma-separated) list of patterns that specifies which
...
`org.apache.flink`. If you want to change this setting you have to make sure to also include
`org.apache.flink` in your list of patterns if you want to keep that default behaviour.
