...
by [Flink’s own type serialization framework]({{ site.baseurl }}/dev/stream/state/schema_evolution.html)
or [Custom State Serialization]({{ site.baseurl }}/dev/stream/state/custom_serialization.html).
