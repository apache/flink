...
<table class="table table-bordered">
  ...
  <tbody>
    ...
    <tr>
          ...
          1.6.x up to 1.6.2: <a href="https://issues.apache.org/jira/browse/FLINK-11087">FLINK-11087</a>. Users
          upgrading to 1.6.x series need to directly migrate to minor versions higher than 1.6.2.</td>
    </tr>
    <tr>
