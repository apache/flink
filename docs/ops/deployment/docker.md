...
[standalone Kubernetes]({% link ops/deployment/kubernetes.md %}) or [native Kubernetes]({% link ops/deployment/native_kubernetes.md %}).
...
* [in a Kubernetes cluster]({% link ops/deployment/kubernetes.md %}),
* [with Docker Compose](#flink-with-docker-compose),
* [with Docker swarm](#flink-with-docker-swarm).

<span class="label label-info">Note</span> [The native Kubernetes]({% link ops/deployment/native_kubernetes.md %}) also runs the same image by default
...
We recommend using [Docker Compose]({% link ops/deployment/docker.md %}#session-cluster-with-docker-compose) or [Docker Swarm]({% link ops/deployment/docker.md %}#session-cluster-with-docker-swarm) for deploying Flink as a Session Cluster to ease system configuration.
...
As described in the [plugins]({% link ops/plugins.md %}) documentation page: in order to use plugins they must be
