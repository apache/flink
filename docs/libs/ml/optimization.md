...
<table class="table table-bordered">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <p>
            This is the `'optimal'` method of sklearn.  Chooses optimal initial $t_0 = \lambda \cdot eta_0$, based on Leon Bottou's [Learning with Large Data Sets ](http://leon.bottou.org/slides/largescale/lstut.pdf)
          </p>
        </td>
        <td class="text-center">\eta_j = \frac{1}{\lambda \cdot (\frac{1}{\lambda \cdot eta_0 } +j -1) }</td>
      ...
      <tr>
        ...
        <td class="text-center">`invScaling`</td>
      </tr>
      <tr>
...
Averaged Stochastic Gradient Descent](http://arxiv.org/pdf/1107.2490.pdf).
          </p>
        </td>
        <td class="text-center">\eta_j = \lambda \cdot (1+ \lambda \cdot \eta_0 \cdot j^{\$tau} )</td>
        <td class="text-center">`xu`</td>
      </tr>
    </tbody>
  </table>
