...
multi-way join operator (`StreamingMultiJoinOperator`) that drastically reduces state size
...
PyFlink 2.1 will support Python 3.12 and remove the support of Python 3.8.
