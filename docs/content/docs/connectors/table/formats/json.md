...
<table class="table table-bordered">
    ...
    <tr>
      ...
      <ul>
        ...
        parse input TIMESTAMP_LTZ values in "yyyy-MM-dd HH:mm:ss.s{precision}" format, e.g "2020-12-30 12:13:14.123" and output timestamp in the same format.</li>
        ...
        parse input TIMESTAMP_LTZ in "yyyy-MM-ddTHH:mm:ss.s{precision}" format, e.g "2020-12-30T12:13:14.123" and output timestamp in the same format.</li>
      </ul>
      </td>
    </tr>
    <tr>
