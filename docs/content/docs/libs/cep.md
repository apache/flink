...
If you want to jump right in, [set up a Flink program]({{< ref "docs/dev/configuration" >}}) and
...
FlinkCEP is not part of the binary distribution. See how to link with it for cluster execution [here]({{< ref "docs/dev/configuration" >}}).
