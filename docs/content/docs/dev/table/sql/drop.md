...
DROP statements are used to remove a catalog with given catalog name or used to remove a registered table/view/function from current or specified [Catalog]({{< ref "docs/dev/table/catalogs" >}}).
