...
CREATE DATABASE IF NOT EXISTS db1 COMMENT 'db1' LOCATION '/user'
...
` CREATE FUNCTION` statement create a function that is implemented by the class_name.
...
The function exist for the duration of the current session.
