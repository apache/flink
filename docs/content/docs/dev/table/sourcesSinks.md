...
In particular, the uber JAR should include all the 3rd party dependencies of the connector, 
...
application's classpath won't have direct access to `org.apache.flink.table.planner` classes anymore. 
