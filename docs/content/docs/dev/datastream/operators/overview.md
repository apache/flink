...
The description will be used in the execution plan and displayed as details of a job vertex in web UI.
...
Users can set `pipeline.vertex-description-mode` to be `CASCADING`, if they want to set description to be cascading format as what it is in former versions.
