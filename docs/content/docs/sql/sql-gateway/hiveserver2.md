...
type: docs
aliases:
- /docs/sql/hive-compatibility/hiveserver2/
---
<!--
...
or add the following configuration into [Flink configuration file]({{< ref "docs/deployment/config#flink-configuration-file" >}}) (please replace the `<path to hive conf>` with your hive conf path).
