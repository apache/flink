...
SHOW statements can be executed in [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}).
...
Show all added jars in the session classloader which are added by [`ADD JAR`]({{< ref "docs/sql/reference/utility/jar" >}}#add-jar) statements.

<span class="label label-danger">Attention</span> Currently `SHOW JARS` statements only work in the [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}) or [SQL Gateway]({{< ref "docs/sql/interfaces/sql-gateway/overview" >}}).
...
<span class="label label-danger">Attention</span> Currently `SHOW JOBS` statements only work in the [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}) or [SQL Gateway]({{< ref "docs/sql/interfaces/sql-gateway/overview" >}}).
