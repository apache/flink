...
The following examples show how to run `JOB` statements in [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}).
...
<span class="label label-danger">Attention</span> SHOW JOBS statements only work in [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}) or [SQL Gateway]({{< ref "docs/sql/interfaces/sql-gateway/overview" >}}).
...
<span class="label label-danger">Attention</span> STOP JOB statements only work in [SQL CLI]({{< ref "docs/sql/interfaces/sql-client" >}}) or [SQL Gateway]({{< ref "docs/sql/interfaces/sql-gateway/overview" >}}).
