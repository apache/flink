...
So instead of deploying the TaskManagers as a Deployment, you need to configure a StatefulSet for the TaskManagers.
The StatefulSet allows to configure a volume claim template that you use to mount persistent volumes to the TaskManagers.
