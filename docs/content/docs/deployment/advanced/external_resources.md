...
We provide [an example](https://github.com/apache/flink/blob/{{ site.github_branch }}/flink-examples/flink-examples-datastream/src/main/java/org/apache/flink/streaming/examples/gpu/MatrixVectorMul.java)
