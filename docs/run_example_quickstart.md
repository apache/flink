...
# Review Input Data
Use the `plotPoints.py` tool to review the result of the data generator. [Download Python Script](quickstart/example-data/plotPoints.py)
```bash
...
Use the [Python Script]({{site.baseurl}}/quickstart/example-data/plotPoints.py) again to visualize the result
