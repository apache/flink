...
public class WindowCheckpointingITCase extends TestLogger {
    ...
    public void testTumblingProcessingTimeWindow() {
        ...
        try {
            ...
            env.addSource(new FailingSource(new Generator(), numElements, timeCharacteristic))
                    .rebalance()
                    .keyBy(0)
                    ...
                    .addSink(
                            new ValidatingSink<>(
                                    updaterAndChecker, updaterAndChecker, timeCharacteristic))
                    .setParallelism(1);
    ...
    public static Collection<TimeCharacteristic[]> timeCharacteristic() {
        return Arrays.asList(
                new TimeCharacteristic[] {TimeCharacteristic.ProcessingTime},
