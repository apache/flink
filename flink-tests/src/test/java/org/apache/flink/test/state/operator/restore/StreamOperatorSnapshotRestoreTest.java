...
public class StreamOperatorSnapshotRestoreTest {
    ...
    static class TestOneInputStreamOperator extends AbstractStreamOperator<Integer>
        ...
        public void snapshotState(StateSnapshotContext context) throws Exception {
            ...
            assertEquals(MAX_PARALLELISM, count);
        ...
        public void initializeState(StateInitializationContext context) throws Exception {
            ...
            assertEquals(verifyRestore, context.isRestored());
            ...
            if (context.isRestored()) {
                ...
                for (KeyGroupStatePartitionStreamProvider streamProvider :
                    ...
                    try (InputStream in = streamProvider.getStream()) {
                        ...
                        assertEquals(streamProvider.getKeyGroupId() + 2, div.readInt());
                        ++count;
                    }
                }
                assertEquals(MAX_PARALLELISM, count);
                ...
                assertEquals(10, check.cardinality());
                ...
                assertEquals(13, check.cardinality());
            }
        }
    }
}
