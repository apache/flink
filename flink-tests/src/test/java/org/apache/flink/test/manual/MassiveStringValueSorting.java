    ...
    public void testStringValueSorting() {
        ...
        try {
            ...
            try (IOManager ioMan = new IOManagerAsync()) {
                ...
                sorter =
                        new UnilateralSortMerger<StringValue>(
                                mm,
                                ioMan,
                                inputIterator,
                                new DummyInvokable(),
                                new RuntimeSerializerFactory<StringValue>(
                                        serializer, StringValue.class),
                                comparator,
                                1.0,
                                4,
                                0.8f,
    ...
    public void testStringValueTuplesSorting() {
        ...
        try {
            ...
            try (IOManager ioMan = new IOManagerAsync()) {
                ...
                sorter =
                        new UnilateralSortMerger<Tuple2<StringValue, StringValue[]>>(
                                mm,
                                ioMan,
                                inputIterator,
                                new DummyInvokable(),
                                new RuntimeSerializerFactory<Tuple2<StringValue, StringValue[]>>(
                                        serializer,
                                        (Class<Tuple2<StringValue, StringValue[]>>)
                                                (Class<?>) Tuple2.class),
                                comparator,
                                1.0,
                                4,
