...
public class CustomCompensatableDotProductCoGroup extends AbstractRichFunction implements CoGroupable<VertexWithRankAndDangling, VertexWithRank, VertexWithRankAndDangling> {
