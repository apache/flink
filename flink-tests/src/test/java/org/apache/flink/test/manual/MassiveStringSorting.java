            ...
            try (IOManager ioMan = new IOManagerAsync()) {
                ...
                sorter =
                        new UnilateralSortMerger<String>(
                                ...
                                inputIterator,
                                new DummyInvokable(),
                                new RuntimeSerializerFactory<String>(serializer, String.class),
                                comparator,
                                1.0,
                                4,
                                0.8f,
    ...
    public void testStringTuplesSorting() {
        ...
        try {
            ...
            try (IOManager ioMan = new IOManagerAsync()) {
                ...
                sorter =
                        new UnilateralSortMerger<Tuple2<String, String[]>>(
                                mm,
                                ioMan,
                                inputIterator,
                                new DummyInvokable(),
                                new RuntimeSerializerFactory<Tuple2<String, String[]>>(
                                        serializer,
