...
public class ConnectedComponentsNepheleITCase extends RecordAPITestBase {
			...
			String verticesPath, String edgesPath, String resultPath, int numSubTasks, int maxIterations)
	{
		...
		// -- edges ------------------------------------------------------------------------------------------------
		JobGraphUtils.connect(vertices, head, DistributionPattern.BIPARTITE);
		JobGraphUtils.connect(edges, head, DistributionPattern.BIPARTITE);
		JobGraphUtils.connect(vertices, head, DistributionPattern.BIPARTITE);

		JobGraphUtils.connect(head, intermediate, DistributionPattern.BIPARTITE);
