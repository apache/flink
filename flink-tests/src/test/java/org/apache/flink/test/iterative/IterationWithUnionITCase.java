...
public class IterationWithUnionITCase extends JavaProgramTestBase {
	...
	static final class IdentityMapper extends MapFunction<Record, Record> implements Serializable {
	...
	static final class DummyReducer extends GroupReduceFunction<Record, Record> {
		private static final long serialVersionUID = 1L;
