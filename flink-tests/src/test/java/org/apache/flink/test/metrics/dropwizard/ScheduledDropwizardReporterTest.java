 ...
 * Dropwizard {@link Reporter}.
 */
@PublicEvolving
public abstract class ScheduledDropwizardReporterTest implements MetricReporter, Scheduled, Reporter, CharacterFilter {
	...
	protected ScheduledDropwizardReporterTest() {
