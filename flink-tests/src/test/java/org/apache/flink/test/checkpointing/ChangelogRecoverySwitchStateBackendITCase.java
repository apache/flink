 ...
 */
class ChangelogRecoverySwitchStateBackendITCase extends ChangelogRecoverySwitchEnvTestBase {
    ...
    void testSwitchFromDisablingToEnablingInClaimMode() throws Exception {
        ...
        File thirdCheckpointFolder = TempDirUtils.newFolder(temporaryFolder.toPath());
