...
class ChangelogRescalingITCase {
    ...
    /** Slide size. */
    private static final Duration WINDOW_SLIDE = Duration.ofMillis(10);
    ...
    public static Collection<Integer[]> parameters() {
        return Arrays.asList(new Integer[] {6, 4}, new Integer[] {4, 6});
    }

    public int parallelism1;

    public int parallelism2;
    ...
    void test() throws Exception { // before rescale
        ...
        JobID jobID2 =
                submit(
                        configureJob(parallelism2, tempDir),
    ...
    private String checkpointAndCancel(JobID jobID) throws Exception {
        ...
        return CommonTestUtils.getLatestCompletedCheckpointPath(jobID, cluster.getMiniCluster())
                .orElseThrow(() -> new NoSuchElementException("No checkpoint was created yet"));
    }
