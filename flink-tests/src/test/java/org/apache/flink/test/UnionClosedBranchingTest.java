...
public class UnionClosedBranchingTest extends CompilerTestBase {
	...
	public void testUnionClosedBranchingTest() throws Exception {
		...
		DataSet<Tuple1<Integer>> src1 = env.fromElements(new Tuple1<Integer>(0), new Tuple1<Integer>(1));

		DataSet<Tuple1<Integer>> src2 = env.fromElements(new Tuple1<Integer>(0), new Tuple1<Integer>(1));
