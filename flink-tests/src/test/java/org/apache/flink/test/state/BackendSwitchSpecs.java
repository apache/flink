...
public final class BackendSwitchSpecs {
    ...
    static final BackendSwitchSpec ROCKS = new RocksSpec(RocksDBOptions.PriorityQueueStateType.ROCKSDB);

    /** Specification for a {@link RocksDBKeyedStateBackend} which stores its timers on heap. */
    static final BackendSwitchSpec ROCKS_HEAP_TIMERS = new RocksSpec(
