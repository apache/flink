...
/**
 * Implementation of {@link BlockCompressionFactory} for YarnShuffleServiceITCase.
 */
public class BlockCompressionTestDelegateFactory implements BlockCompressionFactory {
	...
	public AbstractBlockCompressor getCompressor() {
		return new BlockCompressorTestDelegate();
	}

	@Override
	public AbstractBlockDecompressor getDecompressor() {
		return new BlockDecompressorTestDelegate();
	}
}
