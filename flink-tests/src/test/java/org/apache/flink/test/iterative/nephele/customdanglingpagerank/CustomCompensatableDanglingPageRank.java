...
//		intermediateConfig.setDriver(RepeatableHashjoinMatchDriverWithCachedBuildside.class);
		...
		JobGraphUtils.connect(pageWithRankInput, head, DistributionPattern.BIPARTITE);
		...
		JobGraphUtils.connect(adjacencyListInput, intermediate, DistributionPattern.BIPARTITE);
		
		JobGraphUtils.connect(head, tail, DistributionPattern.POINTWISE);
		JobGraphUtils.connect(intermediate, tail, DistributionPattern.BIPARTITE);
