...
public class BackPressureITCase extends TestLogger {
    ...
    public void setUp() throws Exception {
        ...
        final TestingMiniClusterConfiguration testingMiniClusterConfiguration =
    ...
    private static Configuration createNetworkBufferConfiguration() {
        ...
        configuration.set(
                ...
                MemorySize.parse(memorySegmentSizeKb + "kb"));
    ...
    private void assertJobVertexSubtasksAreBackPressured(final JobVertex jobVertex)
            throws Exception {
        try {
            ...
            final String errorMessage =
                    String.format(
                            "Subtasks of job vertex %s were not back pressured within timeout",
                            jobVertex);
    ...
    private SupplierWithException<Boolean, Exception> isJobVertexBackPressured(
        ...
        return () -> {
            final OperatorBackPressureStatsResponse backPressureStatsResponse =
                    dispatcherGateway
