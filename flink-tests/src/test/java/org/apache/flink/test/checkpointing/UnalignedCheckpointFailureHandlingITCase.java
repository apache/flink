...
public class UnalignedCheckpointFailureHandlingITCase {
     ...
     * after catching an exception in {@link CheckpointStateOutputStream#closeAndGetHandle()}. If
     * there are no records in the state, only {@link CheckpointStateOutputStream#close()} will be
