...
public class FinishingLifecycleTwoInputOperator<IN1, IN2> extends AbstractStreamOperator<String>
        implements TwoInputStreamOperator<IN1, IN2, String>, ProcessingTimeCallback {
    ...
    public void processElement1(StreamRecord<IN1> element) throws Exception {
        ...
        listState.add(
                String.format(
                        "%d > (input 1) > %s",
                        getRuntimeContext().getIndexOfThisSubtask(), element));
    }
