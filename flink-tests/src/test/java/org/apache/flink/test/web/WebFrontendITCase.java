...
public class WebFrontendITCase extends MultipleProgramsTestBase {
	...
	public WebFrontendITCase(ExecutionMode m) {
		super(m);
	}

	@Parameterized.Parameters(name = "Execution mode = {0}")
	public static Collection<ExecutionMode[]> executionModes(){
		Collection<ExecutionMode[]> c = new ArrayList<ExecutionMode[]>(1);
