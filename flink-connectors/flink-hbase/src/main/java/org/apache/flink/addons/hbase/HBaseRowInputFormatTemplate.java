 ...
 */
public abstract class HBaseRowInputFormatTemplate extends AbstractTableInputFormat<Row> implements ResultTypeQueryable<Row> {

	private static final long serialVersionUID = 1L;

	private static final Logger LOG = LoggerFactory.getLogger(HBaseRowInputFormatTemplate.class);
	...
	public HBaseRowInputFormatTemplate(org.apache.hadoop.conf.Configuration conf, String tableName, HBaseTableSchema schema) {
	...
	private void connectToTable() {
		...
		try {
			...
			this.table = (HTable) conn.getTable(TableName.valueOf(tableName));
