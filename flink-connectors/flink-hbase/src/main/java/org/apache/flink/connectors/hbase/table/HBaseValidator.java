...
public class HBaseValidator extends ConnectorDescriptorValidator {
	...
	public static final String CONNECTOR_QUALIFIER_DELIMITER = "connector.qualifier-delimiter";
	...
	public void validate(DescriptorProperties properties) {
		...
		properties.validateString(CONNECTOR_ROW_KEY, true, 1);
		properties.validateString(CONNECTOR_QUALIFIER_DELIMITER, true, 1);
