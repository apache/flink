...
public class HBaseTypeUtils {
	...
	public static Object deserializeToObject(
		byte[] value, int typeIdx, String stringCharset) throws UnsupportedEncodingException {
		switch (typeIdx) {
			case 0: // byte[]
				return value;
			case 1: // String
	...
	public static byte[] serializeFromObject(
		Object value, int typeIdx, String stringCharset) throws UnsupportedEncodingException {
		switch (typeIdx) {
			case 0: // byte[]
				return (byte[]) value;
