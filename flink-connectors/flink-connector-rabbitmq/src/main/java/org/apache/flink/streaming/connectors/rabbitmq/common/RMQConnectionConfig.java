 ...
 * Integer, Integer)} will be used for initialize the RMQ connection or {@link
 * RMQConnectionConfig#RMQConnectionConfig(String, Integer, String, String, String, Integer,
 * Boolean, Boolean, Integer, Integer, Integer, Integer)} will be used for initialize the RMQ
 * connection
 */
