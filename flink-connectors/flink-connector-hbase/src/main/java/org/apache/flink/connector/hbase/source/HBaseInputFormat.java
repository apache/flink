...
public abstract class HBaseInputFormat<T extends Tuple> extends AbstractTableInputFormat<T> {
    ...
    /**
     * Creates a {@link Scan} object and opens the {@link HTable} connection. These are opened here
     * because they are needed in the createInputSplits which is called before the openInputFormat
     * method. So the connection is opened in {@link #configure(Configuration)} and closed in {@link
     * #closeInputFormat()}.
     *
