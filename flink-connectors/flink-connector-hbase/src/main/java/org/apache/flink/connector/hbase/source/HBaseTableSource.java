 ...
 * construction. Use {@link #addColumn(String, String, Class)} to specify the family, qualifier, and
...
public class HBaseTableSource
    ...
    public DataSet<Row> getDataSet(ExecutionEnvironment execEnv) {
        ...
        return execEnv.createInput(
                        new HBaseRowInputFormat(conf, tableName, projectedSchema), getReturnType())
                .name(explainSource());
    }
    ...
    public String explainSource() {
        return "HBaseTableSource[schema="
    ...
    public TableFunction<Row> getLookupFunction(String[] lookupKeys) {
        ...
        return new HBaseLookupFunction(
                this.conf, this.tableName, hbaseSchema.getProjectedHBaseTableSchema(projectFields));
    }

    @Override
    public AsyncTableFunction<Row> getAsyncLookupFunction(String[] lookupKeys) {
        throw new UnsupportedOperationException(
                "HBase table doesn't support async lookup currently.");
    }
