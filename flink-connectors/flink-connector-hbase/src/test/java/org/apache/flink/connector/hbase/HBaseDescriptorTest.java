...
public class HBaseDescriptorTest extends DescriptorTestBase {
    ...
    public void testFormatNeed() {
        String expected =
                "The connector org.apache.flink.table.descriptors.HBase does not require a format description but org.apache.flink.connector.hbase.HBaseDescriptorTest$1 found.";
