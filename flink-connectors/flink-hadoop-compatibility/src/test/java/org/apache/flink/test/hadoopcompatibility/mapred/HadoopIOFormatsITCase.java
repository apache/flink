                                        ...
                                        .mapPartition(
                                                new MapPartitionFunction<
                                                    ...
                                                    public void mapPartition(
                                                            Iterable<Tuple2<LongWritable, Text>>
                                                                    values,
                                                            Collector<Tuple2<LongWritable, Text>>
                                                                    out)
                                                            throws Exception {
                                                        Tuple2<LongWritable, Text> lastElement =
                                                                null;
                                                        while (true) {
                                                            ...
                                                            lastElement = values.iterator().next();
                                                        }
