...
public abstract class KafkaAvroTableSourceFactoryTestBase {
	...
	private void testTableSource(FormatDescriptor format) {
		...
		tableJsonMapping.put("a_street", "street");
		tableJsonMapping.put("street", "street");
		tableJsonMapping.put("b_city", "city");
		tableJsonMapping.put("city", "city");
		tableJsonMapping.put("c_state", "state");
		tableJsonMapping.put("state", "state");
		tableJsonMapping.put("zip", "zip");
		tableJsonMapping.put("num", "num");
		...
		builder.forAvroRecordClass(Address.class)
				.withTableToAvroMapping(tableJsonMapping);
