...
public abstract class KafkaSourceSinkFactoryTestBase extends TestLogger {
	...
	public void testInvalidSinkPartitioner() {
		...
		thrown.expect(ValidationException.class);
		thrown.expect(containsCause(new ValidationException("Could not get class 'abc")));
	...
	private Map<String, String> getFullSourceOptions() {
		...
		tableOptions.put("properties.zookeeper.connect", "dummy");
	...
	protected abstract Class<?> getExpectedScanSourceClass();

	protected abstract Class<?> getExpectedSinkClass();
}
