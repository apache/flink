...
public final class HiveParserConstants {
    ...
    /* Constants for CREATE Table DDL */
    ...
    /* Constants for STORED AS in CREATE TABLE DDL */
    ...
    /* Constants for ROW FORMAT in CREATE TABLE DDL */
