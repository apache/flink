...
public class HiveReflectionUtils {
    ...
    public static ObjectInspector createConstantObjectInspector(String className, Class<?> valueClz, Object value) {
        try {
            Constructor<?> method =
                    Class.forName(className).getDeclaredConstructor(valueClz);
