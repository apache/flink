...
public class HiveInspectors {
	...
	private static ConstantObjectInspector getPrimitiveJavaConstantObjectInspector(HiveShim hiveShim,
		...
		switch (typeInfo.getPrimitiveCategory()) {
			...
			case DATE:
				return HiveRelectionUtils.createJavaConstantDateObjectInspector(hiveShim, value);
			case TIMESTAMP:
				return HiveRelectionUtils.createJavaConstantTimestampObjectInspector(hiveShim, value);
			case DECIMAL:
