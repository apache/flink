...
public class HiveMetastoreClientWrapper implements AutoCloseable {
	...
	public void createTableWithConstraints(Table table, Configuration conf, UniqueConstraint pk, List<Byte> pkTraits,
			List<String> notNullCols, List<Byte> nnTraits) {
		hiveShim.createTableWithConstraints(client, table, conf, pk, pkTraits, notNullCols, nnTraits);
	}
