...
public class HiveSourceBuilder {
     ...
     * @param hiveVersion the version of hive in use, if it's null the version will be detected
     *     automatically
     * @param dbName the name of the database the table belongs to
     * @param tableName the name of the table
     * @param tableOptions additional options needed to read the table
     */
    public HiveSourceBuilder(
        ...
        try (HiveMetastoreClientWrapper client =
                new HiveMetastoreClientWrapper(hiveConf, hiveVersion)) {
            Table hiveTable = client.getTable(dbName, tableName);
            this.fullSchema =
                    HiveTableUtil.createTableSchema(
                            hiveConf, hiveTable, client, HiveShimLoader.loadHiveShim(hiveVersion));
