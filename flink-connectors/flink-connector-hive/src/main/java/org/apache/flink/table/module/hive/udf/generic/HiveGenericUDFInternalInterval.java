 ...
 * token number while initializing. But the token number is different from the tokens maintained in
 * our ported {@link HiveASTParser}, and thus bring unexpected exception.
 */
