...
public class StreamingModeFileSinkITCase extends AbstractFileSinkITCase {
	...
	protected JobGraph createJobGraph(String path) {
		...
		env.addSource(new StreamingModeTestSource(latchId, NUM_RECORDS, triggerFailover))
	...
	private static class StreamingModeTestSource extends RichParallelSourceFunction<Integer>
		...
		public StreamingModeTestSource(String latchId, int numberOfRecords, boolean isFailoverScenario) {
