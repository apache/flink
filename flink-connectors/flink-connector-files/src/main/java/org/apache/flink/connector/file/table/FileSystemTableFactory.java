...
public class FileSystemTableFactory implements DynamicTableSourceFactory, DynamicTableSinkFactory {
    ...
    public Set<ConfigOption<?>> optionalOptions() {
        ...
        options.add(FileSystemConnectorOptions.SOURCE_NESTED_PROJECTION_PUSHDOWN_SUPPORTED_FORMATS);
        options.add(FileSystemConnectorOptions.SOURCE_NESTED_PROJECTION_PUSHDOWN_ENABLED);
