...
public class Elasticsearch6LookupTableITCase extends Elasticsearch6DynamicTableTestBase {

	private final String stringType;
	private final boolean useCache;

	public Elasticsearch6LookupTableITCase(String stringType, boolean useCache) {
	...
	private List<String> runLookup(StreamExecutionEnvironment env, StreamTableEnvironment tEnv, String index, String type) {
		...
		tEnv.executeSql("CREATE TABLE lookup (" +
			...
			String.format("'%s'='%s',\n", ElasticsearchOptions.DOCUMENT_TYPE_OPTION.key(), type) +
