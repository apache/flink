...
public class FlinkKafkaProducer10StateSerializerTest
	...
	protected TypeSerializer<
		TwoPhaseCommitSinkFunction.State<
			FlinkKafkaProducer10.KafkaTransactionState,
			FlinkKafkaProducer10.KafkaTransactionContext>> createSerializer() {
	...
	protected Class<TwoPhaseCommitSinkFunction.State<
			FlinkKafkaProducer10.KafkaTransactionState,
			FlinkKafkaProducer10.KafkaTransactionContext>> getTypeClass() {
	...
	protected TwoPhaseCommitSinkFunction.State<
		...
		return new TwoPhaseCommitSinkFunction.State[] {
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
					new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 0),
					Collections.emptyList(),
					Optional.empty()),
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
				new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 2711),
				Collections.singletonList(new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 42)),
				Optional.empty()),
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
				new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 0),
				Collections.emptyList(),
				Optional.of(new FlinkKafkaProducer10.KafkaTransactionContext(Collections.emptySet()))),
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
				new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 0),
				Collections.emptyList(),
				Optional.of(new FlinkKafkaProducer10.KafkaTransactionContext(Collections.singleton("hello")))),
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
				new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 0),
				Collections.singletonList(new TransactionHolder(new FlinkKafkaProducer10.KafkaTransactionState("fake", 1L, (short) 42, null), 0)),
				Optional.of(new FlinkKafkaProducer10.KafkaTransactionContext(Collections.emptySet()))),
			new TwoPhaseCommitSinkFunction.State<
				FlinkKafkaProducer10.KafkaTransactionState,
				FlinkKafkaProducer10.KafkaTransactionContext>(
