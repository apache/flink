...
public class Kafka10ITCase extends KafkaConsumerTestBase {
	...
	/**
	 * Kafka 10 specific test, ensuring Timestamps are properly written to and read from Kafka.
	 */
	@Test(timeout = 60000)
	public void testTimestamps() throws Exception {
		...
		FlinkKafkaProducer10<Long> prod = new FlinkKafkaProducer10<>(topic, new KeyedSerializationSchemaWrapper<>(longSer), standardProps, Optional.of(new FlinkKafkaPartitioner<Long>() {
		...
		FlinkKafkaConsumer10<Long> kafkaSource = new FlinkKafkaConsumer10<>(topic, new Kafka10ITCase.LimitedLongDeserializer(), standardProps);
