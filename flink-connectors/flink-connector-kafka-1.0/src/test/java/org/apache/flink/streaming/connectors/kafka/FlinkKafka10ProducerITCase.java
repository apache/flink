...
public class FlinkKafka10ProducerITCase extends KafkaTestBase {
	...
	public void testHappyPath() throws IOException {
		...
		try (Producer<String, String> kafkaProducer = new FlinkKafka10Producer<>(extraProperties)) {
	...
	public void testResumeTransaction() throws IOException {
		...
		try (FlinkKafka10Producer<String, String> kafkaProducer = new FlinkKafka10Producer<>(extraProperties)) {
			kafkaProducer.initTransactions();
			kafkaProducer.beginTransaction();
			kafkaProducer.send(new ProducerRecord<>(topicName, "42", "42"));
			kafkaProducer.flush();
			...
			try (FlinkKafka10Producer<String, String> resumeProducer = new FlinkKafka10Producer<>(extraProperties)) {
