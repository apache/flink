...
public class KafkaTestEnvironmentImpl extends KafkaTestEnvironment {
	...
	private FlinkKafkaProducer10.Semantic producerSemantic = FlinkKafkaProducer10.Semantic.EXACTLY_ONCE;
	// 6 seconds is default. Seems to be too small for travis. 30 seconds
	private int zkTimeout = 30000;
	private Config config;

	public void setProducerSemantic(FlinkKafkaProducer10.Semantic producerSemantic) {
	...
	public void prepare(Config config) {
		...
		standardProps.setProperty("auto.offset.reset", "earliest"); // read from the beginning. (earliest is kafka 1.0 value)
