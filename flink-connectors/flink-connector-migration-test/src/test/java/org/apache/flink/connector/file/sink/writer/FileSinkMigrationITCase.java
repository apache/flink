...
public class FileSinkMigrationITCase extends TestLogger {
	...
	public void testMigration() throws Exception {
		...
		FileSinkIntegerTestDataUtils.checkIntegerSequenceSinkOutput(outputPath, NUM_RECORDS, NUM_BUCKETS, NUM_SOURCES);
	}
	...
	private JobGraph createStreamingFileSinkJobGraph(String outputPath) {
		...
		StreamingFileSink<Integer> sink = StreamingFileSink
				.forRowFormat(new Path(outputPath), new FileSinkIntegerTestDataUtils.IntEncoder())
