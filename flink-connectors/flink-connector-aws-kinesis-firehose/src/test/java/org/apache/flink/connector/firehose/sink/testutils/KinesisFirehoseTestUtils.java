...
public class KinesisFirehoseTestUtils {
    ...
    public static FirehoseAsyncClient getFirehoseClient(
            String endpoint, SdkAsyncHttpClient asyncHttpClient) throws URISyntaxException {
    ...
    public static List<String> getSampleDataGenerated(int endValue) throws JsonProcessingException {
