...
public class AWSUtil {
    ...
    /**
     * Creates an AmazonDynamoDB client.
     *
     * @param configProps configuration properties containing the access key, secret key, and region
     * @return a new AmazonDynamoDB client
     */
    public static AmazonDynamoDB createAmazonDynamoDBClient(Properties configProps) {
        return createAmazonDynamoDBClient(
                configProps, new ClientConfigurationFactory().getConfig());
    }
     ...
     */
    static AWSConfigConstants.CredentialProvider getCredentialProviderType(
