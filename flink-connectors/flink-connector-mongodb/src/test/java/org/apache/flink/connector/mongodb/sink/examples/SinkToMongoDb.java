...
public class SinkToMongoDb {
    ...
    public static void main(String[] args) throws Exception {
        ...
        sinkProperties.put(MongoConfigConstants.CONNECTION_STRING, "mongodb://host:1234/db");

        MongoDbSink<String> mongoDbSink =
                MongoDbSink.<String>builder()
                        .setDocumentGenerator(element -> ImmutableMap.of("k1", "v1"))
                        .setFilterGenerator(element -> ImmutableMap.of("k2", "v2"))
                        .setDatabaseName("your-database-name")
                        .setCollectionName("your-collection-name")
                        .setMaxBatchSize(20)
                        .setMongoClientProperties(sinkProperties)
                        .build();
