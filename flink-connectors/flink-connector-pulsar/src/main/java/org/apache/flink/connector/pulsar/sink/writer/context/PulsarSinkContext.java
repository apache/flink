...
/** Context providing information of the pulsar record target location. */
@PublicEvolving
public interface PulsarSinkContext {

    /**
     * Get the number of the subtask the PulsarSink is running on. The numbering starts from 0 and
     ...
     * we wouldn't serialize the record into bytes, we send and serialize it in client.
     */
