...
/**
 * An unmodifiable {@link Configuration} for Pulsar. We provide extra method for building the
...
public abstract class PulsarConfiguration extends UnmodifiableConfiguration {
    ...
    /** Get the option value by prefix. We would return a empty map if the option doesn't exist. */
    ...
    /** Get the option value from given config, convert it into the real value instance. */
