...
public class PulsarPartitionSplitState extends PulsarPartitionSplit {

    public PulsarPartitionSplitState(PulsarPartitionSplit split) {
        super(split.getPartition(), split.getStartCursor(), split.getStopCursor());
    }
    ...
    public PulsarPartitionSplit toPulsarPartitionSplit() {
        return new PulsarPartitionSplit(
                getPartition(), getStartCursor(), getStopCursor(), getLatestConsumedId());
    }
}
