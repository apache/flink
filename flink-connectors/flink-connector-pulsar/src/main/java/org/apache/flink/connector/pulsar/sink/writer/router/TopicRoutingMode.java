...
public enum TopicRoutingMode implements DescribedEnum {
    ...
    /**
     * The producer will publish messages across all partitions in round-robin fashion to achieve
    ...
    ROUND_ROBIN(
            "round-robin",
            text(
                    "The producer will publish messages across all partitions in round-robin fashion to achieve maximum throughput."
