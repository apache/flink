...
abstract class PulsarPartitionSplitReaderTestBase extends PulsarTestSuiteBase {
    ...
    protected SourceConfiguration sourceConfig(Configuration readerConfig) {
    ...
    private PulsarPartitionSplitReaderBase<String> splitReader(SubscriptionType subscriptionType) {
        Configuration readerConfig = readerConfig();
        SourceConfiguration sourceConfig = sourceConfig(readerConfig);
