...
public class NoOpScalingStrategyTest {
    ...
    void testScaleUpNoOp() {
        ...
        Integer currentRate = 10;

        assertThat(scalingStrategy.scaleUp(currentRate)).isEqualTo(currentRate);
    }
    ...
    void testScaleDownNoOp() {
        ...
        assertThat(scalingStrategy.scaleDown(currentRate)).isEqualTo(currentRate);
    }
}
