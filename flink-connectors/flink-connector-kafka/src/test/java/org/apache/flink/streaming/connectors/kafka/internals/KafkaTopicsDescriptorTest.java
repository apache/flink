...
public class KafkaTopicsDescriptorTest {
    ...
    /** Parameterized tests for {@link KafkaTopicsDescriptor}. * */
    @RunWith(Parameterized.class)
    public static class KafkaTopicsDescriptorParametrizedTest {
        ...
        public KafkaTopicsDescriptorParametrizedTest(
    ...
    /** Non parametrized tests for {@link KafkaTopicsDescriptor}. */
    public static class KafkaTopicsDescriptorNonParameterizedTest {
        @Test(expected = IllegalArgumentException.class)
        public void testNullTopicThrowsException() {
            new KafkaTopicsDescriptor(Lists.newArrayList((String) null), null);
        }

        @Test(expected = IllegalArgumentException.class)
        public void testEmptyTopicThrowsException() {
            new KafkaTopicsDescriptor(Lists.newArrayList(""), null);
        }

        @Test(expected = IllegalArgumentException.class)
        public void testBlankTopicThrowsException() {
            new KafkaTopicsDescriptor(Lists.newArrayList("   "), null);
        }
    }
}
