        ...
        try {
            ...
            String initialValues =
                    String.format(
                            "INSERT INTO kafka\n"
                                    + "VALUES\n"
                                    + " ('data 1', 1, TIMESTAMP '2020-03-08 13:12:11.123', MAP['k1', X'C0FFEE', 'k2', X'BABE'], '%s', TRUE),\n"
                                    + " ('data 2', 2, TIMESTAMP '2020-03-09 13:12:11.123', CAST(NULL AS MAP<STRING, BYTES>), '%s', FALSE),\n"
                                    + " ('data 3', 3, TIMESTAMP '2020-03-10 13:12:11.123', MAP['k1', X'10', 'k2', X'20'], '%s', TRUE)",
                            topic, topic, topic);
            try {
                tEnv.executeSql(initialValues).await();
                fail(
        ...
        try {
            ...
            String initialValues =
                    "INSERT INTO kafka_sink\n"
                            + "VALUES\n"
                            + " ('data 1', 1, TIMESTAMP '2020-03-08 13:12:11.123', MAP['k1', X'C0FFEE', 'k2', X'BABE'], CAST(NULL AS VARCHAR), TRUE),\n"
                            + " ('data 2', 2, TIMESTAMP '2020-03-09 13:12:11.123', CAST(NULL AS MAP<STRING, BYTES>), CAST(NULL AS VARCHAR), FALSE),\n"
                            + " ('data 3', 3, TIMESTAMP '2020-03-10 13:12:11.123', MAP['k1', X'10', 'k2', X'20'], CAST(NULL AS VARCHAR), TRUE)";
            try {
                tEnv.executeSql(initialValues).await();
                fail(
                ...
                assertTrue(
                        e.getCause().getCause().getCause().getCause().getCause()
