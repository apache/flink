...
public class KafkaITCase extends KafkaConsumerTestBase {
	...
	public void testHeaders() throws Exception {
		...
		FlinkKafkaConsumer<TestHeadersElement> kafkaSource = new FlinkKafkaConsumer<>(topic, new TestHeadersKafkaDeserializationSchema(testSequenceLength), standardProps);
