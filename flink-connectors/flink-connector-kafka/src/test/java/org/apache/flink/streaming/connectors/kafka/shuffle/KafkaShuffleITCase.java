    ...
    private void testRecordSerDe(TimeCharacteristic timeCharacteristic) throws Exception {
        ...
        switch (timeCharacteristic) {
            case ProcessingTime:
                ...
                // watermark
                assertThat(numElementsPerProducer + 1).isEqualTo(records.size());
                break;
            case IngestionTime:
            ...
            case EventTime:
                ...
                // end-of-event-time watermark
                assertThat(numElementsPerProducer * 2 + 1).isEqualTo(records.size());
                break;
            default:
        ...
        for (ConsumerRecord<byte[], byte[]> consumerRecord : records) {
            ...
            if (element.isRecord()) {
                ...
                switch (timeCharacteristic) {
                    case ProcessingTime:
                        assertThat(0).isEqualTo(watermark.getSubtask());
                        // the last element is the watermark that signifies end-of-event-time
