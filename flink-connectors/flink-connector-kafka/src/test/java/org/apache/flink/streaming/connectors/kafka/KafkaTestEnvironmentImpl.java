...
public class KafkaTestEnvironmentImpl extends KafkaTestEnvironment {
	...
	@Override
	public <T> KafkaSourceBuilder<T> getSourceBuilder(List<String> topics, KafkaDeserializationSchema<T> readSchema, Properties props) {
		return KafkaSource
				.<T>builder()
				.setTopics(topics).setDeserializer(KafkaRecordDeserializer.of(readSchema))
				.setProperties(props);
	}
