...
public class FlinkKafkaProducer<IN>
	...
	private static class PartitionInfoProvider implements KafkaSerializationSchema.PartitionInfo, Serializable {
		...
		private final Function<String, int[]> fetchPartitionsFunction = this::fetchPartitions;
		/**
		...
		public int[] partitionsFor(String topicName) {
			return topicPartitionsMap.computeIfAbsent(topicName, fetchPartitionsFunction);
		}
