...
/** Tests for {@link AWSKinesisStreamsUtil}. */
public class AWSKinesisStreamsUtilTest {
    ...
    public void testCreateKinesisAsyncClient() {
        ...
        AWSKinesisStreamsUtil.createKinesisAsyncClient(
    ...
    public void testClientOverrideConfigurationWithDefaults() {
        ...
        AWSKinesisStreamsUtil.createClientOverrideConfiguration(clientConfiguration, builder);
    ...
    public void testIsRecoverableExceptionForRecoverable() {
        ...
        assertTrue(
                AWSKinesisStreamsUtil.isRecoverableException(new ExecutionException(recoverable)));
    }
    ...
    public void testIsRecoverableExceptionForNonRecoverable() {
        ...
        assertFalse(
                AWSKinesisStreamsUtil.isRecoverableException(
    ...
    public void testIsRecoverableExceptionForRuntimeExceptionWrappingRecoverable() {
        ...
        assertTrue(AWSKinesisStreamsUtil.isRecoverableException(runtime));
    }
    ...
    public void testIsRecoverableExceptionForRuntimeExceptionWrappingNonRecoverable() {
        ...
        assertFalse(AWSKinesisStreamsUtil.isRecoverableException(runtime));
    }

    @Test
    public void testIsRecoverableExceptionForNullCause() {
        Exception nonRecoverable = new IllegalArgumentException("abc");
        assertFalse(AWSKinesisStreamsUtil.isRecoverableException(nonRecoverable));
    }
