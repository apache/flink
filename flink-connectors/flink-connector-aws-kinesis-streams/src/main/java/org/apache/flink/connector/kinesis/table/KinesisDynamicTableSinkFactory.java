...
import static org.apache.flink.connector.kinesis.table.KinesisStreamsConnectorOptionsUtils.KINESIS_CLIENT_PROPERTIES_KEY;
...
public class KinesisDynamicTableSinkFactory extends AsyncDynamicTableSinkFactory {
    ...
    public DynamicTableSink createDynamicTableSink(Context context) {
        ...
        builder.setStream((String) properties.get(STREAM.key()))
                ...
                .setPartitioner(
                        (KinesisStreamsSinkElementConverter.PartitionKeyGenerator<RowData>)
