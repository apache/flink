...
import org.apache.flink.connector.kinesis.sink.KinesisStreamsSinkElementConverter.PartitionKeyGenerator;
...
public class KinesisDynamicSink extends AsyncDynamicTableSink<PutRecordsRequestEntry>
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        ...
        ElementConverter<RowData, PutRecordsRequestEntry> elementConverter =
                KinesisStreamsSinkElementConverter.<RowData>builder()
