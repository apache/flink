...
import org.apache.flink.streaming.connectors.elasticsearch7.Elasticsearch7UpsertTableSink.DefaultRestClientFactory;
...
public class Elasticsearch7UpsertTableSinkFactoryTest extends ElasticsearchUpsertTableSinkFactoryTestBase {
	...
	public void testBuilder() {
		...
		expectedBuilder.setRestClientFactory(new DefaultRestClientFactory("/myapp"));
