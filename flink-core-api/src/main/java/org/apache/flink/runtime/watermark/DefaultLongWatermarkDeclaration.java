 ...
 */
@Internal
public class DefaultLongWatermarkDeclaration implements LongWatermarkDeclaration {
    private final WatermarkSpecs.NumericWatermarkComparison comparison;
    private final String identifier;

    public DefaultLongWatermarkDeclaration(
            WatermarkSpecs.NumericWatermarkComparison comparison, String identifier) {
        this.comparison = comparison;
        this.identifier = identifier;
    }

    @Override
    public WatermarkSpecs.NumericWatermarkComparison getComparisonSemantics() {
        return comparison;
    }
