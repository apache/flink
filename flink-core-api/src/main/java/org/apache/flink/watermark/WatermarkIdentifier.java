...
//
// @Internal
// public class WatermarkIdentifier {
//    public static String generateIdentifier(WatermarkDeclaration declaration) {
//        if (declaration instanceof LongWatermarkDeclaration) {
//            LongWatermarkDeclaration longWatermarkDeclaration = (LongWatermarkDeclaration)
// declaration;
