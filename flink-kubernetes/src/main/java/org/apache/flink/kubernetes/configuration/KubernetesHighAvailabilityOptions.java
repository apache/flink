...
public class KubernetesHighAvailabilityOptions {
	...
	public static final ConfigOption<Duration> KUBERNETES_LEASE_DURATION =
			...
			.withDescription("Define the lease duration for the Kubernetes leader election. The leader will " +
	...
	public static final ConfigOption<Duration> KUBERNETES_RENEW_DEADLINE =
			...
			.durationType()
			.defaultValue(Duration.ofSeconds(15))
			.withDescription("Defines the deadline duration when the leader tries to renew the lease. The leader will " +
	...
	public static final ConfigOption<Duration> KUBERNETES_RETRY_PERIOD =
			...
			.withDescription("Defines the pause duration between consecutive retries. All the contenders, including " +
