...
import org.apache.flink.kubernetes.kubeclient.decorators.FlinkTaskManagerEnvVarDecorator;
import org.apache.flink.kubernetes.kubeclient.decorators.FlinkTaskManagerResourceMountDecorator;
...
public class KubernetesTaskManagerFactory {
	...
	public static KubernetesPod buildTaskManagerKubernetesPod(KubernetesTaskManagerParameters kubernetesTaskManagerParameters) {
		...
		final KubernetesStepDecorator[] stepDecorators = new KubernetesStepDecorator[] {
			...
			new FlinkTaskManagerResourceMountDecorator(kubernetesTaskManagerParameters),
			new FlinkTaskManagerEnvVarDecorator(kubernetesTaskManagerParameters)};
