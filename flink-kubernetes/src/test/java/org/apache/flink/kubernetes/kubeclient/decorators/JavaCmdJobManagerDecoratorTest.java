...
import static org.apache.flink.runtime.jobmanager.JobManagerProcessUtils.*;
...
public class JavaCmdJobManagerDecoratorTest extends KubernetesJobManagerTestBase {
    ...
    private static final String logback =
            String.format(
                    "-Dlogback.configurationFile=file:%s/%s",
    ...
    private static final String log4j =
            String.format(
                    ...
                    FLINK_CONF_DIR_IN_POD,
                    CONFIG_FILE_LOG4J_NAME);
    private static final String jmLogfile =
            String.format("-Dlog.file=%s/jobmanager.log", FLINK_LOG_DIR_IN_POD);
    ...
    protected void onSetup() throws Exception {
        ...
        this.javaCmdJobManagerDecorator =
    ...
    public void testStartCommandWithoutLog4jAndLogback() {
        ...
        assertEquals(
                Collections.singletonList(KUBERNETES_ENTRY_PATH), resultMainContainer.getCommand());

        final String expectedCommand = getJobManagerExpectedCommand("", "");
        final List<String> expectedArgs =
                KubernetesUtils.getStartCommandWithBashWrapper(expectedCommand);
    ...
    public void testStartCommandWithLog4jAndLogback() throws IOException {
        ...
        final String expectedCommand = getJobManagerExpectedCommand("", logback + " " + log4j);
        final List<String> expectedArgs =
                KubernetesUtils.getStartCommandWithBashWrapper(expectedCommand);
        assertEquals(expectedArgs, resultMainContainer.getArgs());
    }
    ...
    public void testContainerStartCommandTemplate1() throws IOException {
        ...
        this.flinkConfig.set(
                KubernetesConfigOptions.CONTAINER_START_COMMAND_TEMPLATE,
