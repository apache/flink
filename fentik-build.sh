...
cp ./flink-connectors/flink-sql-connector-kafka/target/flink-sql-connector-kafka-1.16.0.jar $LIB_DIR
cp ./flink-table/flink-table-runtime/target/flink-table-runtime-1.16.0.jar  $LIB_DIR
cp ./flink-metrics/flink-metrics-prometheus/target/flink-metrics-prometheus-1.16.0.jar $LIB_DIR

# Move flink-connector-hive jar, since it conflicts with flink-connector-files.
mv $LIB_DIR/flink-connector-hive-1.16.0.jar $OPT_DIR
...
cp ./flink-filesystems/flink-s3-fs-presto/target/flink-s3-fs-presto-1.16.0.jar $FLINK_DIR/plugins/s3-fs-presto/
