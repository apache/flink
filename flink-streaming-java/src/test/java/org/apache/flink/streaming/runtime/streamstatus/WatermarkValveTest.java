...
/**
 * Tests for {@link WatermarkValve}. While tests in {@link
 ...
 * WatermarkValve} and that valves are correctly used in the tasks' input processors, the unit tests
 * here additionally makes sure that the watermarks and stream statuses to forward are generated
 * from the valve at the exact correct times and in a deterministic behaviour. The unit tests here
 * also test more complex stream status / watermark input cases.
 *
 ...
 * logic of {@link WatermarkValve}. The behaviours that a series of input calls to the valve is
 * trying to test is explained as inline comments within the tests.
 */
public class WatermarkValveTest {
    ...
    public void testSingleInputIncreasingWatermarks() throws Exception {
        ...
        WatermarkValve valve = new WatermarkValve(1);
    ...
    public void testMultipleInputYieldsWatermarkOnlyWhenAllChannelsReceivesWatermarks()
            throws Exception {
        StatusWatermarkOutput valveOutput = new StatusWatermarkOutput();
        WatermarkValve valve = new WatermarkValve(3);
    ...
    public void testMultipleInputWatermarkStatusToggling() throws Exception {
        StatusWatermarkOutput valveOutput = new StatusWatermarkOutput();
        WatermarkValve valve = new WatermarkValve(2);
