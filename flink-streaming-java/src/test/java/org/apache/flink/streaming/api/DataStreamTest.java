...
public class DataStreamTest extends TestLogger {
        ...
        DataStream<Long> windowed =
                map.windowAll(GlobalWindows.create())
                        ...
                        .fold(
                                ...
                                new FoldFunction<Long, Long>() {
                                    @Override
                                    public Long fold(Long accumulator, Long value)
                                            throws Exception {
                                        return null;
                                    }
                                });
                ...
                window.windowAll(GlobalWindows.create())
                        ...
                        .fold(
                                ...
                                new FoldFunction<String, CustomPOJO>() {
                                    ...
                                    @Override
                                    public CustomPOJO fold(CustomPOJO accumulator, String value)
                                            throws Exception {
                                        return null;
                                    }
                                });
    ...
    public void operatorTest() {
        ...
        List<OutputSelector<?>> outputSelectors =
                getStreamGraph(env).getStreamNode(unionFilter.getId()).getOutputSelectors();
        ...
        StreamEdge splitEdge =
                getStreamGraph(env)
                        .getStreamEdges(unionFilter.getId(), sink.getTransformation().getId())
                        .get(0);
        ...
        StreamEdge newSplitEdge =
                getStreamGraph(env)
                        .getStreamEdges(
                                unionFilter.getId(), sinkWithIdentifier.getTransformation().getId())
                        .get(0);
