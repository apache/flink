...
public class InternalWindowFunctionTest {
	...
	public static class ProcessWindowFunctionMock
		...
		@Override
		public void clear(ProcessWindowFunction<Long, String, Long, TimeWindow>.Context context) throws Exception {

		}

		public class Context extends RichProcessWindowFunction.Context {
	...
	public static class AggregateProcessWindowFunctionMock
		...
		@Override
		public void clear(ProcessWindowFunction<Map<Long, Long>, String, Long, TimeWindow>.Context context) throws Exception {

		}


		public class Context extends ProcessWindowFunction.Context {
