...
public class StreamTaskTestHarness<OUT> {
	...
	public void setupOutputForSingletonOperatorChain() {
		...
		outEdgesInOrder.add(new StreamEdge(sourceVertexDummy, targetVertexDummy, StreamEdge.InputOrder.FIRST, new LinkedList<String>(), new BroadcastPartitioner<Object>(), null /* output tag */));
