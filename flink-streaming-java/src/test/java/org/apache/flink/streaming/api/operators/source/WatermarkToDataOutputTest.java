...
class WatermarkToDataOutputTest {
    ...
    void testInitialZeroWatermark() {
        ...
        wmOutput.emitWatermark(new TimestampWatermark(0L));
    ...
    void testWatermarksDoNotRegress() {
        ...
        wmOutput.emitWatermark(new TimestampWatermark(12L));
        wmOutput.emitWatermark(new TimestampWatermark(17L));
        wmOutput.emitWatermark(new TimestampWatermark(10L));
        wmOutput.emitWatermark(new TimestampWatermark(18L));
        wmOutput.emitWatermark(new TimestampWatermark(17L));
        wmOutput.emitWatermark(new TimestampWatermark(18L));
    ...
    void becomingActiveEmitsStatus() {
        ...
        wmOutput.markIdle();
        wmOutput.emitWatermark(new TimestampWatermark(100L));
