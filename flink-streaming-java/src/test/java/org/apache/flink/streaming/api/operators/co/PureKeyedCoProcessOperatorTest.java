...
/**
 * Tests {@link PureKeyedCoProcessOperator}.
 */
public class PureKeyedCoProcessOperatorTest extends KeyedCoProcessOperatorTest {

	@Test
	public void testGetCurrentKeyFromContext() throws Exception {
		PureKeyedCoProcessOperator<String, Integer, String, String> operator =
			new PureKeyedCoProcessOperator<>(new RepeatKeyProcessFunction());
	...
	public void testGetCurrentKeyFromTimers() throws Exception {
		PureKeyedCoProcessOperator<String, Integer, String, String> operator =
			new PureKeyedCoProcessOperator<>(new EventTimeTriggeringProcessFunction());
	...
	private static class RepeatKeyProcessFunction extends CoKeyedProcessFunction<String, Integer, String, String> {

		@Override
		public void processElement1(Integer value, CoKeyedProcessFunction.Context ctx, Collector<String> out) throws Exception {
			out.collect(value + "," + ctx.getCurrentKey());
		}

		@Override
		public void processElement2(String value, CoKeyedProcessFunction.Context ctx, Collector<String> out) throws Exception {
			out.collect(value + "," + ctx.getCurrentKey());
		}
	}

	private static class EventTimeTriggeringProcessFunction extends CoKeyedProcessFunction<String, Integer, String, String> {
		...
		public void onTimer(
			long timestamp,
			CoKeyedProcessFunction.OnTimerContext ctx,
