...
public class SinkTransformationTest {
	...
	public void unSupportSetResource() {
		final SinkTransformation<Integer, String, String, String> sinkTransformation = createSinkTransformation();

		sinkTransformation.setResources(
				ResourceSpec.newBuilder(1, 1).build(),
				ResourceSpec.newBuilder(2, 2).build());
	}
	...
	private static SinkTransformation<Integer, String, String, String> createSinkTransformation() {
		return new SinkTransformation<>(
				new TestTransformation<>(
						...
						1),
				TestSink.newBuilder().build(), "sink", 1);
	}
