...
public class TriggerTestHarness<T, W extends Window> {
	...
	public TriggerTestHarness(
		...
		this.internalTimerService = new TestInternalTimerService<>();
	}
	...
	private static class TestTriggerContext<K, W extends Window> implements Trigger.TriggerContext {
		...
		public long getCurrentWatermark() {
			return timerService.currentEventTime();
		}

		@Override
		public void registerProcessingTimeTimer(long time) {
			timerService.registerProcessingTimeTimer(key, window, time);
		}

		@Override
		public void registerEventTimeTimer(long time) {
			timerService.registerEventTimeTimer(key, window, time);
		}

		@Override
		public void deleteProcessingTimeTimer(long time) {
			timerService.deleteProcessingTimeTimer(key, window, time);
		}

		@Override
		public void deleteEventTimeTimer(long time) {
			timerService.deleteEventTimeTimer(key, window, time);
		}
