...
/**
 * Tests for {@link TypedProcessingTimeTrigger}.
 */
public class TypedProcessingTimeTriggerTest {
	...
	public void testWindowSeparationAndFiring() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
				new TriggerTestHarness<>(TypedProcessingTimeTrigger.create(), new TimeWindow.Serializer());
	...
	public void testMergingWindows() throws Exception {
		...
		assertTrue(TypedProcessingTimeTrigger.create().canMerge());
