        ...
        StreamTaskStateInitializer streamTaskStateManager =
                new StreamTaskStateInitializerImpl(environment, stateBackend) {
                    ...
                    protected <K> InternalTimeServiceManager<K> internalTimeServiceManager(
                        ...
                        // We do not initialize a timer service manager here, because it would
                        // already consume the raw keyed
                        // state as part of initialization. For the purpose of this test, we want an
                        // unconsumed raw keyed
                        // stream.
                        return null;
                    }
                };
