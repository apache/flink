        ...
        doAnswer(
                        new Answer<Object>() {
                            ...
                            public Object answer(InvocationOnMock invocationOnMock)
                                ...
                                FoldingStateDescriptor<String, String>
                                        windowFoldingStateDescriptor =
                                                new FoldingStateDescriptor<String, String>(
                                                        "windowFolding",
                                                        "",
                                                        (a, b) -> a,
                                                        String.class);
                                FoldingStateDescriptor<String, String>
                                        globalFoldingStateDescriptor =
                                                new FoldingStateDescriptor<String, String>(
                                                        "globalFolding",
                                                        "",
                                                        (a, b) -> a,
                                ...
                                assertEquals(
                                        windowKeyedStateStore
                                                .getFoldingState(windowFoldingStateDescriptor)
                                                .getClass(),
                                        globalKeyedStateStore
                                                .getFoldingState(globalFoldingStateDescriptor)
                                                .getClass());
