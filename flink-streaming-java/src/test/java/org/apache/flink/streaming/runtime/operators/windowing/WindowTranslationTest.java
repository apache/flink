...
public class WindowTranslationTest {
    ...
    /**
     * .fold() does not support RichFoldFunction, since the fold function is used internally in a
     * {@code FoldingState}.
     */
    @Test(expected = UnsupportedOperationException.class)
    public void testFoldWithRichFolderFails() throws Exception {
        ...
        source.keyBy(0)
                ...
                .fold(
                        new Tuple2<>("", 0),
                        new RichFoldFunction<Tuple2<String, Integer>, Tuple2<String, Integer>>() {
    ...
    public void testFoldWithWindowFunctionEventTime() throws Exception {
        ...
        DataStream<Tuple2<String, Integer>> window =
                source.keyBy(new TupleKeySelector())
                        .window(TumblingEventTimeWindows.of(Time.of(1, TimeUnit.SECONDS)))
                        .fold(
                                new Tuple3<>("", "", 0),
    ...
    private static class DummyFolder
        ...
        public Tuple3<String, String, Integer> fold(
                Tuple3<String, String, Integer> accumulator, Tuple2<String, Integer> value)
                throws Exception {
            return accumulator;
        }
    }
