    ...
    void testCleanupTimerWithEmptyStateNoResultForTumblingWindows() throws Exception {
        ...
        assertThat(
                        operator.processContext
                                ...
                                .toString())
                .isEqualTo("[(test_key,1)]");
        testHarness.processWatermark(WatermarkUtils.createWatermarkEventFromTimestamp(1699));
        assertThat(
                        operator.processContext
                                .windowState()
                                .getListState(windowStateDesc)
                                ...
                                .toString())
                .isEqualTo("[(test_key,1)]");
        testHarness.processWatermark(WatermarkUtils.createWatermarkEventFromTimestamp(1799));
        assertThat(
                        operator.processContext
                                .windowState()
                                .getListState(windowStateDesc)
        ...
        expected.add(WatermarkUtils.createWatermarkEventFromTimestamp(1599));
        expected.add(WatermarkUtils.createWatermarkEventFromTimestamp(1699));
        expected.add(WatermarkUtils.createWatermarkEventFromTimestamp(1799));
        expected.add(
                WatermarkUtils.createWatermarkEventFromTimestamp(1999)); // here it fires and purges
        expected.add(
                WatermarkUtils.createWatermarkEventFromTimestamp(
