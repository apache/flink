...
public class AlternatingControllerTest {
    ...
    public void testAlignedTimeoutableCheckpoint() throws Exception {
        ...
        Buffer neverTimeoutableCheckpoint =
                barrier(1, CHECKPOINT, checkpointCreationTime, Long.MAX_VALUE);
    ...
    private void sendBuffer(int bufferSize, CheckpointedInputGate gate, int channelId)
            throws Exception {
        TestInputChannel channel = (TestInputChannel) gate.getChannel(channelId);
    ...
    private Buffer barrier(
            long barrierId,
            CheckpointType checkpointType,
            long barrierTimestamp,
