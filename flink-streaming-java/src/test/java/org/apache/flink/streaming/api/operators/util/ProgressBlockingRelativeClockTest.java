...
class ProgressBlockingRelativeClockTest {
    private static final long TIME_STEP = 14;

    @Test
    void simpleTest() {
        ManualClock baseClock = new ManualClock();
        ProgressBlockingRelativeClock relativeClock = new ProgressBlockingRelativeClock(baseClock);
    ...
    @Test
    void blockedTest() throws Exception {
        ManualClock baseClock = new ManualClock();
        ProgressBlockingRelativeClock relativeClock = new ProgressBlockingRelativeClock(baseClock);
