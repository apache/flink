...
public class TwoInputStreamTaskTest {
	...
	public void testWatermarkMetrics() throws Exception {
		final TwoInputStreamTask<String, Integer, String> task = new TwoInputStreamTask<>();
		final TwoInputStreamTaskTestHarness<String, Integer, String> testHarness = new TwoInputStreamTaskTestHarness<>(task, BasicTypeInfo.STRING_TYPE_INFO, BasicTypeInfo.INT_TYPE_INFO, BasicTypeInfo.STRING_TYPE_INFO);
		...
		InterceptingOperatorMetricGroup headOperatorMetricGroup = new InterceptingOperatorMetricGroup(headOperatorId, "testOperator");
		InterceptingOperatorMetricGroup chainedOperatorMetricGroup = new InterceptingOperatorMetricGroup(chainedOperatorId, "testOperator");
		...
		StreamMockEnvironment env = new StreamMockEnvironment(
			testHarness.jobConfig, testHarness.taskConfig, testHarness.executionConfig, testHarness.memorySize, new MockInputSplitProvider(), testHarness.bufferSize) {
			@Override
