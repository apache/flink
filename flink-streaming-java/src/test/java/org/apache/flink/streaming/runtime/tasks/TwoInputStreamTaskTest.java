...
public class TwoInputStreamTaskTest {
	...
	public void testWatermarkMetrics() throws Exception {
		...
		NumberGauge headInput1WatermarkGauge = (NumberGauge) headOperatorMetricGroup.get(MetricNames.IO_CURRENT_INPUT_1_WATERMARK);
		NumberGauge headInput2WatermarkGauge = (NumberGauge) headOperatorMetricGroup.get(MetricNames.IO_CURRENT_INPUT_2_WATERMARK);
		...
		Assert.assertEquals(Long.MIN_VALUE, headInput1WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(Long.MIN_VALUE, headInput2WatermarkGauge.getNumberValue().longValue());
		...
		testHarness.waitForInputProcessing();
		Assert.assertEquals(Long.MIN_VALUE, headInputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(1L, headInput1WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(Long.MIN_VALUE, headInput2WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(Long.MIN_VALUE, headOutputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(Long.MIN_VALUE, chainedInputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(Long.MIN_VALUE, chainedOutputWatermarkGauge.getNumberValue().longValue());
		...
		Assert.assertEquals(1L, headInput1WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(2L, headInput2WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(1L, headOutputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(1L, chainedInputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(2L, chainedOutputWatermarkGauge.getNumberValue().longValue());

		testHarness.processElement(new Watermark(3L), 0, 0);
		testHarness.waitForInputProcessing();
		Assert.assertEquals(2L, headInputWatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(3L, headInput1WatermarkGauge.getNumberValue().longValue());
		Assert.assertEquals(2L, headInput2WatermarkGauge.getNumberValue().longValue());
