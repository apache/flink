...
public class DynamicEventTimeSessionWindowsTest extends TestLogger {
	...
	public void testInvalidParameters() {
		...
		try {
			SessionWindowTimeGapExtractor extractor = mock(SessionWindowTimeGapExtractor.class);
			when(extractor.extract(any(), anyLong(), any())).thenReturn(0L);
	...
	public void testProperties() {
		...
		assertThat(assigner.getDefaultTrigger(mock(StreamExecutionEnvironment.class)), instanceOf(TypedEventTimeTrigger.class));
	}
}
