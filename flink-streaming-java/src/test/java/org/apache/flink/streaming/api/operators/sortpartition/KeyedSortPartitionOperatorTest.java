...
class KeyedSortPartitionOperatorTest {
    ...
    void before() throws Exception {
        ...
        config.setStateKeySerializer(Types.STRING.createSerializer((SerializerConfig) null));
        config.serializeAllConfigs();
    }

    @Test
    void testSetup() {
        // 1.Test KeyedSortPartitionOperator sorting record by position field.
        ...
        // 2.Test KeyedSortPartitionOperator sorting record by string field.
        ...
        // 3.Test KeyedSortPartitionOperator sorting record by key selector.
    ...
    void testProcessElement() throws Exception {
        ...
        operator1.setProcessingTimeService(new TestProcessingTimeService());
        operator1.initializeState(
                new StreamTaskStateInitializerImpl(environment, new HashMapStateBackend()));
        operator1.setCurrentKey("key");
        ...
        operator2.setProcessingTimeService(new TestProcessingTimeService());
        operator2.initializeState(
                new StreamTaskStateInitializerImpl(environment, new HashMapStateBackend()));
        operator2.setCurrentKey("key");
        ...
        operator3.setProcessingTimeService(new TestProcessingTimeService());
        operator3.initializeState(
                new StreamTaskStateInitializerImpl(environment, new HashMapStateBackend()));
        operator3.setCurrentKey("key");
