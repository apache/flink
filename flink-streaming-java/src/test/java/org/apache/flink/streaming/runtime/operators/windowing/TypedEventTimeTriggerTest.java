...
/**
 * Tests for {@link TypedEventTimeTrigger}.
 */
public class TypedEventTimeTriggerTest {
	...
	public void testWindowSeparationAndFiring() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
				new TriggerTestHarness<>(TypedEventTimeTrigger.create(), new TimeWindow.Serializer());
	...
	public void testMergingWindows() throws Exception {
		...
		assertTrue(TypedEventTimeTrigger.create().canMerge());
