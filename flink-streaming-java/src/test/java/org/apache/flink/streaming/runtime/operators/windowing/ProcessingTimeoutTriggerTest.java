...
public class ProcessingTimeoutTriggerTest {
	...
	public void testWindowFireWithoutResetTimer() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
			new TriggerTestHarness<>(ProcessingTimeoutTrigger.of(CountTrigger.of(3), 50, false, true), new TimeWindow.Serializer());
		...
		assertEquals(TriggerResult.FIRE, testHarness.advanceProcessingTime(Long.MIN_VALUE + 50, new TimeWindow(0, 2)));
	...
	public void testWindowFireWithResetTimer() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
			new TriggerTestHarness<>(ProcessingTimeoutTrigger.of(CountTrigger.of(3), 50, true, true), new TimeWindow.Serializer());
		...
		assertEquals(TriggerResult.FIRE, testHarness.advanceProcessingTime(60, new TimeWindow(0, 2)));
		// After firing states should be clear.
		assertEquals(0, testHarness.numStateEntries());
		assertEquals(0, testHarness.numProcessingTimeTimers());
		assertEquals(0, testHarness.numEventTimeTimers());
		...
		// Check inner trigger is working as well
		assertEquals(TriggerResult.CONTINUE, testHarness.processElement(new StreamRecord<Object>(1, 0), new TimeWindow(0, 2)));
		assertEquals(TriggerResult.CONTINUE, testHarness.processElement(new StreamRecord<Object>(1, 10), new TimeWindow(0, 2)));
		assertEquals(TriggerResult.FIRE, testHarness.processElement(new StreamRecord<Object>(1, 20), new TimeWindow(0, 2)));
	}

	@Test
	public void testWindowFireWithClearAtTimeout() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
			new TriggerTestHarness<>(ProcessingTimeoutTrigger.of(CountTrigger.of(3), 50, false, false), new TimeWindow.Serializer());
	...
	public void testWindowPurgingWhenInnerTriggerIsPurging() throws Exception {
		TriggerTestHarness<Object, TimeWindow> testHarness =
			new TriggerTestHarness<>(ProcessingTimeoutTrigger.of(
				PurgingTrigger.of(ProcessingTimeTrigger.create()), 50, false, false), new TimeWindow.Serializer());
		...
		assertEquals(TriggerResult.FIRE_AND_PURGE, testHarness.advanceProcessingTime(Long.MIN_VALUE + 50, new TimeWindow(0, 2)));
