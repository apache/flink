...
public class StreamTestSingleInputGate<T> extends TestSingleInputGate {
    ...
    private void setupInputChannels() {
        ...
        for (int i = 0; i < numInputChannels; i++) {
            ...
            final RecordSerializer<SerializationDelegate<Object>> recordSerializer =
                    new SpanningRecordSerializer<SerializationDelegate<Object>>();
            ...
            final BufferAndAvailabilityProvider answer =
                    () -> {
                        ...
                        if (input != null && input.isStreamEnd()) {
                            ...
                            return Optional.of(
                                    new BufferAndAvailability(
                                            bufferConsumer.build(), moreAvailable, 0));
                            ...
                            return Optional.of(
                                    new BufferAndAvailability(
                                            EventSerializer.toBuffer(event), moreAvailable, 0));
                        } else {
