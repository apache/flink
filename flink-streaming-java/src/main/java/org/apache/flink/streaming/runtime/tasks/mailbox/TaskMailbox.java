...
public interface TaskMailbox {
     ...
     * and future put operations will throw {@link IllegalStateException}.
     */
    void quiesce();

    /**
     * Close the mailbox. In this state, all pending and future put operations and all pending and
     * future take operations will throw {@link IllegalStateException}. Returns all mails that were
     * still enqueued.
     *
