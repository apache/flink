 ...
 * org.apache.flink.streaming.api.functions.sink.filesystem.StreamingFileSink}. The {@code
 * dateTimePath} is determined based on the current system time and the user provided format string.
 *
