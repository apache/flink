...
import org.apache.flink.streaming.api.checkpoint.CheckpointedFunctionUtils;
...
public abstract class AbstractUdfStreamOperator<OUT, F extends Function>
	...
	public void snapshotState(StateSnapshotContext context) throws Exception {
		...
		CheckpointedFunctionUtils.snapshotFunctionState(context, getOperatorStateBackend(), userFunction);
	}

	@Override
	public void initializeState(StateInitializationContext context) throws Exception {
		super.initializeState(context);
		CheckpointedFunctionUtils.restoreFunctionState(context, userFunction);
	}
