...
public class BucketState {
	...
	/**
	 * A {@link ResumableWriter.ResumeRecoverable} for the currently open part file, or null
	 * if there is no currently open part file.
	 */
	private final ResumableWriter.ResumeRecoverable inProgress;

	/**
	 * The {@link ResumableWriter.CommitRecoverable files} pending to be committed, organized by checkpoint id.
	 */
