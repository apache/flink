 ...
 * WatermarkStatus#IDLE} and {@link WatermarkStatus#ACTIVE}. Stream Status elements are generated at
 * the sources, and may be propagated through the tasks of the topology. They directly infer the
 ...
 *       received Stream Status element from the input stream is {@link WatermarkStatus#ACTIVE}, the
 *       task is active.
 * </ul>
 *
 ...
 * implemented as a {@link WatermarkValve} which downstream tasks should use for such purposes):
 *
 * <ul>
 ...
 * instead of {@link WatermarkStatus#IDLE}. Stream Status elements only serve as markers for
 * temporary status.
 */
@Internal
