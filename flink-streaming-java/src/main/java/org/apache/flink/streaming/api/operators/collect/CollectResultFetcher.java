...
public class CollectResultFetcher<T> {
    ...
    public CollectResultFetcher(
        ...
        this(operatorIdFuture, serializer, accumulatorName, DEFAULT_RETRY_MILLIS);
    }
    ...
    private CollectCoordinationResponse<T> sendRequest(String version, long offset)
     ...
     * CollectSinkFunction}. See Java doc of {@link CollectSinkFunction} for explanation of this
    ...
    private class ResultBuffer {
        ...
        // for detailed explanation of the following 3 variables, see Java doc of
        // CollectSinkFunction
        ...
        private void dealWithResponse(CollectCoordinationResponse<T> response, long responseOffset)
            ...
            // we first check version in the response to decide whether we should throw away dirty
            // results
