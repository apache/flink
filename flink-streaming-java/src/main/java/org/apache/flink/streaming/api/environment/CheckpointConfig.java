...
public class CheckpointConfig implements java.io.Serializable {
     ...
     *     CheckpointingOptions.CHECKPOINTING_MODE} instead.
     */
    public static final CheckpointingMode DEFAULT_MODE =
            CheckpointingOptions.CHECKPOINTING_MODE.defaultValue();

    /**
     * The default timeout of a checkpoint attempt: 10 minutes.
     *
     * @deprecated This field is no longer used. Please use {@link
     *     CheckpointingOptions.CHECKPOINTING_TIMEOUT} instead.
     */
    @Deprecated
    public static final long DEFAULT_TIMEOUT =
            CheckpointingOptions.CHECKPOINTING_TIMEOUT.defaultValue().toMillis();

    /**
     * The default minimum pause to be made between checkpoints: none.
     *
     * @deprecated This field is no longer used. Please use {@link
     *     CheckpointingOptions.MIN_PAUSE_BETWEEN_CHECKPOINTS} instead.
     */
    @Deprecated
    public static final long DEFAULT_MIN_PAUSE_BETWEEN_CHECKPOINTS =
            CheckpointingOptions.MIN_PAUSE_BETWEEN_CHECKPOINTS.defaultValue().toMillis();

    /**
     * The default limit of concurrently happening checkpoints: one.
     *
     * @deprecated This field is no longer used. Please use {@link
     *     CheckpointingOptions.MAX_CONCURRENT_CHECKPOINTS} instead.
     */
    @Deprecated
     ...
     *
     * @deprecated This field is no longer used. Please use {@link
     *     CheckpointingOptions.CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA} instead.
     */
    @Deprecated
    public static final int DEFAULT_CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA =
            CheckpointingOptions.CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA.defaultValue().intValue();
    ...
    public CheckpointingMode getCheckpointingMode() {
        return configuration.get(CheckpointingOptions.CHECKPOINTING_MODE);
    }
    ...
    public void setCheckpointingMode(CheckpointingMode checkpointingMode) {
        configuration.set(CheckpointingOptions.CHECKPOINTING_MODE, checkpointingMode);
    }
    ...
    public boolean isForceCheckpointing() {
        return configuration.get(CheckpointingOptions.FORCE_CHECKPOINTING);
    }
    ...
    public void setForceCheckpointing(boolean forceCheckpointing) {
        configuration.set(CheckpointingOptions.FORCE_CHECKPOINTING, forceCheckpointing);
    }
    ...
    public void setExternalizedCheckpointCleanup(ExternalizedCheckpointCleanup cleanupMode) {
        configuration.set(CheckpointingOptions.EXTERNALIZED_CHECKPOINT, cleanupMode);
    }
     ...
     * CheckpointingOptions#CHECKPOINTING_MODE} is {@link CheckpointingMode#EXACTLY_ONCE}.
     *
     ...
     *     or {@link CheckpointingOptions#ALIGNMENT_TIMEOUT}.
    ...
    public boolean isApproximateLocalRecoveryEnabled() {
        return configuration.get(CheckpointingOptions.APPROXIMATE_LOCAL_RECOVERY);
    }
    ...
    public void enableApproximateLocalRecovery(boolean enabled) {
        configuration.set(CheckpointingOptions.APPROXIMATE_LOCAL_RECOVERY, enabled);
    }
    ...
    public ExternalizedCheckpointCleanup getExternalizedCheckpointCleanup() {
        return configuration.get(CheckpointingOptions.EXTERNALIZED_CHECKPOINT);
    }
    ...
    public void setCheckpointIdOfIgnoredInFlightData(long checkpointIdOfIgnoredInFlightData) {
        configuration.set(
                CheckpointingOptions.CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA,
    ...
    public long getCheckpointIdOfIgnoredInFlightData() {
        return configuration.get(CheckpointingOptions.CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA);
    }

    /**
     * Sets all relevant options contained in the {@link ReadableConfig} such as e.g. {@link
     * CheckpointingOptions#CHECKPOINTING_MODE}.
     *
    ...
    public void configure(ReadableConfig configuration) {
        configuration
                .getOptional(CheckpointingOptions.CHECKPOINTING_MODE)
        ...
        configuration
                .getOptional(CheckpointingOptions.EXTERNALIZED_CHECKPOINT)
                .ifPresent(this::setExternalizedCheckpointCleanup);
        configuration
                .getOptional(CheckpointingOptions.ENABLE_UNALIGNED)
                .ifPresent(this::enableUnalignedCheckpoints);
        configuration
                .getOptional(CheckpointingOptions.CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA)
