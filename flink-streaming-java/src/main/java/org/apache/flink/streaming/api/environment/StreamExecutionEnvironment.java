...
public abstract class StreamExecutionEnvironment {
  ...
  public JobExecutionResult execute() throws Exception {
    return execute(DEFAULT_JOB_NAME, false).getJobExecutionResult();
  }
   ...
   * @throws Exception which occurs during job execution.
   */
  public abstract JobSubmissionResult execute(String jobName, boolean detached) throws Exception;
