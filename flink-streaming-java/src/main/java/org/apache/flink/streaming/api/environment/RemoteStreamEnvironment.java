...
public class RemoteStreamEnvironment extends StreamExecutionEnvironment {
   ...
   * @param jarFiles The JAR files with code that needs to be shipped to the cluster. If the program uses user-defined functions, user-defined input
   * formats, or any libraries, those must be provided in the JAR files.
   */
   ...
   * @param host The host name or address of the master (JobManager), where the program should be executed.
   * @param port The port of the master (JobManager), where the program should be executed.
   * @param clientConfiguration The configuration used to parametrize the client that connects to the remote cluster.
   * @param jarFiles The JAR files with code that needs to be shipped to the cluster. If the program uses user-defined functions, user-defined input
   * formats, or any libraries, those must be provided in the JAR files.
   */
   ...
   * @param jarFiles The JAR files with code that needs to be shipped to the cluster. If the program uses user-defined functions, user-defined input
   * formats, or any libraries, those must be provided in the JAR files.
   * @param globalClasspaths The paths of directories and JAR files that are added to each user code classloader on all nodes in the cluster. Note
   * that the paths must specify a protocol (e.g. file://) and be accessible on all nodes (e.g. by means of a NFS share). The protocol must be
