...
public class StreamGraphUserHashHasher implements StreamGraphHasher {
	...
	public Map<Integer, byte[]> traverseStreamGraphAndGenerateHashes(StreamGraph streamGraph) {
		...
		for (StreamNode streamNode : streamGraph.getStreamNodes()) {
			...
			} else if (streamGraph.getExecutionConfig().hasAutoGeneratedUIDsDisabled()) {
				throw new IllegalStateException("Auto generated UID's have been disabled " +
					"but no UID has been assigned to node " + streamNode.getOperatorName());
			}
		}
