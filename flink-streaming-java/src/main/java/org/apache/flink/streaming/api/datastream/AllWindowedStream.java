...
public class AllWindowedStream<T, W extends Window> {
     ...
     * @param resultType Type information for the result type of the window function
     * @return The data stream that is the result of applying the window function to the window.
     * @deprecated use {@link #aggregate(AggregateFunction, AllWindowFunction, TypeInformation,
     ...
     * @param resultType Type information for the result type of the window function
     * @return The data stream that is the result of applying the window function to the window.
     * @deprecated use {@link #aggregate(AggregateFunction, ProcessAllWindowFunction,
        ...
        if (evictor != null) {
            ...
            operator =
                    new EvictingWindowOperator<>(
                            ...
                            stateDesc,
                            new InternalIterableProcessAllWindowFunction<>(
                                    new FoldApplyProcessAllWindowFunction<>(
                                            initialValue,
                                            foldFunction,
                                            function,
                                            foldAccumulatorType)),
    ...
    @Deprecated
    public <R> SingleOutputStreamOperator<R> apply(
            R initialValue, FoldFunction<T, R> foldFunction, AllWindowFunction<R, R, W> function) {
     ...
     * @param resultType Type information for the result type of the window function
     * @return The data stream that is the result of applying the window function to the window.
     * @deprecated Use {@link #fold(Object, FoldFunction, AllWindowFunction, TypeInformation,
     *     TypeInformation)} instead.
     */
    @Deprecated
    public <R> SingleOutputStreamOperator<R> apply(
