...
public class IterativeStream<T> extends SingleOutputStreamOperator<T> {
     ...
     * DataStream#split(org.apache.flink.streaming.api.collector.selector.OutputSelector)} for more
     * information.
     *
    ...
    public static class ConnectedIterativeStreams<I, F> extends ConnectedStreams<I, F> {
        ...
        @Override
        public ConnectedStreams<I, F> keyBy(
                KeySelector<I, ?> keySelector1, KeySelector<F, ?> keySelector2) {
            throw groupingException;
        }
