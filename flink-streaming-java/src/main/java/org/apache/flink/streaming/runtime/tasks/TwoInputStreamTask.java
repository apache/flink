...
public class TwoInputStreamTask<IN1, IN2, OUT> extends StreamTask<OUT, TwoInputStreamOperator<IN1, IN2, OUT>> {
	...
	public void init() throws Exception {
		...
		headOperator.getMetricGroup().register(MetricNames.IO_CURRENT_INPUT_WATERMARK, minInputWatermarkGauge);
		headOperator.getMetricGroup().register(MetricNames.IO_CURRENT_INPUT_1_WATERMARK, input1WatermarkGauge);
		headOperator.getMetricGroup().register(MetricNames.IO_CURRENT_INPUT_2_WATERMARK, input2WatermarkGauge);
	}
