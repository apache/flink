...
public interface MailboxReceiver {
	...
	/**
	 * Returns the oldest letter from the mailbox (head of queue) if the mailbox is not empty or
	 * <code>null</code> otherwise.
	 *
	 * @return the oldest letter from the mailbox (head of queue) if the mailbox is not empty or
	 * <code>null</code> otherwise.
	 */
	@Nullable
