...
public class ProgressiveTimestampsAndWatermarks<T> implements TimestampsAndWatermarks<T> {
    ...
    private static final class SplitLocalOutputs<T> {
        ...
        private final Map<String, ProgressBlockingRelativeClock> inputActivityClocks =
                new HashMap<>();
        ...
        SourceOutput<T> createOutputForSplit(String splitId) {
            ...
            ProgressBlockingRelativeClock inputActivityClock = createInputActivityClock(splitId);
        ...
        private ProgressBlockingRelativeClock createInputActivityClock(String splitId) {
            ProgressBlockingRelativeClock inputActivityClock =
                    new ProgressBlockingRelativeClock(clock);
