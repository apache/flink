 ...
 * different tasks, use the {@link RichParallelSourceFunctionV2} to get access to the runtime
 ...
 */
@Public
public interface ParallelSourceFunctionV2<OUT> extends SourceFunctionV2<OUT> {
}
