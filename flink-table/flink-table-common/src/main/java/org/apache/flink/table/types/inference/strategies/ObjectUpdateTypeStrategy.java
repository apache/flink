 ...
 *   <li>Creating a new structured type with the same class and field structure
 * </ul>
 *
 * <p>The return type is identical to the input structured type, ensuring that field updates
 * preserve the original type structure while allowing individual field values to be modified.
 */
@Internal
