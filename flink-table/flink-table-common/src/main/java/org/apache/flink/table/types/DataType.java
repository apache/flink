...
public abstract class DataType implements AbstractDataType<DataType>, Serializable {
     ...
     * returns a new {@link DataType}, with the conversion class to {@link
     * org.apache.flink.table.data.RowData} and the children data type with the conversion class to
     * {@link org.apache.flink.table.data.TimestampData}.
     *
     * <p>For a comprehensive list of internal data types, check {@link
