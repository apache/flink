...
/**
 * A factory to create configured table format instances based on string-based properties. See also
...
public interface TableFormatFactory<T> extends TableFactory {
     ...
     * format can handle schema information, those properties must be added to the list of supported
     * properties.
     */
     ...
     *
     * <p>Example format properties might be: - format.line-delimiter - format.ignore-parse-errors -
     * format.fields.#.type - format.fields.#.name
     *
     * <p>If schema derivation is enabled, the list must include schema properties: - schema.#.name
     * - schema.#.type
     *
     * <p>Note: All supported format properties must be prefixed with "format.". If schema
     * derivation is enabled, also properties with "schema." prefix can be used.
     *
