...
class TemporalOverlapsInputTypeStrategy implements InputTypeStrategy {
    ...
    public List<Signature> getExpectedSignatures(FunctionDefinition definition) {
        return Collections.singletonList(
                Signature.of(
                        Signature.Argument.ofKind("leftTimePoint", LogicalTypeFamily.DATETIME),
                        Signature.Argument.ofKind("leftTemporal", "TEMPORAL"),
                        Signature.Argument.ofKind("rightTimePoint", LogicalTypeFamily.DATETIME),
                        Signature.Argument.ofKind("rightTemporal", "TEMPORAL")));
    }
}
