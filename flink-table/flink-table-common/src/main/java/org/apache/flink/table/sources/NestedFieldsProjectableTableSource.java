 ...
 * A {@link TableSource} extending this interface is able to project the fields of the returned
 * {@code DataSet} if it is a {@code BatchTableSource} or {@code DataStream} if it is a {@code StreamTableSource}.
 *
...
public interface NestedFieldsProjectableTableSource<T> {
	 ...
	 *
	 * <p>The nestedFields parameter contains all nested fields that are accessed by the query.
	 ...
	 *
	 * <p>The {@link NestedFieldsProjectableTableSource#projectNestedFields} method is called with parameters
