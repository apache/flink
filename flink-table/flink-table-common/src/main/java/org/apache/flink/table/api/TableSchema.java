...
public class TableSchema {
     ...
     *
     * <p>Note: The returned row data type contains both physical and computed columns. Be careful
     * when using this method in a table source or table sink. In many cases, {@link
        ...
        if (!watermarkSpecs.isEmpty()) {
            for (WatermarkSpec watermark : watermarkSpecs) {
                sb.append(" |-- ")
                        ...
                        .append(watermark.getRowtimeAttribute())
                        .append(" AS ")
