...
public class FunctionService {
    ...
    public static UserDefinedFunction createFunction(
            FunctionDescriptor descriptor, ClassLoader classLoader) {
     ...
     */
    public static UserDefinedFunction createFunction(
            FunctionDescriptor descriptor, ClassLoader classLoader, boolean performValidation) {
    ...
    public static UserDefinedFunction createFunction(
        ...
        switch (properties.getString(FunctionDescriptorValidator.FROM)) {
            case FunctionDescriptorValidator.FROM_VALUE_CLASS:
                ...
                instance =
                        generateInstance(
                                HierarchyDescriptorValidator.EMPTY_PREFIX, properties, classLoader);
                break;
     ...
     * @param descriptorProperties the descriptor properties that contains the class type
     *     information
    ...
    private static <T> T generateInstance(
            String keyPrefix, DescriptorProperties descriptorProperties, ClassLoader classLoader) {
        String instanceClassName =
                descriptorProperties.getString(keyPrefix + ClassInstanceValidator.CLASS);
        ...
        try {
            ...
            String msg =
                    String.format(
                            "Could not find class '%s' for creating an instance.",
                            instanceClassName);
            LOG.error(msg, e);
        ...
        List<Map<String, String>> constructorProps =
                descriptorProperties.getVariableIndexedProperties(
                        constructorPrefix, new ArrayList<>());
        ...
        for (int i = 0; i < constructorProps.size(); i++) {
            ...
            if (constructorProps.get(i).containsKey(ClassInstanceValidator.CLASS)) {
                parameterList.add(
                        generateInstance(constructorKey, descriptorProperties, classLoader));
            }
            // literal value
            else {
                Object literalValue =
                        LiteralValueValidator.getValue(constructorKey, descriptorProperties);
        ...
        try {
            ...
            String msg =
                    String.format(
                            ...
                            parameterNames, instanceClassName);
            LOG.error(msg, e);
            throw new ValidationException(msg);
        }
        ...
        try {
            ...
            String msg =
                    String.format(
                            ...
                            instanceClassName, parameterNames);
            LOG.error(msg, e);
            throw new ValidationException(msg);
        }
    }
