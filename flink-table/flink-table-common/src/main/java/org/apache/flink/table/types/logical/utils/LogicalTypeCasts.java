...
public final class LogicalTypeCasts {
    ...
    static {
        ...
        castTo(BOOLEAN).implicitFrom(BOOLEAN).explicitFromFamily(CHARACTER_STRING).build();

        castTo(BINARY).implicitFrom(BINARY).build();

        castTo(VARBINARY).implicitFromFamily(BINARY_STRING).build();

        castTo(DECIMAL).implicitFromFamily(NUMERIC).explicitFromFamily(CHARACTER_STRING).build();

        castTo(TINYINT).implicitFrom(TINYINT).explicitFromFamily(NUMERIC, CHARACTER_STRING).build();
        ...
        castTo(DOUBLE).implicitFromFamily(NUMERIC).explicitFromFamily(CHARACTER_STRING).build();
