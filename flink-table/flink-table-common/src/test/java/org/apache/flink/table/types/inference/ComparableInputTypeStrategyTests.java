		...
		return asList(
			TestSpec
				.forStrategy(
					...
					InputTypeStrategies.comparable(ConstantArgumentCount.of(7), StructuredComparision.EQUALS))
			...
			TestSpec
				.forStrategy(
					...
					InputTypeStrategies.comparable(ConstantArgumentCount.of(4), StructuredComparision.EQUALS))
				.calledWithArgumentTypes(
					DataTypes.TIMESTAMP(),
			...
			TestSpec
				...
				.calledWithArgumentTypes(
					...
					DataTypes.MAP(DataTypes.DECIMAL(10, 3), DataTypes.TIMESTAMP_WITH_TIME_ZONE())
				)
				.expectArgumentTypes(
					DataTypes.MAP(DataTypes.TINYINT(), DataTypes.TIMESTAMP()),
					DataTypes.MAP(DataTypes.DECIMAL(10, 3), DataTypes.TIMESTAMP_WITH_TIME_ZONE())
			...
			TestSpec
				.forStrategy(
					...
					InputTypeStrategies.TWO_FULLY_COMPARABLE)
				.calledWithArgumentTypes(
					structuredType("type", singletonList(DataTypes.INT()), StructuredComparision.FULL).notNull(),
					structuredType("type", singletonList(DataTypes.INT()), StructuredComparision.FULL).nullable()
				)
				.expectArgumentTypes(
					structuredType("type", singletonList(DataTypes.INT()), StructuredComparision.FULL).notNull(),
					structuredType("type", singletonList(DataTypes.INT()), StructuredComparision.FULL).nullable()
