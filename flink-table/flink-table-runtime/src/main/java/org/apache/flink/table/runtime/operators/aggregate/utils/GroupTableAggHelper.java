...
public abstract class GroupTableAggHelper {
    ...
    /**
     * Processes an input element and updates the aggregate state accordingly.
     *
     * @param accumulators The current state of the accumulators. If null, a new set of accumulators
     *     will be created.
     * @param currentKey The current key being processed.
     * @param out The collector used to emit output rows.
     * @param input The input row, which could be an accumulate or retract message.
     * @return The updated accumulators after processing the input row.
