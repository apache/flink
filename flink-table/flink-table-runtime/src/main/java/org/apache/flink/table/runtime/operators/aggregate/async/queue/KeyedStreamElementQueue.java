...
/** Interface for stream element queues for the {@link KeyedAsyncWaitOperator}. */
@Internal
public interface KeyedStreamElementQueue<K, OUT> {
     ...
     */
    Optional<ResultFuture<OUT>> tryPut(K key, StreamElement streamElement);
    ...
    /**
     * Returns the Map of {@link StreamElement} currently contained in this queue for checkpointing,
     * grouped by key.
     *
     * <p>This includes all non-emitted, completed and non-completed elements.
     *
     * @return Map of currently contained {@link StreamElement}.
     */
    Map<K, List<StreamElement>> valuesByKey();
