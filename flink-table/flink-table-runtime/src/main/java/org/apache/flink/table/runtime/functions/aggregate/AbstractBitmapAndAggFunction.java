...
public abstract class AbstractBitmapAndAggFunction<T>
        extends BuiltInAggregateFunction<T, AbstractBitmapAndAggFunction.BitmapAndAccumulator> {
    ...
    public static final class BitmapAndAggFunction extends AbstractBitmapAndAggFunction<Bitmap> {
    ...
    /** Built-in BITMAP_AND_CARDINALITY_AGG aggregate function that returns cardinality. */
