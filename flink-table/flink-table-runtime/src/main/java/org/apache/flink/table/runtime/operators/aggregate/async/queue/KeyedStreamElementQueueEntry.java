...
/**
 * An entry for the {@link KeyedStreamElementQueue}. The stream element queue entry stores the
 ...
 */
@Internal
public interface KeyedStreamElementQueueEntry<K, OUT> extends ResultFuture<OUT> {
