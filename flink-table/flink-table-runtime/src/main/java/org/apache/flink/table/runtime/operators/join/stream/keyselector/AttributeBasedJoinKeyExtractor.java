...
public class AttributeBasedJoinKeyExtractor implements JoinKeyExtractor, Serializable {
    ...
    // Controls whether key rows built are serialized and copied. This is required for the
    // Heap State Backend to prevent object reuse issues, which can lead to data corruption
