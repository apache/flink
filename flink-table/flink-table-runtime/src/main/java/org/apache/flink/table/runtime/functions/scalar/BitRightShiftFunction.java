...
/** Implementation of {@link BuiltInFunctionDefinitions#SHIFTRIGHT}. */
@Internal
public class BitRightShiftFunction extends BuiltInScalarFunction {

    public BitRightShiftFunction(SpecializedFunction.SpecializedContext context) {
