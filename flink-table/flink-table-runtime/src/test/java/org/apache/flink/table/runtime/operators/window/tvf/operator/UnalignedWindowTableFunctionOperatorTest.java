...
public class UnalignedWindowTableFunctionOperatorTest extends WindowTableFunctionOperatorTestBase {
    ...
    public void testEventTimeSessionWindows() throws Exception {
        ...
        testHarness.processWatermark(WatermarkUtils.createWatermarkEventFromTimestamp(9999));
        expectedOutput.add(WatermarkUtils.createWatermarkEventFromTimestamp(9999));
        ...
        testHarness.processWatermark(WatermarkUtils.createWatermarkEventFromTimestamp(10999));
        ...
        expectedOutput.add(WatermarkUtils.createWatermarkEventFromTimestamp(10999));
