...
public class TemporalRowTimeJoinOperatorTest extends TemporalTimeJoinOperatorTestBase {
    ...
    public void testRowTimeTemporalJoin() throws Exception {
        ...
        expectedOutput.add(new WatermarkEvent(new TimestampWatermark(2)));
    ...
    private void testRowTimeTemporalJoin(boolean isLeftOuterJoin, List<Object> expectedOutput)
        ...
        testHarness.processWatermark1(new WatermarkEvent(new TimestampWatermark(8)));
        testHarness.processWatermark2(new WatermarkEvent(new TimestampWatermark(9)));
    ...
    public void testRowTimeTemporalJoinWithStateRetention() throws Exception {
        ...
        testHarness.processWatermark1(new WatermarkEvent(new TimestampWatermark(15)));
        testHarness.processWatermark2(new WatermarkEvent(new TimestampWatermark(16)));
        ...
        expectedOutput.add(new WatermarkEvent(new TimestampWatermark(15)));
