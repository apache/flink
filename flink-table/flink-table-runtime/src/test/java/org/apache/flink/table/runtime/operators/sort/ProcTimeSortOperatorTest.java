...
import org.apache.flink.table.runtime.operators.sort.asyncprocessing.AsyncStateProcTimeSortOperator;
...
class ProcTimeSortOperatorTest {
    ...
    void test() throws Exception {
        OneInputStreamOperator<RowData, RowData> operator = createSortOperator();
    ...
    private OneInputStreamOperator<RowData, RowData> createSortOperator() {
        if (enableAsyncState) {
            return new AsyncStateProcTimeSortOperator(inputRowType, gComparator);
        } else {
