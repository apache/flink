...
final class PtfChangelogModeValidator {
    ...
    private final Set<String> configuredArgumentNames;
    ...
    PtfChangelogModeValidator(
            ...
            Set<String> configuredArgumentNames,
            @Nullable String onTimeColumnName) {
        this.tableArguments = tableArguments;
        this.configuredArgumentNames = configuredArgumentNames;
    ...
    void validateConfiguration() {
        validateConfiguredArgumentsAreKnown();
    ...
    private void validateConfiguredArgumentsAreKnown() {
        Set<String> validTableArgNames = tableArgNames();
        for (String argName : configuredArgumentNames) {
    ...
    private static void validateUpsertStyleInput(
        ...
        // The planner only delivers an upsert stream when the partition columns equal one of the
        // input's candidate keys, and otherwise retracts. Mirror that, comparing as sets.
