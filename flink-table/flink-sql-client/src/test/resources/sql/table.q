...
CREATE TABLE IF NOT EXISTS orders (
 ...
 amount INT,
 ts TIMESTAMP(3),
 `attribute` ROW<coupon_name STRING NOT NULL, amount DOUBLE, support_sellers ARRAY<STRING> NOT NULL>,
 ptime AS PROCTIME(),
...
| CREATE TABLE `default_catalog`.`default_database`.`orders` (
  ...
  `amount` INT,
  `ts` TIMESTAMP(3),
  `attribute` ROW<`coupon_name` VARCHAR(2147483647) NOT NULL, `amount` DOUBLE, `support_sellers` ARRAY<VARCHAR(2147483647)> NOT NULL>,
  `ptime` AS PROCTIME(),
...
| attribute | ROW<`coupon_name` STRING NOT NULL, `amount` DOUBLE, `support_sellers` ARRAY<STRING> NOT NULL> |  TRUE |           |               |                            |
...
fields.amount.max
fields.amount.min
fields.attribute.amount.max
fields.attribute.amount.min
fields.attribute.coupon_name.length
fields.attribute.kind
fields.attribute.support_sellers.element.length
fields.product.kind
...
CREATE TABLE IF NOT EXISTS daily_orders (
 ...
 'path' = '/var/folders/xd/9dp1y4vd3h56kjkvdk426l500000gp/T/junit5781726749537647921/7bf278b4-9932-4e24-af7b-1126df4667405030013249695173150',
 'format' = 'csv'
);
[INFO] Execute statement succeed.
!info
