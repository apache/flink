...
# preparation for testing explain compiled plan
CREATE TABLE MySink (
 a bigint,
 b int,
 c varchar
...
compile plan '/tmp/compiledJson.json' for INSERT INTO MySink SELECT * FROM MyTable;
[INFO] Execute statement succeed.
!info

# test explain compiled plan with details
explain plan for '/tmp/compiledJson.json';
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                                                                                                                                                                                             result |
+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| == Optimized Execution Plan ==
...
explain json_execution_plan '/tmp/compiledJson.json';
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          result |
+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| == Optimized Execution Plan ==
...
== Physical Execution Plan ==
{
  "nodes" : [ {
    "id" : 3,
    "type" : "Source: MyTable[3]",
    "pact" : "Data Source",
    "contents" : "[3]:TableSourceScan(table=[[default_catalog, default_database, MyTable]], fields=[a, b, c])",
    "parallelism" : 1
  }, {
    "id" : 4,
    "type" : "Sink: MySink[4]",
    "pact" : "Data Sink",
    "contents" : "[4]:Sink(table=[default_catalog.default_database.MySink], fields=[a, b, c])",
    "parallelism" : 1,
    "predecessors" : [ {
      "id" : 3,
      "ship_strategy" : "FORWARD",
