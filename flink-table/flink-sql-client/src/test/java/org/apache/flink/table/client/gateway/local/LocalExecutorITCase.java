...
public class LocalExecutorITCase extends TestLogger {
    ...
    public void testListCatalogs() throws Exception {
        ...
        final List<String> expectedCatalogs =
    ...
    public void testTableSchema() throws Exception {
        ...
        final TableSchema expectedTableSchema =
                new TableSchema(
    ...
    public void testUseCatalogAndUseDatabase() throws Exception {
        ...
        try {
            assertEquals(
                    Collections.singletonList("mydatabase"), executor.listDatabases(sessionId));
            ...
            executor.useDatabase(
                    sessionId, DependencyTest.TestHiveCatalogFactory.ADDITIONAL_TEST_DATABASE);
    ...
    public void testCreateFunction() throws Exception {
        ...
        try {
            ...
            assertThat(
                    executor.listFunctions(sessionId),
