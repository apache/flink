...
public class FlinkDDLDataTypeTest {
    ...
    public static List<TestItem> testData() {
        return Arrays.asList(
                ...
                createTestItem("^NULL^", "(?s).*Encountered \"NULL\" at line 2, column 6..*"),
                ...
                createTestItem(
                        ...
                        "ROW< `f0` `MyType`, `f1` `c`.`d`.`t` >"),
                createTestItem(
                        "^INTERVAL^ YEAR", "(?s).*Encountered \"INTERVAL\" at line 2, column 6..*"),
                createTestItem(
                        "RAW(^)^",
    ...
    protected class TesterImpl implements Tester {
        ...
        public void checkType(String sql, RelDataType type) {
            ...
            RelDataType columnType =
                    ((SqlTableColumn) columns.get(0)).getType().deriveType(factory.getValidator());
        ...
        private void checkEx(
                String expectedMsgPattern, SqlParserUtil.StringAndPos sap, Throwable thrown) {
    ...
    private static class TestFactory {
        ...
        public SqlValidator getValidator() {
            ...
            return validatorFactory
                    .create(operatorTable, catalogReader, typeFactory, conformance)
