...
class WindowTableFunctionQueryOperationTest {
    ...
    @Test
    void testPartitionKeysArePreserved() {
        assertThat(
                        new WindowTableFunctionQueryOperation(
                                        WindowKind.SESSION,
                                        "ts",
    ...
    @Test
    void testAsSerializableStringEmitsPartitionBy() {
        String sql =
                new WindowTableFunctionQueryOperation(
                                WindowKind.SESSION,
                                "ts",
                                ...
                                source())
                        .asSerializableString();
        assertThat(sql).contains("SESSION((").contains(") PARTITION BY (`id`)");
    }

    @Test
    void testUnknownPartitionColumnRejected() {
        assertThatThrownBy(
                        () ->
                                new WindowTableFunctionQueryOperation(
                                        WindowKind.SESSION,
