...
public class TableConfig {
    ...
    /**
     * The minimum time until state which was not updated will be retained. State might be cleared
     * and removed if it was not updated for the defined period of time.
     */
    private long minIdleStateRetentionTime = 0L;

    /**
     * The maximum time until state which was not updated will be retained. State will be cleared
     * and removed if it was not updated for the defined period of time.
     */
