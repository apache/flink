...
public abstract class BaseExpressions<InType, OutType> {
    ...
    /**
     * Returns an ARRAY that contains the elements from array1 that are also in array2. If no
     * elements that are both in array1 and array2, the function returns an empty ARRAY.
     *
     * <p>If one or both arguments are NULL, the function returns NULL. The order of the elements
     * from array1 is kept.
     */
