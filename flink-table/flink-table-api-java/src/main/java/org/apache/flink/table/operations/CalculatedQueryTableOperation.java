 ...
 */
@Internal
public class CalculatedQueryTableOperation<T> implements QueryTableOperation {
	...
	public CalculatedQueryTableOperation(
	...
	@Override
	public <U> U accept(QueryTableOperationVisitor<U> visitor) {
