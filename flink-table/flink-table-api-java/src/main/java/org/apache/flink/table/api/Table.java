...
public interface Table {
    ...
    /**
     * Sorts the given {@link Table}. Similar to SQL ORDER BY. The resulting Table is globally
    ...
    /**
     * Limits a sorted result from an offset position. Similar to a SQL OFFSET clause. Offset is
     * technically part of the Order By operator and thus must be preceded by it.
     *
     * <p>{@link Table#offset(int offset)} can be combined with a subsequent {@link Table#fetch(int
     * fetch)} call to return n rows after skipping the first o rows.
     *
     * <pre>{@code
    ...
    /**
     * Limits a sorted result to the first n rows. Similar to a SQL FETCH clause. Fetch is
     * technically part of the Order By operator and thus must be preceded by it.
     *
     * <p>{@link Table#fetch(int fetch)} can be combined with a preceding {@link Table#offset(int
     * offset)} call to return n rows after skipping the first o rows.
     *
     * <pre>{@code
