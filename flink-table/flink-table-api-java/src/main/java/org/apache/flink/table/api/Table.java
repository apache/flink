...
public interface Table {
	 ...
	 * For the path resolution algorithm see {@link TableEnvironment#useDatabase(String, String)}.
	 *
	 ...
	 * @deprecated use {@link #insertInto(QueryConfig, String...)}
	 */
	@Deprecated
	 ...
	 *
	 * @param conf The {@link QueryConfig} to use.
	 * @param tablePath The path of the {@link TableSink} to which the {@link Table} is written.
	 */
	void insertInto(QueryConfig conf, String... tablePath);
