...
public interface TableResult {
     ...
     *       after the job is submitted. Calling CloseableIterator#close method does not bind to the
     *       job. Therefore the `CloseableIterator#close` will not cancel the job as in the case of
     *       SELECT. If you need to cancel the job, you can use the {@link #getJobClient()}.
     ...
     * }</pre>
     *
     * <p>For streaming mode, this method guarantees end-to-end exactly-once record delivery which
