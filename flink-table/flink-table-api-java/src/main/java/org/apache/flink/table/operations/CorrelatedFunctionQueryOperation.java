...
/**
 * Describes a relational operation that was created from applying a correlated (process) table
 * function.
 */
@Internal
public class CorrelatedFunctionQueryOperation implements QueryOperation {
    ...
    public CorrelatedFunctionQueryOperation(
    ...
    public String asSummaryString() {
        ...
        return OperationUtils.formatWithChildren(
                "CorrelatedFunction", args, getChildren(), Operation::asSummaryString);
    }
