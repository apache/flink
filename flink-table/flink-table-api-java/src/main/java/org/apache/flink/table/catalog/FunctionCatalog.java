...
public final class FunctionCatalog {
        ...
        if (catalogOptional.isPresent()) {
            ...
            try {
                ...
                if (catalog.getFunctionDefinitionFactory().isPresent()
                    ...
                    // TODO update the FunctionDefinitionUtil once we drop the old function stack in
                    // DDL
    ...
    private FunctionDefinition getFunctionDefinition(String name, CatalogFunction function) {
        ...
        // catalog use the FunctionDefinitionUtil to instantiate them and wrap them with
        // `AggregateFunctionDefinition`,
        // `TableAggregateFunctionDefinition`. If the new type inference is fully functional, this
        // should be
