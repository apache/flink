...
/**
 * Unified class to search for a {@link ComponentTableFactory} of provided type and properties. It is similar to
 * {@link TableFactoryService} but it disambiguates based on {@link ComponentTableFactory#optionalContext()}.
 */
@Internal
public class ComponentFactoryService {
	 ...
	 * disambiguating multiple matching {@link ComponentTableFactory}s based on additional
	 * optional context provided via {@link ComponentTableFactory#optionalContext()}.
	 *
	 ...
	 */
	public static <T extends ComponentTableFactory> T find(Class<T> factoryClass, Map<String, String> propertyMap) {
