...
class TableImpl(
  ...
  override def insertInto(tablePath: String*): Unit = {
    insertInto(tableEnv.queryConfig, tablePath: _*)
  }
  ...
  override def insertInto(conf: QueryConfig, tablePath: String*): Unit = {
    tableEnv.insertInto(this, conf, tablePath:_*)
  }
