...
abstract class PlannerBase(
  ...
  private val plannerConfiguration: ReadableConfig =
    new PlannerConfig(tableConfig.getConfiguration, executor.getConfiguration)
  ...
  /**
   * @deprecated
   *   Do not use this method anymore. Use [[getConfiguration]] to access options. Create
