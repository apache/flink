...
abstract class TableEnvImpl(
  ...
  protected val defaultCatalogName: String = config.getBultinCatalogName
  protected val defaultDatabaseName: String = config.getBultinDatabaseName
  ...
  override def useDatabase(catalogName: String, databaseName: String): Unit = {
    catalogManager.setCurrentCatalog(catalogName)
