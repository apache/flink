 ...
 * Flink modifications
 *
 * <p>Lines 305 ~ 307 - reverting the change done in CALCITE-6345. In case of fractional
 * precision not specified, Calcite 1.37 uses the max precision. Flink uses the default value.
 */
