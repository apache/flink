 ...
 * Flink modifications
 *
 * <p>Lines 306 ~ 308 - reverting the change done in CALCITE-6345. In case of fractional precision
 * not specified, Calcite 1.37 uses the max precision. Flink uses the default value.
 */
public class SqlIntervalQualifier extends SqlNode {
    ...
    private static int[] fillIntervalValueArray(int sign, BigDecimal year, BigDecimal month) {
        int[] ret = new int[3];
