 ...
 * CALCITE-4554.
 *
 * <p>Lines 223 ~ 226, Flink improves error message for functions without appropriate arguments in
 * handleUnresolvedFunction.
 *
 * <p>Lines 2440 ~ 2454, Flink improves error message for functions without appropriate arguments in
 * handleUnresolvedFunction at {@link SqlValidatorImpl#handleUnresolvedFunction}.
 *
 * <p>Lines 2712 ~ 2723
 *
 * <p>Lines 2997 ~ 3016, FLINK-38493 set the correct scope for LATERAL.
 *
 * <p>Lines 3047 ~ 3065, set the correct scope for VECTOR_SEARCH.
 *
 * <p>Lines 4641 ~ 4645, 7521 ~ 7527 Flink improves Optimize the retrieval of sub-operands in
