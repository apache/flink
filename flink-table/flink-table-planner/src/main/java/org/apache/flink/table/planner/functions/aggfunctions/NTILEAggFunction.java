...
public class NTILEAggFunction extends DeclarativeAggregateFunction
    ...
    public NTILEAggFunction() {
        this.bucketSize = div(windowSize, operand(0));
        this.bucketsWithPadding = mod(windowSize, operand(0));
    }
    ...
    public Expression[] accumulateExpressions() {
        return new Expression[] {
            ...
            /* bucket = */ plus(bucket, bucketOverflow(literal(1L))),
    ...
    private Expression bucketOverflow(Expression e) {
