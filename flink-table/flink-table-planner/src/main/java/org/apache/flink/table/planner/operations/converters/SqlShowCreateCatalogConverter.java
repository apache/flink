...
public class SqlShowCreateCatalogConverter implements SqlNodeConverter<SqlShowCreateCatalog> {

    @Override
    public Operation convertSqlNode(
            SqlShowCreateCatalog sqlShowCreateCatalog, ConvertContext context) {
        return new ShowCreateCatalogOperation(sqlShowCreateCatalog.catalogName());
    }
}
