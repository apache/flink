...
import org.apache.flink.table.planner.functions.sql.ml.evaluate.MLEvaluationAggregationFunction;
...
public class ExpandMLEvaluateTableFunctionRule
    ...
    private static String getTask(RexCall rexCall) {
        ...
        final RexNode taskNode =
                rexCall.getOperands().size() > 4 ? rexCall.getOperands().get(4) : null;
        String task = null;
