...
public class TemporalJoinUtil {
     ...
     */
    public final static SqlFunction TEMPORAL_JOIN_CONDITION =
            new SqlFunction(
     ...
     */
    public final static SqlFunction INITIAL_TEMPORAL_JOIN_CONDITION =
            new SqlFunction(
    ...
    public final static SqlFunction TEMPORAL_JOIN_LEFT_KEY =
            new SqlFunction(
    ...
    public final static SqlFunction TEMPORAL_JOIN_RIGHT_KEY =
            new SqlFunction(
    ...
    public final static SqlFunction TEMPORAL_JOIN_CONDITION_PRIMARY_KEY =
            new SqlFunction(
