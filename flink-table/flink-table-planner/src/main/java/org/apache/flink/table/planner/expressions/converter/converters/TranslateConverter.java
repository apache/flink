...
/** Conversion for {@link BuiltInFunctionDefinitions#TRANSLATE3}. */
@Internal
class TranslateConverter extends CustomizedConverter {
    @Override
    public RexNode convert(CallExpression call, CallExpressionConvertRule.ConvertContext context) {
        ...
        if (children.size() == 2) {
            return context.getRelBuilder()
                    .call(
                            FlinkSqlOperatorTable.TRANSLATE3,
            ...
            return context.getRelBuilder().call(FlinkSqlOperatorTable.TRANSLATE3, childrenRexNode);
        }
    }
}
