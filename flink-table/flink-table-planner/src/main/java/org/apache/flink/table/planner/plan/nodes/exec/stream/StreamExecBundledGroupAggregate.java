...
import org.apache.flink.table.runtime.operators.aggregate.async.BundledAggregateAsyncFunction;
import org.apache.flink.table.runtime.operators.aggregate.async.KeyedAsyncWaitOperatorFactory;
 ...
 */
@ExecNodeMetadata(
        name = "stream-exec-bundled-group-aggregate",
        version = 1,
        consumedOptions = {},
        producedTransformations =
                StreamExecBundledGroupAggregate.BUNDLED_GROUP_AGGREGATE_TRANSFORMATION,
        minPlanVersion = FlinkVersion.v1_19,
        minStateVersion = FlinkVersion.v1_19)
public class StreamExecBundledGroupAggregate extends StreamExecAggregateBase {

    private static final Logger LOG =
            LoggerFactory.getLogger(StreamExecBundledGroupAggregate.class);

    public static final String BUNDLED_GROUP_AGGREGATE_TRANSFORMATION = "bundled-group-aggregate";

    public static final String STATE_NAME = "bundledGroupAggregateState";
    ...
    public StreamExecBundledGroupAggregate(
    ...
    private void setJobMetadata(TableConfig tableConfig, LogicalType[] accTypes) {
        RowType internalAccType = RowType.of(accTypes);
        tableConfig.addJobParameter("internalAccType", internalAccType.asSerializableString());
    }
    ...
    protected Transformation<RowData> translateToPlanInternal(
        ...
        generator.needAccumulate().needBundled();
        ...
        BundledAggregateAsyncFunction asyncFunction =
                new BundledAggregateAsyncFunction(
                        aggsHandler,
                        recordEqualiser,
                        accTypes,
                        inputRowType,
        ...
        final OneInputStreamOperatorFactory<RowData, RowData> operator =
                new KeyedAsyncWaitOperatorFactory<>(
                        asyncFunction,
                        BundledAggUtil.timeout(config),
                        BundledAggUtil.bufferCapacity(config),
        ...
        final OneInputTransformation<RowData, RowData> transform =
                ExecNodeUtil.createOneInputTransformation(
                        inputTransform,
                        createTransformationMeta(BUNDLED_GROUP_AGGREGATE_TRANSFORMATION, config),
                        operator,
