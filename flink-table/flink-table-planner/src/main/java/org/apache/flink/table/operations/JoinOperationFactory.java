...
/**
 * Utility class for creating a valid {@link JoinQueryTableOperation} operation.
 */
@Internal
public class JoinOperationFactory {
	...
	/**
	 * Creates a valid {@link JoinQueryTableOperation} operation.
	 *
	...
	public QueryTableOperation create(
			QueryTableOperation left,
			QueryTableOperation right,
			JoinType joinType,
		...
		return new JoinQueryTableOperation(left, right, joinType, condition, correlated);
	}

	private void validateCondition(QueryTableOperation right, JoinType joinType, Expression condition, boolean correlated) {
		...
		if (correlated && right instanceof CalculatedQueryTableOperation && joinType != JoinType.INNER) {
	...
	private void validateNamesAmbiguity(QueryTableOperation left, QueryTableOperation right) {
