...
import org.apache.flink.table.operations.SetQueryTableOperation.SetQueryTableOperationType;

import java.util.stream.IntStream;

import static java.lang.String.format;
import static org.apache.flink.table.operations.SetQueryTableOperation.SetQueryTableOperationType.UNION;

/**
 * Utility class for creating a valid {@link SetQueryTableOperation}.
 */
@Internal
public class SetOperationFactory {
	...
	public QueryTableOperation create(
		...
		return new SetQueryTableOperation(left, right, type, all);
	}

	private void validateSetOperation(
			SetQueryTableOperationType operationType,
			QueryTableOperation left,
			QueryTableOperation right) {
	...
	private void failIfStreaming(SetQueryTableOperationType type, boolean all) {
