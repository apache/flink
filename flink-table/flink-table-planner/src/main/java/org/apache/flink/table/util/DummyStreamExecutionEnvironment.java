 ...
 * translation, and this could avoid dirty the buffer of the real StreamExecutionEnvironment
 * instance.
 *
 ...
 * StreamExecutionEnvironment. `execute`, `getStreamGraph` methods are also disabled, while
 * `addOperator` method is enabled to allow the planner to add the generated transformations to the
 * dummy StreamExecutionEnvironment.
 *
