...
/** Rule that matches {@link FlinkLogicalDistribution}. */
public class BatchPhysicalDistributionRule extends ConverterRule {

    public static final RelOptRule INSTANCE =
            new BatchPhysicalDistributionRule(
                    Config.INSTANCE
                            .withConversion(
                                    FlinkLogicalDistribution.class,
                                    FlinkConventions.LOGICAL(),
                                    FlinkConventions.BATCH_PHYSICAL(),
                                    "BatchExecDistributionRule")
                            .withRuleFactory(BatchPhysicalDistributionRule::new));

    protected BatchPhysicalDistributionRule(Config config) {
        super(config);
    }

    @Override
    public RelNode convert(RelNode rel) {
        FlinkLogicalDistribution logicalDistribution = (FlinkLogicalDistribution) rel;
        RelTrait distribution =
