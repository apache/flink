...
public class SqlLoadModuleConverter implements SqlNodeConverter<SqlLoadModule> {

    @Override
    public Operation convertSqlNode(SqlLoadModule node, ConvertContext context) {
        String moduleName = node.moduleName();
        Map<String, String> properties = new HashMap<>();
        for (SqlNode sqlNode : node.getPropertyList().getList()) {
