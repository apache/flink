...
@ExecNodeMetadata(
        name = "batch-exec-sort-window-aggregate",
        version = 1,
...
public class BatchExecSortWindowAggregate extends ExecNodeBase<RowData>
    ...
    public static final String FIELD_NAME_INPUT_TIME_IS_DATE = "inputTimeIsDate";
    public static final String FIELD_NAME_ENABLE_ASSIGN_PANE = "enableAssignPane";
