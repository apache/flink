...
public class SqlCompilePlanConverter implements SqlNodeConverter<SqlCompilePlan> {
    @Override
    public Operation convertSqlNode(SqlCompilePlan node, ConvertContext context) {
