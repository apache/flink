...
public class SqlCompileAndExecutePlanConverter
        implements SqlNodeConverter<SqlCompileAndExecutePlan> {
    @Override
    public Operation convertSqlNode(SqlCompileAndExecutePlan node, ConvertContext context) {
