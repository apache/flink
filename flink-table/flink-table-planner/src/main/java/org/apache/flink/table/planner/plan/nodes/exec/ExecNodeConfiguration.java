...
/**
 * Configuration view that combines the {@link PlannerConfiguration} with the {@link
...
public class ExecNodeConfiguration implements ReadableConfig {
    ...
    public <T> T get(ConfigOption<T> option) {
        return persistedConfig.getOptional(option).orElseGet(() -> plannerConfig.get(option));
    }
