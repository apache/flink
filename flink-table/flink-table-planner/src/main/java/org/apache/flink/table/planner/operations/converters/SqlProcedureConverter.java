 ...
 */
public class SqlProcedureConverter implements SqlNodeConverter<SqlNode> {
    ...
    public Operation convertSqlNode(SqlNode sqlNode, ConvertContext context) {
        ...
        for (int i = 0; i < argumentCount; i++) {
            ...
            // convert the literal to Flink internal value
    ...
    private List<RexNode> reduceOperands(SqlCall sqlCall, ConvertContext context) {
        // we don't really care the input row type while converting to RexNode
        // since call procedure shouldn't reference any inputs.
