...
public class TextGenerationEvaluatorAccumulatorTest {
    ...
    void testIdenticalTexts() {
        ...
        assertThat((double) getMapValue(result, "Mean BLEU")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean ROUGE")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean Semantic Similarity"))
    ...
    void testSimilarTexts() {
        ...
        Row result = accumulator.getValue();
        assertThat(result).isNotNull();
        assertThat((double) getMapValue(result, "Mean BLEU")).isGreaterThan(0.5);
        assertThat((double) getMapValue(result, "Mean ROUGE")).isGreaterThan(0.5);
        assertThat((double) getMapValue(result, "Mean Semantic Similarity")).isGreaterThan(0.5);
    }
    ...
    void testDifferentTexts() {
        ...
        Row result = accumulator.getValue();
        assertThat(result).isNotNull();
        assertThat((double) getMapValue(result, "Mean BLEU")).isLessThan(0.3);
        assertThat((double) getMapValue(result, "Mean ROUGE")).isLessThan(0.3);
        assertThat((double) getMapValue(result, "Mean Semantic Similarity")).isLessThan(0.3);
    }
