...
public class ClassificationEvaluatorAccumulatorTest {
    ...
    void testPerfectClassification() {
        ...
        assertThat((double) getMapValue(result, "Accuracy")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Precision")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Recall")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "F1")).isEqualTo(1.0, offset(DELTA));
    }
    ...
    void testTypicalClassification() {
        ...
        Row result = accumulator.getValue();
        assertThat(result).isNotNull();
        assertThat((double) getMapValue(result, "Accuracy")).isEqualTo(0.5, offset(DELTA));
        assertThat((double) getMapValue(result, "Precision")).isEqualTo(0.5, offset(DELTA));
        assertThat((double) getMapValue(result, "Recall")).isEqualTo(0.5, offset(DELTA));
        assertThat((double) getMapValue(result, "F1")).isEqualTo(0.5, offset(DELTA));
    }
    ...
    void testRetraction() {
        ...
        assertThat((double) getMapValue(result, "Precision")).isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Recall")).isEqualTo(0.5, offset(DELTA));
        assertThat((double) getMapValue(result, "F1")).isEqualTo(2.0 / 3.0, offset(DELTA));
