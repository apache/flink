    ...
    public static List<TestSpec> allTypesBasic() {
        return Arrays.asList(
                ...
                CastTestSpecBuilder.testCastTo(STRING())
                        ...
                        .fromCase(BINARY(3), DEFAULT_BINARY, "[0, 1, 0]")
                        .fromCase(VARBINARY(3), DEFAULT_VARBINARY, "[0, 1, 2]")
                        .fromCase(VARBINARY(5), DEFAULT_VARBINARY, "[0, 1, 2]")
                        .fromCase(BYTES(), DEFAULT_BYTES, "[0, 1, 2, 3, 4]")
