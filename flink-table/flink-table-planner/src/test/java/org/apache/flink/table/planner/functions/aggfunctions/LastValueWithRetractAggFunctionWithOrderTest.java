...
final class LastValueWithRetractAggFunctionWithOrderTest {
    ...
    @Nested
    final class RowLastValueWithRetractAggFunctionWithOrderTest
            extends LastValueWithRetractAggFunctionWithOrderTestBase<RowData> {
    ...
    @Nested
    final class NestedRowLastValueWithRetractAggFunctionWithOrderTest
            extends LastValueWithRetractAggFunctionWithOrderTestBase<RowData> {
