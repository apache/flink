...
public class JavaTableEnvironmentITCase extends TableProgramsCollectionTestBase {
    ...
    public void testTableRegister() throws Exception {
        ...
        Table result =
                tableEnv.scan(tableName).select($("f0"), $("f1")).filter($("f0").isGreater(7));
    ...
    public void testAsFromTupleToPojo() throws Exception {
        ...
        Table table =
                tableEnv.fromDataSet(env.fromCollection(data), $("q"), $("w"), $("e"), $("r"))
        ...
        Table table =
                tableEnv.fromDataSet(
                                env.fromCollection(
                                        data,
                                        TypeInformation.of(
                                                new TypeHint<Either<String, Integer>>() {})),
                                $("either"))
                        .select($("either"));
    ...
    public void testAsFromPojoProjected() throws Exception {
        ...
        Table table =
                tableEnv.fromDataSet(env.fromCollection(data), $("name").as("d")).select($("d"));
    ...
    public void testAsWithPojoAndGenericTypes() throws Exception {
        ...
        data.add(
                new PojoWithGeneric(
                        "Peter", 28, new HashMap<String, String>(), new ArrayList<String>()));
    ...
    public void testFromValues() throws Exception {
        ...
        Table table = tableEnv.fromValues(1L, 2L, 3L).select($("*"));
    ...
    public void testAsWithAmbiguousFields() throws Exception {
        assertThrows(
                ...
                () -> {
                    ...
                    tableEnv.fromDataSet(
                            CollectionDataSets.get3TupleDataSet(env), $("a"), $("b"), $("b"));
                });
    }
    ...
    public static class PojoWithGeneric {
        ...
        public PojoWithGeneric(
                String name, int age, HashMap<String, String> generic, ArrayList<String> generic2) {
            this.name = name;
            this.age = age;
