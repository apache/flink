 ...
 * method without order but with ignore null argument.
 */
@RunWith(Enclosed.class)
public class FirstValueWithRetractAggFunctionWithoutOrderWithIgnoreNullTest {
    // --------------------------------------------------------------------------------------------
    ...
    public static final class ByteFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Byte> {
    ...
    public static final class ShortFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Short> {
    ...
    public static final class IntFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Integer> {
    ...
    public static final class LongFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Long> {
    ...
    public static final class FloatFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Float> {
    ...
    public static final class DoubleFirstValueWithRetractAggFunctionWithoutOrderTest
            extends NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Double> {
    ...
    public static final class BooleanFirstValueWithRetractAggFunctionWithoutOrderTest
            extends FirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<Boolean> {
    ...
    public static final class DecimalFirstValueWithRetractAggFunctionWithoutOrderTest
            extends FirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<DecimalData> {
    ...
    public static final class StringFirstValueWithRetractAggFunctionWithoutOrderTest
            extends FirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<StringData> {
    ...
    public abstract static class FirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<T>
            extends FirstLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<
    ...
    class NumberFirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<T>
            extends FirstValueWithRetractAggFunctionWithoutOrderIgnoreNullTestBase<T> {
