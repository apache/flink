...
public class TableSourceScanBatchRestoreTest extends BatchRestoreTestBase {
    ...
    public List<TableTestProgram> programs() {
        return Arrays.asList(
                ...
                // These two tests have .addOption("disable-lookup", "true") in their test program
                // This causes the test values source to be unbounded (and hence not usable in BCP
                // Tests
