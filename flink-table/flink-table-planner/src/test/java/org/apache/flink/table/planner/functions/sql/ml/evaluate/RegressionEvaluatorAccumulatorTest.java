...
public class RegressionEvaluatorAccumulatorTest {
    ...
    void testPerfectPrediction() {
        ...
        assertThat((double) getMapValue(result, "MAE")).isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "MSE")).isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "RMSE")).isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "MAPE")).isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "R2")).isEqualTo(1.0, offset(DELTA));
    }
    ...
    void testTypicalPredictions() {
        ...
        Row result = accumulator.getValue();
        assertThat(result).isNotNull();
        assertThat((double) getMapValue(result, "MAE")).isEqualTo(0.2, offset(DELTA));
        assertThat((double) getMapValue(result, "MSE")).isEqualTo(0.04, offset(DELTA));
        assertThat((double) getMapValue(result, "RMSE")).isEqualTo(0.2, offset(DELTA));
        assertThat((double) getMapValue(result, "R2")).isLessThan(1.0);
    }
