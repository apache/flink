 ...
 * order argument and ignore null.
 */
@RunWith(Enclosed.class)
public class LastValueAggFunctionWithOrderIgnoreNullTest {

    // --------------------------------------------------------------------------------------------
    // Test sets for a particular type being aggregated
    //
    // Actual tests are implemented in:
    //  - FirstLastValueAggFunctionWithOrderIgnoreNullTestBase -> tests specific for FirstValue and
    // LastValue
    //  - AggFunctionTestBase -> tests that apply to all aggregate functions
    // --------------------------------------------------------------------------------------------

    /** Test for {@link TinyIntType}. */
    public static final class ByteLastValueAggFunctionWithOrderIgnoreNullTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Byte> {
    ...
    public static final class ShortLastValueAggFunctionWithOrderIgnoreNullTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Short> {
    ...
    public static final class IntLastValueAggFunctionWithOrderIgnoreNullTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Integer> {
    ...
    public static final class LongLastValueAggFunctionWithOrderIgnoreNullTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Long> {
    ...
    public static final class FloatLastValueAggFunctionWithOrderIgnoreNullTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Float> {
    ...
    public static final class DoubleLastValueAggFunctionWithOrderIgnoreTest
            extends NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<Double> {
    ...
    public static final class BooleanLastValueAggFunctionWithOrderIgnoreNullTest
            extends LastValueAggFunctionWithOrderIgnoreNullTestBase<Boolean> {
    ...
    public static final class DecimalLastValueAggFunctionWithOrderIgnoreNullTest
            extends LastValueAggFunctionWithOrderIgnoreNullTestBase<DecimalData> {
    ...
    public static final class StringLastValueAggFunctionWithOrderIgnoreNullTest
            extends LastValueAggFunctionWithOrderIgnoreNullTestBase<StringData> {
    ...
    public abstract static class LastValueAggFunctionWithOrderIgnoreNullTestBase<T>
            extends FirstLastValueAggFunctionWithOrderIgnoreNullTestBase<T, RowData> {
    ...
    public abstract static class NumberLastValueAggFunctionWithOrderIgnoreNullTestBase<T>
            extends LastValueAggFunctionWithOrderIgnoreNullTestBase<T> {
