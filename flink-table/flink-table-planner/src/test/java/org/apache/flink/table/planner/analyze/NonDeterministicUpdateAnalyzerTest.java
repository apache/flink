...
class NonDeterministicUpdateAnalyzerTest extends TableTestBase {
    ...
    void testOverAggregateWithNonDeterminismInPartitionBy() {
        ...
        assertEquals(expectedOverAggNduErrorMsg2, tableException.getMessage());
    }
