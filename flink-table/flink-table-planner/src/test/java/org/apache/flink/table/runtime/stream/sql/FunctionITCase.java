...
public class FunctionITCase extends AbstractTestBase {
    ...
    public void testCreateTemporarySystemFunction() {
        ...
        String ddl2 =
                "create temporary system function if not exists f5"
    ...
    public void testUserDefinedTemporarySystemFunction() throws Exception {
        TableEnvironment tableEnv = getTableEnvironment();
        String functionDDL =
                "create temporary system function addOne as " + "'" + TEST_FUNCTION + "'";
    ...
    private void testUserDefinedCatalogFunction(TableEnvironment tableEnv, String createFunctionDDL)
            throws Exception {
        List<Row> sourceData =
                Arrays.asList(
                        Row.of(1, "1000", 2),
