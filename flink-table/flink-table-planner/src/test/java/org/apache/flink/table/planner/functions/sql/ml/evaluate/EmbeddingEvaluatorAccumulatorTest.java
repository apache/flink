...
import static org.apache.flink.table.planner.functions.sql.ml.evaluate.MLEvaluationAggregationFunctionTest.getMapValue;
...
public class EmbeddingEvaluatorAccumulatorTest {
    ...
    public void testPerfectMatch() {
        ...
        Row result = accumulator.getValue();

        assertThat((double) getMapValue(result, "Mean Cosine Similarity"))
                .isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean Jaccard Similarity"))
                .isEqualTo(1.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean Euclidean Distance"))
                .isEqualTo(0.0, offset(DELTA));
    }
    ...
    public void testOrthogonalVectors() {
        ...
        assertThat((double) getMapValue(result, "Mean Jaccard Similarity"))
                .isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean Euclidean Distance"))
                .isEqualTo(Math.sqrt(2.0), offset(DELTA));
    }
    ...
    public void testNonNegativeVectors() {
        ...
        assertThat((double) getMapValue(result, "Mean Cosine Similarity")).isPositive();
        assertThat((double) getMapValue(result, "Mean Jaccard Similarity")).isPositive();
        assertThat((double) getMapValue(result, "Mean Euclidean Distance")).isNotNegative();
    }
    ...
    public void testNegativeVectors() {
        ...
        assertThat((double) getMapValue(result, "Mean Jaccard Similarity"))
                .isEqualTo(0.0, offset(DELTA));
        assertThat((double) getMapValue(result, "Mean Euclidean Distance"))
                .isEqualTo(Math.sqrt(8), offset(DELTA));
    }
}
