...
public final class FirstValueAggFunctionWithOrderIgnoreNullTest {
    ...
    public static final class ByteFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Byte> {
        @Override
    ...
    public static final class ShortFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Short> {
    ...
    public static final class IntFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Integer> {
    ...
    public static final class LongFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Long> {
    ...
    public static final class FloatFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Float> {
    ...
    public static final class DoubleFirstValueAggFunctionWithOrderTest
            extends NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<Double> {
    ...
    public static final class BooleanFirstValueAggFunctionWithOrderTest
            extends FirstValueAggFunctionWithOrderIgnoreNullTestBase<Boolean> {
    ...
    public static final class DecimalFirstValueAggFunctionWithOrderIgnoreNullTest
            extends FirstValueAggFunctionWithOrderIgnoreNullTestBase<DecimalData> {
    ...
    public static final class StringFirstValueAggFunctionWithOrderIgnoreNullTest
            extends FirstValueAggFunctionWithOrderIgnoreNullTestBase<StringData> {
        @Override
    ...
    public abstract static class FirstValueAggFunctionWithOrderIgnoreNullTestBase<T>
    ...
    public abstract static class NumberFirstValueAggFunctionWithOrderIgnoreNullTestBase<T>
            extends FirstValueAggFunctionWithOrderIgnoreNullTestBase<T> {
