...
final class LastValueAggFunctionWithoutOrderTest {
    ...
    @Nested
    final class RowLastValueAggFunctionWithoutOrderTest
            extends LastValueAggFunctionWithoutOrderTestBase<RowData> {
    ...
    @Nested
    final class NestedRowLastValueAggFunctionWithoutOrderTest
            extends LastValueAggFunctionWithoutOrderTestBase<RowData> {
