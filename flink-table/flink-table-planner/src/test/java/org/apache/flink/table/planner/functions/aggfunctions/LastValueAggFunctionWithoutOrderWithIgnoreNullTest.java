 ...
 * without order argument but with ignore null argument.
 */
@RunWith(Enclosed.class)
public class LastValueAggFunctionWithoutOrderWithIgnoreNullTest {
    ...
    public static final class ByteLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Byte> {
    ...
    public static final class ShortLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Short> {
    ...
    public static final class IntLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Integer> {
    ...
    public static final class LongLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Long> {
    ...
    public static final class FloatLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Float> {
    ...
    public static final class DoubleLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Double> {
    ...
    public static final class BooleanLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends LastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<Boolean> {
    ...
    public static final class DecimalLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends LastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<DecimalData> {
    ...
    public static final class StringLastValueAggFunctionWithoutOrderWithIgnoreNullTest
            extends LastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<StringData> {
    ...
    public abstract static class LastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<T>
            extends FirstLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<T, RowData> {
    ...
    public abstract static class NumberLastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<T>
            extends LastValueAggFunctionWithoutOrderWithIgnoreNullTestBase<T> {
