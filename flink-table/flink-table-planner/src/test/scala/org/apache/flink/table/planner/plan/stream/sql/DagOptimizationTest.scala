...
class DagOptimizationTest extends TableTestBase {
  ...
  def testSingleSinkSplitOnUnion(): Unit = {
    util.tableEnv.getConfig.getConfiguration
      .setBoolean(RelNodeBlockPlanBuilder.TABLE_OPTIMIZER_UNIONALL_AS_BREAKPOINT_ENABLED, false)
  ...
  def testMultiSinks2(): Unit = {
    val stmtSet = util.tableEnv.createStatementSet()
    util.tableEnv.getConfig.getConfiguration
      .setBoolean(RelNodeBlockPlanBuilder.TABLE_OPTIMIZER_UNIONALL_AS_BREAKPOINT_ENABLED, true)
