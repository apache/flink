...
class ScalarFunctionsTest extends ScalarTypesTestBase {
  ...
  def testTruncate(): Unit = {
    ...
    testAllApis('f29.truncate(), "f29.truncate()", "truncate(f29)", "0.0")

    testAllApis('f31.truncate('f7), "f31.truncate(f7)", "truncate(f31, f7)", "-0.123")

    testAllApis('f31.truncate(), "f31.truncate()", "truncate(f31)", "0")

    testAllApis('f4.truncate('f32), "f4.truncate(f32)", "truncate(f4, f32)", "40")

    testAllApis('f4.truncate(), "f4.truncate()", "truncate(f4)", "44")
    ...
    testAllApis(42.truncate(), "42.truncate()", "truncate(42)", "42")
  ...
  def testHashFunctions(): Unit = {
    ...
    testAllApis("test".sha2('f44), "sha2('test', f44)", "SHA2('test', f44)", expectedSha256)
  ...
  def testNullBigDecimal(): Unit = {
    testAllApis('f41.sign(), "f41.sign()", "SIGN(f41)", "NULL")
  }
  ...
  def testIf(): Unit = {
    ...
    testSqlApi("IF(f7 < 5, f53, f54)", "hello world") // hello world
