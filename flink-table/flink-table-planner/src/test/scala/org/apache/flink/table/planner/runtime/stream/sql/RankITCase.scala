...
class RankITCase(mode: StateBackendMode, enableAsyncState: Boolean)
  ...
  def testTopNWithUpsertSink(): Unit = {
    ...
    table.executeInsert("MySink", SinkConflictStrategy.DEDUPLICATE).await()
  ...
  def testMultipleUnaryTopNAfterAgg(): Unit = {
    ...
    table1.executeInsert("MySink1", SinkConflictStrategy.DEDUPLICATE).await()
    ...
    table2.executeInsert("MySink2", SinkConflictStrategy.DEDUPLICATE).await()
