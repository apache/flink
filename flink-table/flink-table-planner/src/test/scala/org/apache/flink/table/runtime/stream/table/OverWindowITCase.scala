...
class OverWindowITCase extends StreamingWithStateTestBase {
  ...
  def testProcTimeUnBoundedPartitionedRowOver(): Unit = {
    ...
    val expected = Seq(
      "(Hello World,1,7,1)", "(Hello World,2,7,2)", "(Hello World,3,7,2)",
      "(Hello World,4,13,3)", "(Hello,1,1,1)", "(Hello,2,1,2)", "(Hello,3,2,3)",
      "(Hello,4,3,4)", "(Hello,5,3,5)", "(Hello,6,4,6)", "(null,1,20,1)")
