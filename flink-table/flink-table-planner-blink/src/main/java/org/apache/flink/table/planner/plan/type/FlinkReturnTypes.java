...
public class FlinkReturnTypes {
    ...
    public static final SqlReturnTypeInference FLINK_QUOTIENT_NULLABLE =
            opBinding -> {
                ...
                if (SqlTypeUtil.isDecimal(type1) || SqlTypeUtil.isDecimal(type2)) {
                    ...
                    if (type1.isNullable() || type2.isNullable()) {
                        return opBinding
                                .getTypeFactory()
                                .createTypeWithNullability(doubleType, true);
                    } else {
                        return doubleType;
                    }
                }
    ...
    public static final SqlReturnTypeInference FLINK_DIV_NULLABLE =
            opBinding -> {
                RelDataType type1 = opBinding.getOperandType(0);
                RelDataType type2 = opBinding.getOperandType(1);
                ...
                if (SqlTypeUtil.isDecimal(type1) || SqlTypeUtil.isDecimal(type2)) {
                    DecimalType dt =
                            FlinkTypeSystem.inferIntDivType(
                ...
                return opBinding
                        ...
                        .createTypeWithNullability(
                                returnType, type1.isNullable() || type2.isNullable());
            };
