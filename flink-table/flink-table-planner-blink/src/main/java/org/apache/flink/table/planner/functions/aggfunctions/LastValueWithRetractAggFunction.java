...
public abstract class LastValueWithRetractAggFunction<T>
    ...
    public TypeInformation<GenericRowData> getAccumulatorType() {
        ...
        String[] fieldNames =
                new String[] {
                    "lastValue", "lastOrder", "valueToOrderMapView", "orderToValueMapView"
                };
    ...
    public static class DecimalLastValueWithRetractAggFunction
            extends LastValueWithRetractAggFunction<DecimalData> {
    ...
    public static class StringLastValueWithRetractAggFunction
            extends LastValueWithRetractAggFunction<StringData> {
