...
class MapView[K, V](
    @transient private[flink] val keyType: TypeInformation[_],
    @transient private[flink] val valueType: TypeInformation[_],
  ...
  /**
    ...
    */
  def this(keyType: TypeInformation[_], valueType: TypeInformation[_]) {
