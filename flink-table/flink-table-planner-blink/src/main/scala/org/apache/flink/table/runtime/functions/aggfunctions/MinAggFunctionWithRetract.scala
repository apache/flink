...
class ByteMinWithRetractAggFunction extends MinWithRetractAggFunction[Byte] {
  ...
  override def getValueTypeInfo: TypeInformation[lang.Byte] = BasicTypeInfo.BYTE_TYPE_INFO
}
...
class ShortMinWithRetractAggFunction extends MinWithRetractAggFunction[Short] {
  ...
  override def getValueTypeInfo: TypeInformation[lang.Short] = BasicTypeInfo.SHORT_TYPE_INFO
}
...
class IntMinWithRetractAggFunction extends MinWithRetractAggFunction[Int] {
  ...
  override def getValueTypeInfo: TypeInformation[Integer] = BasicTypeInfo.INT_TYPE_INFO
}
...
class LongMinWithRetractAggFunction extends MinWithRetractAggFunction[Long] {
  ...
  override def getValueTypeInfo: TypeInformation[JLong] = BasicTypeInfo.LONG_TYPE_INFO
}
...
class FloatMinWithRetractAggFunction extends MinWithRetractAggFunction[Float] {
  ...
  override def getValueTypeInfo: TypeInformation[lang.Float] = BasicTypeInfo.FLOAT_TYPE_INFO
}
...
class DoubleMinWithRetractAggFunction extends MinWithRetractAggFunction[Double] {
  ...
  override def getValueTypeInfo: TypeInformation[lang.Double] = BasicTypeInfo.DOUBLE_TYPE_INFO
}
...
class BooleanMinWithRetractAggFunction extends MinWithRetractAggFunction[Boolean] {
  ...
  override def getValueTypeInfo: TypeInformation[lang.Boolean] = BasicTypeInfo.BOOLEAN_TYPE_INFO
}

/**
  * Built-in Decimal Min with retraction aggregate function
  */
class DecimalMinWithRetractAggFunction(decimalType: DecimalTypeInfo)
  extends MinWithRetractAggFunction[Decimal] {
  override def getInitValue: Decimal = {
    Decimal.castFrom(0, decimalType.precision(), decimalType.scale())
  }

  override def getValueTypeInfo: TypeInformation[Decimal] = decimalType
}
...
class StringMinWithRetractAggFunction extends MinWithRetractAggFunction[String] {
  ...
  override def getValueTypeInfo: TypeInformation[String] = BasicTypeInfo.STRING_TYPE_INFO
}
...
class TimestampMinWithRetractAggFunction extends MinWithRetractAggFunction[Timestamp] {
  ...
  override def getValueTypeInfo: TypeInformation[Timestamp] = Types.SQL_TIMESTAMP
}
...
class DateMinWithRetractAggFunction extends MinWithRetractAggFunction[Date] {
  ...
  override def getValueTypeInfo: TypeInformation[Date] = Types.SQL_DATE
}
...
class TimeMinWithRetractAggFunction extends MinWithRetractAggFunction[Time] {
  ...
  override def getValueTypeInfo: TypeInformation[Time] = Types.SQL_TIME
}
