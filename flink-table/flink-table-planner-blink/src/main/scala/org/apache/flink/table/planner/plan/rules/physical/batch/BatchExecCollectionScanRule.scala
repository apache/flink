...
import org.apache.flink.table.planner.plan.nodes.physical.batch.BatchExecCollectionScan
import org.apache.flink.table.planner.plan.schema.CollectionTable

/**
  * Rule that converts [[FlinkLogicalCollectionScan]] to [[BatchExecCollectionScan]]
  */
class BatchExecCollectionScanRule
  extends ConverterRule(
    classOf[FlinkLogicalCollectionScan],
    FlinkConventions.LOGICAL,
    FlinkConventions.BATCH_PHYSICAL,
    "BatchExecCollectionScanRule") {
...
object BatchExecCollectionScanRule {
  val INSTANCE: RelOptRule = new BatchExecCollectionScanRule
}
