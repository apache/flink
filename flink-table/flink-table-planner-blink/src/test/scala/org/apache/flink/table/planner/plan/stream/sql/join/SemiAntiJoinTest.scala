...
class SemiAntiJoinTest extends TableTestBase {
  ...
  def testInWithUncorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r)")
  }

  @Test
  def testInWithUncorrelated_SimpleCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r WHERE e < 100) AND b > 10")
  }

  @Test
  def testInWithUncorrelated_SimpleCondition3(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a + 1 IN (SELECT d FROM r)")
  }
  ...
  def testInWithUncorrelated_ComplexCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE (a IN (SELECT d FROM r)) IS TRUE")
  }
  ...
  def testInWithUncorrelated_ComplexCondition4(): Unit = {
    util.verifyPlan("SELECT a FROM l WHERE (SELECT MAX(e) FROM r WHERE d > 0) IN (SELECT j FROM t)")
  }
  ...
  def testInWithUncorrelated_AggInSubQuery1(): Unit = {
    util.verifyPlan("SELECT a FROM l WHERE b IN (SELECT MAX(e) FROM r WHERE d < 3 GROUP BY f)")
  }
  ...
  def testMultiInWithUncorrelated1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r) AND b IN (SELECT j FROM t)")
  }

  @Test
  def testMultiInWithUncorrelated2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r WHERE e IN (SELECT j FROM t))")
  }

  @Test
  def testInWithCorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r WHERE l.b = r.e)")
  }
  ...
  def testInWithCorrelated_SimpleCondition3(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r where CAST(l.b AS INTEGER) = r.d)")
  }
  ...
  def testInWithCorrelated_NonEquiCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a IN (SELECT d FROM r WHERE l.b > 10)")
  }
  ...
  def testExistsWithUncorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE EXISTS (SELECT * FROM r)")
  }

  @Test
  def testExistsWithUncorrelated_SimpleCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE EXISTS (SELECT * FROM r) AND b > 10")
  }
  ...
  def testExistsWithCorrelated_SimpleCondition(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE EXISTS (SELECT * FROM r WHERE a = d)")
  }

  @Test
  def testExistsWithCorrelated_NonEquiCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE EXISTS (SELECT * FROM r WHERE l.a < r.d)")
  }

  @Test
  def testExistsWithCorrelated_NonEquiCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE EXISTS (SELECT * FROM r WHERE l.a < 10)")
  }
  ...
  def testNotInWithUncorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a NOT IN (SELECT d FROM r)")
  }

  @Test
  def testNotInWithUncorrelated_SimpleCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a NOT IN (SELECT d FROM r WHERE e < 100) AND b > 10")
  }

  @Test
  def testNotInWithUncorrelated_SimpleCondition3(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a * b NOT IN (SELECT d FROM r)")
  }

  @Test
  def testNotInWithUncorrelated_ComplexCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT ( NOT ( a NOT IN (SELECT d FROM r)))")
  }
  ...
  def testNotInWithUncorrelated_MultiFields(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE (a, c) NOT IN (SELECT d, f FROM r)")
  }

  @Test
  def testNotInWithCorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a NOT IN (SELECT d FROM r WHERE l.b = r.e)")
  }
  ...
  def testNotInWithCorrelated_NonEquiCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE a NOT IN (SELECT d FROM r WHERE l.b > 10)")
  }
  ...
  def testNotInWithCorrelated_MultiFields(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE (a, c) NOT IN (SELECT d, f FROM r WHERE l.b = r.e)")
  }
  ...
  def testNotExistsWithUncorrelated_SimpleCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT EXISTS (SELECT * FROM r)")
  }

  @Test
  def testNotExistsWithUncorrelated_SimpleCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT EXISTS (SELECT * FROM r) AND b > 10")
  }
  ...
  def testNotExistsWithCorrelated_SimpleCondition(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT EXISTS (SELECT * FROM r WHERE a = d)")
  }

  @Test
  def testNotExistsWithCorrelated_NonEquiCondition1(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT EXISTS (SELECT * FROM r WHERE l.a < r.d)")
  }

  @Test
  def testNotExistsWithCorrelated_NonEquiCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT EXISTS (SELECT * FROM r WHERE l.a < 10)")
  }
