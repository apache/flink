...
class ScalarOperatorsTest extends ScalarOperatorsTestBase {
  ...
  def testCasting(): Unit = {
    ...
    testTableApi('f3.cast(DataTypes.SMALLINT()), "f3.cast(SHORT)", "1")
    ...
    testTableApi('f3.cast(DataTypes.BIGINT()), "f3.cast(LONG)", "1")
    testTableApi('f6.cast(DataTypes.BOOLEAN), "f6.cast(BOOLEAN)", "true")
    // String -> BASIC TYPE (not String, Date, Void, Character)
    testTableApi('f2.cast(DataTypes.TINYINT()), "f2.cast(BYTE)", "1")
    testTableApi('f2.cast(DataTypes.SMALLINT()), "f2.cast(SHORT)", "1")
    testTableApi('f2.cast(DataTypes.INT), "f2.cast(INT)", "1")
    testTableApi('f2.cast(DataTypes.BIGINT()), "f2.cast(LONG)", "1")
  ...
  def testIn(): Unit = {
    ...
    testTableApi(
      'f10.in(
        "This is a test String.", "String", "Hello world", "Comment#1", nullOf(DataTypes.STRING)),
    ...
    testTableApi(
      'f10.in("FAIL", "FAIL", nullOf(DataTypes.STRING)),
  ...
  def testOtherExpressions(): Unit = {
    ...
    // null
    testAllApis(nullOf(DataTypes.INT), "Null(INT)", "CAST(NULL AS INT)", "null")
    testAllApis(
