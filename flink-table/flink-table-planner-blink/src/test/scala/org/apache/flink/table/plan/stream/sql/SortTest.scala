...
class SortTest extends TableTestBase {
  ...
  def testSortProcessingTimeWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c LIMIT 2")
  }

  @Test
  def testSortProcessingTimeWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c OFFSET 2")
  }

  @Test
  def testSortRowTimeWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c LIMIT 2")
  }

  @Test
  def testSortRowTimeWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c OFFSET 2")
  }
  ...
  def testSortProcessingTimeDescWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime desc, c LIMIT 2")
  }

  @Test
  def testSortProcessingTimeDescWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime desc, c OFFSET 2")
  }

  @Test
  def testSortRowTimeDescWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime desc, c LIMIT 2")
  }

  @Test
  def testSortRowTimeDescWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime desc, c OFFSET 2")
  }
  ...
  def testSortProcessingTimeSecondWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime LIMIT 2")
  }

  @Test
  def testSortProcessingTimeSecondWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime OFFSET 2")
  }

  @Test
  def testSortRowTimeSecondWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime LIMIT 2")
  }

  @Test
  def testSortRowTimeSecondWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime OFFSET 2")
  }
  ...
  def testSortProcessingTimeSecondDescWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime desc LIMIT 2")
  }

  @Test
  def testSortProcessingTimeSecondDescWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime desc OFFSET 2")
  }

  @Test
  def testSortRowTimeDescSecondWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime desc LIMIT 2")
  }

  @Test
  def testSortRowTimeDescSecondWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime desc OFFSET 2")
  }

  @Test
  def testSortProcessingTimeSecondDescWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime desc LIMIT 0")
  }

  @Test
  def testSortProcessingTimeSecondDescWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime desc LIMIT 1")
  }

  @Test
  def testSortProcessingTimeSecondAscWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, proctime LIMIT 1")
  }

  @Test
  def testSortProcessingTimeFirstDescWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime desc LIMIT 0")
  }
  ...
  def testSortProcessingTimeFirstAscWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c LIMIT 0")
  }

  @Test
  def testSortProcessingTimeFirstAscWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c LIMIT 1")
  }

  @Test
  def testSortProcessingTimeFirstDescWithOffSet0AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c desc LIMIT 1 OFFSET 0")
  }

  @Test
  def testSortProcessingTimeFirstDescWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c desc LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortProcessingTimeFirstAscWithOffSet1AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c LIMIT 0 OFFSET 1")
  }

  @Test
  def testSortProcessingTimeFirstAscWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime, c LIMIT 1 OFFSET 1")
  }
  ...
  def testSortProcessingTimeDescWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime desc LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortProcessingTimeAscWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY proctime LIMIT 1 OFFSET 1")
  }
  ...
  def testSortRowTimeSecondDescWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime desc LIMIT 0")
  }

  @Test
  def testSortRowTimeSecondDescWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime desc LIMIT 1")
  }

  @Test
  def testSortRowTimeSecondAscWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime LIMIT 0")
  }

  @Test
  def testSortRowTimeSecondAscWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c, rowtime LIMIT 1")
  }
  ...
  def testSortRowTimeFirstAscWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c LIMIT 0")
  }

  @Test
  def testSortRowTimeFirstAscWithLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c LIMIT 1")
  }

  @Test
  def testSortRowTimeFirstDescWithOffSet1AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c desc LIMIT 0 OFFSET 1")
  }

  @Test
  def testSortRowTimeFirstDescWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c desc LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortRowTimeFirstAscWithOffSet1AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c LIMIT 0 OFFSET 1")
  }

  @Test
  def testSortRowTimeFirstAscWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime, c LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortRowTimeAscWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime LIMIT 0")
  }
  ...
  def testSortRowTimeDescWithOffSet1AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime desc LIMIT 0 OFFSET 1")
  }

  @Test
  def testSortRowTimeDescWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime desc LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortRowTimeAscWithOffSet1AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime LIMIT 0 OFFSET 1")
  }

  @Test
  def testSortRowTimeAscWithOffSet1AndLimit1(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime LIMIT 1 OFFSET 1")
  }

  @Test
  def testSortRowTimeDescWithOffSet0AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime desc LIMIT 0 OFFSET 0")
  }
  ...
  def testSortRowTimeAscWithOffSet0AndLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY rowtime LIMIT 0 OFFSET 0")
  }
  ...
  def testSortWithoutTimeWithLimit(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c LIMIT 2")
  }

  @Test
  def testSortWithoutTimeWithLimit0(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c LIMIT 0")
  }

  @Test
  def testSortWithoutTimeWithOffset(): Unit = {
    util.verifyPlan("SELECT a FROM MyTable ORDER BY c OFFSET 2")
  }
