...
object BatchScalaTableEnvUtil {
  ...
  /**
    ...
    */
  def registerCollection[T : ClassTag : TypeInformation](tEnv: BatchTableEnvironment,
  ...
  /**
    ...
    */
  def fromElements[T: ClassTag : TypeInformation](tEnv: BatchTableEnvironment, data: T*): Table = {
