...
class SubQueryAntiJoinTest extends SubQueryTestBase {
  ...
  def testNotInOnWhere_NotSubQuery(): Unit = {
    ...
    util.verifyPlanNotExpected(sqlQuery, "joinType=[anti]")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere1(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a NOT IN (SELECT c FROM y)")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere2(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a NOT IN (SELECT c FROM y WHERE d < 100) AND b > 10")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere3(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a + 1 NOT IN (SELECT c FROM y)")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere4(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a * b NOT IN (SELECT d FROM y)")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere5(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE CAST(a AS BIGINT) NOT IN (SELECT d FROM y)")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere6(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a NOT IN (SELECT c FROM y WHERE c IS NOT NULL)")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere7(): Unit = {
    util.verifyPlan("SELECT a FROM x x1 WHERE a NOT IN (SELECT a FROM x WHERE a < 3 GROUP BY a)")
  }
  ...
  def testNotInWithUncorrelatedOnWhere_ComplexCondition2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT (a IN (SELECT d FROM r))")
  }
  ...
  def testNotInWithUncorrelatedOnWhere_ComplexCondition4(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE NOT (a IN (SELECT d FROM r) OR b > 10)")
  }
  ...
  def testNotInWithUncorrelatedOnWhere_ComplexCondition6(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE (a NOT IN (SELECT c FROM y)) IS TRUE")
  }

  @Test
  def testNotInWithUncorrelatedOnWhere_ComplexCondition7(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE (a NOT IN (SELECT c FROM y) = TRUE)")
  }
  ...
  def testNotInWithUncorrelatedOnWhere_UnsupportedCondition(): Unit = {
    ...
    util.verifyPlanNotExpected(sqlQuery5, "joinType=[anti]")
  }
  ...
  def testNotInWithUncorrelatedOnWhere_MultiFields2(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE (a + 1, c) NOT IN (SELECT d, f FROM r)")
  }
  ...
  def testNotInWithCorrelatedOnWhere1(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a NOT IN (SELECT c FROM y where x.b = y.d)")
  }
  ...
  def testNotInWithCorrelatedOnWhere6(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE a NOT IN (SELECT c FROM y WHERE x.b > 10)")
  }
  ...
  def testNotInWithCorrelatedOnWhere_ComplexCondition3(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE c NOT IN (SELECT TRIM(f) FROM r where l.a = r.d + 1)")
  }
  ...
  def testNotExistsWithUncorrelatedOnWhere1(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y)")
  }

  @Test
  def testNotExistsWithUncorrelatedOnWhere2(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y where c > 0) AND a < 100")
  }

  @Test
  def testNotExistsWithUncorrelatedOnWhere3(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT (NOT (NOT EXISTS (SELECT * FROM y))) AND x.b = 10")
  }
  ...
  def testNotExistsWithUncorrelatedOnWhere5(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE (NOT EXISTS (SELECT d FROM y)) IS TRUE")
  }
  ...
  def testNotExistsWithUncorrelatedOnWhere6(): Unit = {
    ...
    util.verifyPlan("SELECT a FROM x WHERE NOT EXISTS (SELECT x.b IS NULL FROM y)")
  }

  @Test
  def testNotExistsWithUncorrelatedOnWhere7(): Unit = {
    util.verifyPlan("SELECT * FROM l WHERE (NOT EXISTS (SELECT d FROM r)) = true")
  }
  ...
  def testNotExistsWithCorrelatedOnWhere1(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y WHERE a = c)")
  }

  @Test
  def testNotExistsWithCorrelatedOnWhere2(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y WHERE a = c) AND x.a > 2")
  }
  ...
  def testNotExistsWithCorrelatedOnWhere4(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y WHERE x.a = c and x.b > 10)")
  }
  ...
  def testNotExistsWithCorrelatedOnWhere6(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE NOT EXISTS (SELECT * FROM y WHERE x.a < y.c)")
  }

  @Test
  def testNotExistsWithCorrelatedOnWhere7(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE (NOT EXISTS (SELECT d FROM y WHERE y.d = x.b)) IS TRUE")
  }
  ...
  def testNotExistsWithCorrelatedOnWhere8(): Unit = {
    ...
    util.verifyPlan("SELECT a FROM x WHERE NOT EXISTS (SELECT x.a IS NULL FROM y WHERE y.d = x.b)")
  }

  @Test
  def testNotExistsWithCorrelatedOnWhere9(): Unit = {
    util.verifyPlan("SELECT * FROM x WHERE (NOT EXISTS (SELECT d FROM y WHERE y.d = x.b)) = true")
  }
