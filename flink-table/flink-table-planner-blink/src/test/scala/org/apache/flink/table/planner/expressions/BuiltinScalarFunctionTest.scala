...
class BuiltinScalarFunctionTest extends ExpressionTestBase {
  ...
  @Ignore // there is no implicit type coercion now.
  @Test
...
//      "null")
  ...
  override def testData: Row = {
    ...
    testData.setField(16, DateTimeTestUtil.localDate("1996-11-10"))
    testData.setField(17, DateTimeTestUtil.localTime("06:55:44"))
    testData.setField(18, DateTimeTestUtil.localDateTime("1996-11-10 06:55:44.333"))
    ...
    testData.setField(23, DateTimeTestUtil.localDate("1997-11-11"))
    testData.setField(24, DateTimeTestUtil.localTime("09:44:55"))
    testData.setField(25, DateTimeTestUtil.localDateTime("1997-11-11 09:44:55.333"))
