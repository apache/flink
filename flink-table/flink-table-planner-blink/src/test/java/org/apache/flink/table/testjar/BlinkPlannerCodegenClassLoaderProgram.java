...
public class BlinkPlannerCodegenClassLoaderProgram {
	...
	public static void main(String[] args) throws Exception {
		...
		//StreamExecutionEnvironment#getStreamGraph will check size of transformations > 0, an extra operator is necessary
		SingleOutputStreamOperator<CustomerPojo> source = env.fromElements(new CustomerPojo(1)).filter(e -> true);
