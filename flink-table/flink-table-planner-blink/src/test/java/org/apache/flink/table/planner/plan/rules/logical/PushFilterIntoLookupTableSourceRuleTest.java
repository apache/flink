...
/**
 * Test for Push Filter Into LookupTable.
 */
public class PushFilterIntoLookupTableSourceRuleTest extends TableTestBase {
	...
	public void setup() {
		...
		calciteConfig.getBatchProgram().get().addLast(
			...
			FlinkHepRuleSetProgramBuilder.<BatchOptimizeContext>newBuilder()
				...
				.add(RuleSets.ofList(FilterJoinRule.FILTER_ON_JOIN,
					FlinkFilterSnapshotTransposeRule.INSTNACE, PushFilterIntoTableSourceScanRule.INSTANCE))
				.build()
		);
		String ddl1  =
