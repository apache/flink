...
public class SqlGatewayServiceConfigOptions {
    ...
    public static final ConfigOption<Boolean>
            SQL_GATEWAY_SECURITY_REDACT_SENSITIVE_OPTIONS_ENABLED =
                    key("sql-gateway.security.redact-sensitive-options.enabled")
                            .booleanType()
                            .defaultValue(true)
                            .withDescription(
    ...
    public static final ConfigOption<String> SQL_GATEWAY_SECURITY_REDACT_SENSITIVE_OPTIONS_NAMES =
            key("sql-gateway.security.redact-sensitive-options.names")
                    .stringType()
                    .defaultValue("pass,secret,key,token,credentials,sas")
                    .withDescription(
