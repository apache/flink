 ...
 *
 * <p>If object reuse is disable, we rely on the {@link ExternalSerializer} to perform the output
 * conversion lazily. Therefore, the output of this operator might be in internal or external
 * format. But will arrive in external format at the next operator.
 */
@Internal
