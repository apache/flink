...
public class RetractableTopNFunction extends AbstractTopNFunction {
    ...
    /**
     * Note: Because it's impossible to restore a RecordComparator instance generated by
     * GeneratedRecordComparator from snapshot, We introduce ComparatorWrapper class to wrap the
     * GeneratedRecordComparator, a ComparatorWrapper instance is serializable, and a
     * RecordComparator instance could be restored based on the deserialized ComparatorWrapper
     * instance.
     */
        ...
        public boolean equals(Object obj) {
            if (obj instanceof ComparatorWrapper) {
                ...
                return generatedRecordComparator
                                .getClassName()
                                .equals(oGeneratedComparator.getClassName())
                        && generatedRecordComparator
                                .getCode()
                                .equals(oGeneratedComparator.getCode())
                        && Arrays.equals(
                                generatedRecordComparator.getReferences(),
