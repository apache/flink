...
public class BinaryArrayDataTest {
    ...
    public void testArray() {
        ...
        // 2.test write to binary row.
        {
            ...
            writer2.writeArray(
                    0, array, new ArrayDataSerializer(DataTypes.INT().getLogicalType(), null));
            writer2.complete();
        ...
        // 3.test write var seg array to binary row.
        {
            ...
            BinaryRowWriter writer2 = new BinaryRowWriter(row2);
            writer2.writeArray(
                    0, array3, new ArrayDataSerializer(DataTypes.INT().getLogicalType(), null));
            writer2.complete();
    ...
    public void testArrayTypes() {
...

        {
            ...
            writer.setNullAt(0);
            writer.writeArray(
                    1, subArray, new ArrayDataSerializer(DataTypes.INT().getLogicalType(), null));
            writer.complete();
    ...
    public void testNested() {
        ...
        writer.writeRow(
                ...
                new RowDataSerializer(
                        null, RowType.of(new VarCharType(VarCharType.MAX_LENGTH), new IntType())));
        writer.setNullAt(1);
        writer.complete();
