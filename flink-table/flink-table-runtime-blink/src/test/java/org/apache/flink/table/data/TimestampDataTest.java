...
public class TimestampDataTest {
    ...
    public void testNormal() {
        ...
        Assertions.assertEquals(1123L, TimestampData.fromEpochMillis(1123L).getMillisecond());
        Assertions.assertEquals(-1123L, TimestampData.fromEpochMillis(-1123L).getMillisecond());

        Assertions.assertEquals(1123L, TimestampData.fromEpochMillis(1123L, 45678).getMillisecond());
        ...
        Assertions.assertEquals(t19, TimestampData.fromTimestamp(t19).toTimestamp());
        Assertions.assertEquals(t16, TimestampData.fromTimestamp(t16).toTimestamp());
        Assertions.assertEquals(t13, TimestampData.fromTimestamp(t13).toTimestamp());
        Assertions.assertEquals(t10, TimestampData.fromTimestamp(t10).toTimestamp());

        java.sql.Timestamp t2 = java.sql.Timestamp.valueOf("1979-01-02 00:00:00.123456");
        Assertions.assertEquals(t2, TimestampData.fromTimestamp(t2).toTimestamp());

        java.sql.Timestamp t3 = new java.sql.Timestamp(1572333940000L);
        Assertions.assertEquals(t3, TimestampData.fromTimestamp(t3).toTimestamp());
        ...
        Assertions.assertEquals(ldt19, TimestampData.fromLocalDateTime(ldt19).toLocalDateTime());
        Assertions.assertEquals(ldt16, TimestampData.fromLocalDateTime(ldt16).toLocalDateTime());
        Assertions.assertEquals(ldt13, TimestampData.fromLocalDateTime(ldt13).toLocalDateTime());
        Assertions.assertEquals(ldt10, TimestampData.fromLocalDateTime(ldt10).toLocalDateTime());

        LocalDateTime ldt2 = LocalDateTime.of(1969, 1, 2, 0, 0, 0, 0);
        Assertions.assertEquals(ldt2, TimestampData.fromLocalDateTime(ldt2).toLocalDateTime());

        LocalDateTime ldt3 = LocalDateTime.of(1989, 1, 2, 0, 0, 0, 123456789);
        Assertions.assertEquals(ldt3, TimestampData.fromLocalDateTime(ldt3).toLocalDateTime());

        LocalDateTime ldt4 = LocalDateTime.of(1989, 1, 2, 0, 0, 0, 123456789);
        java.sql.Timestamp t4 = java.sql.Timestamp.valueOf(ldt4);
        Assertions.assertEquals(TimestampData.fromLocalDateTime(ldt4), TimestampData.fromTimestamp(t4));
        ...
        Assertions.assertEquals(instant1, TimestampData.fromInstant(instant1).toInstant());
        Assertions.assertEquals(instant2, TimestampData.fromInstant(instant2).toInstant());
        Assertions.assertEquals(instant3, TimestampData.fromInstant(instant3).toInstant());
    }
    ...
    public void testDaylightSavingTime() {
        ...
        Assertions.assertEquals(dstBegin2018, TimestampData.fromTimestamp(dstBegin2018).toTimestamp());

        java.sql.Timestamp dstBegin2019 = java.sql.Timestamp.valueOf("2019-03-10 02:00:00");
        Assertions.assertEquals(dstBegin2019, TimestampData.fromTimestamp(dstBegin2019).toTimestamp());
