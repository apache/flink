...
public class TimestampDataTest {
	...
	public void testNormal() {
		...
		Assert.assertEquals(45678, TimestampData.fromEpochMillis(1123L, 45678).getNanoOfMillisecond());
	...
	public void testToString() {
		...
		Assert.assertEquals("1969-01-02T00:00:00.123456789", TimestampData.fromTimestamp(t).toString());
		...
		Assert.assertEquals("1969-01-02T00:00:00.123456789", TimestampData.fromLocalDateTime(ldt).toString());

		Instant instant = Instant.ofEpochSecond(0L, 123456789L);
		Assert.assertEquals("1970-01-01T00:00:00.123456789", TimestampData.fromInstant(instant).toString());
	}
}
