...
public class TableOperatorWrapperGeneratorTest extends MultipleInputTestBase {
	...
	public void testComplex() {
		...
		TwoInputTransformation<RowData, RowData, RowData> join3 = createTwoInputTransform(
				source4,
				source5,
				"join3",
				InternalTypeInfo.of(RowType.of(
		...
		TwoInputTransformation<RowData, RowData, RowData> join4 = createTwoInputTransform(
				join2,
				join3,
				"join4",
				InternalTypeInfo.of(RowType.of(
	...
	private TableOperatorWrapper<StreamOperator<RowData>> createWrapper(
		...
		TableOperatorWrapper<StreamOperator<RowData>> wrapper = new TableOperatorWrapper<>(
