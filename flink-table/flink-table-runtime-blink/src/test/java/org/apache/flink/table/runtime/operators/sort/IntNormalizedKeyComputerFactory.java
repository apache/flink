...
/** Factory to create int {@link NormalizedKeyComputer} in different order. */
public class IntNormalizedKeyComputerFactory {

    /** Example for int {@link NormalizedKeyComputer}. */
    public abstract static class IntNormalizedKeyComputerBase implements NormalizedKeyComputer {
        @Override
    ...
    public static NormalizedKeyComputer createComputerInAscendingOrder() {
        return createComputerInAscendingOrder(true);
    }

    public static NormalizedKeyComputer createComputerInAscendingOrder(boolean isFullyDetermined) {
        return new IntNormalizedKeyComputerBase() {
    ...
    public static NormalizedKeyComputer createComputerInDescendingOrder() {
        return new IntNormalizedKeyComputerBase() {
            @Override
            public int getNumKeyBytes() {
                return 5;
    ...
    public static NormalizedKeyComputer createComputerWithoutNormalizedKey() {
        return new IntNormalizedKeyComputerBase() {
            @Override
