...
abstract class TopNFunctionTestBase {
    ...
    static GeneratedRecordComparator sortKeyComparator =
    ...
    BinaryRowDataKeySelector sortKeySelector =
            new BinaryRowDataKeySelector(new int[] {sortKeyIdx}, inputRowType.getLogicalTypes());
    ...
    private BinaryRowDataKeySelector keySelector =
            new BinaryRowDataKeySelector(
                    new int[] {partitionKeyIdx}, inputRowType.getLogicalTypes());

    private RowDataTypeInfo outputTypeWithoutRowNumber = inputRowType;

    private RowDataTypeInfo outputTypeWithRowNumber =
            new RowDataTypeInfo(
    ...
    RowDataHarnessAssertor assertorWithoutRowNumber =
            new RowDataHarnessAssertor(
                    ...
                    new GenericRowRecordSortComparator(
                            sortKeyIdx, outputTypeWithoutRowNumber.getLogicalTypes()[sortKeyIdx]));

    RowDataHarnessAssertor assertorWithRowNumber =
            new RowDataHarnessAssertor(
                    outputTypeWithRowNumber.getFieldTypes(),
                    new GenericRowRecordSortComparator(
                            sortKeyIdx, outputTypeWithRowNumber.getLogicalTypes()[sortKeyIdx]));
