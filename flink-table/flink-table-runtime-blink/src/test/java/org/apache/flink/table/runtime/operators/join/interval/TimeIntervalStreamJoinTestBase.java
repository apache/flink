...
abstract class TimeIntervalStreamJoinTestBase {
    RowDataTypeInfo rowType =
            new RowDataTypeInfo(new BigIntType(), new VarCharType(VarCharType.MAX_LENGTH));

    private RowDataTypeInfo outputRowType =
            new RowDataTypeInfo(
                    new BigIntType(),
    ...
    GeneratedFunction<FlatJoinFunction<RowData, RowData, RowData>> generatedFunction =
            new GeneratedFunction("IntervalJoinFunction", funcCode, new Object[0]);
}
