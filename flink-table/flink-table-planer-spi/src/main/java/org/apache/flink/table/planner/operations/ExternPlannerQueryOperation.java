...
@Internal
public class ExternPlannerQueryOperation implements QueryOperation {

    private final RelNode calciteTree;
    private final ResolvedSchema resolvedSchema;

    public ExternPlannerQueryOperation(RelNode calciteTree, ResolvedSchema resolvedSchema) {
