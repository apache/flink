...
public class ConnectExample {
	...
	/**
	 * user defind function OrderMergeInfos.
	 */
	private static class OrderMergeInfos extends CoProcessFunction<Tuple2<String, String>, Tuple2<String, String>, Tuple2<String, String>> {
		private static final long serialVersionUID = -1721031958980429667L;
