...
class StreamingExamplesITCase extends StreamingMultipleProgramsTestBase {
  ...
  def testTwitterExample(): Unit = {
    ...
    TestBaseUtils.compareResultsByLinesInMemory(TwitterExampleData.STREAMING_COUNTS_AS_TUPLES, resultPath)
  }
  ...
  def testWordCount(): Unit = {
    ...
    TestBaseUtils.compareResultsByLinesInMemory(WordCountData.STREAMING_COUNTS_AS_TUPLES, resultPath)
  }
}
