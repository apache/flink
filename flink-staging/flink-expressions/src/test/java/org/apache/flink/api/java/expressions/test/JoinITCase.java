...
public class JoinITCase extends MultipleProgramsTestBase {
	...
	public void testJoin() throws Exception {
		...
		ExpressionOperation<JavaBatchTranslator> result = in1.join(in2).where("b === e").select("c, g");
	...
	public void testJoinWithMultipleKeys() throws Exception {
		...
		ExpressionOperation<JavaBatchTranslator> result = in1.join(in2).where("a === d && b === h").select("c, g");
	...
	public void testJoinNonExistingKey() throws Exception {
		...
		ExpressionOperation<JavaBatchTranslator> result = in1.join(in2).where("foo === e").select("c, g");
	...
	public void testJoinWithAmbiguousFields() throws Exception {
		...
		ExpressionOperation<JavaBatchTranslator> in1 = ExpressionUtil.from(ds1, "a, b, c");
		ExpressionOperation<JavaBatchTranslator> in2 = ExpressionUtil.from(ds2, "d, e, f, g, c");
