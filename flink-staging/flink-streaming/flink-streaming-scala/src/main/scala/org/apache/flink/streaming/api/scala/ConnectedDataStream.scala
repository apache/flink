...
import org.apache.flink.streaming.api.invokable.operator.co.{CoFlatMapStreamOperator, CoMapStreamOperator, CoReduceStreamOperator}
...
class ConnectedDataStream[IN1, IN2](javaStream: JavaCStream[IN1, IN2]) {
  ...
  DataStream[R] = {
    ...
    new DataStream(javaStream.addCoFunction("map", implicitly[TypeInformation[R]],
      new CoMapStreamOperator[IN1, IN2, R](comapper)))
  }
  ...
  DataStream[R] = {
    ...
    new DataStream[R](javaStream.addCoFunction("flatMap", implicitly[TypeInformation[R]],
      new CoFlatMapStreamOperator[IN1, IN2, R](coFlatMapper)))
  }
  ...
  DataStream[R] = {
    ...
    new DataStream[R](javaStream.addCoFunction("coReduce", implicitly[TypeInformation[R]],
      new CoReduceStreamOperator[IN1, IN2, R](coReducer)))
  }
