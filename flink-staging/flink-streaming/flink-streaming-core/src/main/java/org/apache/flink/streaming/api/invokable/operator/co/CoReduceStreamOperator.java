...
public class CoReduceStreamOperator<IN1, IN2, OUT> extends CoStreamOperator<IN1, IN2, OUT> {
	...
	public CoReduceStreamOperator(CoReduceFunction<IN1, IN2, OUT> coReducer) {
		super(coReducer);
