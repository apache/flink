 ...
 */
public class WindowBufferStreamOperator<T> extends ChainableStreamOperator<WindowEvent<T>, StreamWindow<T>> {

	protected WindowBuffer<T> buffer;

	public WindowBufferStreamOperator(WindowBuffer<T> buffer) {
		super(null);
		this.buffer = buffer;
		withoutInputCopy();
	}
