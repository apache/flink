 ...
 * to test a {@link org.apache.flink.streaming.api.operators.TwoInputStreamOperator}.
 *
 * <p>
 ...
 */
public class MockTwoInputTask<IN1, IN2, OUT> {
	...
	public MockTwoInputTask(TwoInputStreamOperator<IN1, IN2, OUT> operator) {
