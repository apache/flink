...
def get_environment():
    ...
    """
    return Environment(len(sys.argv)==3 and sys.argv[1] =="FLINK_KEY_EXECUTION")


class Environment(object):
    def __init__(self, operatorExecution):
        # util
        self._execute = operatorExecution
    ...
    def execute(self, local=False, debug=False):
        ...
        if not self._execute:
            ...
            try:
                ...
                id = struct.unpack(">i", s.recv(4, socket.MSG_WAITALL))[0]
