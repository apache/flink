	...
	implements CustomUnaryOperation<Vertex<VertexKey, VertexValue>, Vertex<VertexKey, VertexValue>>
{
	...
	private static abstract class VertexUpdateUdf<VertexKey extends Comparable<VertexKey> & Serializable,
		VV extends Serializable, VertexValue extends Serializable, Message>
		extends RichCoGroupFunction<Tuple2<VertexKey, Message>, Vertex<VertexKey, VV>,
			Vertex<VertexKey, VV>>
		implements ResultTypeQueryable<Vertex<VertexKey, VV>>
	{
	...
	private static final class VertexUpdateUdfSimpleVertexValue<VertexKey extends Comparable<VertexKey> & Serializable,
			VertexValue extends Serializable, Message> extends VertexUpdateUdf<VertexKey,
			VertexValue, VertexValue, Message> {
	...
	private static final class VertexUpdateUdfVertexValueWithDegrees<VertexKey extends Comparable<VertexKey> & Serializable,
			VertexValue extends Serializable, Message> extends VertexUpdateUdf<VertexKey,
	 ...
	 */
	private static abstract class MessagingUdfWithEdgeValues<VertexKey extends Comparable<VertexKey> & Serializable,
		VV extends Serializable, VertexValue extends Serializable, Message, EdgeValue extends Serializable>
		extends RichCoGroupFunction<Edge<VertexKey, EdgeValue>, Vertex<VertexKey, VV>, Tuple2<VertexKey, Message>>
	...
	private static final class MessagingUdfWithEdgeValuesSimpleVertexValue<VertexKey extends Comparable<VertexKey> & Serializable,
	...
	private static final class MessagingUdfWithEdgeValuesVertexValueWithDegrees<VertexKey extends Comparable<VertexKey> & Serializable,
			VertexValue extends Serializable, Message, EdgeValue extends Serializable>
	...
	private <VV extends Serializable> DeltaIteration<Vertex<VertexKey, VV>, Vertex<VertexKey, VV>> setUpIteration(
	...
	private <VV extends Serializable> void configureUpdateFunction(CoGroupOperator<?, ?, Vertex<VertexKey, VV>> updates) {
