...
class PyFlinkBatchExpressionTests(PyFlinkTestCase):
    ...
    def test_expression(self):
        ...
        self.assertEqual('first_value(a, true)', str(expr1.first_value(True)))
        self.assertEqual('first_value(a, false)', str(expr1.first_value(False)))
        self.assertEqual('last_value(a)', str(expr1.last_value()))
        self.assertEqual('last_value(a, true)', str(expr1.last_value(True)))
        self.assertEqual('last_value(a, false)', str(expr1.last_value(False)))
