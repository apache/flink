...
class Expression(Generic[T]):
    ...
    def shiftleft(self, n: Union[int, 'Expression[int]'] = 0) -> 'Expression[T]':
        ...
        This operation is equivalent to multiplying the number by 2 raised to the power of
        ...
        Returns:
        - int: The result of shifting the bits of the number to the left by the specified
        number of positions.

        Examples:
        - shiftleft(5, 2) returns 20 (binary 101 shifted left by 2 positions becomes 10100,
    ...
    def shiftright(self, n: Union[int, 'Expression[int]'] = 0) -> 'Expression[T]':
        ...
        This operation is equivalent to dividing the number by 2 raised to the power of the
        specified number of positions, discarding any remainder.
        ...
        Returns:
        - int: The result of shifting the bits of the number to the right by the specified
        number of positions.

        Examples:
        - shiftright(20, 2) returns 5 (binary 10100 shifted right by 2 positions becomes 101,
