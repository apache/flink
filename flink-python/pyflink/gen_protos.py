...
GRPC_TOOLS = 'grpcio-tools>=1.29.0,<=1.54.3'
PROTO_PATHS = ['proto']
        ...
        try:
            ...
            if platform.system() == 'Windows':
                ...
                raise RuntimeError(
                    ...
                    'using \'pip install "grpcio-tools>=1.29.0,<=1.54.3"\'.')
...
def _check_grpcio_tools_version():
    ...
    from pkg_resources import parse_version
    if version < parse_version('1.29.0') or version > parse_version('1.54.3'):
        raise RuntimeError(
            "Version of grpcio-tools must be between 1.29.0 and 1.54.3, got %s" % version)
