...
class CsvSchemaBuilder(object):
    ...
    def add_array_column(self, name: str, separator: str = ';',
                         element_type: Optional[DataType] = None) -> 'CsvSchemaBuilder':
        """
    ...
    def add_number_column(self, name: str,
                          number_type: Optional[NumericType] = None) -> 'CsvSchemaBuilder':
        """
