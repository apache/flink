...
class KinesisDeserializationSchema(object):
    ...
    def __init__(self, _j_deserialization_schema):
        if _j_deserialization_schema is None:
            ...
            self._j_kinesis_deserialization_schema = _j_deserialization_schema
...
class FlinkKinesisConsumer(SourceFunction):
    ...
    def __init__(self,
        ...
        self._j_kinesis_consumer = JKinesisConsumer(streams, deserializer, j_properties)
...
class KinesisFirehoseSink(Sink):
    ...
    stream using the buffering protocol specified in AsyncSinkBase.
    """
...
class KinesisFirehoseSinkBuilder(object):
    ...
    ::
        ...
        ...     .set_delivery_stream_name(DELIVERY_STREAM_NAME) \\
        ...     .set_serialization_schema(SimpleStringSchema()) \\
        ...     .build()
    ...
    def set_max_buffered_requests(self, max_buffered_requests) -> 'KinesisFirehoseSinkBuilder':
        """
        The maximum buffer length. Callbacks to add elements to the buffer and calls to write will
        block if this length has been reached and will only unblock if elements from the buffer have
        been removed for flushing.
