...
class BaseBroadcastProcessFunction(Function):
    ...
    include the :class:`BroadcastProcessFunction` and the :class:`KeyedBroadcastProcessFunction`.
    """

    class BaseContext(ABC):
        """
        The base context available to all methods in a broadcast process function. This include
        :class:`BroadcastProcessFunction` and :class:`KeyedBroadcastProcessFunctions`.
        """
