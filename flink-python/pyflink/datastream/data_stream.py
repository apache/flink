...
class DataStream(object):
    ...
    def _get_java_python_function_operator(self,
        ...
        if func_type == UserDefinedDataStreamFunction.REDUCE:  # type: ignore
            ...
            DataStreamStatefulPythonFunctionOperator = gateway.jvm\
                .org.apache.flink.streaming.api.operators.python\
                .StatefulPythonFunctionOperator
            j_python_data_stream_function_operator = DataStreamStatefulPythonFunctionOperator(
                j_conf,
                j_input_types,
