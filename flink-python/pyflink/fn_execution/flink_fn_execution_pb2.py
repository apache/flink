...
_TYPEINFO_TYPENAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_DATE', index=23, number=24,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_TIME', index=24, number=25,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_DATETIME', index=25, number=26,
      options=None,
      type=None),
  ],
  containing_type=None,
