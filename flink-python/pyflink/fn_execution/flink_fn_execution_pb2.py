...
_CODERPARAM_DATATYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OVER_WINDOW_ARROW', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_CODERPARAM = _descriptor.Descriptor(
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='field_type', full_name='org.apache.flink.fn_execution.v1.CoderParam.field_type',
      index=0, containing_type=None, fields=[]),
  ],
...
_CODERPARAM.oneofs_by_name['field_type'].fields.append(
  _CODERPARAM.fields_by_name['schema'])
_CODERPARAM.fields_by_name['schema'].containing_oneof = _CODERPARAM.oneofs_by_name['field_type']
_CODERPARAM.oneofs_by_name['field_type'].fields.append(
  _CODERPARAM.fields_by_name['type_info'])
_CODERPARAM.fields_by_name['type_info'].containing_oneof = _CODERPARAM.oneofs_by_name['field_type']
