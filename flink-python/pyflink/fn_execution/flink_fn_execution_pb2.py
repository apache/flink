...
_USERDEFINEDFUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='used_in_row_based_operation', full_name='org.apache.flink.fn_execution.v1.UserDefinedFunction.used_in_row_based_operation', index=3,
