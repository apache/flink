...
_TYPEINFO_TYPENAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INSTANT', index=15, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ARRAY', index=16, number=16,
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PICKLED_BYTES', index=17, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
