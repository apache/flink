...
_CODERPARAM_DATATYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BATCH_OVER_WINDOW_ARROW', index=4, number=4,
      options=None,
      type=None),
  ],
  containing_type=None,
