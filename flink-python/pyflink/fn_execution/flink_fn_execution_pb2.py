...
_USERDEFINEDDATASTREAMFUNCTION_FUNCTIONTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='KEYED_CO_BROADCAST_PROCESS', index=6, number=6,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REVISE_OUTPUT', index=7, number=100,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_TYPEINFO_AVROTYPEINFO = _descriptor.Descriptor(
  name='AvroTypeInfo',
  full_name='org.apache.flink.fn_execution.v1.TypeInfo.AvroTypeInfo',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='schema', full_name='org.apache.flink.fn_execution.v1.TypeInfo.AvroTypeInfo.schema', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TYPEINFO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='avro_type_info', full_name='org.apache.flink.fn_execution.v1.TypeInfo.avro_type_info', index=5,
      number=6, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_TYPEINFO_MAPTYPEINFO, _TYPEINFO_ROWTYPEINFO, _TYPEINFO_TUPLETYPEINFO, _TYPEINFO_AVROTYPEINFO, ],
  enum_types=[
    _TYPEINFO_TYPENAME,
  ],
  options=None,
...
_USERDEFINEDDATASTREAMFUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='has_side_output', full_name='org.apache.flink.fn_execution.v1.UserDefinedDataStreamFunction.has_side_output', index=6,
      number=7, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state_cache_size', full_name='org.apache.flink.fn_execution.v1.UserDefinedDataStreamFunction.state_cache_size', index=7,
      number=8, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='map_state_read_cache_size', full_name='org.apache.flink.fn_execution.v1.UserDefinedDataStreamFunction.map_state_read_cache_size', index=8,
      number=9, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='map_state_write_cache_size', full_name='org.apache.flink.fn_execution.v1.UserDefinedDataStreamFunction.map_state_write_cache_size', index=9,
      number=10, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_TYPEINFO_AVROTYPEINFO.containing_type = _TYPEINFO
...
_TYPEINFO.fields_by_name['avro_type_info'].message_type = _TYPEINFO_AVROTYPEINFO
...
_TYPEINFO.oneofs_by_name['type_info'].fields.append(
  _TYPEINFO.fields_by_name['avro_type_info'])
_TYPEINFO.fields_by_name['avro_type_info'].containing_oneof = _TYPEINFO.oneofs_by_name['type_info']
...
TypeInfo = _reflection.GeneratedProtocolMessageType('TypeInfo', (_message.Message,), dict(
  ...
  AvroTypeInfo = _reflection.GeneratedProtocolMessageType('AvroTypeInfo', (_message.Message,), dict(
