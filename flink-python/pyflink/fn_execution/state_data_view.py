...
class KeyedStateListView(StateListView[N]):
    """
    KeyedStateListView is an default implementation of StateListView whose underlying
...
class NamespacedStateListView(StateListView[N]):
    """
    NamespacedStateListView is an StateListView whose underlying representation is a keyed and
...
class KeyedStateMapView(StateMapView[N]):
    """
    KeyedStateMapView is an default implementation of StateMapView whose underlying
    representation is a keyed state.
    """
...
class NamespacedStateMapView(StateMapView[N]):
    """
    NamespacedStateMapView is an StateMapView whose underlying representation is a keyed and
    namespaced state. It also support to change current namespace.
    """
...
class PerWindowStateDataViewStore(StateDataViewStore):
    ...
    registration to an underlying RemoteKeyedStateBackend. The created state by this store has the
