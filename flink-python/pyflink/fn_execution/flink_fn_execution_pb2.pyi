...
class UserDefinedFunctions(_message.Message):
    __slots__ = ("udfs", "metric_enabled", "windows", "profile_enabled", "job_parameters", "async_max_concurrent_operations", "async_timeout_ms", "async_retry_enabled", "async_retry_max_attempts", "async_retry_delay_ms")
    ...
    ASYNC_MAX_CONCURRENT_OPERATIONS_FIELD_NUMBER: _ClassVar[int]
    ASYNC_TIMEOUT_MS_FIELD_NUMBER: _ClassVar[int]
    ASYNC_RETRY_ENABLED_FIELD_NUMBER: _ClassVar[int]
    ASYNC_RETRY_MAX_ATTEMPTS_FIELD_NUMBER: _ClassVar[int]
    ...
    async_max_concurrent_operations: int
    async_timeout_ms: int
    async_retry_enabled: bool
    async_retry_max_attempts: int
    async_retry_delay_ms: int
    def __init__(self, udfs: _Optional[_Iterable[_Union[UserDefinedFunction, _Mapping]]] = ..., metric_enabled: bool = ..., windows: _Optional[_Iterable[_Union[OverWindow, _Mapping]]] = ..., profile_enabled: bool = ..., job_parameters: _Optional[_Iterable[_Union[JobParameter, _Mapping]]] = ..., async_max_concurrent_operations: _Optional[int] = ..., async_timeout_ms: _Optional[int] = ..., async_retry_enabled: bool = ..., async_retry_max_attempts: _Optional[int] = ..., async_retry_delay_ms: _Optional[int] = ...) -> None: ...
