...
public class PooledByteBufAllocator extends AbstractByteBufAllocator
    ...
    static {
        ...
        // Assuming each arena has 3 chunks, the pool should not consume more than 50% of max
        // memory.
        ...
        // 32 kb is the default maximum capacity of the cached buffer. Similar to what is explained
        // in
        // 'Scalable memory allocation using jemalloc'
        DEFAULT_MAX_CACHED_BUFFER_CAPACITY =
                SystemPropertyUtil.getInt("io.netty.allocator.maxCachedBufferCapacity", 32 * 1024);

        // the number of threshold of allocations when cached entries will be freed up if not
        // frequently used
        DEFAULT_CACHE_TRIM_INTERVAL =
                SystemPropertyUtil.getInt("io.netty.allocator.cacheTrimInterval", 8192);
        ...
        // Use 1023 by default as we use an ArrayDeque as backing storage which will then allocate
        // an internal array
        // of 1024 elements. Otherwise we would allocate 2048 and only use 1024 which is wasteful.
        DEFAULT_MAX_CACHED_BYTEBUFFERS_PER_CHUNK =
                SystemPropertyUtil.getInt("io.netty.allocator.maxCachedByteBuffersPerChunk", 1023);
        ...
        if (logger.isDebugEnabled()) {
            ...
            logger.debug(
                    "-Dio.netty.allocator.chunkSize: {}", DEFAULT_PAGE_SIZE << DEFAULT_MAX_ORDER);
    ...
    @Deprecated
    public PooledByteBufAllocator(
            boolean preferDirect, int nHeapArena, int nDirectArena, int pageSize, int maxOrder) {
        this(
                preferDirect,
                nHeapArena,
                nDirectArena,
    ...
    /**
     * Default number of direct arenas - System Property: io.netty.allocator.numDirectArenas -
     * default 2 * cores
     */
