...
public class PythonInputFormatTableSource extends InputFormatTableSource<Row> {
    ...
    public PythonInputFormatTableSource(
            InputFormat<Row, ? extends InputSplit> inputFormat, DataType rowType) {
    ...
    public TableSchema getTableSchema() {
        return TableSchema.fromTypeInfo(TypeConversions.fromDataTypeToLegacyInfo(rowType));
    }

    @Override
    public TypeInformation<Row> getReturnType() {
        return (TypeInformation<Row>) TypeConversions.fromDataTypeToLegacyInfo(rowType);
    }
}
