...
object PythonTableUtils {
  ...
  /**
    * Wrap the unpickled python data with CollectionInputFormat. It will be passed to
    * PythonCollectionInputFormatTableSource later.
    *
    ...
    * @return A CollectionInputFormat containing the python data.
    */
  def getInputFormat(
