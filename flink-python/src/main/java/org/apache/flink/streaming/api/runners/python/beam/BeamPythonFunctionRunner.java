...
public abstract class BeamPythonFunctionRunner implements PythonFunctionRunner {
    ...
    /** The Python external execution environment manager. */
    private final ExternalPythonEnvironmentManager environmentManager;
    ...
    public BeamPythonFunctionRunner(
            String taskName,
            ExternalPythonEnvironmentManager environmentManager,
