    ...
    public static class TypeInfoToProtoConverter {
        ...
        public static FlinkFnApi.TypeInfo toTypeInfoProto(FlinkFnApi.TypeInfo.FieldType fieldType) {
            return FlinkFnApi.TypeInfo.newBuilder()
                    .addField(FlinkFnApi.TypeInfo.Field.newBuilder().setType(fieldType).build())
                    .build();
        }

        private static FlinkFnApi.TypeInfo.FieldType buildBasicTypeProto(
            ...
            for (int index = 0; index < arity; index++) {
                rowTypeInfoBuilder.addField(
                        FlinkFnApi.TypeInfo.Field.newBuilder()
                                ...
                                .setType(
                                        TypeInfoToProtoConverter.getFieldType(
        ...
        private static FlinkFnApi.TypeInfo.FieldType buildPickledBytesTypeProto(
                PickledByteArrayTypeInfo pickledByteArrayTypeInfo) {
            return FlinkFnApi.TypeInfo.FieldType.newBuilder()
                    .setTypeName(FlinkFnApi.TypeInfo.TypeName.PICKLED_BYTES)
                    .build();
        }

        private static FlinkFnApi.TypeInfo.FieldType buildTupleTypeProto(
