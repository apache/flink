...
public enum PythonOperatorUtils {
    ...
    public static FlinkFnApi.UserDefinedDataStreamFunction
        ...
        FlinkFnApi.TypeInfo.FieldType builtKeyFieldType =
                PythonTypeUtils.TypeInfoToProtoConverter.getFieldType(keyTypeInfo);
        return userDefinedDataStreamFunction
                .toBuilder()
                .setKeyTypeInfo(
                        PythonTypeUtils.TypeInfoToProtoConverter.toTypeInfoProto(builtKeyFieldType))
                .build();
    }
