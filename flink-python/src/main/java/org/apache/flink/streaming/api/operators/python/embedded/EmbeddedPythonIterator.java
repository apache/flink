 ...
 *
 * <p>PEMJA iterator objects may come back from a different user-code classloader after recovery,
 * so callers should not hard-cast them to {@code pemja.core.object.PyIterator}.
 */
@Internal
