...
/**
 * A {@link BaseRowPythonScalarFunctionRunner} that just return the input elements as the execution results.
 */
public class PassThroughBaseRowPythonScalarFunctionRunner extends BaseRowPythonScalarFunctionRunner {

	private final JobBundleFactory jobBundleFactory;
	private final List<byte[]> bufferedInputs;

	public PassThroughBaseRowPythonScalarFunctionRunner(
		String taskName,
