...
/**
 * An {@link BaseRowArrowPythonScalarFunctionRunner} that just return the input elements as the execution results.
 */
public class PassThroughBaseRowArrowPythonScalarFunctionRunner extends BaseRowArrowPythonScalarFunctionRunner {

	private final JobBundleFactory jobBundleFactory;
	private final List<byte[]> bufferedInputs;

	public PassThroughBaseRowArrowPythonScalarFunctionRunner(
		String taskName,
