...
public class PythonOptionsTest {
    ...
    public void testPythonFrameworkMemorySize() {
        final Configuration configuration = new Configuration();
        final String defaultPythonFrameworkMemorySize =
                configuration.getString(PythonOptions.PYTHON_FRAMEWORK_MEMORY_SIZE);
        assertThat(
                defaultPythonFrameworkMemorySize,
        ...
        configuration.setString(
                PythonOptions.PYTHON_FRAMEWORK_MEMORY_SIZE, expectedPythonFrameworkMemorySize);

        final String actualPythonFrameworkMemorySize =
                configuration.getString(PythonOptions.PYTHON_FRAMEWORK_MEMORY_SIZE);
    ...
    public void testPythonBufferMemorySize() {
        final Configuration configuration = new Configuration();
        final String defaultPythonBufferMemorySize =
                configuration.getString(PythonOptions.PYTHON_DATA_BUFFER_MEMORY_SIZE);
        assertThat(
                defaultPythonBufferMemorySize,
                is(equalTo(PythonOptions.PYTHON_DATA_BUFFER_MEMORY_SIZE.defaultValue())));

        final String expectedPythonBufferMemorySize = "100mb";
        configuration.setString(
                PythonOptions.PYTHON_DATA_BUFFER_MEMORY_SIZE, expectedPythonBufferMemorySize);

        final String actualPythonBufferMemorySize =
                configuration.getString(PythonOptions.PYTHON_DATA_BUFFER_MEMORY_SIZE);
