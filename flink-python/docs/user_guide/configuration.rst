...
You could refer to the :flinkdoc:`Table API Configuration <docs/dev/table/config/>` for more details
...
For a complete list of Python configuration options, please refer to the
:flinkdoc:`Python Configuration Documentation <docs/dev/python/python_config/>`
in the main Flink documentation.
