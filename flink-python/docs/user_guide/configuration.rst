...
.. list-table:: Python Configuration Options
   ...
   * - .. confval:: python.fn-execution.bundle.size
     - 1000
     - Integer
   ...
   * - .. confval:: python.fn-execution.bundle.time
     - 1000
     - Long
   ...
   * - .. confval:: python.fn-execution.memory.managed
     - true
     - Boolean
   ...
   * - .. confval:: python.map-state.iterate-response-batch-size
     - 1000
     - Integer
   ...
   * - .. confval:: python.map-state.read-cache-size
     - 1000
     - Integer
   ...
   * - .. confval:: python.map-state.write-cache-size
     - 1000
     - Integer
   ...
   * - .. confval:: python.profile.enabled
     - false
     - Boolean
   ...
   * - .. confval:: python.state.cache-size
     - 1000
     - Integer
   ...
   * - .. confval:: python.systemenv.enabled
     - true
     - Boolean
