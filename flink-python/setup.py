...
try:
    ...
    # (akhilg): Set the dependency of py4j from 0.10.9.7 to 0.10.9.5 to be compatible with pyspark==3.3 dependency
    # (akhilg): Set the dependency on numpy to include 1.22.0 to handle a security issue.
    # (akhilg): Set the apache-beam dependency to 2.38.0 instead of 2.43.0 since the latter seems to break pyflink.
    install_requires = ['py4j==0.10.9.5', 'python-dateutil>=2.8.0,<3', 'apache-beam==2.38.0',
