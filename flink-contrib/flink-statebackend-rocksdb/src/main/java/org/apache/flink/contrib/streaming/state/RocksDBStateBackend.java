...
public class RocksDBStateBackend extends AbstractStateBackend implements PartitionedStateBackendFactory {
	...
	public void initializeForJob(
		...
		this.nonPartitionedStateBackend.initializeForJob(env, operatorIdentifier);
	...
	@Override
	public <K> PartitionedRocksDBStateBackend<K> createPartitionedStateBackend(TypeSerializer<K> keySerializer) throws IOException {
		return new PartitionedRocksDBStateBackend<K>(
			keySerializer,
			classLoader,
			checkpointDirectory,
			operatorIdentifier,
