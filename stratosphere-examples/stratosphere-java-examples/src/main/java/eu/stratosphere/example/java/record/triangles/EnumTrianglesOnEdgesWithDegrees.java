...
import eu.stratosphere.example.java.record.triangles.io.EdgeWithDegreesInputFormat;
import eu.stratosphere.example.java.record.triangles.io.TriangleOutputFormat;
