...
/**
 * On the base of {@link RuntimeContext}, {@link TwoOutputPartitionedContext} also contains all
 * partition-wise execution information, such as getting state, registering timer, etc.
 */
@Experimental
public interface TwoOutputPartitionedContext extends AbstractPartitionedContext {
