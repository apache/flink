...
public abstract class AbstractQueryableStateTestBase extends TestLogger {
    ...
    @Test
    public void testMergeWindowState() throws Exception {
...
//            clusterClient.setDetached(true);
    ...
    public CompletableFuture<AggregatingState<Tuple2<Integer, Long>, Long>> getWindowKvStates(
            final JobID jobId,
    ...
    public void testDuplicateRegistrationFailsJob() throws Exception {
        ...
        try {
            ClientUtils.submitJobAndWaitForResult(
                    clusterClient, jobGraph, AbstractQueryableStateTestBase.class.getClassLoader());
    ...
    /**
     * Tests simple folding state queryable state instance. Each source emits (subtaskIndex,
     * 0)..(subtaskIndex, numElements) tuples, which are then queried. The folding state sums these
     * up and maps them to Strings. The test succeeds after each subtask index is queried with
     * result n*(n+1)/2 (as a String).
     */
    @Test
    public void testFoldingState() throws Exception {
        ...
        FoldingStateDescriptor<Tuple2<Integer, Long>, String> foldingState =
                new FoldingStateDescriptor<>("any", "0", new SumFold(), StringSerializer.INSTANCE);
