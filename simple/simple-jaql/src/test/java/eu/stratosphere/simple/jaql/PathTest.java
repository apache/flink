...
public class PathTest extends ParserTestCase {
	...
	public void shouldParseSpreadOperatorWithFieldAccess() {
		assertParseResult(new PathExpression(new ObjectCreation(), new ArrayAccess(), new ObjectAccess("field")),
			"$in = {}; $in[*].field");
	}
	...
	public void shouldParseDoubleSpreadOperatorWithFieldAccess() {
		assertParseResult(new PathExpression(new ObjectCreation(), new ArrayAccess(), new ObjectAccess("field"),
			new ObjectAccess("field2"), new ArrayAccess(), new ObjectAccess("field3")),
