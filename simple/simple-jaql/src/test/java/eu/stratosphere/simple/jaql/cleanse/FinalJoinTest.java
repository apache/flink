	...
	public void testComplexJoin() {
		...
		final Join join = new Join()
			...
			withJoinCondition(
				new AndExpression(
					new OrExpression(
						new ElementInSetExpression(createPath("1", "id"), Quantor.EXISTS_IN, createPath("0",
							"relatives", "[*]", "id")),
						new ComparativeExpression(createPath("1", "id"), BinaryOperator.EQUAL, createPath("0", "id"))),
					new ElementInSetExpression(createPath("2", "id"), Quantor.EXISTS_IN, createPath("0",
						"enacted_funds", "[*]", "id")),
					new ElementInSetExpression(createPath("3", "id"), Quantor.EXISTS_IN, createPath("2", "recipients")),
					new OrExpression(
						new ElementInSetExpression(createPath("4", "id"), Quantor.EXISTS_IN, createPath("3",
							"subsidiaries", "[*]", "id")),
