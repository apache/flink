 ...
 */
public class TestMessageHeaders implements MessageHeaders<TestRequestBody, TestResponseBody, TestMessageParameters> {

	private static final String URL = "/test/:" + TestPathParameter.KEY;
	...
	@Override
	public Class<TestResponseBody> getResponseClass() {
	...
	public String getDescription() {
		return "This is a testing REST API.";
	}
