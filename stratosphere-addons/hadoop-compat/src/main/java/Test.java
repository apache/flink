 ...
 */
public class Test implements Program, ProgramDescription {
	...
	public static class TokenizeLine extends MapFunction implements Serializable {
		...
		public void map(Record record, Collector<Record> collector) {
			...
			long line1 = record.getField(0, LongValue.class).getValue();
			String line2 = record.getField(1, StringValue.class).getValue();
...
//				collector.collect(new Record(new StringValue(word), new IntValue(1)));
				collector.collect(new Record(new LongValue(line1), new StringValue(line2)));
//			}
		}
	}
