...
public class TestingMesosWorkerStore implements MesosWorkerStore {
	...
	public static class Builder {
		...
		private Supplier<Option<Protos.FrameworkID>> getFrameworkIDSupplier =
				() -> Option.apply(Protos.FrameworkID.newBuilder().setValue("testing-framework").build());
		...
		private Supplier<Protos.TaskID> newTaskIDSupplier = () -> Protos.TaskID.newBuilder().setValue("testing-task").build();
		...
		public Builder setGetFrameworkIDSupplier(Supplier<Option<Protos.FrameworkID>> getFrameworkIDSupplier) {
			this.getFrameworkIDSupplier = Preconditions.checkNotNull(getFrameworkIDSupplier);
			return this;
		}

		public Builder setSetFrameworkIDConsumer(Consumer<Option<Protos.FrameworkID>> setFrameworkIDConsumer) {
		...
		public Builder setRemoveWorkerFunction(Function<Protos.TaskID, Boolean> removeWorkerFunction) {
