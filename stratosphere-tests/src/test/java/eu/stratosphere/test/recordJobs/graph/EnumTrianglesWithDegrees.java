...
import eu.stratosphere.test.recordJobs.graph.ComputeEdgeDegrees.CountEdges;
import eu.stratosphere.test.recordJobs.graph.ComputeEdgeDegrees.JoinCountsAndUniquify;
import eu.stratosphere.test.recordJobs.graph.ComputeEdgeDegrees.ProjectEdge;
import eu.stratosphere.test.recordJobs.graph.EnumTrianglesOnEdgesWithDegrees.BuildTriads;
import eu.stratosphere.test.recordJobs.graph.EnumTrianglesOnEdgesWithDegrees.CloseTriads;
import eu.stratosphere.test.recordJobs.graph.EnumTrianglesOnEdgesWithDegrees.ProjectOutCounts;
import eu.stratosphere.test.recordJobs.graph.EnumTrianglesOnEdgesWithDegrees.ProjectToLowerDegreeVertex;
