...
import eu.stratosphere.example.java.record.relational.TPCHQuery3.AggLiO;
import eu.stratosphere.example.java.record.relational.TPCHQuery3.FilterO;
import eu.stratosphere.example.java.record.relational.TPCHQuery3.JoinLiO;
