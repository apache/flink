...
public class DenseVectorTest {
	...
	@Test
	public void normMax() throws Exception {
		DenseVector vec = new DenseVector(new double[]{1, 2, -3});
	...
	public void normalize() throws Exception {
		...
		Assert.assertArrayEquals(((DenseVector) vec).getData(), new double[]{1. / 6, 2. / 6, -3. / 6}, 1e-6);
	}
	...
	public void standardize() throws Exception {
		...
		Assert.assertArrayEquals(((DenseVector) vec).getData(), new double[]{0, 1, -4}, 1e-6);
	}
