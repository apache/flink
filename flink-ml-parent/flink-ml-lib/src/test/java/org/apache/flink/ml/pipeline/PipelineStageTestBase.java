 ...
 * Transformers. This class is package private because we do not expect extension outside of the
 * package.
 */
abstract class PipelineStageTestBase {
    ...
    public void testMismatchTableEnvironment() {
        ...
        if (pipelineStageBase instanceof EstimatorBase) {
            ((Estimator) pipelineStageBase)
                    .fit(MLEnvironmentFactory.getDefault().getBatchTableEnvironment(), t);
        } else {
