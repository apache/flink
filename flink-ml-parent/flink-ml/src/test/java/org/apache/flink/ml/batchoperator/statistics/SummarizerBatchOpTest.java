...
import org.apache.flink.ml.pipeline.statistics.Summarizer;

import org.junit.Assert;
import org.junit.Test;

/**
 * Test for SummarizerBatchOp.
 */
public class SummarizerBatchOpTest {
	@Test
	public void testTable() throws Exception {
		BatchOperator data = GenerateData.getMultiTypeTable();
		SummarizerBatchOp summary = new SummarizerBatchOp();
		data.link(summary).print();
	}

	@Test
	public void testTableWithSelected() throws Exception {
		BatchOperator data = GenerateData.getMultiTypeTable();
		SummarizerBatchOp summary = new SummarizerBatchOp()
	...
	@Test
	public void testSparseTable() throws Exception {
		BatchOperator data = GenerateData.getSparseVector();
		VectorSummarizerBatchOp summary = new VectorSummarizerBatchOp()
			.setSelectedColName("vec");
		data.link(summary).print();
	}

	@Test
	public void testDenseTable() throws Exception {
		BatchOperator data = GenerateData.getDenseVector();
		VectorSummarizerBatchOp summary = new VectorSummarizerBatchOp()
			.setSelectedColName("vec");
		data.link(summary).print();
	}
