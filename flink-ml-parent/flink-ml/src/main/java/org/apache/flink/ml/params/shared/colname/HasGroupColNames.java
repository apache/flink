 ...
 */
public interface HasGroupColNames<T> extends BaseWithParam <T> {

	ParamInfo <String[]> GROUP_COL_NAMES = ParamInfoFactory
		.createParamInfo("groupColNames", String[].class)
		.setDescription("Names of grouping columns")
		.setRequired()
		.build();
