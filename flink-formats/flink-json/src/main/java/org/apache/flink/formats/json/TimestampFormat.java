...
public enum TimestampFormat {
    /**
     * Options to specify timestamp format. It will parse timestamp in "yyyy-MM-dd
     ...
     * "yyyy-MM-ddTHH:mm:ss.s{precision}" format and output timestamp in the same format
     */
    ISO_8601
}
