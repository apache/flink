...
interface RuntimeSerializationConverterFactory {
	...
	/**
	 * Creates a converter based on the given {@link RowTypeInfo} that can be used during runtime to serialize
	 * {@link org.apache.flink.types.Row}s into json.
	 */
	SerializationRuntimeConverter getSerializationRuntimeConverter(RowTypeInfo typeInfo);
}
