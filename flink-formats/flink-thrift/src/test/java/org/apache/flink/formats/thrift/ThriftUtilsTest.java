...
/**
 * Unit tests for ThriftUtils methods.
 */
public class ThriftUtilsTest {

	@Test
	public void getMetaDataMapFieldTest() throws IOException {
		Map<TFieldIdEnum, FieldMetaData> metaDataMap = ThriftUtils.getMetaDataMapField(Event.class);
