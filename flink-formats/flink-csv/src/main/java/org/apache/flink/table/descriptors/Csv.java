...
public class Csv extends FormatDescriptor {
    ...
    /**
     * Skip fields and rows with parse errors instead of failing. Fields are set to {@code null} in
     * case of errors. By default, an exception is thrown.
     */
    ...
    /**
     * Sets the array element delimiter string for separating array or row element values (";" by
     * default).
     *
     ...
     * @deprecated {@link Csv} supports derive schema from table schema by default, it is no longer
