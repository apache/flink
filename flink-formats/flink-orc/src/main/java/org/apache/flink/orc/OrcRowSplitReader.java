 ...
 */
public class OrcRowSplitReader extends OrcSplitReader<Row, HiveOrcVectorizedBatch> {
	...
	protected int fillRows() {
		return OrcBatchReader.fillRows(rows, schema, rowBatch.getBatch(), selectedFields);
	}
