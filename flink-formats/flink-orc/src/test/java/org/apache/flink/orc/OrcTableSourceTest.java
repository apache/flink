...
public class OrcTableSourceTest {
    ...
    public void testProjectFields() throws Exception {
        ...
        assertEquals(
                Types.ROW_NAMED(
                        ...
                        new TypeInformation[] {
                            fieldTypes[3], fieldTypes[5], fieldTypes[1], fieldTypes[0]
                        }),
    ...
    public void testApplyPredicate() throws Exception {
        ...
        ArgumentCaptor<OrcSplitReader.Predicate> arguments =
                ArgumentCaptor.forClass(OrcSplitReader.Predicate.class);
        ...
        assertTrue(
                values.contains(
                        new OrcSplitReader.Not(
                                        new OrcSplitReader.LessThanEquals(
                                                "int1", PredicateLeaf.Type.LONG, 100))
                                .toString()));
        assertTrue(
                values.contains(
    ...
    public void testUnsupportedPredOnly() {
        ...
        // apply predicates on TableSource
        OrcTableSource projected =
                (OrcTableSource) orc.applyPredicate(Collections.singletonList(unsupportedPred()));
