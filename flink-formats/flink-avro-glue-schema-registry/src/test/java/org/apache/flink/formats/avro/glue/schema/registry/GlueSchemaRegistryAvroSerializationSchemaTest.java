...
public class GlueSchemaRegistryAvroSerializationSchemaTest {
    @Mock private GlueSchemaRegistrySerializationFacade mockSerializationFacade;
    ...
    public void testSerialize_withValidParams_succeeds(
        ...
        when(mockSerializationFacade.encode(
                        anyString(),
