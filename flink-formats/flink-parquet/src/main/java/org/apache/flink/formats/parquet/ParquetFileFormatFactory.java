...
public class ParquetFileFormatFactory implements BulkReaderFormatFactory, BulkWriterFormatFactory {
    ...
    public static final ConfigOption<Boolean> WRITE_INT64_TIMESTAMP =
            key("write.int64.timestamp")
                    ...
                    .defaultValue(false)
                    .withDescription(
                            "Write parquet timestamp as int64/LogicalTypes instead of int96/OriginalTypes. Note: Timestamp will be time zone agnostic (NEVER converted to a different time zone).");
