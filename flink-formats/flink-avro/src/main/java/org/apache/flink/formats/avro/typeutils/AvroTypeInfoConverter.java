...
/**
 * Utils for avro record class conversion.
 */
public class AvroTypeInfoConverter {
	/**
	...
	public static <T extends SpecificRecordBase> TypeInformation<Row> convertToRowTypeInformation(Class<T> avroClass) {
