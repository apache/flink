...
class AwsSdkMetricBridgeTest {
    ...
    void startsPublishingAfterMetricGroupIsAttached() {
        ...
        final MetricCollection call = apiCall("PutObject", Duration.ofMillis(120), true, 0, 200);
    ...
    void reattachingMetricGroupRedirectsSubsequentMetrics() {
        ...
        final AwsSdkMetricBridge bridge = new AwsSdkMetricBridge(firstListener.getMetricGroup());
        final MetricCollection call = apiCall("PutObject", Duration.ofMillis(120), true, 0, 200);
        ...
        assertThat(count(firstListener, "op", "PutObject", "status_class", "2xx", "api_call_count"))
                .isEqualTo(1L);
        assertThat(
                        count(
                                secondListener,
