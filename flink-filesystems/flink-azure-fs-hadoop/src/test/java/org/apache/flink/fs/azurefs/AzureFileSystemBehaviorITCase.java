...
class AzureFileSystemBehaviorITCase {
    ...
    @Nested
    class HttpsAzureFileSystemBehaviorITCase extends AzureFileSystemBehaviorITCaseBase {
        @Override
    ...
    /**
     * Azure Blob Storage defaults to https only storage accounts, tested above.
     *
    ...
    class HttpSupportAzureFileSystemBehaviorITCase extends AzureFileSystemBehaviorITCaseBase {
        @BeforeAll
    ...
    abstract static class AzureFileSystemBehaviorITCaseBase extends FileSystemBehaviorTestSuite {

        static final String CONTAINER = System.getenv("ARTIFACTS_AZURE_CONTAINER");
        static final String ACCOUNT = System.getenv("ARTIFACTS_AZURE_STORAGE_ACCOUNT");
        private static final String ACCESS_KEY = System.getenv("ARTIFACTS_AZURE_ACCESS_KEY");
        static final String RESOURCE_GROUP = System.getenv("ARTIFACTS_AZURE_RESOURCE_GROUP");
        ...
        static void checkCredentialsAndSetup() {
            ...
            conf.setString(
                    "fs.azure.account.key." + ACCOUNT + ".blob.core.windows.net", ACCESS_KEY);
        ...
        void testDirectoryListing() throws Exception {
            ...
            try {
                ...
                for (int i = 0; i < numFiles; i++) {
                    ...
                    // just in case, wait for the file to exist (should then also be reflected in
