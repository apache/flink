...
public final class HadoopBlockLocation implements BlockLocation {
    ...
    public String[] getHosts() throws IOException {
         ...
         * BlockLocation.getHosts() contains the hostnames with their respective domain suffix or
         * not (FQDN or not). We have witnessed both versions, depending on the cluster's network
         * configuration. As a workaround, we therefore strip every hostname to make sure it does
         * not contain the domain suffix.
         */
