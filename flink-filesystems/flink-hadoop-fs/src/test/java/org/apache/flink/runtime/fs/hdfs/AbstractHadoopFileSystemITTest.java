...
public abstract class AbstractHadoopFileSystemITTest extends TestLogger {
    ...
    /** Gets an instance of the {@code FileSystem}. */
    protected abstract FileSystem getFileSystem() throws Exception;

    /** Gets the base path in the of the file system. */
    ...
    @Test
    public void testUniqueBasePath() throws Exception {
        // check for uniqueness of the test directory
        // directory must not yet exist
        assertThat(getFileSystem().exists(getBasePath())).isFalse();
    }
    ...
    public void testSimpleFileWriteAndRead() throws Exception {
        ...
        try {
            ...
            try (FSDataInputStream in = fs.open(path);
                ...
                assertThat(testLine).isEqualTo(line);
            }
        } finally {
