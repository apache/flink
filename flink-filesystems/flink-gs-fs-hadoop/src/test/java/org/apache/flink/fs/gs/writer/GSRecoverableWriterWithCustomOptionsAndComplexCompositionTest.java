...
public class GSRecoverableWriterWithCustomOptionsAndComplexCompositionTest
        extends GSRecoverableWriterWithOptionsTestBase {

    /**
     * Construct the test, using a data set count of 70 (i.e. >32) means that the composition will
     * be complex, i.e. performed in multiple steps. Since this uses a custom temporary bucket,
