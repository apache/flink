...
public class GSRecoverableWriterWithDefaultOptionsAndSimpleCompositionTest
     ...
     * be simple, i.e. performed in one step. Since this uses the default temporary bucket, there
