 ...
 */
public class FlinkS3FileSystem extends FileSystem {
	...
	public FlinkS3FileSystem(
		...
		this.fs = checkNotNull(hadoopS3FileSystem, "hadoopS3FileSystem");
	...
	@Override
	public FSDataOutputStream create(final Path f, final WriteMode overwrite) throws IOException {
