...
public class OSSTestUtils {
	...
	public static void objectContentEquals(FileSystem fs, Path objectPath, List<byte[]> expectContents) throws IOException {
		String actualContent;
		try (FSDataInputStream in = fs.open(objectPath); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
	...
	public static void objectContentEquals(FileSystem fs, Path objectPath, byte[] ... expectContents) throws IOException {
	...
	public static void uploadPart(OSSRecoverableMultipartUpload uploader, final TemporaryFolder temporaryFolder, final byte[] content) throws IOException {
	...
	public static RefCountedBufferingFileStream writeData(TemporaryFolder temporaryFolder, byte[] content) throws IOException {
