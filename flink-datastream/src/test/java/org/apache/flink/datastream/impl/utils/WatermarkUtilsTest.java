...
import org.apache.flink.streaming.api.watermark.generalized.Alignable;
import org.apache.flink.streaming.api.watermark.generalized.AlignableLongWatermarkDeclaration;
...
public class WatermarkUtilsTest {
    ...
    @Test
    public void testGetInternalWatermarkDeclarationsFromStreamGraph()
        ...
        assertThat(watermarkDeclarations.size()).isEqualTo(internalWatermarkDeclarations.size());
        ...
        NonKeyedPartitionStream.ProcessConfigurableAndNonKeyedPartitionStream<Integer> stream1 =
                source.process(
                        new OneInputStreamProcessFunction<Integer, Integer>() {
                            ...
                            @Override
                            public Collection<? extends WatermarkDeclaration>
                                    watermarkDeclarations() {
                                return Collections.singletonList(watermarkDeclarations.get(0));
                            }
                        });
                ...
                stream2 =
                        stream1.process(
                                new TwoOutputStreamProcessFunction<Integer, Integer, Integer>() {
                                    ...
                                    public Collection<? extends WatermarkDeclaration>
                                            watermarkDeclarations() {
                                        return watermarkDeclarations.subList(
