...
class StreamingJobGraphGeneratorWithAttributeTest {
    ...
    void testNoOutputUntilEndOfInputWithOperatorChainCase1() throws Exception {
        ...
        assertManagedMemoryWeightsSize(nodeMap.get("Source: Collection Source"), 0);
    ...
    private static class TestMapTask1 implements OneInputStreamProcessFunction<Integer, Integer> {
    ...
    private static class TestMapTask2 implements OneInputStreamProcessFunction<Integer, Integer> {
