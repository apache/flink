 ...
 * Tuples.
 */
public class StreamRecordGeneric<T extends Tuple> implements IOReadableWritable, Serializable {
	private static final long serialVersionUID = 1L;

	protected List<T> tupleBatch;
	...
	public StreamRecordGeneric(int numOfFields) {
		...
		this.numOfTuples = 0;
		this.batchSize = 1;
		tupleBatch = new ArrayList<T>(batchSize);
	}
	...
	public StreamRecordGeneric(StreamRecordGeneric<T> record) {
		this.numOfFields = record.getNumOfFields();
		this.numOfTuples = 0;
		tupleBatch = new ArrayList<T>();
	 ...
	 */
	public StreamRecordGeneric<T> setId(int channelID) {
	 ...
	 */
	public Iterable<T> getBatchIterable() {
		return (Iterable<T>) tupleBatch;
	}
	 ...
	 */
	public StreamRecordGeneric<T> copySerialized() throws IOException {
		ByteArrayOutputStream buff = new ByteArrayOutputStream();
		DataOutputStream out = new DataOutputStream(buff);
		StreamRecordGeneric<T> newRecord = new StreamRecordGeneric<T>();
		this.write(out);
	 ...
	 * 
	 */
	public StreamRecordGeneric<T> copy() {
		StreamRecordGeneric<T> newRecord = new StreamRecordGeneric<T>(numOfFields, numOfTuples);
	 ...
	 */
	public void appendRecord(StreamRecordGeneric<T> record) {
		for (int i = 0; i < record.getNumOfTuples(); ++i) {
