...
//
//public final class OldStreamRecord {
//	private Record record;
//	private StringValue uid = new StringValue("");
//	private String channelID = "";
//
//	public OldStreamRecord(Record record) {
//		this.record = record.createCopy();
//	}
//
//	public OldStreamRecord(Record record, String channelID) {
//		this.record = record.createCopy();
//		this.channelID = channelID;
//	}
//	
//	public OldStreamRecord addId() {
