...
public class FaultToleranceUtilTest {
	...
	public void testAddRecord() {
		...
		assertArrayEquals(record.getRecord(0),
				faultTolerancyBuffer.getRecordBuffer().get(record.getId()).getRecord(0));
	}
	...
	public void testAddTimestamp() {
		...
		assertArrayEquals(records, faultTolerancyBuffer.getRecordsByTime().get(recordTimeStamp)
				.toArray());
	...
	public void testPopRecord() {
		...
		assertArrayEquals(record1.getRecord(0), faultTolerancyBuffer.removeRecord(record1.getId())
				.getRecord(0));
		System.out.println("---------");
	}
	...
	public void testFailRecord() {
		...
		Long record2TS = faultTolerancyBuffer.getRecordTimestamps().get(newID);
		...
		assertTrue(faultTolerancyBuffer.getRecordBuffer().containsKey(newID));
		assertTrue(faultTolerancyBuffer.getAckCounter().containsKey(newID));
		assertTrue(faultTolerancyBuffer.getRecordTimestamps().containsKey(newID));
		assertTrue(faultTolerancyBuffer.getRecordsByTime().get(record2TS).contains(newID));
		System.out.println("---------");
	}
