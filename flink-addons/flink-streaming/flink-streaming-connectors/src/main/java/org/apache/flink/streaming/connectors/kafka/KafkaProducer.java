 ...
 * 		java -cp kafka-0.8/libs/*:yourJarFile.jar org.apache.flink.streaming.kafka.KafkaProducer yourTopicID kafkaServerIp
 * As an example:
 * 		java -cp kafka-0.8/libs/*:stratosphere-streaming.jar org.apache.flink.streaming.kafka.KafkaProducer test localhost:9092
 */
