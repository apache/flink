...
public class HadoopInputFormatTest {
	...
	public class DummyParquetInputFormat<T> extends FileInputFormat<Void, T> {

		public DummyParquetInputFormat() {
		}
	...
	public void checkTypeInformation() {
		try {
			...
			HadoopInputFormat<Void, Long> hadoopInputFormat = new HadoopInputFormat<Void, Long>( new DummyParquetInputFormat(), Void.class, Long.class, new JobConf());
